...
set logging off
set logging redirect off
set logging file AES1.log
set logging redirect on
set logging on
x/256x 0x50050400
set logging off
set logging redirect off
set logging file AES2.log
set logging redirect on
set logging on
x/256x 0x58001800
set logging off
...
set logging off
set logging redirect off
set logging file SCB.log
set logging redirect on
set logging on
x/17x 0xE000ED00
set logging off
set logging redirect off
set logging file MPU.log
set logging redirect on
set logging on
x/6x 0xE000ED90
set logging off
set logging redirect off
set logging file STK.log
set logging redirect on
set logging on
x/5x 0xE000E010
set logging off
set logging redirect off
set logging file FPU.log
set logging redirect on
set logging on
x/4x 0xE000EF34
set logging off
