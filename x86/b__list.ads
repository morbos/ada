...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_list" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#731bb461#;
   pragma Export (C, u00001, "listB");
   ...
   u00114 : constant Version_32 := 16#4b56bef7#;
   pragma Export (C, u00114, "gen_listB");
   u00115 : constant Version_32 := 16#4741cd9a#;
   pragma Export (C, u00115, "gen_listS");
