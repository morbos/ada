...
package body STM32.PKA is
   ...
   is
      RCC : aliased RCC_Peripheral with Import, Address => STM32_SVD.RCC_Base;
   begin
      RCC.AHB3ENR.PKAEN := True;
      loop
         PKA.CR.EN := True;
         exit when PKA.CR.EN;
      end loop;
   ...
   procedure Clear_Ram
   is
      PKA_RAM : aliased All_PKA_Ram with Import, Volatile, Address => STM32_SVD.PKA_Base;
   begin
   ...
   begin
      ...
      if Mode = Signing then
         declare
            ECDSA : aliased ECDSA_Sign_Ram with Import, Address => STM32_SVD.PKA_Base;
         begin
         ...
         declare
            ECDSA : aliased ECDSA_Verify_Ram with Import, Address => STM32_SVD.PKA_Base;
         begin
            Copy_S_To_U32 (Curve.P, ECDSA.Mod_GF);
         ...
         declare
            ECDSA : aliased ECDSA_Point_Check_Ram with Import, Address => STM32_SVD.PKA_Base;
         begin
         ...
         declare
            ECDSA : aliased ECDSA_Ram with Import, Address => STM32_SVD.PKA_Base;
         begin
            Copy_S_To_U32 (Curve.P, ECDSA.Mod_GF);
         end;
      end if;
   ...
   is
      ECDSA : aliased ECDSA_Point_Ram with Import, Address => STM32_SVD.PKA_Base;
   begin
      Enable_Pka;
      Curve := Common_Init (Field_Arithmetic);
      Clear_Ram;
