...
--  Failure to follow the procedure will yield no RND numbers
   ...
   begin
      if not RNG.CR.RNGEN then
         ...
         loop
            exit when not SEC_RNG_Periph.CR.CONDRST;
         end loop;
