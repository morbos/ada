...
package STM32_SVD.RTC is
   ...
   type RTC_MISR_Register is record
      ...
      ALRAMF        : Boolean;
      --  Read-only. Alarm B nonsecure masked flag
      ALRBMF        : Boolean;
      --  Read-only. Wake-up timer nonsecure masked flag
      WUTMF         : Boolean;
      --  Read-only. Timestamp nonsecure masked flag
      TSMF          : Boolean;
      --  Read-only. Timestamp overflow nonsecure masked flag
      TSOVMF        : Boolean;
      --  Read-only. Internal timestamp nonsecure masked flag
      ITSMF         : Boolean;
      --  Read-only. SSR underflow nonsecure masked flag
      SSRUMF        : Boolean;
      --  unspecified
      Reserved_7_31 : HAL.UInt25;
   end record
   ...
   type RTC_TAMPTSCR_Register is record
      --  Timestamp on external tamper TAMP1 event
      TAMP1TS        : Boolean := False;
      --  Timestamp on external tamper TAMP2 event
      TAMP2TS        : Boolean := False;
      --  Timestamp on external tamper TAMP3 event
      TAMP3TS        : Boolean := False;
      --  Timestamp on external tamper TAMP4 event
      TAMP4TS        : Boolean := False;
      --  Timestamp on external tamper TAMP5 event
      TAMP5TS        : Boolean := False;
      --  unspecified
      Reserved_5_15  : HAL.UInt11 := 16#0#;
      --  Timestamp on internal tamper event
      ITAMPTS        : Boolean := False;
      --  unspecified
      Reserved_17_31 : HAL.UInt15 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   for RTC_TAMPTSCR_Register use record
      TAMP1TS        at 0 range 0 .. 0;
      TAMP2TS        at 0 range 1 .. 1;
      TAMP3TS        at 0 range 2 .. 2;
      TAMP4TS        at 0 range 3 .. 3;
      TAMP5TS        at 0 range 4 .. 4;
      Reserved_5_15  at 0 range 5 .. 15;
      ITAMPTS        at 0 range 16 .. 16;
      Reserved_17_31 at 0 range 17 .. 31;
   end record;

   subtype RTC_TSIDR_TSID_Field is HAL.UInt6;

   --  RTC timestamp status register
   type RTC_TSIDR_Register is record
      --  Read-only. Timestamp flag source identification
      TSID          : RTC_TSIDR_TSID_Field;
      --  unspecified
   ...
   for RTC_TSIDR_Register use record
      TSID          at 0 range 0 .. 5;
   ...
   type RTC_Peripheral is record
      ...
      --  RTC timestamp on tamper control register
      RTC_TAMPTSCR : aliased RTC_TAMPTSCR_Register;
      --  RTC timestamp status register
      RTC_TSIDR    : aliased RTC_TSIDR_Register;
   ...
   for RTC_Peripheral use record
      ...
      RTC_TAMPTSCR at 16#64# range 0 .. 31;
      RTC_TSIDR    at 16#68# range 0 .. 31;
