...
package STM32_SVD.I2C is
   ...
   type I2C_ISR_Register is record
      ...
      --  Read-only. Timeout or tless thansub>LOWless than/sub> detection flag
   ...
   type I2C_AUTOCR_Register is record
      ...
      --  Trigger selection (refer to Section45.
   ...
   --  I2C1 address block description
   ...
   SEC_I2C1_Periph : aliased I2C_Peripheral
     with Import, Address => SEC_I2C1_Base;

   --  I2C1 address block description
   SEC_I2C2_Periph : aliased I2C_Peripheral
     with Import, Address => SEC_I2C2_Base;

   --  I2C1 address block description
   SEC_I2C3_Periph : aliased I2C_Peripheral
     with Import, Address => SEC_I2C3_Base;

   --  I2C1 address block description
   SEC_I2C4_Periph : aliased I2C_Peripheral
     with Import, Address => SEC_I2C4_Base;
