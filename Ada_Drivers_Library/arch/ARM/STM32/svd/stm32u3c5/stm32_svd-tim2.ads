...
package STM32_SVD.TIM2 is
   ...
   subtype TIM2_CCMR1_CC1S_Field is HAL.UInt2;
   subtype TIM2_CCMR1_IC1PSC_Field is HAL.UInt2;
   subtype TIM2_CCMR1_IC1F_Field is HAL.UInt4;
   subtype TIM2_CCMR1_CC2S_Field is HAL.UInt2;
   subtype TIM2_CCMR1_IC2PSC_Field is HAL.UInt2;
   subtype TIM2_CCMR1_IC2F_Field is HAL.UInt4;

   --  TIM2 capture/compare mode register 1
   type TIM2_CCMR1_Register is record
      --  Capture/Compare 1 selection
      CC1S           : TIM2_CCMR1_CC1S_Field := 16#0#;
      --  Input capture 1 prescaler
      IC1PSC         : TIM2_CCMR1_IC1PSC_Field := 16#0#;
      --  Input capture 1 filter
      IC1F           : TIM2_CCMR1_IC1F_Field := 16#0#;
      --  Capture/compare 2 selection
      CC2S           : TIM2_CCMR1_CC2S_Field := 16#0#;
      --  Input capture 2 prescaler
      IC2PSC         : TIM2_CCMR1_IC2PSC_Field := 16#0#;
      --  Input capture 2 filter
      IC2F           : TIM2_CCMR1_IC2F_Field := 16#0#;
      --  unspecified
   ...
   for TIM2_CCMR1_Register use record
      CC1S           at 0 range 0 .. 1;
   ...
   subtype TIM2_CCMR1_ALTERNATE1_CC1S_Field is HAL.UInt2;
   subtype TIM2_CCMR1_ALTERNATE1_OC1M_Field is HAL.UInt3;
   subtype TIM2_CCMR1_ALTERNATE1_CC2S_Field is HAL.UInt2;
   subtype TIM2_CCMR1_ALTERNATE1_OC2M_Field is HAL.UInt3;

   --  TIM2 capture/compare mode register 1
   type TIM2_CCMR1_ALTERNATE1_Register is record
      --  Capture/Compare 1 selection
      CC1S           : TIM2_CCMR1_ALTERNATE1_CC1S_Field := 16#0#;
      --  Output compare 1 fast enable
      OC1FE          : Boolean := False;
      --  Output compare 1 preload enable
      OC1PE          : Boolean := False;
      --  OC1M[2:0]: Output compare 1 mode
      OC1M           : TIM2_CCMR1_ALTERNATE1_OC1M_Field := 16#0#;
      --  Output compare 1 clear enable
      OC1CE          : Boolean := False;
      --  Capture/Compare 2 selection
      CC2S           : TIM2_CCMR1_ALTERNATE1_CC2S_Field := 16#0#;
      --  Output compare 2 fast enable
      OC2FE          : Boolean := False;
      --  Output compare 2 preload enable
      OC2PE          : Boolean := False;
      --  OC2M[2:0]: Output compare 2 mode
      OC2M           : TIM2_CCMR1_ALTERNATE1_OC2M_Field := 16#0#;
   ...
   for TIM2_CCMR1_ALTERNATE1_Register use record
      CC1S           at 0 range 0 .. 1;
   ...
   subtype TIM2_CCMR2_CC3S_Field is HAL.UInt2;
   subtype TIM2_CCMR2_IC3PSC_Field is HAL.UInt2;
   subtype TIM2_CCMR2_IC3F_Field is HAL.UInt4;
   subtype TIM2_CCMR2_CC4S_Field is HAL.UInt2;
   subtype TIM2_CCMR2_IC4PSC_Field is HAL.UInt2;
   subtype TIM2_CCMR2_IC4F_Field is HAL.UInt4;

   --  TIM2 capture/compare mode register 2
   type TIM2_CCMR2_Register is record
      --  Capture/Compare 3 selection
      CC3S           : TIM2_CCMR2_CC3S_Field := 16#0#;
      --  Input capture 3 prescaler
      IC3PSC         : TIM2_CCMR2_IC3PSC_Field := 16#0#;
      --  Input capture 3 filter
      IC3F           : TIM2_CCMR2_IC3F_Field := 16#0#;
      --  Capture/Compare 4 selection
      CC4S           : TIM2_CCMR2_CC4S_Field := 16#0#;
      --  Input capture 4 prescaler
      IC4PSC         : TIM2_CCMR2_IC4PSC_Field := 16#0#;
      --  Input capture 4 filter
      IC4F           : TIM2_CCMR2_IC4F_Field := 16#0#;
      --  unspecified
      Reserved_16_31 : HAL.UInt16 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   for TIM2_CCMR2_Register use record
      CC3S           at 0 range 0 .. 1;
   ...
   subtype TIM2_CCMR2_ALTERNATE1_CC3S_Field is HAL.UInt2;
   subtype TIM2_CCMR2_ALTERNATE1_OC3M_Field is HAL.UInt3;
   subtype TIM2_CCMR2_ALTERNATE1_CC4S_Field is HAL.UInt2;
   subtype TIM2_CCMR2_ALTERNATE1_OC4M_Field is HAL.UInt3;

   --  TIM2 capture/compare mode register 2
   type TIM2_CCMR2_ALTERNATE1_Register is record
      --  Capture/Compare 3 selection
      CC3S           : TIM2_CCMR2_ALTERNATE1_CC3S_Field := 16#0#;
      --  Output compare 3 fast enable
      OC3FE          : Boolean := False;
      --  Output compare 3 preload enable
      OC3PE          : Boolean := False;
      --  OC3M[2:0]: Output compare 3 mode
      OC3M           : TIM2_CCMR2_ALTERNATE1_OC3M_Field := 16#0#;
      --  Output compare 3 clear enable
      OC3CE          : Boolean := False;
      --  Capture/Compare 4 selection
      CC4S           : TIM2_CCMR2_ALTERNATE1_CC4S_Field := 16#0#;
      --  Output compare 4 fast enable
      OC4FE          : Boolean := False;
      --  Output compare 4 preload enable
      OC4PE          : Boolean := False;
      --  OC4M[2:0]: Output compare 4 mode
      OC4M           : TIM2_CCMR2_ALTERNATE1_OC4M_Field := 16#0#;
   ...
   for TIM2_CCMR2_ALTERNATE1_Register use record
      CC3S           at 0 range 0 .. 1;
   ...
   type TIM2_Peripheral
     (Discriminent : SEC_TIM2_Disc := Default)
   is record
      --  TIM2 control register 1
      ...
      case Discriminent is
         when Default =>
            --  TIM2 capture/compare mode register 1
            TIM2_CCMR1 : aliased TIM2_CCMR1_Register;
            --  TIM2 capture/compare mode register 2
            TIM2_CCMR2 : aliased TIM2_CCMR2_Register;
         when Alternate1 =>
            --  TIM2 capture/compare mode register 1
            TIM2_CCMR1_ALTERNATE1 : aliased TIM2_CCMR1_ALTERNATE1_Register;
            --  TIM2 capture/compare mode register 2
            TIM2_CCMR2_ALTERNATE1 : aliased TIM2_CCMR2_ALTERNATE1_Register;
      end case;
   end record
   ...
   for TIM2_Peripheral use record
      ...
      TIM2_CCMR1            at 16#18# range 0 .. 31;
      TIM2_CCMR2            at 16#1C# range 0 .. 31;
      TIM2_CCMR1_ALTERNATE1 at 16#18# range 0 .. 31;
      TIM2_CCMR2_ALTERNATE1 at 16#1C# range 0 .. 31;
   end record;

   --  TIM2 address block description
   SEC_TIM2_Periph : aliased TIM2_Peripheral
