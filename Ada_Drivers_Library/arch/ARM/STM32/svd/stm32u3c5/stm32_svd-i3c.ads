...
package STM32_SVD.I3C is
   ...
   subtype I3C_CR_DCNT_Field is HAL.UInt16;
   subtype I3C_CR_ADD_Field is HAL.UInt7;
   subtype I3C_CR_MTYPE_Field is HAL.UInt4;
   ...
   subtype I3C_CR_ALTERNATE1_DCNT_Field is HAL.UInt16;
   subtype I3C_CR_ALTERNATE1_CCC_Field is HAL.UInt8;
   subtype I3C_CR_ALTERNATE1_MTYPE_Field is HAL.UInt4;
   ...
   subtype I3C_CFGR_TRIGSEL_Field is HAL.UInt4;
   ...
   type I3C_CFGR_Register is record
      ...
      --  FCF generation disable (when I3C acts as controller)
      FCFDIS         : Boolean := False;
      --  Hardware trigger signal selection (when IP acts as controller)
      TRIGSEL        : I3C_CFGR_TRIGSEL_Field := 16#0#;
      --  Hardware trigger signal polarity (when IP acts as controller)
      TRIGPOL        : Boolean := False;
      --  Hardware trigger enable (when IP acts as controller)
      TRIGHWEN       : Boolean := False;
   ...
   for I3C_CFGR_Register use record
      ...
      FCFDIS         at 0 range 23 .. 23;
      TRIGSEL        at 0 range 24 .. 27;
      TRIGPOL        at 0 range 28 .. 28;
      TRIGHWEN       at 0 range 29 .. 29;
      TSFSET         at 0 range 30 .. 30;
      Reserved_31_31 at 0 range 31 .. 31;
   end record;

   subtype I3C_RDR_RDB0_Field is HAL.UInt8;
   ...
   subtype I3C_RDWR_RDB_Element is HAL.UInt8;
   ...
   subtype I3C_TDR_TDB0_Field is HAL.UInt8;
   ...
   subtype I3C_TDWR_TDB_Element is HAL.UInt8;
   ...
   subtype I3C_IBIDR_IBIDB_Element is HAL.UInt8;
   ...
   subtype I3C_TGTTDR_TGTTDCNT_Field is HAL.UInt16;
   ...
   subtype I3C_SR_xDCNT_Field is HAL.UInt16;
   subtype I3C_SR_MID_Field is HAL.UInt8;
   ...
   subtype I3C_SER_CODERR_Field is HAL.UInt4;
   ...
   subtype I3C_RMR_IBIRDCNT_Field is HAL.UInt3;
   subtype I3C_RMR_RCODE_Field is HAL.UInt8;
   subtype I3C_RMR_RADD_Field is HAL.UInt7;
   ...
   --  I3C masked interrupt status register
   type I3C_MISR_Register is record
      --  unspecified
      Reserved_0_1   : HAL.UInt2;
      --  Read-only. C-FIFO not full masked interrupt status (when the I3C acts
      --  as controller)
      CFNFMIS        : Boolean;
      --  Read-only. S-FIFO not empty masked interrupt status (when the I3C
      --  acts as controller)
      SFNEMIS        : Boolean;
      --  Read-only. Tx-FIFO not full masked interrupt status (whatever the I3C
      --  acts as controller/target)
      TxFNFMIS       : Boolean;
      --  Read-only. Rx-FIFO not empty masked interrupt status (whatever the
      --  I3C acts as controller/target)
      RxFNEMIS       : Boolean;
      --  unspecified
      Reserved_6_8   : HAL.UInt3;
      --  Read-only. frame complete masked interrupt status (whatever the I3C
      --  acts as controller/target)
      FCMIS          : Boolean;
      --  Read-only. target-initiated read end masked interrupt status (when
      --  the I3C acts as controller)
      RxTGTENDMIS    : Boolean;
      --  Read-only. error masked interrupt status (whatever the I3C acts as
      --  controller/target)
      ERRMIS         : Boolean;
      --  unspecified
      Reserved_12_14 : HAL.UInt3;
      --  Read-only. IBI request masked interrupt status (when the I3C acts as
      --  controller)
      IBIMIS         : Boolean;
      --  Read-only. IBI end masked interrupt status (when the I3C acts as
      --  target)
      IBIENDMIS      : Boolean;
      --  Read-only. Controller-role request masked interrupt status (when the
      --  I3C acts as controller)
      CRMIS          : Boolean;
      --  Read-only. Controller-role update masked interrupt status (when the
      --  I3C acts as target)
      CRUPDMIS       : Boolean;
      --  Read-only. Hot-join masked interrupt status (when the I3C acts as
      --  controller)
      HJMIS          : Boolean;
      --  unspecified
      Reserved_20_20 : HAL.Bit;
      --  Read-only. Wake-up/missed start masked interrupt status (when the I3C
      --  acts as target)
      WKPMIS         : Boolean;
      --  Read-only. GETxxx CCC masked interrupt status, except GETSTATUS of
      --  format 1 (when the I3C acts as target)
      GETMIS         : Boolean;
      --  Read-only. format 1 GETSTATUS CCC masked interrupt status (when the
      --  I3C acts as target)
      STAMIS         : Boolean;
      --  Read-only. ENTDAA/RSTDAA/SETNEWDA CCC masked interrupt status (when
      --  the I3C acts as target)
      DAUPDMIS       : Boolean;
      --  Read-only. SETMWL CCC masked interrupt status (when the I3C acts as
      --  target)
      MWLUPDMIS      : Boolean;
      --  Read-only. SETMRL CCC masked interrupt status (when the I3C acts as
      --  target)
      MRLUPDMIS      : Boolean;
      --  Read-only. reset pattern masked interrupt status (when the I3C acts
      --  as target)
      RSTMIS         : Boolean;
      --  Read-only. ENTASx CCC masked interrupt status (when the I3C acts as
      --  target)
      ASUPDMIS       : Boolean;
      --  Read-only. ENEC/DISEC CCC masked interrupt status (when the I3C acts
      --  as target)
      INTUPDMIS      : Boolean;
      --  Read-only. DEFTGTS CCC masked interrupt status (when the I3C acts as
      --  target)
      DEFMIS         : Boolean;
      --  Read-only. DEFGRPA CCC masked interrupt status (when the I3C acts as
      --  target)
      GRPMIS         : Boolean;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   for I3C_MISR_Register use record
      Reserved_0_1   at 0 range 0 .. 1;
      CFNFMIS        at 0 range 2 .. 2;
      SFNEMIS        at 0 range 3 .. 3;
      TxFNFMIS       at 0 range 4 .. 4;
      RxFNEMIS       at 0 range 5 .. 5;
      Reserved_6_8   at 0 range 6 .. 8;
      FCMIS          at 0 range 9 .. 9;
      RxTGTENDMIS    at 0 range 10 .. 10;
      ERRMIS         at 0 range 11 .. 11;
      Reserved_12_14 at 0 range 12 .. 14;
      IBIMIS         at 0 range 15 .. 15;
      IBIENDMIS      at 0 range 16 .. 16;
      CRMIS          at 0 range 17 .. 17;
      CRUPDMIS       at 0 range 18 .. 18;
      HJMIS          at 0 range 19 .. 19;
      Reserved_20_20 at 0 range 20 .. 20;
      WKPMIS         at 0 range 21 .. 21;
      GETMIS         at 0 range 22 .. 22;
      STAMIS         at 0 range 23 .. 23;
      DAUPDMIS       at 0 range 24 .. 24;
      MWLUPDMIS      at 0 range 25 .. 25;
      MRLUPDMIS      at 0 range 26 .. 26;
      RSTMIS         at 0 range 27 .. 27;
      ASUPDMIS       at 0 range 28 .. 28;
      INTUPDMIS      at 0 range 29 .. 29;
      DEFMIS         at 0 range 30 .. 30;
      GRPMIS         at 0 range 31 .. 31;
   end record;

   subtype I3C_DEVR0_DA_Field is HAL.UInt7;
   subtype I3C_DEVR0_AS_Field is HAL.UInt2;
   subtype I3C_DEVR0_RSTACT_Field is HAL.UInt2;
   ...
   subtype I3C_DEVR_DA_Field is HAL.UInt7;
   ...
   type I3C_DEVR_Register is record
      ...
      --  Read-only. Disables writes to DA[6:0] (when the I3C acts as
      --  controller)
      DIS            : Boolean := False;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype I3C_MAxRLR_MRL_Field is HAL.UInt16;
   subtype I3C_MAxRLR_IBIP_Field is HAL.UInt3;
   ...
   subtype I3C_MAxWLR_MWL_Field is HAL.UInt16;
   ...
   subtype I3C_TIMINGR0_SCLL_PP_Field is HAL.UInt8;
   subtype I3C_TIMINGR0_SCLH_I3C_Field is HAL.UInt8;
   subtype I3C_TIMINGR0_SCLL_OD_Field is HAL.UInt8;
   subtype I3C_TIMINGR0_SCLH_I2C_Field is HAL.UInt8;
   ...
   subtype I3C_TIMINGR1_AVAL_Field is HAL.UInt8;
   subtype I3C_TIMINGR1_ASNCR_Field is HAL.UInt2;
   subtype I3C_TIMINGR1_FREE_Field is HAL.UInt7;
   subtype I3C_TIMINGR1_SDA_HD_Field is HAL.UInt2;

   --  I3C timing register 1
   type I3C_TIMINGR1_Register is record
      --  Number of kernel clock cycles to set a time unit of 1 us, whatever
      --  I3C acts as controller or target.
      ...
      SDA_HD         : I3C_TIMINGR1_SDA_HD_Field := 16#0#;
      --  unspecified
   ...
   for I3C_TIMINGR1_Register use record
      ...
      SDA_HD         at 0 range 28 .. 29;
      Reserved_30_31 at 0 range 30 .. 31;
   end record;

   subtype I3C_TIMINGR2_STALL_Field is HAL.UInt8;

   --  I3C timing register 2
   type I3C_TIMINGR2_Register is record
      --  Controller clock stall enable on T-bit phase of data
      ...
      --  Controller clock stall enable in the data ACK/NACK phase of a legacy
      --  I2C read message.
      STALLR         : Boolean := False;
      --  Controller clock stall enable in the data ACK/NACK phase of a legacy
      --  I2C write message.
      STALLS         : Boolean := False;
      --  Controller clock stall enable in the address ACK/NACK phase (before
      --  the ninth bit) of a legacy I2C read/write message.
      STALLL         : Boolean := False;
      --  unspecified
   ...
   for I3C_TIMINGR2_Register use record
      ...
      STALLR         at 0 range 4 .. 4;
      STALLS         at 0 range 5 .. 5;
      STALLL         at 0 range 6 .. 6;
   ...
   subtype I3C_DCR_DCR_Field is HAL.UInt8;
   ...
   subtype I3C_GETMxDSR_HOFFAS_Field is HAL.UInt2;
   subtype I3C_GETMxDSR_FMT_Field is HAL.UInt2;
   subtype I3C_GETMxDSR_RDTURN_Field is HAL.UInt8;
   ...
   subtype I3C_EPIDR_MIPIID_Field is HAL.UInt4;
   subtype I3C_EPIDR_MIPIMID_Field is HAL.UInt15;
   ...
   is record
      ...
      --  I3C masked interrupt status register
      I3C_MISR          : aliased I3C_MISR_Register;
      --  I3C own device characteristics register
   ...
   --  I3C register block
   SEC_I3C1_Periph : aliased I3C_Peripheral
     with Import, Address => SEC_I3C1_Base;

   --  I3C register block
   SEC_I3C2_Periph : aliased I3C_Peripheral
     with Import, Address => SEC_I3C2_Base;
