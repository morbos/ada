...
package STM32_SVD.TIM12 is
   ...
   subtype TIM12_CCMR1_CC1S_Field is HAL.UInt2;
   subtype TIM12_CCMR1_IC1PSC_Field is HAL.UInt2;
   subtype TIM12_CCMR1_IC1F_Field is HAL.UInt4;
   subtype TIM12_CCMR1_CC2S_Field is HAL.UInt2;
   subtype TIM12_CCMR1_IC2PSC_Field is HAL.UInt2;
   subtype TIM12_CCMR1_IC2F_Field is HAL.UInt4;

   --  TIM12 capture/compare mode register 1
   type TIM12_CCMR1_Register is record
      --  Capture/Compare 1 selection
      CC1S           : TIM12_CCMR1_CC1S_Field := 16#0#;
      --  Input capture 1 prescaler
      IC1PSC         : TIM12_CCMR1_IC1PSC_Field := 16#0#;
      --  Input capture 1 filter
      IC1F           : TIM12_CCMR1_IC1F_Field := 16#0#;
      --  Capture/compare 2 selection
      CC2S           : TIM12_CCMR1_CC2S_Field := 16#0#;
      --  Input capture 2 prescaler
      IC2PSC         : TIM12_CCMR1_IC2PSC_Field := 16#0#;
      --  Input capture 2 filter
      IC2F           : TIM12_CCMR1_IC2F_Field := 16#0#;
      --  unspecified
   ...
   for TIM12_CCMR1_Register use record
      CC1S           at 0 range 0 .. 1;
   ...
   subtype TIM12_CCMR1_ALTERNATE1_CC1S_Field is HAL.UInt2;
   subtype TIM12_CCMR1_ALTERNATE1_OC1M_Field is HAL.UInt3;
   subtype TIM12_CCMR1_ALTERNATE1_CC2S_Field is HAL.UInt2;
   subtype TIM12_CCMR1_ALTERNATE1_OC2M_Field is HAL.UInt3;

   --  TIM12 capture/compare mode register 1
   type TIM12_CCMR1_ALTERNATE1_Register is record
      --  Capture/Compare 1 selection
      CC1S           : TIM12_CCMR1_ALTERNATE1_CC1S_Field := 16#0#;
      --  Output compare 1 fast enable
      OC1FE          : Boolean := False;
      --  Output compare 1 preload enable
      OC1PE          : Boolean := False;
      --  OC1M[2:0]: Output compare 1 mode (refer to bit 16 for OC1M[3])
      OC1M           : TIM12_CCMR1_ALTERNATE1_OC1M_Field := 16#0#;
      --  unspecified
      Reserved_7_7   : HAL.Bit := 16#0#;
      --  Capture/Compare 2 selection
      CC2S           : TIM12_CCMR1_ALTERNATE1_CC2S_Field := 16#0#;
      --  Output compare 2 fast enable
      OC2FE          : Boolean := False;
      --  Output compare 2 preload enable
      OC2PE          : Boolean := False;
      --  OC2M[2:0]: Output compare 2 mode
      OC2M           : TIM12_CCMR1_ALTERNATE1_OC2M_Field := 16#0#;
      --  unspecified
   ...
   for TIM12_CCMR1_ALTERNATE1_Register use record
      CC1S           at 0 range 0 .. 1;
   ...
   type SEC_TIM12_Disc is
     (Default,
      Alternate1);

   --  TIM12 address block description
   type TIM12_Peripheral
     (Discriminent : SEC_TIM12_Disc := Default)
   is record
      --  TIM12 control register 1
      ...
      case Discriminent is
         when Default =>
            --  TIM12 capture/compare mode register 1
            TIM12_CCMR1 : aliased TIM12_CCMR1_Register;
         when Alternate1 =>
            --  TIM12 capture/compare mode register 1
            TIM12_CCMR1_ALTERNATE1 : aliased TIM12_CCMR1_ALTERNATE1_Register;
      end case;
   end record
   ...
   for TIM12_Peripheral use record
      ...
      TIM12_CCMR1            at 16#18# range 0 .. 31;
      TIM12_CCMR1_ALTERNATE1 at 16#18# range 0 .. 31;
   end record;

   --  TIM12 address block description
   SEC_TIM12_Periph : aliased TIM12_Peripheral
     with Import, Address => SEC_TIM12_Base;
