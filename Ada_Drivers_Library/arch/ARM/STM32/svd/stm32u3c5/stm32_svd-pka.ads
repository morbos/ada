...
package STM32_SVD.PKA is
   ...
   type PKA_CR_Register is record
      ...
      --  Read-only. Chaining mode flags interrupt enable
      CMFIE          : Boolean := False;
      --  unspecified
   ...
   type PKA_SR_Register is record
      ...
      LMF            : Boolean;
      --  Read-only. Coupling and chaining mode enable
      CCEN           : Boolean;
      --  unspecified
      Reserved_3_7   : HAL.UInt5;
      --  Read-only. RNG OK flag
      RNGOKF         : Boolean;
      --  Read-only. Data OK flag
      DATAOKF        : Boolean;
      --  Read-only. Increment error flag
      INCRERRF       : Boolean;
      --  Read-only. Data 0-ed error flag
      DATAZF         : Boolean;
      --  Read-only. Trailing 0s error flag
      TRZERRF        : Boolean;
      --  Read-only. Mode error flag
      MDERRF         : Boolean;
      --  Read-only. RNG error flag
      RNGERRF        : Boolean;
      --  unspecified
   ...
   for PKA_SR_Register use record
      ...
      RNGOKF         at 0 range 8 .. 8;
      DATAOKF        at 0 range 9 .. 9;
      INCRERRF       at 0 range 10 .. 10;
      DATAZF         at 0 range 11 .. 11;
      TRZERRF        at 0 range 12 .. 12;
      MDERRF         at 0 range 13 .. 13;
      RNGERRF        at 0 range 14 .. 14;
   ...
   type PKA_CLRFR_Register is record
      ...
      --  Read-only. Clear chaining mode flag
      CMFC           : Boolean := False;
      --  unspecified
      Reserved_23_31 : HAL.UInt9 := 16#0#;
   end record
