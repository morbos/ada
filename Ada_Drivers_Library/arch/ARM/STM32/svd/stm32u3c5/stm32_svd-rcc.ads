...
package STM32_SVD.RCC is
   ...
   subtype RCC_ICSCR1_MSICAL1_Field is HAL.UInt6;
   subtype RCC_ICSCR1_MSICAL0_Field is HAL.UInt6;
   subtype RCC_ICSCR1_MSIPLL1N_Field is HAL.UInt2;
   subtype RCC_ICSCR1_MSIKDIV_Field is HAL.UInt2;
   subtype RCC_ICSCR1_MSISDIV_Field is HAL.UInt2;
   ...
   subtype RCC_ICSCR2_MSITRIM1_Field is HAL.UInt6;
   subtype RCC_ICSCR2_MSITRIM0_Field is HAL.UInt6;
   ...
   subtype RCC_CFGR1_MCO2SEL_Field is HAL.UInt4;
   subtype RCC_CFGR1_MCO2PRE_Field is HAL.UInt3;
   ...
   subtype RCC_CFGR4_BOOSTSEL_Field is HAL.UInt2;
   subtype RCC_CFGR4_BOOSTDIV_Field is HAL.UInt4;
   ...
   type RCC_AHB1SLPENR1_Register is record
      ...
      --  unspecified
      Reserved_18_23 : HAL.UInt6 := 16#3F#;
      --  GTZC1 clock enable during Sleep mode
      GTZC1SLPEN     : Boolean := True;
      --  unspecified
      Reserved_25_28 : HAL.UInt4 := 16#F#;
   ...
   type RCC_AHB2SLPENR1_Register is record
      ...
      --  unspecified
      Reserved_22_26 : HAL.UInt5 := 16#1F#;
   ...
   type RCC_AHB2SLPENR2_Register is record
      ...
      --  unspecified
      Reserved_5_31 : HAL.UInt27 := 16#7FFFFFF#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type RCC_APB1SLPENR2_Register is record
      ...
      --  unspecified
      Reserved_10_31 : HAL.UInt22 := 16#3FFFFF#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type RCC_AHB1STPENR1_Register is record
      ...
      --  unspecified
      Reserved_25_29 : HAL.UInt5 := 16#1F#;
   ...
   type RCC_AHB2STPENR1_Register is record
      ...
      --  unspecified
      Reserved_12_29 : HAL.UInt18 := 16#3FFFF#;
   ...
   type RCC_APB2STPENR_Register is record
      ...
      --  unspecified
      Reserved_15_23 : HAL.UInt9 := 16#1FF#;
   ...
   subtype RCC_CCIPR2_ADF1SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR2_SAI1SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR2_ADCDACPRE_Field is HAL.UInt4;
   subtype RCC_CCIPR2_ADCDACSEL_Field is HAL.UInt2;
   ...
   subtype RCC_CCIPR3_LPUART1SEL_Field is HAL.UInt2;
   ...
   subtype RCC_CSR_MSIKDIVS_Field is HAL.UInt2;
   subtype RCC_CSR_MSISDIVS_Field is HAL.UInt2;
