...
package STM32_SVD.ADF is
   ...
   subtype ADF_TRGISEL_TRGISEL_Field is HAL.UInt2;

   --  ADF trigger input selection register
   type ADF_TRGISEL_Register is record
      --  Input selection for adf_trgi
      TRGISEL       : ADF_TRGISEL_TRGISEL_Field := 16#0#;
      --  unspecified
   ...
   for ADF_TRGISEL_Register use record
      TRGISEL       at 0 range 0 .. 1;
   ...
   type ADF_Peripheral is record
      ...
      --  ADF trigger input selection register
      ADF_TRGISEL   : aliased ADF_TRGISEL_Register;
      --  ADF serial interface control register 0
   ...
   for ADF_Peripheral use record
      ...
      ADF_TRGISEL   at 16#20# range 0 .. 31;
   ...
   --  ADF register block
   SEC_ADF_Periph : aliased ADF_Peripheral
     with Import, Address => SEC_ADF_Base;
