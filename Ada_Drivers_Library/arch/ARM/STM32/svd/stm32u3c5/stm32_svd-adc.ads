...
package STM32_SVD.ADC is
   ...
   type ADC_ISR_Register is record
      ...
      --  Read-only. ADC internal voltage regulator output ready flag
   ...
   type ADC_SMPR2_Register is record
      --  Channel x sampling time selection (x=19 to 10)
   ...
   subtype ADC_PCSEL_PCSEL_Field is HAL.UInt19;
   ...
   subtype ADC_AWD2CR_AWDCH_Field is HAL.UInt19;
   ...
   for ADC_AWD2CR_Register use record
      AWDCH          at 0 range 0 .. 18;
      Reserved_19_31 at 0 range 19 .. 31;
   end record;

   subtype ADC_AWD3CR_AWDCH_Field is HAL.UInt19;
   ...
   subtype ADC_DIFSEL_DIFSEL_Field is HAL.UInt19;
   ...
   --  ADC register block
   SEC_ADC1_Periph : aliased ADC_Peripheral
     with Import, Address => SEC_ADC1_Base;

   --  ADC register block
   SEC_ADC2_Periph : aliased ADC_Peripheral
     with Import, Address => SEC_ADC2_Base;
