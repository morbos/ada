...
package STM32_SVD.SYSCFG is
   ...
   subtype SYSCFG_CM55CR_FPU_IT_EN_Field is HAL.UInt6;
   ...
   subtype SYSCFG_CM55TCMCR_CFGITCMSZ_Field is HAL.UInt4;
   subtype SYSCFG_CM55TCMCR_CFGDTCMSZ_Field is HAL.UInt4;
   ...
   subtype SYSCFG_CM55RWMCR_RM_TCM_Field is HAL.UInt4;
   subtype SYSCFG_CM55RWMCR_RM_CACHE_Field is HAL.UInt4;
   ...
   subtype SYSCFG_INITSVTORCR_SVTOR_ADDR_Field is HAL.UInt25;
   ...
   subtype SYSCFG_INITNSVTORCR_NSVTOR_ADDR_Field is HAL.UInt25;
   ...
   subtype SYSCFG_VDDIOCCCR_RANSRC_Field is HAL.UInt4;
   subtype SYSCFG_VDDIOCCCR_RAPSRC_Field is HAL.UInt4;
   ...
   subtype SYSCFG_VDDIOCCSR_ANSRC_Field is HAL.UInt4;
   subtype SYSCFG_VDDIOCCSR_APSRC_Field is HAL.UInt4;
   ...
   subtype SYSCFG_SEC_AIDCR_DMACID_SEC_Field is HAL.UInt3;
   ...
   subtype SYSCFG_SMPSHDPCR_SMPSHDPSEL_Field is HAL.UInt4;
   ...
   subtype SYSCFG_NONSEC_AIDCR_DMACID_NONSEC_Field is HAL.UInt3;
   ...
   type SYSCFG_Peripheral is record
      ...
      SYSCFG_ICNCGCR        : aliased HAL.UInt32;
      --  SYSCFG ICN bandwidth regulator control register
      SYSCFG_ICNBWRCR       : aliased HAL.UInt32;
      --  SYSCFG /O control register
      SYSCFG_IOCR           : aliased HAL.UInt32;
      --  SYSCFG VDDIO1 compensation cell control register
      ...
      SYSCFG_AHBWP_ERROR_SR : aliased HAL.UInt32;
      --  SYSCFG SMPS observable signals through HDP selection	configuration
      --  register
