...
package STM32_SVD.TIM10_S is
   ...
   subtype TIM10_CCMR1_Output_OC1M_Field is HAL.UInt3;
   ...
   type TIM10_S_Disc is
     (Input,
      Output);

   --  General-purpose timers
   type TIM10_S_Peripheral
     (Discriminent : TIM10_S_Disc := Input)
   is record
      --  TIM10 control register 1
   ...
   for TIM10_S_Peripheral use record
   ...
   --  General-purpose timers
   TIM10_S_Periph : aliased TIM10_S_Peripheral
     with Import, Address => TIM10_S_Base;

end STM32_SVD.TIM10_S;
