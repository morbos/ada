...
package STM32_SVD.SDMMC is
   ...
   type SDMMC_RESPR_Registers is array (1 .. 4) of HAL.UInt32;
   ...
   type SDMMC_IDMABASER_Registers is array (0 .. 1) of HAL.UInt32;
   ...
   type SDMMC_Peripheral is record
      ...
      SDMMC_RESPR      : aliased SDMMC_RESPR_Registers;
      ...
      SDMMC_IDMABASER  : aliased SDMMC_IDMABASER_Registers;
   ...
   for SDMMC_Peripheral use record
      ...
      SDMMC_RESPR      at 16#14# range 0 .. 127;
      ...
      SDMMC_IDMABASER  at 16#58# range 0 .. 63;
