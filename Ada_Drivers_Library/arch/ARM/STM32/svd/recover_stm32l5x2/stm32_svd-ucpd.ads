...
package STM32_SVD.UCPD is
   ...
   subtype CFG3_TRIM1_NG_CCRPD_Field is HAL.UInt4;
   subtype CFG3_TRIM1_NG_CC1A5_Field is HAL.UInt5;
   subtype CFG3_TRIM1_NG_CC3A0_Field is HAL.UInt4;
   subtype CFG3_TRIM2_NG_CCRPD_Field is HAL.UInt4;
   subtype CFG3_TRIM2_NG_CC1A5_Field is HAL.UInt5;
   subtype CFG3_TRIM2_NG_CC3A0_Field is HAL.UInt4;
   ...
   subtype RX_ORDEXT_RXSOPX1_Field is HAL.UInt20;

   type RX_ORDEXT_Register is record
      --  RXSOPX1
      RXSOPX1        : RX_ORDEXT_RXSOPX1_Field := 16#0#;
      --  unspecified
      Reserved_20_31 : HAL.UInt12 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   for RX_ORDEXT_Register use record
      RXSOPX1        at 0 range 0 .. 19;
      Reserved_20_31 at 0 range 20 .. 31;
   end record;

   type RX_ORDEXT_Registers is array (1 .. 2) of RX_ORDEXT_Register;
   ...
   type UCPD_Peripheral is record
      ...
      RX_ORDEXT : aliased RX_ORDEXT_Registers;
   end record
     with Volatile;
