...
package STM32_SVD.ICache is
   ...
   type ICACHE_CRR_Register is record
      ...
      --  RSIZE
      RSIZE          : ICACHE_CRR_RSIZE_Field := 16#0#;
      --  unspecified
   ...
   type ICACHE_CRR_Registers is array (0 .. 3) of ICACHE_CRR_Register;
   ...
   type ICache_Peripheral is record
      ...
      ICACHE_CRR   : aliased ICACHE_CRR_Registers;
   end record
     with Volatile;
   ...
   for ICache_Peripheral use record
      ...
      ICACHE_CRR   at 16#20# range 0 .. 127;
   end record;
