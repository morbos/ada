...
package STM32_SVD.GTZC is
   ...
   ------------------------------------
   -- TZSC_MPCWM cluster's Registers --
   ------------------------------------

   subtype NSWMR_TZSC_MPCWM_NSWM1STRT_Field is HAL.UInt11;
   subtype NSWMR_TZSC_MPCWM_NSWM1LGTH_Field is HAL.UInt12;

   type NSWMR_TZSC_MPCWM_Register is record
      --  NSWM1STRT
      NSWM1STRT      : NSWMR_TZSC_MPCWM_NSWM1STRT_Field := 16#0#;
      --  unspecified
      Reserved_11_15 : HAL.UInt5 := 16#0#;
      --  NSWM1LGTH
      NSWM1LGTH      : NSWMR_TZSC_MPCWM_NSWM1LGTH_Field := 16#0#;
      --  unspecified
   ...
   for NSWMR_TZSC_MPCWM_Register use record
   ...
   type NSWMR_TZSC_MPCWM_Registers is array (1 .. 2)
     of NSWMR_TZSC_MPCWM_Register;

   type TZSC_MPCWM_Cluster is record
      NSWMR : aliased NSWMR_TZSC_MPCWM_Registers;
   end record
     with Size => 64;

   for TZSC_MPCWM_Cluster use record
      NSWMR at 0 range 0 .. 63;
   end record;

   type TZSC_MPCWM_Clusters is array (1 .. 3) of TZSC_MPCWM_Cluster;
   ...
   --  GTZC_MPCBB1
   type GTZC_MPCBB1_Peripheral is record
      --  MPCBB control register
   ...
   for GTZC_MPCBB1_Peripheral use record
   ...
   --  GTZC_MPCBB1
   GTZC_MPCBB1_Periph : aliased GTZC_MPCBB1_Peripheral
     with Import, Address => GTZC_MPCBB1_Base;

   --  GTZC_MPCBB2
   type GTZC_MPCBB2_Peripheral is record
      --  MPCBB control register
   ...
   for GTZC_MPCBB2_Peripheral use record
   ...
   --  GTZC_MPCBB2
   GTZC_MPCBB2_Periph : aliased GTZC_MPCBB2_Peripheral
     with Import, Address => GTZC_MPCBB2_Base;

   --  GTZC_TZIC
   type GTZC_TZIC_Peripheral is record
      --  TZIC interrupt enable register 1
   ...
   for GTZC_TZIC_Peripheral use record
   ...
   --  GTZC_TZIC
   GTZC_TZIC_Periph : aliased GTZC_TZIC_Peripheral
     with Import, Address => GTZC_TZIC_Base;

   --  GTZC_TZIC
   SEC_GTZC_TZIC_Periph : aliased GTZC_TZIC_Peripheral
     with Import, Address => SEC_GTZC_TZIC_Base;

   --  GTZC_TZSC
   type GTZC_TZSC_Peripheral is record
      --  TZSC control register
      ...
      TZSC_MPCWM     : aliased TZSC_MPCWM_Clusters;
   end record
     with Volatile;

   for GTZC_TZSC_Peripheral use record
      ...
      TZSC_MPCWM     at 16#30# range 0 .. 191;
   end record;

   --  GTZC_TZSC
   GTZC_TZSC_Periph : aliased GTZC_TZSC_Peripheral
     with Import, Address => GTZC_TZSC_Base;

   --  GTZC_TZSC
   SEC_GTZC_TZSC_Periph : aliased GTZC_TZSC_Peripheral
     with Import, Address => SEC_GTZC_TZSC_Base;
