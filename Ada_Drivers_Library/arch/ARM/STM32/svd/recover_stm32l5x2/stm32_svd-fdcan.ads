...
package STM32_SVD.FDCAN is
   ...
   -----------------------------------
   -- FDCAN_RXF cluster's Registers --
   -----------------------------------

   subtype S_FDCAN_RXF_F0FL_Field is HAL.UInt4;
   subtype S_FDCAN_RXF_F0GI_Field is HAL.UInt2;
   subtype S_FDCAN_RXF_F0PI_Field is HAL.UInt2;

   --  FDCAN Rx FIFO 0 Status Register
   type S_FDCAN_RXF_Register is record
      --  Rx FIFO 0 Fill Level
      F0FL           : S_FDCAN_RXF_F0FL_Field := 16#0#;
      --  unspecified
      Reserved_4_7   : HAL.UInt4 := 16#0#;
      --  Rx FIFO 0 Get Index
      F0GI           : S_FDCAN_RXF_F0GI_Field := 16#0#;
      --  unspecified
      Reserved_10_15 : HAL.UInt6 := 16#0#;
      --  Rx FIFO 0 Put Index
      F0PI           : S_FDCAN_RXF_F0PI_Field := 16#0#;
      --  unspecified
   ...
   for S_FDCAN_RXF_Register use record
      F0FL           at 0 range 0 .. 3;
   ...
   subtype A_FDCAN_RXF_F0AI_Field is HAL.UInt3;

   --  CAN Rx FIFO 0 Acknowledge Register
   type A_FDCAN_RXF_Register is record
      --  Rx FIFO 0 Acknowledge Index
      F0AI          : A_FDCAN_RXF_F0AI_Field := 16#0#;
      --  unspecified
   ...
   for A_FDCAN_RXF_Register use record
      F0AI          at 0 range 0 .. 2;
      Reserved_3_31 at 0 range 3 .. 31;
   end record;

   type FDCAN_RXF_Cluster is record
      --  FDCAN Rx FIFO 0 Status Register
      S : aliased S_FDCAN_RXF_Register;
      --  CAN Rx FIFO 0 Acknowledge Register
      A : aliased A_FDCAN_RXF_Register;
   end record
     with Size => 64;

   for FDCAN_RXF_Cluster use record
      S at 16#0# range 0 .. 31;
      A at 16#4# range 0 .. 31;
   end record;

   type FDCAN_RXF_Clusters is array (0 .. 1) of FDCAN_RXF_Cluster;
   ...
   type FDCAN_Peripheral is record
      ...
      FDCAN_RXF    : aliased FDCAN_RXF_Clusters;
      --  FDCAN Tx buffer configuration register
   ...
   for FDCAN_Peripheral use record
      ...
      FDCAN_RXF    at 16#90# range 0 .. 127;
