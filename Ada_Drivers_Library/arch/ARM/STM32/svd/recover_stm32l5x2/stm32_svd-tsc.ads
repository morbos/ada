...
package STM32_SVD.TSC is
   ...
   subtype IOGCR_CNT_Field is HAL.UInt14;

   type IOGCR_Register is record
      --  Counter value
      CNT            : IOGCR_CNT_Field := 16#0#;
      --  unspecified
   ...
   for IOGCR_Register use record
      CNT            at 0 range 0 .. 13;
      Reserved_14_31 at 0 range 14 .. 31;
   end record;

   type IOGCR_Registers is array (1 .. 8) of IOGCR_Register;
