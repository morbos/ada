...
package STM32_SVD.Flash is
   ...
   subtype NSCR_NSPNB_Field is HAL.UInt7;
   ...
   subtype SECCR_SECPNB_Field is HAL.UInt7;
   ...
   subtype NSBOOTADD0R_NSBOOTADD0_Field is HAL.UInt25;
   ...
   subtype NSBOOTADD1R_NSBOOTADD1_Field is HAL.UInt25;
   ...
   subtype SECBOOTADD0R_SECBOOTADD0_Field is HAL.UInt25;
   ...
   subtype SECWM1R1_SECWM1_PSTRT_Field is HAL.UInt7;
   subtype SECWM1R1_SECWM1_PEND_Field is HAL.UInt7;
   ...
   type SECWM1R1_Register is record
      ...
      --  unspecified
      Reserved_7_15  : HAL.UInt9 := 16#1FE#;
      --  SECWM1_PEND
      SECWM1_PEND    : SECWM1R1_SECWM1_PEND_Field := 16#0#;
      --  unspecified
      Reserved_23_31 : HAL.UInt9 := 16#1FE#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype SECWM1R2_PCROP1_PSTRT_Field is HAL.UInt7;
   subtype SECWM1R2_HDP1_PEND_Field is HAL.UInt7;
   ...
   subtype WRP1AR_WRP1A_PSTRT_Field is HAL.UInt7;
   subtype WRP1AR_WRP1A_PEND_Field is HAL.UInt7;
   ...
   subtype WRP1BR_WRP1B_PSTRT_Field is HAL.UInt7;
   subtype WRP1BR_WRP1B_PEND_Field is HAL.UInt7;
   ...
   subtype SECWM2R1_SECWM2_PSTRT_Field is HAL.UInt7;
   subtype SECWM2R1_SECWM2_PEND_Field is HAL.UInt7;
   ...
   subtype SECWM2R2_PCROP2_PSTRT_Field is HAL.UInt7;
   subtype SECWM2R2_HDP2_PEND_Field is HAL.UInt7;
   ...
   subtype WRP2AR_WRP2A_PSTRT_Field is HAL.UInt7;
   subtype WRP2AR_WRP2A_PEND_Field is HAL.UInt7;
   ...
   subtype WRP2BR_WRP2B_PSTRT_Field is HAL.UInt7;
   subtype WRP2BR_WRP2B_PEND_Field is HAL.UInt7;
   ...
   type Flash_Peripheral is record
      ...
      SECBB1R1     : aliased HAL.UInt32;
      --  FLASH secure block based bank 1 register
      SECBB1R2     : aliased HAL.UInt32;
      --  FLASH secure block based bank 1 register
      SECBB1R3     : aliased HAL.UInt32;
      --  FLASH secure block based bank 1 register
      SECBB1R4     : aliased HAL.UInt32;
      --  FLASH secure block based bank 2 register
      SECBB2R1     : aliased HAL.UInt32;
      --  FLASH secure block based bank 2 register
      SECBB2R2     : aliased HAL.UInt32;
      --  FLASH secure block based bank 2 register
      SECBB2R3     : aliased HAL.UInt32;
      --  FLASH secure block based bank 2 register
      SECBB2R4     : aliased HAL.UInt32;
      --  FLASH secure HDP control register
