...
package STM32_SVD.GPIOC_S is
   ...
   subtype GPIOC_MODER_MODE_Element is HAL.UInt2;
   ...
   subtype GPIOC_OSPEEDR_OSPEED_Element is HAL.UInt2;
   ...
   subtype GPIOC_PUPDR_PUPD_Element is HAL.UInt2;
   ...
   subtype GPIOC_AFRL_AFSEL_Element is HAL.UInt4;
   ...
   subtype GPIOC_AFRH_AFSEL_Element is HAL.UInt4;
   ...
   subtype GPIOC_DELAYRL_DELAY_Element is HAL.UInt4;
   ...
   subtype GPIOC_DELAYRH_DELAY_Element is HAL.UInt4;
   ...
   subtype GPIOC_PIOCFGRL_PIOCFG_Element is HAL.UInt4;
   ...
   subtype GPIOC_PIOCFGRH_PIOCFG_Element is HAL.UInt4;
   ...
   subtype GPIOC_HWCFGR10_AHB_IOP_Field is HAL.UInt4;
   subtype GPIOC_HWCFGR10_AFSIZE_CFG_Field is HAL.UInt4;
   subtype GPIOC_HWCFGR10_SPEED_CFG_Field is HAL.UInt4;
   subtype GPIOC_HWCFGR10_LOCK_CFG_Field is HAL.UInt4;
   subtype GPIOC_HWCFGR10_SEC_CFG_Field is HAL.UInt4;
   subtype GPIOC_HWCFGR10_OR_CFG_Field is HAL.UInt4;
   ...
   subtype GPIOC_HWCFGR9_EN_IO_Field is HAL.UInt16;
   ...
   subtype GPIOC_HWCFGR8_FAST_AF_IO_Element is HAL.UInt4;
   ...
   subtype GPIOC_HWCFGR7_FAST_AF_IO_Element is HAL.UInt4;
   ...
   subtype GPIOC_HWCFGR3_ODR_RES_Field is HAL.UInt16;
   subtype GPIOC_HWCFGR3_OTYPER_RES_Field is HAL.UInt16;
   ...
   subtype GPIOC_HWCFGR0_OR_RES_Field is HAL.UInt16;
   ...
   subtype GPIOC_VERR_MINREV_Field is HAL.UInt4;
   subtype GPIOC_VERR_MAJREV_Field is HAL.UInt4;
   ...
   --  General-purpose I/Os
   type GPIOC_S_Peripheral is record
      --  GPIO port C mode register
   ...
   --  General-purpose I/Os
   GPIOC_S_Periph : aliased GPIOC_S_Peripheral
     with Import, Address => GPIOC_S_Base;

end STM32_SVD.GPIOC_S;
