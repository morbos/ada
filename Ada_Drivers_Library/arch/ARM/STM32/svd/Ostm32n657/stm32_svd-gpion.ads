...
package STM32_SVD.GPION is
   ...
   subtype GPION_MODER_MODE_Element is HAL.UInt2;
   ...
   subtype GPION_OSPEEDR_OSPEED_Element is HAL.UInt2;
   ...
   subtype GPION_PUPDR_PUPD_Element is HAL.UInt2;
   ...
   subtype GPION_AFRL_AFSEL_Element is HAL.UInt4;
   ...
   subtype GPION_AFRH_AFSEL_Element is HAL.UInt4;
   ...
   subtype GPION_DELAYRL_DELAY_Element is HAL.UInt4;
   ...
   subtype GPION_DELAYRH_DELAY_Element is HAL.UInt4;
   ...
   subtype GPION_PIOCFGRL_PIOCFG_Element is HAL.UInt4;
   ...
   subtype GPION_PIOCFGRH_PIOCFG_Element is HAL.UInt4;
   ...
   subtype GPION_HWCFGR10_AHB_IOP_Field is HAL.UInt4;
   subtype GPION_HWCFGR10_AFSIZE_CFG_Field is HAL.UInt4;
   subtype GPION_HWCFGR10_SPEED_CFG_Field is HAL.UInt4;
   subtype GPION_HWCFGR10_LOCK_CFG_Field is HAL.UInt4;
   subtype GPION_HWCFGR10_SEC_CFG_Field is HAL.UInt4;
   subtype GPION_HWCFGR10_OR_CFG_Field is HAL.UInt4;
   ...
   subtype GPION_HWCFGR9_EN_IO_Field is HAL.UInt16;
   ...
   subtype GPION_HWCFGR8_FAST_AF_IO_Element is HAL.UInt4;
   ...
   subtype GPION_HWCFGR7_FAST_AF_IO_Element is HAL.UInt4;
   ...
   subtype GPION_HWCFGR3_ODR_RES_Field is HAL.UInt16;
   subtype GPION_HWCFGR3_OTYPER_RES_Field is HAL.UInt16;
   ...
   subtype GPION_HWCFGR0_OR_RES_Field is HAL.UInt16;
   ...
   subtype GPION_VERR_MINREV_Field is HAL.UInt4;
   subtype GPION_VERR_MAJREV_Field is HAL.UInt4;
   ...
   --  General-purpose I/Os
   type GPION_Peripheral is record
      --  GPIO port N mode register
   ...
   --  General-purpose I/Os
   GPION_Periph : aliased GPION_Peripheral
