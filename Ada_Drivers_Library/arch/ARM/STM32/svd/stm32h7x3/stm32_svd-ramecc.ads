...
package STM32_SVD.RAMECC is
   ...
   is record
      ...
      M1FAR  : aliased HAL.UInt32;
      --  RAMECC monitor x failing data low register
      M1FDRL : aliased HAL.UInt32;
      --  RAMECC monitor x failing data high register
      M1FDRH : aliased HAL.UInt32;
      --  RAMECC monitor x failing ECC error code register
      M1FECR : aliased HAL.UInt32;
      --  RAMECC monitor x configuration register
      M2CR   : aliased M2CR_Register;
      --  RAMECC monitor x status register
      M2SR   : aliased M2SR_Register;
      --  RAMECC monitor x failing address register
      M2FAR  : aliased HAL.UInt32;
      --  RAMECC monitor x failing data low register
      M2FDRL : aliased HAL.UInt32;
      --  RAMECC monitor x failing data high register
      M2FDRH : aliased HAL.UInt32;
      --  RAMECC monitor x failing ECC error code register
      M2FECR : aliased HAL.UInt32;
      --  RAMECC monitor x configuration register
      M3CR   : aliased M3CR_Register;
      --  RAMECC monitor x status register
      M3SR   : aliased M3SR_Register;
      --  RAMECC monitor x failing address register
      M3FAR  : aliased HAL.UInt32;
      --  RAMECC monitor x failing data low register
      M3FDRL : aliased HAL.UInt32;
      --  RAMECC monitor x failing data high register
      M3FDRH : aliased HAL.UInt32;
      --  RAMECC monitor x failing ECC error code register
      M3FECR : aliased HAL.UInt32;
      --  RAMECC monitor x configuration register
      M4CR   : aliased M4CR_Register;
      --  RAMECC monitor x status register
      M4SR   : aliased M4SR_Register;
      --  RAMECC monitor x failing address register
      M4FAR  : aliased HAL.UInt32;
      --  RAMECC monitor x failing data low register
      M4FDRL : aliased HAL.UInt32;
      --  RAMECC monitor x configuration register
      M5CR   : aliased M5CR_Register;
      --  RAMECC monitor x status register
      M5SR   : aliased M5SR_Register;
      --  RAMECC monitor x failing address register
      M5FAR  : aliased HAL.UInt32;
      --  RAMECC monitor x failing data low register
      M5FDRL : aliased HAL.UInt32;
      --  RAMECC monitor x failing data high register
      M5FDRH : aliased HAL.UInt32;
      --  RAMECC monitor x failing ECC error code register
      M5FECR : aliased HAL.UInt32;
      case Discriminent is
         when Drh =>
            --  RAMECC monitor x failing data high register
            M4FDRH : aliased HAL.UInt32;
         when Ecr =>
            --  RAMECC monitor x failing ECC error code register
            M4FECR : aliased HAL.UInt32;
      end case;
   end record
