...
package NXP_SVD.FLASH is
   ...
   subtype STARTA_STARTA_Field is HAL.UInt18;
   ...
   subtype STOPA_STOPA_Field is HAL.UInt18;
   ...
   --  result.
   type DATAW_Registers is array (0 .. 3) of HAL.UInt32
     with Volatile;
   ...
   subtype MODULE_ID_APERTURE_Field is HAL.UInt8;
   subtype MODULE_ID_MINOR_REV_Field is HAL.UInt4;
   subtype MODULE_ID_MAJOR_REV_Field is HAL.UInt4;
   subtype MODULE_ID_ID_Field is HAL.UInt16;
