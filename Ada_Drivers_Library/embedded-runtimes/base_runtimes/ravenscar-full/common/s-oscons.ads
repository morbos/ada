...
package System.OS_Constants is
   ...
   Target_Name                   : constant String  := "aarch64-linux";
   ...
   SO_BINDTODEVICE               : constant := 25;         --  Bind to a NIC - Network Interface Controller
   ...
   PTHREAD_ATTR_SIZE             : constant := 64;         --  pthread_attr_t
   PTHREAD_MUTEXATTR_SIZE        : constant := 8;          --  pthread_mutexattr_t
   PTHREAD_MUTEX_SIZE            : constant := 48;         --  pthread_mutex_t
