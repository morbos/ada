...
package Interfaces.STM32.Flash is
   ...
   subtype ACR_WRHIGHFREQ_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype CR1_PSIZE1_Field is Interfaces.Bit_Types.UInt2;
   subtype CR1_SNB1_Field is Interfaces.Bit_Types.UInt3;
   ...
   type OPTCR_Register is record
      ...
      MER            : Boolean := False;
      --  unspecified
      Reserved_5_29  : Interfaces.Bit_Types.UInt25 := 16#0#;
   ...
   subtype OPTSR_CUR_BOR_LEV_Field is Interfaces.Bit_Types.UInt2;
   subtype OPTSR_CUR_RDP_Field is Interfaces.Bit_Types.Byte;
   subtype OPTSR_CUR_ST_RAM_SIZE_Field is Interfaces.Bit_Types.UInt2;
   ...
   type OPTSR_CUR_Register is record
      ...
      --  unspecified
      Reserved_22_28 : Interfaces.Bit_Types.UInt7 := 16#0#;
   ...
   subtype OPTSR_PRG_BOR_LEV_Field is Interfaces.Bit_Types.UInt2;
   subtype OPTSR_PRG_RDP_Field is Interfaces.Bit_Types.Byte;
   subtype OPTSR_PRG_ST_RAM_SIZE_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype PRAR_CUR1_PROT_AREA_START1_Field is Interfaces.Bit_Types.UInt12;
   subtype PRAR_CUR1_PROT_AREA_END1_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype PRAR_PRG1_PROT_AREA_START1_Field is Interfaces.Bit_Types.UInt12;
   subtype PRAR_PRG1_PROT_AREA_END1_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype SCAR_CUR1_SEC_AREA_START1_Field is Interfaces.Bit_Types.UInt12;
   subtype SCAR_CUR1_SEC_AREA_END1_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype SCAR_PRG1_SEC_AREA_START1_Field is Interfaces.Bit_Types.UInt12;
   subtype SCAR_PRG1_SEC_AREA_END1_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype WPSN_CUR1R_WRPSn1_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype WPSN_PRG1R_WRPSn1_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype BOOT_CURR_BOOT_ADD_Element is Interfaces.Bit_Types.UInt16;
   ...
   subtype BOOT_PRGR_BOOT_ADD_Element is Interfaces.Bit_Types.UInt16;
   ...
   subtype CRCCR_CRC_SECT_Field is Interfaces.Bit_Types.UInt3;
   subtype CRCCR_CRC_BURST_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype CRCSADD1R_CRC_START_ADDR_Field is Interfaces.Bit_Types.UInt18;
   ...
   subtype CRCEADD1R_CRC_END_ADDR_Field is Interfaces.Bit_Types.UInt18;
   ...
   subtype ECC_FA1R_FAIL_ECC_ADDR1_Field is Interfaces.Bit_Types.UInt15;
   ...
   subtype CR2_PSIZE2_Field is Interfaces.Bit_Types.UInt2;
   subtype CR2_SNB2_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype PRAR_CUR2_PROT_AREA_START2_Field is Interfaces.Bit_Types.UInt12;
   subtype PRAR_CUR2_PROT_AREA_END2_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype PRAR_PRG2_PROT_AREA_START2_Field is Interfaces.Bit_Types.UInt12;
   subtype PRAR_PRG2_PROT_AREA_END2_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype SCAR_CUR2_SEC_AREA_START2_Field is Interfaces.Bit_Types.UInt12;
   subtype SCAR_CUR2_SEC_AREA_END2_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype SCAR_PRG2_SEC_AREA_START2_Field is Interfaces.Bit_Types.UInt12;
   subtype SCAR_PRG2_SEC_AREA_END2_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype WPSN_CUR2R_WRPSn2_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype WPSN_PRG2R_WRPSn2_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype CRCSADD2R_CRC_START_ADDR_Field is Interfaces.Bit_Types.UInt18;
   ...
   subtype CRCEADD2R_CRC_END_ADDR_Field is Interfaces.Bit_Types.UInt18;
   ...
   subtype ECC_FA2R_FAIL_ECC_ADDR2_Field is Interfaces.Bit_Types.UInt15;
   ...
   type Flash_Peripheral is record
      ...
      CRCDATAR    : aliased Interfaces.Bit_Types.UInt32;
      --  FLASH ECC fail address for bank 1
      ...
      --  FLASH option key register
      OPTKEYR_1   : aliased Interfaces.Bit_Types.UInt32;
      --  FLASH control register for bank 2
      ...
      --  FLASH CRC data register
      CRCDATAR_1  : aliased Interfaces.Bit_Types.UInt32;
      --  FLASH ECC fail address for bank 2
