...
package Interfaces.STM32.PWR is
   ...
   subtype CR1_SVOS_Field is Interfaces.Bit_Types.UInt2;
   subtype CR1_ALS_Field is Interfaces.Bit_Types.UInt2;
   ...
   type CR1_Register is record
      ...
      --  unspecified
      Reserved_19_31 : Interfaces.Bit_Types.UInt13 := 16#1E00#;
   end record
   ...
   subtype CSR1_ACTVOS_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype D3CR_VOS_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype WKUPCR_WKUPC_Field is Interfaces.Bit_Types.UInt6;
   ...
   subtype WKUPEPR_WKUPPUPD_Element is Interfaces.Bit_Types.UInt2;
