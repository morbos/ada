...
package Interfaces.STM32.FLASH is
   ...
   subtype FLASH_CR_PNB_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype FLASH_SCR_PNB_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype FLASH_ECCCORR_ADDR_ECC_Field is Interfaces.Bit_Types.UInt20;
   ...
   subtype FLASH_ECCDETR_ADDR_ECC_Field is Interfaces.Bit_Types.UInt20;
   ...
   subtype FLASH_BOOT0R_ADD_Field is Interfaces.Bit_Types.UInt25;
   ...
   subtype FLASH_BOOT1R_ADD_Field is Interfaces.Bit_Types.UInt25;
   ...
   subtype FLASH_SBOOT0R_ADD_Field is Interfaces.Bit_Types.UInt25;
   ...
   subtype FLASH_SECWM1R1_SECWM1_STRT_Field is Interfaces.Bit_Types.Byte;
   subtype FLASH_SECWM1R1_SECWM1_END_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype FLASH_SECWM1R2_HDP1_END_Field is Interfaces.Bit_Types.Byte;
   subtype FLASH_SECWM1R2_HDP1EN_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype FLASH_WRP1AR_STRT_Field is Interfaces.Bit_Types.Byte;
   subtype FLASH_WRP1AR_END_Field is Interfaces.Bit_Types.Byte;
   ...
   type FLASH_WRP1AR_Register is record
      ...
      --  unspecified
      Reserved_24_30 : Interfaces.Bit_Types.UInt7 := 16#F#;
   ...
   subtype FLASH_WRP1BR_STRT_Field is Interfaces.Bit_Types.Byte;
   subtype FLASH_WRP1BR_END_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype FLASH_SECWM2R1_SECWM2_STRT_Field is Interfaces.Bit_Types.Byte;
   subtype FLASH_SECWM2R1_SECWM2_END_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype FLASH_SECWM2R2_HDP2_END_Field is Interfaces.Bit_Types.Byte;
   subtype FLASH_SECWM2R2_HDP2EN_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype FLASH_WRP2AR_STRT_Field is Interfaces.Bit_Types.Byte;
   subtype FLASH_WRP2AR_END_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype FLASH_WRP2BR_STRT_Field is Interfaces.Bit_Types.Byte;
   subtype FLASH_WRP2BR_END_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype FLASH_SECHDPCR_HDP1_ACCDIS_Field is Interfaces.Bit_Types.Byte;
   subtype FLASH_SECHDPCR_HDP2_ACCDIS_Field is Interfaces.Bit_Types.Byte;
   subtype FLASH_SECHDPCR_HDP1EXT_ACCDIS_Field is Interfaces.Bit_Types.Byte;
   subtype FLASH_SECHDPCR_HDP2EXT_ACCDIS_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype FLASH_SECHDPEXTR_HDP1_EXT_Field is Interfaces.Bit_Types.UInt9;
   subtype FLASH_SECHDPEXTR_HDP2_EXT_Field is Interfaces.Bit_Types.UInt9;
   ...
   subtype FLASH_OEMKEYSR_OEM1KEYCRC_Field is Interfaces.Bit_Types.Byte;
   subtype FLASH_OEMKEYSR_OEM2KEYCRC_Field is Interfaces.Bit_Types.Byte;
   ...
   type FLASH_Peripheral is record
      ...
      FLASH_SKEYR      : aliased Interfaces.Bit_Types.UInt32;
      ...
      FLASH_OEM1KEYR3  : aliased Interfaces.Bit_Types.UInt32;
      --  FLASH OEM1 key register 4
      FLASH_OEM1KEYR4  : aliased Interfaces.Bit_Types.UInt32;
      ...
      FLASH_OEM2KEYR3  : aliased Interfaces.Bit_Types.UInt32;
      --  FLASH OEM2 key register 4
      FLASH_OEM2KEYR4  : aliased Interfaces.Bit_Types.UInt32;
      --  FLASH OEM key status register
