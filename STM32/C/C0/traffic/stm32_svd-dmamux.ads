...
package STM32_SVD.DMAMUX is
   ...
   subtype DMAMUX_C0CR_DMAREQ_ID_Field is HAL.UInt6;
   ...
   subtype DMAMUX_C1CR_DMAREQ_ID_Field is HAL.UInt6;
   ...
   subtype DMAMUX_C2CR_DMAREQ_ID_Field is HAL.UInt6;
   ...
   type DMAMUX_CSR_SOF_Field_Array is array (0 .. 2) of Boolean
   ...
   type DMAMUX_CFR_CSOF_Field_Array is array (0 .. 2) of Boolean
     with Component_Size => 1, Size => 3;
