...
package STM32_SVD.I2C is
   ...
   type I2C_CR1_Register is record
      ...
      --  an interrupt: Transfer Complete (TC) Transfer Complete Reload (TCR)
      TCIE           : Boolean := False;
      ...
      --  with a length of up to DNF[3:0] * tI2CCLK ... Note: If the analog
      --  filter is also enabled, the digital filter is added to the analog
      --  filter. This filter can only be programmed when the I2C is disabled
      --  (PE = 0).
      ...
      --  to 0. Refer to . Note: WUPEN can be set only when DNF = 0000
      WUPEN          : Boolean := False;
      --  General call enable
      GCEN           : Boolean := False;
      ...
      --  reserved and forced by hardware to 0. Refer to .
   ...
   type I2C_CR2_Register is record
      ...
      --  is free. Note: Writing 0 to this bit has no effect. The START bit can
      --  be set even if the bus is BUSY or I2C is in slave mode. This bit has
   ...
   type I2C_TIMINGR_Register is record
      ...
      --  counters (refer to ) and for SCL high and low level counters (refer
   ...
   type I2C_ISR_Register is record
      ...
      --  is reserved and forced by hardware to 0. Refer to .
