...
procedure VL53L1X_DISP is

   Rs  : VL53L1X_Ranging_Sensor (Vl_I2C_Port);
   ...
   is
      ...
      Vl_Clock_Speed       : constant := 400_000;
   ...
   is
   begin
      Clear (Vl_HW_Shutdown_Pin);
      delay until Clock + Milliseconds (100);
      Set (Vl_HW_Shutdown_Pin);
      delay until Clock + Milliseconds (100);
   end Reset;
...
--   Display : SSD1306_128x64_Screen (Port => Vl_I2C_Port,
--                                    RST => Vl_RST_Pin'Access,
...
begin
   ...
   Initialize_Range_Sensor
        (Port     => Vl_I2C_Port,
         I2C_AF   => Vl_I2C_Port_AF,
         SCL      => Vl_I2C_Clock_Pin,
         SDA      => Vl_I2C_Data_Pin,
         Shutdown => Vl_HW_Shutdown_Pin,
         GPIO     => Vl_HW_GPIO_Pin
        );
