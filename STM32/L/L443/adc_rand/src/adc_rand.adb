...
procedure Adc_Rand is
   ...
   --   Input_Channel0 : constant Analog_Input_Channel := VRef_Channel;
   Input_Channel0 : constant Analog_Input_Channel := 17;
   Input0         : constant GPIO_Point := PA4;

   All_Regular_Conversions : constant Regular_Channel_Conversions :=
     (1 => (Channel => Input_Channel0, Sample_Time => Sample_3_Cycles));
...
begin
   ...
   loop
      ...
      X := 39;
      Y := 20;
      DrawString (Display, X, Y, UInt32'Image (Rand), 1);
