...
--                                              Reserved   => 0);
      ...
      MapT.Device_Info_Table   := TL_DevInfoTable'Access;
      MapT.Ble_Table           := TL_Ble_Table'Access;
      MapT.Thread_Table        := TL_ThreadTable'Access;
      MapT.Sys_Table           := TL_SysTable'Access;
      MapT.Mem_Manager_Table   := TL_MemManagerTable'Access;
      MapT.Traces_Table        := TL_TracesTable'Access;
      MapT.Mac_802_15_4_Table  := TL_Mac_802_15_4'Access;
      MapT.Zigbee_Table        := null;
