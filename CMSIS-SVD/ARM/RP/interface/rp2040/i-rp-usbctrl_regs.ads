...
package Interfaces.RP.USBCTRL_REGS is
   pragma Preelaborate;
   ...
   subtype ADDR_ENDP_ADDRESS_Field is Interfaces.Bit_Types.UInt7;
   subtype ADDR_ENDP_ENDPOINT_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype ADDR_ENDP_INTEP_DIR_Field is Interfaces.Bit_Types.Bit;
   subtype ADDR_ENDP_INTEP_PREAMBLE_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype MAIN_CTRL_CONTROLLER_EN_Field is Interfaces.Bit_Types.Bit;
   subtype MAIN_CTRL_HOST_NDEVICE_Field is Interfaces.Bit_Types.Bit;
   subtype MAIN_CTRL_SIM_TIMING_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype SOF_WR_COUNT_Field is Interfaces.Bit_Types.UInt11;
   ...
   subtype SOF_RD_COUNT_Field is Interfaces.Bit_Types.UInt11;
   ...
   subtype SIE_CTRL_START_TRANS_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_SEND_SETUP_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_SEND_DATA_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_RECEIVE_DATA_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_STOP_TRANS_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_PREAMBLE_EN_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_SOF_SYNC_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_SOF_EN_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_KEEP_ALIVE_EN_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_VBUS_EN_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_RESUME_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_RESET_BUS_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_PULLDOWN_EN_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_PULLUP_EN_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_RPU_OPT_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_TRANSCEIVER_PD_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_DIRECT_DM_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_DIRECT_DP_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_DIRECT_EN_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_EP0_INT_NAK_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_EP0_INT_2BUF_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_EP0_INT_1BUF_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_EP0_DOUBLE_BUF_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_CTRL_EP0_INT_STALL_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype SIE_STATUS_VBUS_DETECTED_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_STATUS_LINE_STATE_Field is Interfaces.Bit_Types.UInt2;
   subtype SIE_STATUS_SUSPENDED_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_STATUS_SPEED_Field is Interfaces.Bit_Types.UInt2;
   subtype SIE_STATUS_VBUS_OVER_CURR_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_STATUS_RESUME_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_STATUS_CONNECTED_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_STATUS_SETUP_REC_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_STATUS_TRANS_COMPLETE_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_STATUS_BUS_RESET_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_STATUS_CRC_ERROR_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_STATUS_BIT_STUFF_ERROR_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_STATUS_RX_OVERFLOW_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_STATUS_RX_TIMEOUT_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_STATUS_NAK_REC_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_STATUS_STALL_REC_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_STATUS_ACK_REC_Field is Interfaces.Bit_Types.Bit;
   subtype SIE_STATUS_DATA_SEQ_ERROR_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype INT_EP_CTRL_INT_EP_ACTIVE_Field is Interfaces.Bit_Types.UInt15;
   ...
   subtype BUFF_STATUS_EP0_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP0_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP1_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP1_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP2_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP2_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP3_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP3_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP4_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP4_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP5_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP5_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP6_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP6_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP7_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP7_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP8_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP8_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP9_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP9_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP10_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP10_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP11_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP11_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP12_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP12_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP13_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP13_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP14_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP14_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP15_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_STATUS_EP15_OUT_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype BUFF_CPU_SHOULD_HANDLE_EP0_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP0_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP1_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP1_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP2_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP2_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP3_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP3_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP4_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP4_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP5_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP5_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP6_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP6_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP7_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP7_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP8_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP8_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP9_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP9_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP10_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP10_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP11_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP11_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP12_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP12_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP13_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP13_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP14_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP14_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP15_IN_Field is Interfaces.Bit_Types.Bit;
   subtype BUFF_CPU_SHOULD_HANDLE_EP15_OUT_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype EP_ABORT_EP0_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP0_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP1_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP1_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP2_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP2_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP3_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP3_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP4_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP4_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP5_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP5_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP6_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP6_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP7_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP7_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP8_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP8_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP9_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP9_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP10_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP10_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP11_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP11_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP12_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP12_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP13_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP13_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP14_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP14_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP15_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_EP15_OUT_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype EP_ABORT_DONE_EP0_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP0_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP1_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP1_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP2_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP2_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP3_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP3_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP4_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP4_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP5_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP5_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP6_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP6_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP7_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP7_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP8_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP8_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP9_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP9_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP10_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP10_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP11_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP11_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP12_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP12_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP13_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP13_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP14_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP14_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP15_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_ABORT_DONE_EP15_OUT_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype EP_STALL_ARM_EP0_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STALL_ARM_EP0_OUT_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype NAK_POLL_DELAY_LS_Field is Interfaces.Bit_Types.UInt10;
   subtype NAK_POLL_DELAY_FS_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype EP_STATUS_STALL_NAK_EP0_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP0_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP1_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP1_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP2_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP2_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP3_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP3_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP4_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP4_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP5_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP5_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP6_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP6_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP7_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP7_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP8_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP8_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP9_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP9_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP10_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP10_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP11_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP11_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP12_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP12_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP13_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP13_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP14_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP14_OUT_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP15_IN_Field is Interfaces.Bit_Types.Bit;
   subtype EP_STATUS_STALL_NAK_EP15_OUT_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype USB_MUXING_TO_PHY_Field is Interfaces.Bit_Types.Bit;
   subtype USB_MUXING_TO_EXTPHY_Field is Interfaces.Bit_Types.Bit;
   subtype USB_MUXING_TO_DIGITAL_PAD_Field is Interfaces.Bit_Types.Bit;
   subtype USB_MUXING_SOFTCON_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype USB_PWR_VBUS_EN_Field is Interfaces.Bit_Types.Bit;
   subtype USB_PWR_VBUS_EN_OVERRIDE_EN_Field is Interfaces.Bit_Types.Bit;
   subtype USB_PWR_VBUS_DETECT_Field is Interfaces.Bit_Types.Bit;
   subtype USB_PWR_VBUS_DETECT_OVERRIDE_EN_Field is Interfaces.Bit_Types.Bit;
   subtype USB_PWR_OVERCURR_DETECT_Field is Interfaces.Bit_Types.Bit;
   subtype USB_PWR_OVERCURR_DETECT_EN_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype USBPHY_DIRECT_DP_PULLUP_HISEL_Field is Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_DP_PULLUP_EN_Field is Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_DP_PULLDN_EN_Field is Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_DM_PULLUP_HISEL_Field is Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_DM_PULLUP_EN_Field is Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_DM_PULLDN_EN_Field is Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_TX_DP_OE_Field is Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_TX_DM_OE_Field is Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_TX_DP_Field is Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_TX_DM_Field is Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_RX_PD_Field is Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_TX_PD_Field is Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_TX_FSSLEW_Field is Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_TX_DIFFMODE_Field is Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_RX_DD_Field is Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_RX_DP_Field is Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_RX_DM_Field is Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_DP_OVCN_Field is Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_DM_OVCN_Field is Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_DP_OVV_Field is Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_DM_OVV_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype USBPHY_DIRECT_OVERRIDE_DM_PULLUP_HISEL_OVERRIDE_EN_Field is
     Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_OVERRIDE_DP_PULLUP_EN_OVERRIDE_EN_Field is
     Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_OVERRIDE_DP_PULLDN_EN_OVERRIDE_EN_Field is
     Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_OVERRIDE_DM_PULLDN_EN_OVERRIDE_EN_Field is
     Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_OVERRIDE_TX_DP_OE_OVERRIDE_EN_Field is
     Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_OVERRIDE_TX_DM_OE_OVERRIDE_EN_Field is
     Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_OVERRIDE_TX_DP_OVERRIDE_EN_Field is
     Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_OVERRIDE_TX_DM_OVERRIDE_EN_Field is
     Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_OVERRIDE_RX_PD_OVERRIDE_EN_Field is
     Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_OVERRIDE_TX_PD_OVERRIDE_EN_Field is
     Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_OVERRIDE_TX_FSSLEW_OVERRIDE_EN_Field is
     Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_OVERRIDE_DM_PULLUP_OVERRIDE_EN_Field is
     Interfaces.Bit_Types.Bit;
   subtype USBPHY_DIRECT_OVERRIDE_TX_DIFFMODE_OVERRIDE_EN_Field is
     Interfaces.Bit_Types.Bit;
   ...
   subtype USBPHY_TRIM_DP_PULLDN_TRIM_Field is Interfaces.Bit_Types.UInt5;
   subtype USBPHY_TRIM_DM_PULLDN_TRIM_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype INTR_HOST_CONN_DIS_Field is Interfaces.Bit_Types.Bit;
   subtype INTR_HOST_RESUME_Field is Interfaces.Bit_Types.Bit;
   subtype INTR_HOST_SOF_Field is Interfaces.Bit_Types.Bit;
   subtype INTR_TRANS_COMPLETE_Field is Interfaces.Bit_Types.Bit;
   subtype INTR_BUFF_STATUS_Field is Interfaces.Bit_Types.Bit;
   subtype INTR_ERROR_DATA_SEQ_Field is Interfaces.Bit_Types.Bit;
   subtype INTR_ERROR_RX_TIMEOUT_Field is Interfaces.Bit_Types.Bit;
   subtype INTR_ERROR_RX_OVERFLOW_Field is Interfaces.Bit_Types.Bit;
   subtype INTR_ERROR_BIT_STUFF_Field is Interfaces.Bit_Types.Bit;
   subtype INTR_ERROR_CRC_Field is Interfaces.Bit_Types.Bit;
   subtype INTR_STALL_Field is Interfaces.Bit_Types.Bit;
   subtype INTR_VBUS_DETECT_Field is Interfaces.Bit_Types.Bit;
   subtype INTR_BUS_RESET_Field is Interfaces.Bit_Types.Bit;
   subtype INTR_DEV_CONN_DIS_Field is Interfaces.Bit_Types.Bit;
   subtype INTR_DEV_SUSPEND_Field is Interfaces.Bit_Types.Bit;
   subtype INTR_DEV_RESUME_FROM_HOST_Field is Interfaces.Bit_Types.Bit;
   subtype INTR_SETUP_REQ_Field is Interfaces.Bit_Types.Bit;
   subtype INTR_DEV_SOF_Field is Interfaces.Bit_Types.Bit;
   subtype INTR_ABORT_DONE_Field is Interfaces.Bit_Types.Bit;
   subtype INTR_EP_STALL_NAK_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype INTE_HOST_CONN_DIS_Field is Interfaces.Bit_Types.Bit;
   subtype INTE_HOST_RESUME_Field is Interfaces.Bit_Types.Bit;
   subtype INTE_HOST_SOF_Field is Interfaces.Bit_Types.Bit;
   subtype INTE_TRANS_COMPLETE_Field is Interfaces.Bit_Types.Bit;
   subtype INTE_BUFF_STATUS_Field is Interfaces.Bit_Types.Bit;
   subtype INTE_ERROR_DATA_SEQ_Field is Interfaces.Bit_Types.Bit;
   subtype INTE_ERROR_RX_TIMEOUT_Field is Interfaces.Bit_Types.Bit;
   subtype INTE_ERROR_RX_OVERFLOW_Field is Interfaces.Bit_Types.Bit;
   subtype INTE_ERROR_BIT_STUFF_Field is Interfaces.Bit_Types.Bit;
   subtype INTE_ERROR_CRC_Field is Interfaces.Bit_Types.Bit;
   subtype INTE_STALL_Field is Interfaces.Bit_Types.Bit;
   subtype INTE_VBUS_DETECT_Field is Interfaces.Bit_Types.Bit;
   subtype INTE_BUS_RESET_Field is Interfaces.Bit_Types.Bit;
   subtype INTE_DEV_CONN_DIS_Field is Interfaces.Bit_Types.Bit;
   subtype INTE_DEV_SUSPEND_Field is Interfaces.Bit_Types.Bit;
   subtype INTE_DEV_RESUME_FROM_HOST_Field is Interfaces.Bit_Types.Bit;
   subtype INTE_SETUP_REQ_Field is Interfaces.Bit_Types.Bit;
   subtype INTE_DEV_SOF_Field is Interfaces.Bit_Types.Bit;
   subtype INTE_ABORT_DONE_Field is Interfaces.Bit_Types.Bit;
   subtype INTE_EP_STALL_NAK_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype INTF_HOST_CONN_DIS_Field is Interfaces.Bit_Types.Bit;
   subtype INTF_HOST_RESUME_Field is Interfaces.Bit_Types.Bit;
   subtype INTF_HOST_SOF_Field is Interfaces.Bit_Types.Bit;
   subtype INTF_TRANS_COMPLETE_Field is Interfaces.Bit_Types.Bit;
   subtype INTF_BUFF_STATUS_Field is Interfaces.Bit_Types.Bit;
   subtype INTF_ERROR_DATA_SEQ_Field is Interfaces.Bit_Types.Bit;
   subtype INTF_ERROR_RX_TIMEOUT_Field is Interfaces.Bit_Types.Bit;
   subtype INTF_ERROR_RX_OVERFLOW_Field is Interfaces.Bit_Types.Bit;
   subtype INTF_ERROR_BIT_STUFF_Field is Interfaces.Bit_Types.Bit;
   subtype INTF_ERROR_CRC_Field is Interfaces.Bit_Types.Bit;
   subtype INTF_STALL_Field is Interfaces.Bit_Types.Bit;
   subtype INTF_VBUS_DETECT_Field is Interfaces.Bit_Types.Bit;
   subtype INTF_BUS_RESET_Field is Interfaces.Bit_Types.Bit;
   subtype INTF_DEV_CONN_DIS_Field is Interfaces.Bit_Types.Bit;
   subtype INTF_DEV_SUSPEND_Field is Interfaces.Bit_Types.Bit;
   subtype INTF_DEV_RESUME_FROM_HOST_Field is Interfaces.Bit_Types.Bit;
   subtype INTF_SETUP_REQ_Field is Interfaces.Bit_Types.Bit;
   subtype INTF_DEV_SOF_Field is Interfaces.Bit_Types.Bit;
   subtype INTF_ABORT_DONE_Field is Interfaces.Bit_Types.Bit;
   subtype INTF_EP_STALL_NAK_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype INTS_HOST_CONN_DIS_Field is Interfaces.Bit_Types.Bit;
   subtype INTS_HOST_RESUME_Field is Interfaces.Bit_Types.Bit;
   subtype INTS_HOST_SOF_Field is Interfaces.Bit_Types.Bit;
   subtype INTS_TRANS_COMPLETE_Field is Interfaces.Bit_Types.Bit;
   subtype INTS_BUFF_STATUS_Field is Interfaces.Bit_Types.Bit;
   subtype INTS_ERROR_DATA_SEQ_Field is Interfaces.Bit_Types.Bit;
   subtype INTS_ERROR_RX_TIMEOUT_Field is Interfaces.Bit_Types.Bit;
   subtype INTS_ERROR_RX_OVERFLOW_Field is Interfaces.Bit_Types.Bit;
   subtype INTS_ERROR_BIT_STUFF_Field is Interfaces.Bit_Types.Bit;
   subtype INTS_ERROR_CRC_Field is Interfaces.Bit_Types.Bit;
   subtype INTS_STALL_Field is Interfaces.Bit_Types.Bit;
   subtype INTS_VBUS_DETECT_Field is Interfaces.Bit_Types.Bit;
   subtype INTS_BUS_RESET_Field is Interfaces.Bit_Types.Bit;
   subtype INTS_DEV_CONN_DIS_Field is Interfaces.Bit_Types.Bit;
   subtype INTS_DEV_SUSPEND_Field is Interfaces.Bit_Types.Bit;
   subtype INTS_DEV_RESUME_FROM_HOST_Field is Interfaces.Bit_Types.Bit;
   subtype INTS_SETUP_REQ_Field is Interfaces.Bit_Types.Bit;
   subtype INTS_DEV_SOF_Field is Interfaces.Bit_Types.Bit;
   subtype INTS_ABORT_DONE_Field is Interfaces.Bit_Types.Bit;
   subtype INTS_EP_STALL_NAK_Field is Interfaces.Bit_Types.Bit;
...
end Interfaces.RP.USBCTRL_REGS;
