...
package Interfaces.RP.XOSC is
   ...
   type STATUS_Register is record
      ...
      FREQ_RANGE     : STATUS_FREQ_RANGE_Field :=
                        Interfaces.RP.XOSC.Val_1_15Mhz;
      --  unspecified
      ...
      --  unspecified
      Reserved_13_23 : Interfaces.Bit_Types.UInt11 := 16#0#;
   ...
   subtype STARTUP_DELAY_Field is Interfaces.Bit_Types.UInt14;
   subtype STARTUP_X4_Field is Interfaces.Bit_Types.Bit;
