...
package Interfaces.RP.WATCHDOG is
   pragma Preelaborate;
   ...
   subtype CTRL_TIME_Field is Interfaces.Bit_Types.UInt24;
   subtype CTRL_PAUSE_JTAG_Field is Interfaces.Bit_Types.Bit;
   --  CTRL_PAUSE_DBG array element
   subtype CTRL_PAUSE_DBG_Element is Interfaces.Bit_Types.Bit;
   ...
   subtype CTRL_TRIGGER_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype LOAD_LOAD_Field is Interfaces.Bit_Types.UInt24;
   ...
   subtype REASON_TIMER_Field is Interfaces.Bit_Types.Bit;
   subtype REASON_FORCE_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype TICK_CYCLES_Field is Interfaces.Bit_Types.UInt9;
   subtype TICK_ENABLE_Field is Interfaces.Bit_Types.Bit;
   subtype TICK_RUNNING_Field is Interfaces.Bit_Types.Bit;
   subtype TICK_COUNT_Field is Interfaces.Bit_Types.UInt9;
   ...
   type WATCHDOG_Peripheral is record
      ...
      --  chip.
      SCRATCH0 : aliased Interfaces.Bit_Types.UInt32;
      --  Scratch register. Information persists through soft reset of the
      --  chip.
      SCRATCH1 : aliased Interfaces.Bit_Types.UInt32;
      --  Scratch register. Information persists through soft reset of the
      --  chip.
      SCRATCH2 : aliased Interfaces.Bit_Types.UInt32;
      --  Scratch register. Information persists through soft reset of the
      --  chip.
      SCRATCH3 : aliased Interfaces.Bit_Types.UInt32;
      --  Scratch register. Information persists through soft reset of the
      --  chip.
      SCRATCH4 : aliased Interfaces.Bit_Types.UInt32;
      --  Scratch register. Information persists through soft reset of the
      --  chip.
      SCRATCH5 : aliased Interfaces.Bit_Types.UInt32;
      --  Scratch register. Information persists through soft reset of the
      --  chip.
      SCRATCH6 : aliased Interfaces.Bit_Types.UInt32;
      --  Scratch register. Information persists through soft reset of the
      --  chip.
      SCRATCH7 : aliased Interfaces.Bit_Types.UInt32;
      --  Controls the tick generator
