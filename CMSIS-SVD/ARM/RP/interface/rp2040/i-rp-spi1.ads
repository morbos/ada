...
package Interfaces.RP.SPI1 is
   ...
   subtype SSPCR0_DSS_Field is Interfaces.Bit_Types.UInt4;
   subtype SSPCR0_FRF_Field is Interfaces.Bit_Types.UInt2;
   subtype SSPCR0_SPO_Field is Interfaces.Bit_Types.Bit;
   subtype SSPCR0_SPH_Field is Interfaces.Bit_Types.Bit;
   subtype SSPCR0_SCR_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype SSPCR1_LBM_Field is Interfaces.Bit_Types.Bit;
   subtype SSPCR1_SSE_Field is Interfaces.Bit_Types.Bit;
   subtype SSPCR1_MS_Field is Interfaces.Bit_Types.Bit;
   subtype SSPCR1_SOD_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype SSPDR_DATA_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype SSPSR_TFE_Field is Interfaces.Bit_Types.Bit;
   subtype SSPSR_TNF_Field is Interfaces.Bit_Types.Bit;
   subtype SSPSR_RNE_Field is Interfaces.Bit_Types.Bit;
   subtype SSPSR_RFF_Field is Interfaces.Bit_Types.Bit;
   subtype SSPSR_BSY_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype SSPCPSR_CPSDVSR_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype SSPIMSC_RORIM_Field is Interfaces.Bit_Types.Bit;
   subtype SSPIMSC_RTIM_Field is Interfaces.Bit_Types.Bit;
   subtype SSPIMSC_RXIM_Field is Interfaces.Bit_Types.Bit;
   subtype SSPIMSC_TXIM_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype SSPRIS_RORRIS_Field is Interfaces.Bit_Types.Bit;
   subtype SSPRIS_RTRIS_Field is Interfaces.Bit_Types.Bit;
   subtype SSPRIS_RXRIS_Field is Interfaces.Bit_Types.Bit;
   subtype SSPRIS_TXRIS_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype SSPMIS_RORMIS_Field is Interfaces.Bit_Types.Bit;
   subtype SSPMIS_RTMIS_Field is Interfaces.Bit_Types.Bit;
   subtype SSPMIS_RXMIS_Field is Interfaces.Bit_Types.Bit;
   subtype SSPMIS_TXMIS_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype SSPICR_RORIC_Field is Interfaces.Bit_Types.Bit;
   subtype SSPICR_RTIC_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype SSPDMACR_RXDMAE_Field is Interfaces.Bit_Types.Bit;
   subtype SSPDMACR_TXDMAE_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype SSPPERIPHID0_PARTNUMBER0_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype SSPPERIPHID1_PARTNUMBER1_Field is Interfaces.Bit_Types.UInt4;
   subtype SSPPERIPHID1_DESIGNER0_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype SSPPERIPHID2_DESIGNER1_Field is Interfaces.Bit_Types.UInt4;
   subtype SSPPERIPHID2_REVISION_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype SSPPERIPHID3_CONFIGURATION_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype SSPPCELLID0_SSPPCELLID0_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype SSPPCELLID1_SSPPCELLID1_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype SSPPCELLID2_SSPPCELLID2_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype SSPPCELLID3_SSPPCELLID3_Field is Interfaces.Bit_Types.Byte;
