...
package Interfaces.RP.XIP_CTRL is
   pragma Preelaborate;
   ...
   subtype CTRL_ERR_BADWRITE_Field is Interfaces.Bit_Types.Bit;
   subtype CTRL_POWER_DOWN_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype FLUSH_FLUSH_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype STAT_FLUSH_READY_Field is Interfaces.Bit_Types.Bit;
   subtype STAT_FIFO_EMPTY_Field is Interfaces.Bit_Types.Bit;
   subtype STAT_FIFO_FULL_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype STREAM_ADDR_STREAM_ADDR_Field is Interfaces.Bit_Types.UInt30;
   ...
   subtype STREAM_CTR_STREAM_CTR_Field is Interfaces.Bit_Types.UInt22;
   ...
   type XIP_CTRL_Peripheral is record
      ...
      CTR_HIT     : aliased Interfaces.Bit_Types.UInt32;
      ...
      CTR_ACC     : aliased Interfaces.Bit_Types.UInt32;
      --  FIFO stream address
      ...
      --  traffic.
      STREAM_FIFO : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
