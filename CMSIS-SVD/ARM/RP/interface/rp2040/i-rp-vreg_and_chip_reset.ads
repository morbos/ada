...
--  subsystem
package Interfaces.RP.VREG_AND_CHIP_RESET is
   pragma Preelaborate;
   ...
   subtype VREG_EN_Field is Interfaces.Bit_Types.Bit;
   subtype VREG_HIZ_Field is Interfaces.Bit_Types.Bit;
   subtype VREG_VSEL_Field is Interfaces.Bit_Types.UInt4;
   subtype VREG_ROK_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype BOD_EN_Field is Interfaces.Bit_Types.Bit;
   subtype BOD_VSEL_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype CHIP_RESET_HAD_POR_Field is Interfaces.Bit_Types.Bit;
   subtype CHIP_RESET_HAD_RUN_Field is Interfaces.Bit_Types.Bit;
   subtype CHIP_RESET_HAD_PSM_RESTART_Field is Interfaces.Bit_Types.Bit;
   subtype CHIP_RESET_PSM_RESTART_FLAG_Field is Interfaces.Bit_Types.Bit;
...
end Interfaces.RP.VREG_AND_CHIP_RESET;
