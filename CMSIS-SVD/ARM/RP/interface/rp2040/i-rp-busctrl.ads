...
package Interfaces.RP.BUSCTRL is
   pragma Preelaborate;
   ...
   subtype BUS_PRIORITY_PROC0_Field is Interfaces.Bit_Types.Bit;
   subtype BUS_PRIORITY_PROC1_Field is Interfaces.Bit_Types.Bit;
   subtype BUS_PRIORITY_DMA_R_Field is Interfaces.Bit_Types.Bit;
   subtype BUS_PRIORITY_DMA_W_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype BUS_PRIORITY_ACK_BUS_PRIORITY_ACK_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype PERFCTR0_PERFCTR0_Field is Interfaces.Bit_Types.UInt24;
   ...
   subtype PERFSEL0_PERFSEL0_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype PERFCTR1_PERFCTR1_Field is Interfaces.Bit_Types.UInt24;
   ...
   subtype PERFSEL1_PERFSEL1_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype PERFCTR2_PERFCTR2_Field is Interfaces.Bit_Types.UInt24;
   ...
   subtype PERFSEL2_PERFSEL2_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype PERFCTR3_PERFCTR3_Field is Interfaces.Bit_Types.UInt24;
   ...
   subtype PERFSEL3_PERFSEL3_Field is Interfaces.Bit_Types.UInt5;
