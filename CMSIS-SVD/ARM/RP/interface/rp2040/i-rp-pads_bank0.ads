...
package Interfaces.RP.PADS_BANK0 is
   pragma Preelaborate;
   ...
   type VOLTAGE_SELECT_Register is record
      VOLTAGE_SELECT : VOLTAGE_SELECT_VOLTAGE_SELECT_Field :=
                        Interfaces.RP.PADS_BANK0.Val_3V3;
      --  unspecified
   ...
   subtype GPIO_SLEWFAST_Field is Interfaces.Bit_Types.Bit;
   subtype GPIO_SCHMITT_Field is Interfaces.Bit_Types.Bit;
   subtype GPIO_PDE_Field is Interfaces.Bit_Types.Bit;
   subtype GPIO_PUE_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype GPIO_IE_Field is Interfaces.Bit_Types.Bit;
   subtype GPIO_OD_Field is Interfaces.Bit_Types.Bit;
   ...
   type GPIO_Register is record
      ...
      --  Drive strength.
      DRIVE         : GPIO0_DRIVE_Field := Interfaces.RP.PADS_BANK0.Val_4MA;
      --  Input enable
   ...
   subtype SWCLK_SLEWFAST_Field is Interfaces.Bit_Types.Bit;
   subtype SWCLK_SCHMITT_Field is Interfaces.Bit_Types.Bit;
   subtype SWCLK_PDE_Field is Interfaces.Bit_Types.Bit;
   subtype SWCLK_PUE_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype SWCLK_IE_Field is Interfaces.Bit_Types.Bit;
   subtype SWCLK_OD_Field is Interfaces.Bit_Types.Bit;
   ...
   type SWCLK_Register is record
      ...
      --  Drive strength.
      DRIVE         : SWCLK_DRIVE_Field := Interfaces.RP.PADS_BANK0.Val_4MA;
      --  Input enable
   ...
   subtype SWD_SLEWFAST_Field is Interfaces.Bit_Types.Bit;
   subtype SWD_SCHMITT_Field is Interfaces.Bit_Types.Bit;
   subtype SWD_PDE_Field is Interfaces.Bit_Types.Bit;
   subtype SWD_PUE_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype SWD_IE_Field is Interfaces.Bit_Types.Bit;
   subtype SWD_OD_Field is Interfaces.Bit_Types.Bit;
   ...
   type SWD_Register is record
      ...
      --  Drive strength.
      DRIVE         : SWD_DRIVE_Field := Interfaces.RP.PADS_BANK0.Val_4MA;
      --  Input enable
