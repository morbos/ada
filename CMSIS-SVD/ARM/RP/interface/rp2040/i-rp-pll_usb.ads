...
package Interfaces.RP.PLL_USB is
   pragma Preelaborate;
   ...
   subtype CS_REFDIV_Field is Interfaces.Bit_Types.UInt6;
   subtype CS_BYPASS_Field is Interfaces.Bit_Types.Bit;
   subtype CS_LOCK_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype PWR_PD_Field is Interfaces.Bit_Types.Bit;
   subtype PWR_DSMPD_Field is Interfaces.Bit_Types.Bit;
   subtype PWR_POSTDIVPD_Field is Interfaces.Bit_Types.Bit;
   subtype PWR_VCOPD_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype FBDIV_INT_FBDIV_INT_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype PRIM_POSTDIV2_Field is Interfaces.Bit_Types.UInt3;
   subtype PRIM_POSTDIV1_Field is Interfaces.Bit_Types.UInt3;
