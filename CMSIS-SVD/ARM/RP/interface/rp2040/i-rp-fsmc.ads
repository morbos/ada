...
package Interfaces.RP.FSMC is
   ...
   subtype BCR1_MBKEN_Field is Interfaces.Bit_Types.Bit;
   subtype BCR1_MUXEN_Field is Interfaces.Bit_Types.Bit;
   subtype BCR1_MTYP_Field is Interfaces.Bit_Types.UInt2;
   subtype BCR1_MWID_Field is Interfaces.Bit_Types.UInt2;
   subtype BCR1_FACCEN_Field is Interfaces.Bit_Types.Bit;
   subtype BCR1_BURSTEN_Field is Interfaces.Bit_Types.Bit;
   subtype BCR1_WAITPOL_Field is Interfaces.Bit_Types.Bit;
   subtype BCR1_WAITCFG_Field is Interfaces.Bit_Types.Bit;
   subtype BCR1_WREN_Field is Interfaces.Bit_Types.Bit;
   subtype BCR1_WAITEN_Field is Interfaces.Bit_Types.Bit;
   subtype BCR1_EXTMOD_Field is Interfaces.Bit_Types.Bit;
   subtype BCR1_ASYNCWAIT_Field is Interfaces.Bit_Types.Bit;
   subtype BCR1_CBURSTRW_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype BCR_MBKEN_Field is Interfaces.Bit_Types.Bit;
   subtype BCR_MUXEN_Field is Interfaces.Bit_Types.Bit;
   subtype BCR_MTYP_Field is Interfaces.Bit_Types.UInt2;
   subtype BCR_MWID_Field is Interfaces.Bit_Types.UInt2;
   subtype BCR_FACCEN_Field is Interfaces.Bit_Types.Bit;
   subtype BCR_BURSTEN_Field is Interfaces.Bit_Types.Bit;
   subtype BCR_WAITPOL_Field is Interfaces.Bit_Types.Bit;
   subtype BCR_WRAPMOD_Field is Interfaces.Bit_Types.Bit;
   subtype BCR_WAITCFG_Field is Interfaces.Bit_Types.Bit;
   subtype BCR_WREN_Field is Interfaces.Bit_Types.Bit;
   subtype BCR_WAITEN_Field is Interfaces.Bit_Types.Bit;
   subtype BCR_EXTMOD_Field is Interfaces.Bit_Types.Bit;
   subtype BCR_ASYNCWAIT_Field is Interfaces.Bit_Types.Bit;
   subtype BCR_CBURSTRW_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype PCR_PWAITEN_Field is Interfaces.Bit_Types.Bit;
   subtype PCR_PBKEN_Field is Interfaces.Bit_Types.Bit;
   subtype PCR_PTYP_Field is Interfaces.Bit_Types.Bit;
   subtype PCR_PWID_Field is Interfaces.Bit_Types.UInt2;
   subtype PCR_ECCEN_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype SR_IRS_Field is Interfaces.Bit_Types.Bit;
   subtype SR_ILS_Field is Interfaces.Bit_Types.Bit;
   subtype SR_IFS_Field is Interfaces.Bit_Types.Bit;
   subtype SR_IREN_Field is Interfaces.Bit_Types.Bit;
   subtype SR_ILEN_Field is Interfaces.Bit_Types.Bit;
   subtype SR_IFEN_Field is Interfaces.Bit_Types.Bit;
   subtype SR_FEMPT_Field is Interfaces.Bit_Types.Bit;
   ...
   type FSMC_Peripheral is record
      ...
      ECCR2 : aliased Interfaces.Bit_Types.UInt32;
      ...
      ECCR3 : aliased Interfaces.Bit_Types.UInt32;
