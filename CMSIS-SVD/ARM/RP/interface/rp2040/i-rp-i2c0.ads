...
package Interfaces.RP.I2C0 is
   ...
   subtype IC_CON_STOP_DET_IF_MASTER_ACTIVE_Field is Interfaces.Bit_Types.Bit;
   ...
   type IC_CON_Register is record
      ...
      SPEED                     : IC_CON_SPEED_Field :=
                                   Interfaces.RP.I2C0.Fast;
      --  When acting as a slave, this bit controls whether the DW_apb_i2c
      --  responds to 7- or 10-bit addresses. - 0: 7-bit addressing. The
      --  DW_apb_i2c ignores transactions that involve 10-bit addressing; for
      --  7-bit addressing, only the lower 7 bits of the IC_SAR register are
      ...
      IC_SLAVE_DISABLE          : IC_CON_IC_SLAVE_DISABLE_Field :=
                                   Interfaces.RP.I2C0.Slave_Disabled;
      --  In slave mode: - 1'b1: issues the STOP_DET interrupt only when it is
      --  addressed. - 1'b0: issues the STOP_DET irrespective of whether it's
      --  addressed or not. Reset value: 0x0\n\n NOTE: During a general call
      --  address, this slave does not issue the STOP_DET interrupt if
   ...
   subtype IC_TAR_IC_TAR_Field is Interfaces.Bit_Types.UInt10;
   ...
   type IC_TAR_Register is record
      ...
      GC_OR_START    : IC_TAR_GC_OR_START_Field :=
                        Interfaces.RP.I2C0.General_Call;
      ...
      SPECIAL        : IC_TAR_SPECIAL_Field := Interfaces.RP.I2C0.Disabled;
      --  unspecified
   ...
   subtype IC_SAR_IC_SAR_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype IC_DATA_CMD_DAT_Field is Interfaces.Bit_Types.Byte;
   ...
   type IC_DATA_CMD_Register is record
      ...
      --  occurs.\n\n Reset value: 0x0
      CMD             : IC_DATA_CMD_CMD_Field := Interfaces.RP.I2C0.Write;
      --  After a write operation all bits in the field are cleared (set to
      ...
      STOP            : IC_DATA_CMD_STOP_Field := Interfaces.RP.I2C0.Disable;
      --  After a write operation all bits in the field are cleared (set to
      ...
      --  is issued instead.\n\n Reset value: 0x0
      RESTART         : IC_DATA_CMD_RESTART_Field :=
                         Interfaces.RP.I2C0.Disable;
   ...
   subtype IC_SS_SCL_HCNT_IC_SS_SCL_HCNT_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype IC_SS_SCL_LCNT_IC_SS_SCL_LCNT_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype IC_FS_SCL_HCNT_IC_FS_SCL_HCNT_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype IC_FS_SCL_LCNT_IC_FS_SCL_LCNT_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype IC_RX_TL_RX_TL_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype IC_TX_TL_TX_TL_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype IC_CLR_INTR_CLR_INTR_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype IC_CLR_RX_UNDER_CLR_RX_UNDER_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype IC_CLR_RX_OVER_CLR_RX_OVER_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype IC_CLR_TX_OVER_CLR_TX_OVER_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype IC_CLR_RD_REQ_CLR_RD_REQ_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype IC_CLR_TX_ABRT_CLR_TX_ABRT_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype IC_CLR_RX_DONE_CLR_RX_DONE_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype IC_CLR_ACTIVITY_CLR_ACTIVITY_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype IC_CLR_STOP_DET_CLR_STOP_DET_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype IC_CLR_START_DET_CLR_START_DET_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype IC_CLR_GEN_CALL_CLR_GEN_CALL_Field is Interfaces.Bit_Types.Bit;
   ...
   type IC_ENABLE_Register is record
      ...
      ENABLE        : IC_ENABLE_ENABLE_Field := Interfaces.RP.I2C0.Disabled;
      --  When set, the controller initiates the transfer abort. - 0: ABORT not
      --  initiated or ABORT done - 1: ABORT operation in progress The software
      --  can abort the I2C transfer in master mode by setting this bit. The
      --  software can set this bit only when ENABLE is already set; otherwise,
      ...
      ABORT_k       : IC_ENABLE_ABORT_Field := Interfaces.RP.I2C0.Disable;
      ...
      TX_CMD_BLOCK  : IC_ENABLE_TX_CMD_BLOCK_Field :=
                       Interfaces.RP.I2C0.Not_Blocked;
      --  unspecified
   ...
   subtype IC_TXFLR_TXFLR_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype IC_RXFLR_RXFLR_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype IC_SDA_HOLD_IC_SDA_TX_HOLD_Field is Interfaces.Bit_Types.UInt16;
   subtype IC_SDA_HOLD_IC_SDA_RX_HOLD_Field is Interfaces.Bit_Types.Byte;
...
--  present
   ...
   subtype IC_TX_ABRT_SOURCE_TX_FLUSH_CNT_Field is Interfaces.Bit_Types.UInt9;
   ...
   type IC_TX_ABRT_SOURCE_Register is record
      ...
      --  unspecified
      Reserved_17_22       : Interfaces.Bit_Types.UInt6;
   ...
   type IC_DMA_CR_Register is record
      --  Receive DMA Enable. This bit enables/disables the receive FIFO DMA
      --  channel. Reset value: 0x0
      RDMAE         : IC_DMA_CR_RDMAE_Field := Interfaces.RP.I2C0.Disabled;
      --  Transmit DMA Enable. This bit enables/disables the transmit FIFO DMA
      --  channel. Reset value: 0x0
      TDMAE         : IC_DMA_CR_TDMAE_Field := Interfaces.RP.I2C0.Disabled;
      --  unspecified
   ...
   subtype IC_DMA_TDLR_DMATDL_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype IC_DMA_RDLR_DMARDL_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype IC_SDA_SETUP_SDA_SETUP_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype IC_FS_SPKLEN_IC_FS_SPKLEN_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype IC_CLR_RESTART_DET_CLR_RESTART_DET_Field is
   ...
   subtype IC_COMP_PARAM_1_APB_DATA_WIDTH_Field is Interfaces.Bit_Types.UInt2;
   subtype IC_COMP_PARAM_1_MAX_SPEED_MODE_Field is Interfaces.Bit_Types.UInt2;
   subtype IC_COMP_PARAM_1_HC_COUNT_VALUES_Field is Interfaces.Bit_Types.Bit;
   subtype IC_COMP_PARAM_1_INTR_IO_Field is Interfaces.Bit_Types.Bit;
   subtype IC_COMP_PARAM_1_HAS_DMA_Field is Interfaces.Bit_Types.Bit;
   subtype IC_COMP_PARAM_1_ADD_ENCODED_PARAMS_Field is
     Interfaces.Bit_Types.Bit;
   subtype IC_COMP_PARAM_1_RX_BUFFER_DEPTH_Field is Interfaces.Bit_Types.Byte;
   subtype IC_COMP_PARAM_1_TX_BUFFER_DEPTH_Field is Interfaces.Bit_Types.Byte;
   ...
   type I2C0_Peripheral is record
      ...
      IC_COMP_VERSION       : aliased Interfaces.Bit_Types.UInt32;
      --  I2C Component Type Register
      IC_COMP_TYPE          : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
