...
package Interfaces.RP.ROSC is
   ...
   subtype FREQA_DS0_Field is Interfaces.Bit_Types.UInt3;
   subtype FREQA_DS1_Field is Interfaces.Bit_Types.UInt3;
   subtype FREQA_DS2_Field is Interfaces.Bit_Types.UInt3;
   subtype FREQA_DS3_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype FREQB_DS4_Field is Interfaces.Bit_Types.UInt3;
   subtype FREQB_DS5_Field is Interfaces.Bit_Types.UInt3;
   subtype FREQB_DS6_Field is Interfaces.Bit_Types.UInt3;
   subtype FREQB_DS7_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype PHASE_SHIFT_Field is Interfaces.Bit_Types.UInt2;
   subtype PHASE_FLIP_Field is Interfaces.Bit_Types.Bit;
   subtype PHASE_ENABLE_Field is Interfaces.Bit_Types.Bit;
   subtype PHASE_PASSWD_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype STATUS_ENABLED_Field is Interfaces.Bit_Types.Bit;
   subtype STATUS_DIV_RUNNING_Field is Interfaces.Bit_Types.Bit;
   subtype STATUS_BADWRITE_Field is Interfaces.Bit_Types.Bit;
   subtype STATUS_STABLE_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype RANDOMBIT_RANDOMBIT_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype COUNT_COUNT_Field is Interfaces.Bit_Types.Byte;
   ...
   type ROSC_Peripheral is record
      ...
      --  dormant mode
      DORMANT   : aliased Interfaces.Bit_Types.UInt32;
      --  Controls the output divider
