...
package Interfaces.NXP.OSTIMER is
   pragma Preelaborate;
   ...
   subtype EVTIMERH_EVTIMER_COUNT_VALUE_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype CAPTUREn_H_CAPTUREn_VALUE_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype MATCHn_H_MATCHn_VALUE_Field is Interfaces.Bit_Types.UInt10;
