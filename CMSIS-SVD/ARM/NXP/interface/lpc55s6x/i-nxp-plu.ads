...
package Interfaces.NXP.PLU is
   ...
   type LUT_INP_MUX_LUT_Register is record
      ...
      --  low.
      LUTn_INPx     : LUT_INP_MUX_LUTn_INPx_Field :=
                       Interfaces.NXP.PLU.PLU_INPUTS0;
      --  unspecified
   ...
   --  Specifies the Truth Table contents for LUT0
   type LUT_TRUTH_Registers is array (0 .. 25) of Interfaces.Bit_Types.Word
     with Volatile;

   subtype OUTPUTS_OUTPUT_STATE_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype WAKEINT_CTRL_MASK_Field is Interfaces.Bit_Types.Byte;
   ...
   type WAKEINT_CTRL_Register is record
      ...
      --  control input of the PLU, add filtering for glitch.
      FILTER_MODE    : WAKEINT_CTRL_FILTER_MODE_Field :=
                        Interfaces.NXP.PLU.Bypass;
      --  hclk is divided by 2**filter_clksel.
      FILTER_CLKSEL  : WAKEINT_CTRL_FILTER_CLKSEL_Field :=
                        Interfaces.NXP.PLU.Fro1Mhz;
   ...
   type OUTPUT_MUX_Register is record
      --  Selects the source to be connected to PLU Output 0.
      OUTPUTn       : OUTPUT_MUX_OUTPUTn_Field :=
                       Interfaces.NXP.PLU.PLU_OUTPUT0;
      --  unspecified
