...
package Interfaces.NXP.USART is
   pragma Preelaborate;
   ...
   type CFG_Register is record
      --  USART Enable.
      ENABLE         : CFG_ENABLE_Field := Interfaces.NXP.USART.Disabled;
      --  unspecified
      Reserved_1_1   : Interfaces.Bit_Types.Bit := 16#0#;
      --  Selects the data size for the USART.
      DATALEN        : CFG_DATALEN_Field := Interfaces.NXP.USART.Bit_7;
      --  Selects what type of parity is used by the USART.
      PARITYSEL      : CFG_PARITYSEL_Field := Interfaces.NXP.USART.No_Parity;
      --  Number of stop bits appended to transmitted data. Only a single stop
      --  bit is required for received data.
      STOPLEN        : CFG_STOPLEN_Field := Interfaces.NXP.USART.Bit_1;
      --  Selects standard or 32 kHz clocking mode.
      MODE32K        : CFG_MODE32K_Field := Interfaces.NXP.USART.Disabled;
      --  LIN break mode enable.
      LINMODE        : CFG_LINMODE_Field := Interfaces.NXP.USART.Disabled;
      ...
      --  is enabled.
      CTSEN          : CFG_CTSEN_Field := Interfaces.NXP.USART.Disabled;
      --  unspecified
      Reserved_10_10 : Interfaces.Bit_Types.Bit := 16#0#;
      --  Selects synchronous or asynchronous operation.
      SYNCEN         : CFG_SYNCEN_Field :=
                        Interfaces.NXP.USART.Asynchronous_Mode;
      --  Selects the clock polarity and sampling edge of received data in
      --  synchronous mode.
      CLKPOL         : CFG_CLKPOL_Field := Interfaces.NXP.USART.Falling_Edge;
      --  unspecified
      Reserved_13_13 : Interfaces.Bit_Types.Bit := 16#0#;
      --  Synchronous mode Master select.
      SYNCMST        : CFG_SYNCMST_Field := Interfaces.NXP.USART.Slave;
      --  Selects data loopback mode.
      LOOP_k         : CFG_LOOP_Field := Interfaces.NXP.USART.Normal;
      --  unspecified
      Reserved_16_17 : Interfaces.Bit_Types.UInt2 := 16#0#;
      --  Output Enable Turnaround time enable for RS-485 operation.
      OETA           : CFG_OETA_Field := Interfaces.NXP.USART.Disabled;
      --  Automatic Address matching enable.
      AUTOADDR       : CFG_AUTOADDR_Field := Interfaces.NXP.USART.Disabled;
      --  Output Enable Select.
      OESEL          : CFG_OESEL_Field := Interfaces.NXP.USART.Standard;
      --  Output Enable Polarity.
      OEPOL          : CFG_OEPOL_Field := Interfaces.NXP.USART.Low;
      --  Receive data polarity.
      RXPOL          : CFG_RXPOL_Field := Interfaces.NXP.USART.Standard;
      --  Transmit data polarity.
      TXPOL          : CFG_TXPOL_Field := Interfaces.NXP.USART.Standard;
      --  unspecified
   ...
   type CTL_Register is record
      ...
      --  Break Enable.
      TXBRKEN        : CTL_TXBRKEN_Field := Interfaces.NXP.USART.Normal;
      --  Enable address detect mode.
      ADDRDET        : CTL_ADDRDET_Field := Interfaces.NXP.USART.Disabled;
      --  unspecified
      Reserved_3_5   : Interfaces.Bit_Types.UInt3 := 16#0#;
      --  Transmit Disable.
      TXDIS          : CTL_TXDIS_Field := Interfaces.NXP.USART.Enabled;
      --  unspecified
      Reserved_7_7   : Interfaces.Bit_Types.Bit := 16#0#;
      --  Continuous Clock generation. By default, SCLK is only output while
      --  data is being transmitted in synchronous mode.
      CC             : CTL_CC_Field :=
                        Interfaces.NXP.USART.Clock_On_Character;
      --  Clear Continuous Clock.
      CLRCCONRX      : CTL_CLRCCONRX_Field := Interfaces.NXP.USART.No_Effect;
      --  unspecified
      Reserved_10_15 : Interfaces.Bit_Types.UInt6 := 16#0#;
      --  Autobaud enable.
      AUTOBAUD       : CTL_AUTOBAUD_Field := Interfaces.NXP.USART.Disabled;
      --  unspecified
   ...
   subtype BRG_BRGVAL_Field is Interfaces.Bit_Types.Short;
   ...
   type INTSTAT_Register is record
      ...
      TXDISINT       : Boolean;
      --  unspecified
      Reserved_7_10  : Interfaces.Bit_Types.UInt4;
   ...
   subtype OSR_OSRVAL_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype ADDR_ADDRESS_Field is Interfaces.Bit_Types.Byte;
   ...
   type FIFOCFG_Register is record
      --  Enable the transmit FIFO.
      ENABLETX       : FIFOCFG_ENABLETX_Field :=
                        Interfaces.NXP.USART.Disabled;
      --  Enable the receive FIFO.
      ENABLERX       : FIFOCFG_ENABLERX_Field :=
                        Interfaces.NXP.USART.Disabled;
      --  unspecified
      ...
      --  DMA configuration for transmit.
      DMATX          : FIFOCFG_DMATX_Field := Interfaces.NXP.USART.Disabled;
      --  DMA configuration for receive.
      DMARX          : FIFOCFG_DMARX_Field := Interfaces.NXP.USART.Disabled;
      ...
      WAKETX         : FIFOCFG_WAKETX_Field := Interfaces.NXP.USART.Disabled;
      ...
      --  The CPU will remain stopped until woken by another cause, such as DMA
      --  completion. See Hardware Wake-up control register.
      WAKERX         : FIFOCFG_WAKERX_Field := Interfaces.NXP.USART.Disabled;
   ...
   type FIFOTRIG_Register is record
      ...
      --  interrupt if enabled in FIFOINTENSET, or a DMA trigger if DMATX in
      --  FIFOCFG is set.
      TXLVLENA       : FIFOTRIG_TXLVLENA_Field :=
                        Interfaces.NXP.USART.Disabled;
      ...
      --  FIFOCFG is set.
      RXLVLENA       : FIFOTRIG_RXLVLENA_Field :=
                        Interfaces.NXP.USART.Disabled;
      --  unspecified
   ...
   type FIFOINTENSET_Register is record
      --  Determines whether an interrupt occurs when a transmit error occurs,
      --  based on the TXERR flag in the FIFOSTAT register.
      TXERR         : FIFOINTENSET_TXERR_Field :=
                       Interfaces.NXP.USART.Disabled;
      --  Determines whether an interrupt occurs when a receive error occurs,
      --  based on the RXERR flag in the FIFOSTAT register.
      RXERR         : FIFOINTENSET_RXERR_Field :=
                       Interfaces.NXP.USART.Disabled;
   ...
   subtype FIFOWR_TXDATA_Field is Interfaces.Bit_Types.UInt9;
   ...
   subtype FIFORD_RXDATA_Field is Interfaces.Bit_Types.UInt9;
   ...
   type FIFORD_Register is record
      ...
      --  unspecified
      Reserved_9_12  : Interfaces.Bit_Types.UInt4;
   ...
   subtype FIFORDNOPOP_RXDATA_Field is Interfaces.Bit_Types.UInt9;
