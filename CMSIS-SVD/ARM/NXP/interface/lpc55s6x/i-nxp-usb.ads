...
package Interfaces.NXP.USB is
   ...
   subtype DEVCMDSTAT_DEV_ADDR_Field is Interfaces.Bit_Types.UInt7;
   ...
   type DEVCMDSTAT_Register is record
      ...
      SETUP          : Boolean := False;
      --  Forces the NEEDCLK output to always be on:
      FORCE_NEEDCLK  : DEVCMDSTAT_FORCE_NEEDCLK_Field :=
                        Interfaces.NXP.USB.Normal;
      --  unspecified
      Reserved_10_10 : Interfaces.Bit_Types.Bit := 16#0#;
      --  LPM Supported:
      LPM_SUP        : DEVCMDSTAT_LPM_SUP_Field := Interfaces.NXP.USB.Yes;
      --  Interrupt on NAK for interrupt and bulk OUT EP
      INTONNAK_AO    : DEVCMDSTAT_INTONNAK_AO_Field :=
                        Interfaces.NXP.USB.Disabled;
      --  Interrupt on NAK for interrupt and bulk IN EP
      INTONNAK_AI    : DEVCMDSTAT_INTONNAK_AI_Field :=
                        Interfaces.NXP.USB.Disabled;
      --  Interrupt on NAK for control OUT EP
      INTONNAK_CO    : DEVCMDSTAT_INTONNAK_CO_Field :=
                        Interfaces.NXP.USB.Disabled;
      --  Interrupt on NAK for control IN EP
      INTONNAK_CI    : DEVCMDSTAT_INTONNAK_CI_Field :=
                        Interfaces.NXP.USB.Disabled;
   ...
   subtype INFO_FRAME_NR_Field is Interfaces.Bit_Types.UInt11;
   ...
   subtype INFO_MINREV_Field is Interfaces.Bit_Types.Byte;
   subtype INFO_MAJREV_Field is Interfaces.Bit_Types.Byte;
   ...
   type INFO_Register is record
      ...
      --  The error code which last occurred:
      ERR_CODE       : INFO_ERR_CODE_Field := Interfaces.NXP.USB.No_Error;
      --  unspecified
   ...
   subtype EPLISTSTART_EP_LIST_Field is Interfaces.Bit_Types.UInt24;
   ...
   subtype DATABUFSTART_DA_BUF_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype LPM_HIRD_HW_Field is Interfaces.Bit_Types.UInt4;
   subtype LPM_HIRD_SW_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype EPSKIP_SKIP_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype EPINUSE_BUF_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype EPBUFCFG_BUF_SB_Field is Interfaces.Bit_Types.Byte;
   ...
   type INTSTAT_Register is record
      ...
      EP4IN          : Boolean := False;
      --  unspecified
      Reserved_10_29 : Interfaces.Bit_Types.UInt20 := 16#0#;
   ...
   subtype INTEN_EP_INT_EN_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype INTSETSTAT_EP_SET_INT_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype EPTOGGLE_TOGGLE_Field is Interfaces.Bit_Types.UInt10;
