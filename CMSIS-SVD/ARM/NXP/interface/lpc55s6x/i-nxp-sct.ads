...
package Interfaces.NXP.SCT is
   ...
   subtype CONFIG_INSYNC_Field is Interfaces.Bit_Types.UInt4;

   --  SCT configuration register
   type CONFIG_Register is record
      --  SCT operation
      UNIFY          : CONFIG_UNIFY_Field := Interfaces.NXP.SCT.Dual_Counter;
      --  SCT clock mode
      CLKMODE        : CONFIG_CLKMODE_Field :=
                        Interfaces.NXP.SCT.System_Clock_Mode;
      --  SCT clock select. The specific functionality of the designated
      --  input/edge is dependent on the CLKMODE bit selection in this
      --  register.
      CKSEL          : CONFIG_CKSEL_Field :=
                        Interfaces.NXP.SCT.Input_0_Rising_Edges;
   ...
   type CTRL_Register is record
      ...
      --  L or unified counter direction select
      BIDIR_L        : CTRL_BIDIR_L_Field := Interfaces.NXP.SCT.Up;
      ...
      --  Direction select
      BIDIR_H        : CTRL_BIDIR_H_Field := Interfaces.NXP.SCT.Up;
      --  Specifies the factor by which the SCT clock is prescaled to produce
   ...
   type RES_Register is record
      --  Effect of simultaneous set and clear on output 0.
      O0RES  : RES_O0RES_Field := Interfaces.NXP.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 1.
      O1RES  : RES_O1RES_Field := Interfaces.NXP.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 2.
      O2RES  : RES_O2RES_Field := Interfaces.NXP.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 3.
      O3RES  : RES_O3RES_Field := Interfaces.NXP.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 4.
      O4RES  : RES_O4RES_Field := Interfaces.NXP.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 5.
      O5RES  : RES_O5RES_Field := Interfaces.NXP.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 6.
      O6RES  : RES_O6RES_Field := Interfaces.NXP.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 7.
      O7RES  : RES_O7RES_Field := Interfaces.NXP.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 8.
      O8RES  : RES_O8RES_Field := Interfaces.NXP.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 9.
      O9RES  : RES_O9RES_Field := Interfaces.NXP.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 10.
      O10RES : RES_O10RES_Field := Interfaces.NXP.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 11.
      O11RES : RES_O11RES_Field := Interfaces.NXP.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 12.
      O12RES : RES_O12RES_Field := Interfaces.NXP.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 13.
      O13RES : RES_O13RES_Field := Interfaces.NXP.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 14.
      O14RES : RES_O14RES_Field := Interfaces.NXP.SCT.No_Change;
      --  Effect of simultaneous set and clear on output 15.
      O15RES : RES_O15RES_Field := Interfaces.NXP.SCT.No_Change;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype DMAREQ0_DEV_0_Field is Interfaces.Bit_Types.Short;
   ...
   subtype DMAREQ1_DEV_1_Field is Interfaces.Bit_Types.Short;
   ...
   subtype EVEN_IEN_Field is Interfaces.Bit_Types.Short;
   ...
   subtype EVFLAG_FLAG_Field is Interfaces.Bit_Types.Short;
   ...
   subtype CONEN_NCEN_Field is Interfaces.Bit_Types.Short;
   ...
   subtype CONFLAG_NCFLAG_Field is Interfaces.Bit_Types.Short;
   ...
   subtype CAP_CAPn_L_Field is Interfaces.Bit_Types.Short;
   subtype CAP_CAPn_H_Field is Interfaces.Bit_Types.Short;
   ...
   subtype MATCH_MATCHn_L_Field is Interfaces.Bit_Types.Short;
   subtype MATCH_MATCHn_H_Field is Interfaces.Bit_Types.Short;
   ...
   subtype CAPCTRL_CAPCONn_L_Field is Interfaces.Bit_Types.Short;
   subtype CAPCTRL_CAPCONn_H_Field is Interfaces.Bit_Types.Short;
   ...
   subtype MATCHREL_RELOADn_L_Field is Interfaces.Bit_Types.Short;
   subtype MATCHREL_RELOADn_H_Field is Interfaces.Bit_Types.Short;
   ...
   subtype EV_STATE_EV_STATEMSKn_Field is Interfaces.Bit_Types.Short;
   ...
   subtype EV_CTRL_EV_MATCHSEL_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype EV_CTRL_EV_IOSEL_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype EV_CTRL_EV_STATEV_Field is Interfaces.Bit_Types.UInt5;
   ...
   type EV_CTRL_EV_Register is record
      ...
      --  Select L/H counter. Do not set this bit if UNIFY = 1.
      HEVENT         : EV_CTRL_HEVENT_Field := Interfaces.NXP.SCT.L_Counter;
      --  Input/output select
      OUTSEL         : EV_CTRL_OUTSEL_Field := Interfaces.NXP.SCT.Input;
      ...
      IOCOND         : EV_CTRL_IOCOND_Field := Interfaces.NXP.SCT.Low;
      --  Selects how the specified match and I/O condition are used and
      --  combined.
      COMBMODE       : EV_CTRL_COMBMODE_Field := Interfaces.NXP.SCT.Or_k;
      --  This bit controls how the STATEV value modifies the state selected by
      --  HEVENT when this event is the highest-numbered event occurring for
      --  that state.
      STATELD        : EV_CTRL_STATELD_Field := Interfaces.NXP.SCT.Add;
      ...
      DIRECTION      : EV_CTRL_DIRECTION_Field :=
                        Interfaces.NXP.SCT.Direction_Independent;
      --  unspecified
   ...
   subtype OUT_SET_OUT_SET_Field is Interfaces.Bit_Types.Short;
   ...
   subtype OUT_CLR_OUT_CLR_Field is Interfaces.Bit_Types.Short;
