...
package Interfaces.NXP.FLASH_CMPA is
   pragma Preelaborate;
   ...
   subtype BOOT_CFG_BOOT_FAILURE_PIN_Field is Interfaces.Bit_Types.Byte;
   ...
   type BOOT_CFG_Register is record
      ...
      DEFAULT_ISP_MODE : BOOT_CFG_DEFAULT_ISP_MODE_Field :=
                          Interfaces.NXP.FLASH_CMPA.Value_0;
      --  Core clock:
   ...
   subtype SPI_FLASH_CFG_SPI_RECOVERY_BOOT_EN_Field is
   ...
   subtype USB_ID_USB_VENDOR_ID_Field is Interfaces.Bit_Types.Short;
   subtype USB_ID_USB_PRODUCT_ID_Field is Interfaces.Bit_Types.Short;
   ...
   subtype CC_SOCU_PIN_INVERSE_VALUE_Field is Interfaces.Bit_Types.Short;

   --  .
   type CC_SOCU_PIN_Register is record
      --  Non Secure non-invasive debug enable
      NIDEN          : CC_SOCU_PIN_NIDEN_Field :=
                        Interfaces.NXP.FLASH_CMPA.Value_0;
      --  Non Secure debug enable
      DBGEN          : CC_SOCU_PIN_DBGEN_Field :=
                        Interfaces.NXP.FLASH_CMPA.Value_0;
      --  Secure non-invasive debug enable
      SPNIDEN        : CC_SOCU_PIN_SPNIDEN_Field :=
                        Interfaces.NXP.FLASH_CMPA.Value_0;
      --  Secure invasive debug enable
      SPIDEN         : CC_SOCU_PIN_SPIDEN_Field :=
                        Interfaces.NXP.FLASH_CMPA.Value_0;
      --  JTAG TAP enable
      TAPEN          : CC_SOCU_PIN_TAPEN_Field :=
                        Interfaces.NXP.FLASH_CMPA.Value_0;
      --  CPU1 (Micro cortex M33) invasive debug enable
   ...
   subtype CC_SOCU_DFLT_INVERSE_VALUE_Field is Interfaces.Bit_Types.Short;

   --  .
   type CC_SOCU_DFLT_Register is record
      --  Non Secure non-invasive debug fixed state
      NIDEN          : CC_SOCU_DFLT_NIDEN_Field :=
                        Interfaces.NXP.FLASH_CMPA.Disable;
      --  Non Secure debug fixed state
      DBGEN          : CC_SOCU_DFLT_DBGEN_Field :=
                        Interfaces.NXP.FLASH_CMPA.Disable;
      --  Secure non-invasive debug fixed state
      ...
      SPIDEN         : CC_SOCU_DFLT_SPIDEN_Field :=
                        Interfaces.NXP.FLASH_CMPA.Disable;
      --  JTAG TAP fixed state
      TAPEN          : CC_SOCU_DFLT_TAPEN_Field :=
                        Interfaces.NXP.FLASH_CMPA.Disable;
      --  CPU1 (Micro cortex M33) invasive debug fixed state
   ...
   subtype VENDOR_USAGE_VENDOR_USAGE_Field is Interfaces.Bit_Types.Short;
   ...
   subtype SECURE_BOOT_CFG_RSA4K_Field is Interfaces.Bit_Types.UInt2;
   subtype SECURE_BOOT_CFG_DICE_ENC_NXP_CFG_Field is
     Interfaces.Bit_Types.UInt2;
   subtype SECURE_BOOT_CFG_DICE_CUST_CFG_Field is Interfaces.Bit_Types.UInt2;
   subtype SECURE_BOOT_CFG_SKIP_DICE_Field is Interfaces.Bit_Types.UInt2;
   subtype SECURE_BOOT_CFG_TZM_IMAGE_TYPE_Field is Interfaces.Bit_Types.UInt2;
   subtype SECURE_BOOT_CFG_BLOCK_SET_KEY_Field is Interfaces.Bit_Types.UInt2;
   subtype SECURE_BOOT_CFG_BLOCK_ENROLL_Field is Interfaces.Bit_Types.UInt2;
   subtype SECURE_BOOT_CFG_DICE_INC_SEC_EPOCH_Field is
     Interfaces.Bit_Types.UInt2;
   subtype SECURE_BOOT_CFG_SEC_BOOT_EN_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype PRINCE_BASE_ADDR_ADDR0_PRG_Field is Interfaces.Bit_Types.UInt4;
   subtype PRINCE_BASE_ADDR_ADDR1_PRG_Field is Interfaces.Bit_Types.UInt4;
   subtype PRINCE_BASE_ADDR_ADDR2_PRG_Field is Interfaces.Bit_Types.UInt4;
   --  PRINCE_BASE_ADDR_LOCK_REG array element
   subtype PRINCE_BASE_ADDR_LOCK_REG_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype PRINCE_BASE_ADDR_REG0_ERASE_CHECK_EN_Field is
     Interfaces.Bit_Types.UInt2;
   subtype PRINCE_BASE_ADDR_REG1_ERASE_CHECK_EN_Field is
     Interfaces.Bit_Types.UInt2;
   subtype PRINCE_BASE_ADDR_REG2_ERASE_CHECK_EN_Field is
     Interfaces.Bit_Types.UInt2;
   ...
   type ROTKH_Registers is array (0 .. 7) of Interfaces.Bit_Types.Word
     with Volatile;
   ...
   type FLASH_CMPA_Peripheral is record
      ...
      --  .
      SDIO_CFG                 : aliased Interfaces.Bit_Types.Word;
      --  .
      ...
      PRINCE_SR_0              : aliased Interfaces.Bit_Types.Word;
      --  Region 1, sub-region enable
      PRINCE_SR_1              : aliased Interfaces.Bit_Types.Word;
      --  Region 2, sub-region enable
      PRINCE_SR_2              : aliased Interfaces.Bit_Types.Word;
      --  Xtal 32kHz capabank triming.
