...
package Interfaces.NXP.SPI is
   ...
   type CFG_Register is record
      --  SPI enable.
      ENABLE         : CFG_ENABLE_Field := Interfaces.NXP.SPI.Disabled;
      --  unspecified
      Reserved_1_1   : Interfaces.Bit_Types.Bit := 16#0#;
      --  Master mode select.
      MASTER         : CFG_MASTER_Field := Interfaces.NXP.SPI.Slave_Mode;
      --  LSB First mode enable.
      LSBF           : CFG_LSBF_Field := Interfaces.NXP.SPI.Standard;
      --  Clock Phase select.
      CPHA           : CFG_CPHA_Field := Interfaces.NXP.SPI.Change;
      --  Clock Polarity select.
      CPOL           : CFG_CPOL_Field := Interfaces.NXP.SPI.Low;
      --  unspecified
      Reserved_6_6   : Interfaces.Bit_Types.Bit := 16#0#;
      --  Loopback mode enable. Loopback mode applies only to Master mode, and
      --  connects transmit and receive data connected together to allow simple
      --  software testing.
      LOOP_k         : CFG_LOOP_Field := Interfaces.NXP.SPI.Disabled;
      --  SSEL0 Polarity select.
      SPOL0          : CFG_SPOL0_Field := Interfaces.NXP.SPI.Low;
      --  SSEL1 Polarity select.
      SPOL1          : CFG_SPOL1_Field := Interfaces.NXP.SPI.Low;
      --  SSEL2 Polarity select.
      SPOL2          : CFG_SPOL2_Field := Interfaces.NXP.SPI.Low;
      --  SSEL3 Polarity select.
      SPOL3          : CFG_SPOL3_Field := Interfaces.NXP.SPI.Low;
      --  unspecified
   ...
   subtype DLY_PRE_DELAY_Field is Interfaces.Bit_Types.UInt4;
   subtype DLY_POST_DELAY_Field is Interfaces.Bit_Types.UInt4;
   subtype DLY_FRAME_DELAY_Field is Interfaces.Bit_Types.UInt4;
   subtype DLY_TRANSFER_DELAY_Field is Interfaces.Bit_Types.UInt4;
   ...
   type INTENSET_Register is record
      ...
      --  Slave select assert interrupt enable. Determines whether an interrupt
      --  occurs when the Slave Select is asserted.
      SSAEN         : INTENSET_SSAEN_Field := Interfaces.NXP.SPI.Disabled;
      --  Slave select deassert interrupt enable. Determines whether an
      --  interrupt occurs when the Slave Select is deasserted.
      SSDEN         : INTENSET_SSDEN_Field := Interfaces.NXP.SPI.Disabled;
      --  unspecified
      Reserved_6_7  : Interfaces.Bit_Types.UInt2 := 16#0#;
      --  Master idle interrupt enable.
      MSTIDLEEN     : INTENSET_MSTIDLEEN_Field := Interfaces.NXP.SPI.Disabled;
      --  unspecified
      Reserved_9_31 : Interfaces.Bit_Types.UInt23 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype DIV_DIVVAL_Field is Interfaces.Bit_Types.Short;
   ...
   subtype FIFOCFG_SIZE_Field is Interfaces.Bit_Types.UInt2;
   ...
   type FIFOCFG_Register is record
      --  Enable the transmit FIFO.
      ENABLETX       : FIFOCFG_ENABLETX_Field := Interfaces.NXP.SPI.Disabled;
      --  Enable the receive FIFO.
      ENABLERX       : FIFOCFG_ENABLERX_Field := Interfaces.NXP.SPI.Disabled;
      --  unspecified
      ...
      --  DMA configuration for transmit.
      DMATX          : FIFOCFG_DMATX_Field := Interfaces.NXP.SPI.Disabled;
      --  DMA configuration for receive.
      DMARX          : FIFOCFG_DMARX_Field := Interfaces.NXP.SPI.Disabled;
      ...
      WAKETX         : FIFOCFG_WAKETX_Field := Interfaces.NXP.SPI.Disabled;
      ...
      --  The CPU will remain stopped until woken by another cause, such as DMA
      --  completion. See Hardware Wake-up control register.
      WAKERX         : FIFOCFG_WAKERX_Field := Interfaces.NXP.SPI.Disabled;
   ...
   subtype FIFOSTAT_TXLVL_Field is Interfaces.Bit_Types.UInt5;
   subtype FIFOSTAT_RXLVL_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype FIFOTRIG_TXLVL_Field is Interfaces.Bit_Types.UInt4;
   subtype FIFOTRIG_RXLVL_Field is Interfaces.Bit_Types.UInt4;
   ...
   type FIFOTRIG_Register is record
      ...
      --  interrupt if enabled in FIFOINTENSET, or a DMA trigger if DMATX in
      --  FIFOCFG is set.
      TXLVLENA       : FIFOTRIG_TXLVLENA_Field := Interfaces.NXP.SPI.Disabled;
      ...
      --  FIFOCFG is set.
      RXLVLENA       : FIFOTRIG_RXLVLENA_Field := Interfaces.NXP.SPI.Disabled;
      --  unspecified
   ...
   type FIFOINTENSET_Register is record
      --  Determines whether an interrupt occurs when a transmit error occurs,
      --  based on the TXERR flag in the FIFOSTAT register.
      TXERR         : FIFOINTENSET_TXERR_Field := Interfaces.NXP.SPI.Disabled;
      --  Determines whether an interrupt occurs when a receive error occurs,
      --  based on the RXERR flag in the FIFOSTAT register.
      RXERR         : FIFOINTENSET_RXERR_Field := Interfaces.NXP.SPI.Disabled;
      ...
      --  register.
      TXLVL         : FIFOINTENSET_TXLVL_Field := Interfaces.NXP.SPI.Disabled;
      --  Determines whether an interrupt occurs when a the receive FIFO
      --  reaches the level specified by the TXLVL field in the FIFOTRIG
      --  register.
      RXLVL         : FIFOINTENSET_RXLVL_Field := Interfaces.NXP.SPI.Disabled;
      --  unspecified
   ...
   subtype FIFOWR_TXDATA_Field is Interfaces.Bit_Types.Short;
   ...
   subtype FIFOWR_LEN_Field is Interfaces.Bit_Types.UInt4;
   ...
   type FIFOWR_Register is record
      ...
      TXSSEL0_N      : FIFOWR_TXSSEL0_N_Field := Interfaces.NXP.SPI.Asserted;
      --  Write-only. Transmit slave select. This field asserts SSEL1 in master
      --  mode. The output on the pin is active LOW by default.
      TXSSEL1_N      : FIFOWR_TXSSEL1_N_Field := Interfaces.NXP.SPI.Asserted;
      --  Write-only. Transmit slave select. This field asserts SSEL2 in master
      --  mode. The output on the pin is active LOW by default.
      TXSSEL2_N      : FIFOWR_TXSSEL2_N_Field := Interfaces.NXP.SPI.Asserted;
      --  Write-only. Transmit slave select. This field asserts SSEL3 in master
      --  mode. The output on the pin is active LOW by default.
      TXSSEL3_N      : FIFOWR_TXSSEL3_N_Field := Interfaces.NXP.SPI.Asserted;
      ...
      EOT            : FIFOWR_EOT_Field := Interfaces.NXP.SPI.Not_Deasserted;
      ...
      EOF            : FIFOWR_EOF_Field := Interfaces.NXP.SPI.Not_Eof;
      ...
      --  the DMA.
      RXIGNORE       : FIFOWR_RXIGNORE_Field := Interfaces.NXP.SPI.Read;
      --  unspecified
   ...
   subtype FIFORD_RXDATA_Field is Interfaces.Bit_Types.Short;
   ...
   subtype FIFORDNOPOP_RXDATA_Field is Interfaces.Bit_Types.Short;
