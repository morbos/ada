...
package Interfaces.NXP.DBGMAILBOX is
   pragma Preelaborate;
   ...
   type DBGMAILBOX_Peripheral is record
      ...
      --  CRC seed register
      REQUEST  : aliased Interfaces.Bit_Types.Word;
      --  Return value from ROM.
      RETURN_k : aliased Interfaces.Bit_Types.Word;
      --  Identification register
      ID       : aliased Interfaces.Bit_Types.Word;
   end record
     with Volatile;
