...
package Interfaces.NXP.RNG is
   ...
   subtype COUNTER_VAL_CLK_RATIO_Field is Interfaces.Bit_Types.Byte;
   subtype COUNTER_VAL_REFRESH_CNT_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype COUNTER_CFG_MODE_Field is Interfaces.Bit_Types.UInt2;
   subtype COUNTER_CFG_CLOCK_SEL_Field is Interfaces.Bit_Types.UInt3;
   subtype COUNTER_CFG_SHIFT4X_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype ONLINE_TEST_CFG_DATA_SEL_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype ONLINE_TEST_VAL_LIVE_CHI_SQUARED_Field is
     Interfaces.Bit_Types.UInt4;
   subtype ONLINE_TEST_VAL_MIN_CHI_SQUARED_Field is Interfaces.Bit_Types.UInt4;
   subtype ONLINE_TEST_VAL_MAX_CHI_SQUARED_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype MODULEID_APERTURE_Field is Interfaces.Bit_Types.Byte;
   subtype MODULEID_MIN_REV_Field is Interfaces.Bit_Types.UInt4;
   subtype MODULEID_MAJ_REV_Field is Interfaces.Bit_Types.UInt4;
   subtype MODULEID_ID_Field is Interfaces.Bit_Types.Short;
   ...
   type RNG_Peripheral is record
      ...
      RANDOM_NUMBER   : aliased Interfaces.Bit_Types.Word;
      --  no description available
