...
package Interfaces.NXP.CASPER is
   pragma Preelaborate;
   ...
   subtype CTRL0_CDOFF_Field is Interfaces.Bit_Types.UInt11;
   ...
   type CTRL0_Register is record
      ...
      --  2-up
      ABBPAIR        : CTRL0_ABBPAIR_Field := Interfaces.NXP.CASPER.Pair0;
      --  unspecified
      ...
      --  2-up
      CDBPAIR        : CTRL0_CDBPAIR_Field := Interfaces.NXP.CASPER.Pair0;
      --  unspecified
   ...
   subtype CTRL1_ITER_Field is Interfaces.Bit_Types.Byte;
   subtype CTRL1_MODE_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype CTRL1_RESOFF_Field is Interfaces.Bit_Types.UInt11;
   ...
   type CTRL1_Register is record
      ...
      --  supported)
      RESBPAIR       : CTRL1_RESBPAIR_Field := Interfaces.NXP.CASPER.Pair0;
      --  unspecified
      Reserved_17_17 : Interfaces.Bit_Types.Bit := 16#0#;
      ...
      CSKIP          : CTRL1_CSKIP_Field := Interfaces.NXP.CASPER.No_Skip;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype LOADER_COUNT_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype LOADER_CTRLOFF_Field is Interfaces.Bit_Types.UInt11;
   ...
   type LOADER_Register is record
      ...
      --  2-up. Does not matter which bank is used as this is loaded when not
      --  performing an operation.
      CTRLBPAIR      : LOADER_CTRLBPAIR_Field := Interfaces.NXP.CASPER.Pair0;
      --  unspecified
      Reserved_17_17 : Interfaces.Bit_Types.Bit := 16#0#;
   ...
   type INTENSET_Register is record
      --  Set if the accelerator should interrupt when done.
      DONE          : INTENSET_DONE_Field :=
                       Interfaces.NXP.CASPER.No_Interrupt;
      --  unspecified
   ...
   type INTENCLR_Register is record
      ...
      DONE          : INTENCLR_DONE_Field := Interfaces.NXP.CASPER.Ignored;
      --  unspecified
      Reserved_1_31 : Interfaces.Bit_Types.UInt31 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type LOCK_Register is record
      ...
      --  unlock, 1 to lock.
      LOCK           : LOCK_LOCK_Field := Interfaces.NXP.CASPER.Unlock;
      --  unspecified
      Reserved_1_3   : Interfaces.Bit_Types.UInt3 := 16#0#;
      --  Must be written as 0x73D to change the register.
   ...
   type CASPER_Peripheral is record
      ...
      --  A register
      AREG     : aliased Interfaces.Bit_Types.Word;
      --  B register
      BREG     : aliased Interfaces.Bit_Types.Word;
      --  C register
      CREG     : aliased Interfaces.Bit_Types.Word;
      --  D register
      DREG     : aliased Interfaces.Bit_Types.Word;
      --  Result register 0
      RES0     : aliased Interfaces.Bit_Types.Word;
      --  Result register 1
      RES1     : aliased Interfaces.Bit_Types.Word;
      --  Result register 2
      RES2     : aliased Interfaces.Bit_Types.Word;
      --  Result register 3
      RES3     : aliased Interfaces.Bit_Types.Word;
      --  Optional mask register
      MASK     : aliased Interfaces.Bit_Types.Word;
      --  Optional re-mask register
      REMASK   : aliased Interfaces.Bit_Types.Word;
      --  Security lock register
