...
package Interfaces.NXP.I2S is
   ...
   subtype CFG1_DATALEN_Field is Interfaces.Bit_Types.UInt5;

   --  Configuration register 1 for the primary channel pair.
   type CFG1_Register is record
      --  Main enable for I 2S function in this Flexcomm
      MAINENABLE     : CFG1_MAINENABLE_Field := Interfaces.NXP.I2S.Disabled;
      --  Data flow Pause. Allows pausing data flow between the I2S
      --  serializer/deserializer and the FIFO. This could be done in order to
      ...
      DATAPAUSE      : CFG1_DATAPAUSE_Field := Interfaces.NXP.I2S.Normal;
      --  Provides the number of I2S channel pairs in this Flexcomm This is a
      --  read-only field whose value may be different in other Flexcomms. 00 =
      --  there is 1 I2S channel pair in this Flexcomm. 01 = there are 2 I2S
      --  channel pairs in this Flexcomm. 10 = there are 3 I2S channel pairs in
      --  this Flexcomm. 11 = there are 4 I2S channel pairs in this Flexcomm.
      PAIRCOUNT      : CFG1_PAIRCOUNT_Field := Interfaces.NXP.I2S.Pairs_1;
      --  Master / slave configuration selection, determining how SCK and WS
      --  are used by all channel pairs in this Flexcomm.
      MSTSLVCFG      : CFG1_MSTSLVCFG_Field :=
                        Interfaces.NXP.I2S.Normal_Slave_Mode;
      ...
      --  examples.
      MODE           : CFG1_MODE_Field := Interfaces.NXP.I2S.Classic_Mode;
      ...
      RIGHTLOW       : CFG1_RIGHTLOW_Field := Interfaces.NXP.I2S.Right_High;
      --  Left Justify data.
      LEFTJUST       : CFG1_LEFTJUST_Field :=
                        Interfaces.NXP.I2S.Right_Justified;
      --  Single channel mode. Applies to both transmit and receive. This
      --  configuration bit applies only to the first I2S channel pair. Other
      --  channel pairs may select this mode independently in their separate
      --  CFG1 registers.
      ONECHANNEL     : CFG1_ONECHANNEL_Field :=
                        Interfaces.NXP.I2S.Dual_Channel;
      --  unspecified
      Reserved_11_11 : Interfaces.Bit_Types.Bit := 16#0#;
      --  SCK polarity.
      SCK_POL        : CFG1_SCK_POL_Field := Interfaces.NXP.I2S.Falling_Edge;
      --  WS polarity.
      WS_POL         : CFG1_WS_POL_Field := Interfaces.NXP.I2S.Not_Inverted;
      --  unspecified
   ...
   subtype CFG2_FRAMELEN_Field is Interfaces.Bit_Types.UInt9;
   subtype CFG2_POSITION_Field is Interfaces.Bit_Types.UInt9;
   ...
   type STAT_Register is record
      ...
      BUSY          : STAT_BUSY_Field := Interfaces.NXP.I2S.Idle;
      ...
      SLVFRMERR     : STAT_SLVFRMERR_Field := Interfaces.NXP.I2S.No_Error;
      ...
      LR            : STAT_LR_Field := Interfaces.NXP.I2S.Left_Channel;
      --  Read-only. Data Paused status flag. Applies to all I2S channels
      DATAPAUSED    : STAT_DATAPAUSED_Field := Interfaces.NXP.I2S.Not_Paused;
      --  unspecified
   ...
   subtype DIV_DIV_Field is Interfaces.Bit_Types.UInt12;
   ...
   type FIFOCFG_Register is record
      --  Enable the transmit FIFO.
      ENABLETX       : FIFOCFG_ENABLETX_Field := Interfaces.NXP.I2S.Disabled;
      --  Enable the receive FIFO.
      ENABLERX       : FIFOCFG_ENABLERX_Field := Interfaces.NXP.I2S.Disabled;
      ...
      TXI2SE0        : FIFOCFG_TXI2SE0_Field := Interfaces.NXP.I2S.Last_Value;
      --  Packing format for 48-bit data. This relates to how data is entered
      --  into or taken from the FIFO by software or DMA.
      PACK48         : FIFOCFG_PACK48_Field := Interfaces.NXP.I2S.Bit_24;
      ...
      --  DMA configuration for transmit.
      DMATX          : FIFOCFG_DMATX_Field := Interfaces.NXP.I2S.Disabled;
      --  DMA configuration for receive.
      DMARX          : FIFOCFG_DMARX_Field := Interfaces.NXP.I2S.Disabled;
      ...
      WAKETX         : FIFOCFG_WAKETX_Field := Interfaces.NXP.I2S.Disabled;
      ...
      --  The CPU will remain stopped until woken by another cause, such as DMA
      --  completion. See Hardware Wake-up control register.
      WAKERX         : FIFOCFG_WAKERX_Field := Interfaces.NXP.I2S.Disabled;
   ...
   type FIFOTRIG_Register is record
      ...
      --  interrupt if enabled in FIFOINTENSET, or a DMA trigger if DMATX in
      --  FIFOCFG is set.
      TXLVLENA       : FIFOTRIG_TXLVLENA_Field := Interfaces.NXP.I2S.Disabled;
      ...
      --  FIFOCFG is set.
      RXLVLENA       : FIFOTRIG_RXLVLENA_Field := Interfaces.NXP.I2S.Disabled;
      --  unspecified
   ...
   type FIFOINTENSET_Register is record
      --  Determines whether an interrupt occurs when a transmit error occurs,
      --  based on the TXERR flag in the FIFOSTAT register.
      TXERR         : FIFOINTENSET_TXERR_Field := Interfaces.NXP.I2S.Disabled;
      --  Determines whether an interrupt occurs when a receive error occurs,
      --  based on the RXERR flag in the FIFOSTAT register.
      RXERR         : FIFOINTENSET_RXERR_Field := Interfaces.NXP.I2S.Disabled;
      ...
      --  register.
      TXLVL         : FIFOINTENSET_TXLVL_Field := Interfaces.NXP.I2S.Disabled;
      --  Determines whether an interrupt occurs when a the receive FIFO
      --  reaches the level specified by the TXLVL field in the FIFOTRIG
      --  register.
      RXLVL         : FIFOINTENSET_RXLVL_Field := Interfaces.NXP.I2S.Disabled;
      --  unspecified
      Reserved_4_31 : Interfaces.Bit_Types.UInt28 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype FIFOWR48H_TXDATA_Field is Interfaces.Bit_Types.UInt24;
   ...
   subtype FIFORD48H_RXDATA_Field is Interfaces.Bit_Types.UInt24;
   ...
   subtype FIFORD48HNOPOP_RXDATA_Field is Interfaces.Bit_Types.UInt24;
   ...
   type I2S_Peripheral is record
      ...
      --  FIFO write data.
      FIFOWR         : aliased Interfaces.Bit_Types.Word;
      --  FIFO write data for upper data bits. May only be used if the I2S is
      --  configured for 2x 24-bit data and not using DMA.
      FIFOWR48H      : aliased FIFOWR48H_Register;
      --  FIFO read data.
      FIFORD         : aliased Interfaces.Bit_Types.Word;
      --  FIFO read data for upper data bits. May only be used if the I2S is
      --  configured for 2x 24-bit data and not using DMA.
      FIFORD48H      : aliased FIFORD48H_Register;
      --  FIFO data read with no FIFO pop.
      FIFORDNOPOP    : aliased Interfaces.Bit_Types.Word;
