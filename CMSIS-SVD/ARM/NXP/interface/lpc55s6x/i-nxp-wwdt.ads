...
package Interfaces.NXP.WWDT is
   pragma Preelaborate;
   ...
   type MOD_Register is record
      ...
      WDEN          : MOD_WDEN_Field := Interfaces.NXP.WWDT.Stop;
      --  Watchdog reset enable bit. Once this bit has been written with a 1 it
      --  cannot be re-written with a 0.
      WDRESET       : MOD_WDRESET_Field := Interfaces.NXP.WWDT.Interrupt;
      ...
      WDPROTECT     : MOD_WDPROTECT_Field := Interfaces.NXP.WWDT.Flexible;
      --  unspecified
   ...
   subtype TC_COUNT_Field is Interfaces.Bit_Types.UInt24;
   ...
   subtype WARNINT_WARNINT_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype WINDOW_WINDOW_Field is Interfaces.Bit_Types.UInt24;
