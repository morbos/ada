...
package Interfaces.NXP.USBPHY is
   pragma Preelaborate;
   ...
   type PWD_Register is record
      ...
      --  Note that this bit will be auto cleared if there is USB wakeup event
      --  while ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      TXPWDFS        : PWD_TXPWDFS_Field := Interfaces.NXP.USBPHY.VALUE1;
      --  Note that this bit will be auto cleared if there is USB wakeup event
      --  while ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      TXPWDIBIAS     : PWD_TXPWDIBIAS_Field := Interfaces.NXP.USBPHY.VALUE1;
      --  Note that this bit will be auto cleared if there is USB wakeup event
      --  while ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      TXPWDV2I       : PWD_TXPWDV2I_Field := Interfaces.NXP.USBPHY.VALUE1;
      --  unspecified
      Reserved_13_16 : Interfaces.Bit_Types.UInt4 := 16#0#;
      --  Note that this bit will be auto cleared if there is USB wakeup event
      --  while ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      RXPWDENV       : PWD_RXPWDENV_Field := Interfaces.NXP.USBPHY.VALUE1;
      --  Note that this bit will be auto cleared if there is USB wakeup event
      --  while ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      RXPWD1PT1      : PWD_RXPWD1PT1_Field := Interfaces.NXP.USBPHY.VALUE1;
      --  Note that this bit will be auto cleared if there is USB wakeup event
      --  while ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      RXPWDDIFF      : PWD_RXPWDDIFF_Field := Interfaces.NXP.USBPHY.VALUE1;
      --  This bit will be auto cleared if there is USB wakeup event while
      --  ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      RXPWDRX        : PWD_RXPWDRX_Field := Interfaces.NXP.USBPHY.VALUE1;
      --  unspecified
   ...
   type PWD_SET_Register is record
      ...
      --  Note that this bit will be auto cleared if there is USB wakeup event
      --  while ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      TXPWDFS        : PWD_SET_TXPWDFS_Field := Interfaces.NXP.USBPHY.VALUE1;
      --  Note that this bit will be auto cleared if there is USB wakeup event
      --  while ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      TXPWDIBIAS     : PWD_SET_TXPWDIBIAS_Field :=
                        Interfaces.NXP.USBPHY.VALUE1;
      --  Note that this bit will be auto cleared if there is USB wakeup event
      --  while ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      TXPWDV2I       : PWD_SET_TXPWDV2I_Field := Interfaces.NXP.USBPHY.VALUE1;
      --  unspecified
      Reserved_13_16 : Interfaces.Bit_Types.UInt4 := 16#0#;
      --  Note that this bit will be auto cleared if there is USB wakeup event
      --  while ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      RXPWDENV       : PWD_SET_RXPWDENV_Field := Interfaces.NXP.USBPHY.VALUE1;
      --  Note that this bit will be auto cleared if there is USB wakeup event
      --  while ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      ...
      --  This bit will be auto cleared if there is USB wakeup event while
      --  ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      RXPWDRX        : PWD_SET_RXPWDRX_Field := Interfaces.NXP.USBPHY.VALUE1;
      --  unspecified
      Reserved_21_31 : Interfaces.Bit_Types.UInt11 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type PWD_CLR_Register is record
      ...
      --  Note that this bit will be auto cleared if there is USB wakeup event
      --  while ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      TXPWDFS        : PWD_CLR_TXPWDFS_Field := Interfaces.NXP.USBPHY.VALUE1;
      --  Note that this bit will be auto cleared if there is USB wakeup event
      --  while ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      ...
      --  Note that this bit will be auto cleared if there is USB wakeup event
      --  while ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      TXPWDV2I       : PWD_CLR_TXPWDV2I_Field := Interfaces.NXP.USBPHY.VALUE1;
      --  unspecified
      Reserved_13_16 : Interfaces.Bit_Types.UInt4 := 16#0#;
      --  Note that this bit will be auto cleared if there is USB wakeup event
      --  while ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      RXPWDENV       : PWD_CLR_RXPWDENV_Field := Interfaces.NXP.USBPHY.VALUE1;
      --  Note that this bit will be auto cleared if there is USB wakeup event
      --  while ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      ...
      --  This bit will be auto cleared if there is USB wakeup event while
      --  ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      RXPWDRX        : PWD_CLR_RXPWDRX_Field := Interfaces.NXP.USBPHY.VALUE1;
      --  unspecified
      Reserved_21_31 : Interfaces.Bit_Types.UInt11 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type PWD_TOG_Register is record
      ...
      --  Note that this bit will be auto cleared if there is USB wakeup event
      --  while ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      TXPWDFS        : PWD_TOG_TXPWDFS_Field := Interfaces.NXP.USBPHY.VALUE1;
      --  Note that this bit will be auto cleared if there is USB wakeup event
      --  while ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      ...
      --  Note that this bit will be auto cleared if there is USB wakeup event
      --  while ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      TXPWDV2I       : PWD_TOG_TXPWDV2I_Field := Interfaces.NXP.USBPHY.VALUE1;
      --  unspecified
      Reserved_13_16 : Interfaces.Bit_Types.UInt4 := 16#0#;
      --  Note that this bit will be auto cleared if there is USB wakeup event
      --  while ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      RXPWDENV       : PWD_TOG_RXPWDENV_Field := Interfaces.NXP.USBPHY.VALUE1;
      --  Note that this bit will be auto cleared if there is USB wakeup event
      --  while ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      ...
      --  This bit will be auto cleared if there is USB wakeup event while
      --  ENAUTOCLR_PHY_PWD bit of CTRL is enabled
      RXPWDRX        : PWD_TOG_RXPWDRX_Field := Interfaces.NXP.USBPHY.VALUE1;
      --  unspecified
      Reserved_21_31 : Interfaces.Bit_Types.UInt11 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype TX_TXCAL45DM_Field is Interfaces.Bit_Types.UInt4;
   subtype TX_TXCAL45DP_Field is Interfaces.Bit_Types.UInt4;
   ...
   type TX_Register is record
      ...
      --  unspecified
      Reserved_22_31 : Interfaces.Bit_Types.UInt10 := 16#28#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype TX_SET_TXCAL45DM_Field is Interfaces.Bit_Types.UInt4;
   subtype TX_SET_TXCAL45DP_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype TX_CLR_TXCAL45DM_Field is Interfaces.Bit_Types.UInt4;
   subtype TX_CLR_TXCAL45DP_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype TX_TOG_TXCAL45DM_Field is Interfaces.Bit_Types.UInt4;
   subtype TX_TOG_TXCAL45DP_Field is Interfaces.Bit_Types.UInt4;
   ...
   type RX_Register is record
      --  The ENVADJ field adjusts the trip point for the envelope detector
      ENVADJ         : RX_ENVADJ_Field := Interfaces.NXP.USBPHY.VALUE0;
      --  unspecified
      Reserved_3_3   : Interfaces.Bit_Types.Bit := 16#0#;
      --  The DISCONADJ field adjusts the trip point for the disconnect
      --  detector.
      DISCONADJ      : RX_DISCONADJ_Field := Interfaces.NXP.USBPHY.VALUE0;
      --  unspecified
      Reserved_7_21  : Interfaces.Bit_Types.UInt15 := 16#0#;
      --  This test mode is intended for lab use only, replace FS differential
      --  receiver with DP single ended receiver
      RXDBYPASS      : RX_RXDBYPASS_Field := Interfaces.NXP.USBPHY.VALUE0;
      --  unspecified
   ...
   type RX_SET_Register is record
      --  The ENVADJ field adjusts the trip point for the envelope detector
      ENVADJ         : RX_SET_ENVADJ_Field := Interfaces.NXP.USBPHY.VALUE0;
      --  unspecified
      Reserved_3_3   : Interfaces.Bit_Types.Bit := 16#0#;
      --  The DISCONADJ field adjusts the trip point for the disconnect
      --  detector.
      DISCONADJ      : RX_SET_DISCONADJ_Field := Interfaces.NXP.USBPHY.VALUE0;
      --  unspecified
      Reserved_7_21  : Interfaces.Bit_Types.UInt15 := 16#0#;
      --  This test mode is intended for lab use only, replace FS differential
      --  receiver with DP single ended receiver
      RXDBYPASS      : RX_SET_RXDBYPASS_Field := Interfaces.NXP.USBPHY.VALUE0;
      --  unspecified
      Reserved_23_31 : Interfaces.Bit_Types.UInt9 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type RX_CLR_Register is record
      --  The ENVADJ field adjusts the trip point for the envelope detector
      ENVADJ         : RX_CLR_ENVADJ_Field := Interfaces.NXP.USBPHY.VALUE0;
      --  unspecified
      Reserved_3_3   : Interfaces.Bit_Types.Bit := 16#0#;
      --  The DISCONADJ field adjusts the trip point for the disconnect
      --  detector.
      DISCONADJ      : RX_CLR_DISCONADJ_Field := Interfaces.NXP.USBPHY.VALUE0;
      --  unspecified
      Reserved_7_21  : Interfaces.Bit_Types.UInt15 := 16#0#;
      --  This test mode is intended for lab use only, replace FS differential
      --  receiver with DP single ended receiver
      RXDBYPASS      : RX_CLR_RXDBYPASS_Field := Interfaces.NXP.USBPHY.VALUE0;
      --  unspecified
      Reserved_23_31 : Interfaces.Bit_Types.UInt9 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type RX_TOG_Register is record
      --  The ENVADJ field adjusts the trip point for the envelope detector
      ENVADJ         : RX_TOG_ENVADJ_Field := Interfaces.NXP.USBPHY.VALUE0;
      --  unspecified
      Reserved_3_3   : Interfaces.Bit_Types.Bit := 16#0#;
      --  The DISCONADJ field adjusts the trip point for the disconnect
      --  detector.
      DISCONADJ      : RX_TOG_DISCONADJ_Field := Interfaces.NXP.USBPHY.VALUE0;
      --  unspecified
      Reserved_7_21  : Interfaces.Bit_Types.UInt15 := 16#0#;
      --  This test mode is intended for lab use only, replace FS differential
      --  receiver with DP single ended receiver
      RXDBYPASS      : RX_TOG_RXDBYPASS_Field := Interfaces.NXP.USBPHY.VALUE0;
      --  unspecified
      Reserved_23_31 : Interfaces.Bit_Types.UInt9 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type STATUS_Register is record
      ...
      --  unspecified
      Reserved_1_2            : Interfaces.Bit_Types.UInt2;
   ...
   type PLL_SIC_Register is record
      ...
      --  unspecified
      Reserved_14_18  : Interfaces.Bit_Types.UInt5 := 16#4#;
      --  Reference bias power down select.
   ...
   subtype ANACTRL_PFD_CLK_SEL_Field is Interfaces.Bit_Types.UInt2;
   ...
   type ANACTRL_Register is record
      ...
      DEV_PULLDOWN   : ANACTRL_DEV_PULLDOWN_Field :=
                        Interfaces.NXP.USBPHY.VALUE1;
      --  unspecified
      Reserved_11_31 : Interfaces.Bit_Types.UInt21 := 16#14000#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype ANACTRL_SET_PFD_CLK_SEL_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype ANACTRL_CLR_PFD_CLK_SEL_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype ANACTRL_TOG_PFD_CLK_SEL_Field is Interfaces.Bit_Types.UInt2;
