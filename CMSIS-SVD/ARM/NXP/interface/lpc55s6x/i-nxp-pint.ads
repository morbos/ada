...
package Interfaces.NXP.PINT is
   pragma Preelaborate;
   ...
   subtype ISEL_PMODE_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype IENR_ENRL_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype SIENR_SETENRL_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype CIENR_CENRL_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype IENF_ENAF_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype SIENF_SETENAF_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype CIENF_CENAF_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype RISE_RDET_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype FALL_FDET_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype IST_PSTAT_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype PMCTRL_PMAT_Field is Interfaces.Bit_Types.Byte;

   --  Pattern match interrupt control register
   type PMCTRL_Register is record
      --  Specifies whether the 8 pin interrupts are controlled by the pin
      --  interrupt function or by the pattern match function.
      SEL_PMATCH    : PMCTRL_SEL_PMATCH_Field :=
                       Interfaces.NXP.PINT.Pin_Interrupt;
      --  Enables the RXEV output to the CPU and/or to a GPIO output when the
      --  specified boolean expression evaluates to true.
      ENA_RXEV      : PMCTRL_ENA_RXEV_Field := Interfaces.NXP.PINT.Disabled;
      --  unspecified
   ...
   type PMSRC_Register is record
      ...
      --  Selects the input source for bit slice 0
      SRC0         : PMSRC_SRC0_Field := Interfaces.NXP.PINT.Input0;
      --  Selects the input source for bit slice 1
      SRC1         : PMSRC_SRC1_Field := Interfaces.NXP.PINT.Input0;
      --  Selects the input source for bit slice 2
      SRC2         : PMSRC_SRC2_Field := Interfaces.NXP.PINT.Input0;
      --  Selects the input source for bit slice 3
      SRC3         : PMSRC_SRC3_Field := Interfaces.NXP.PINT.Input0;
      --  Selects the input source for bit slice 4
      SRC4         : PMSRC_SRC4_Field := Interfaces.NXP.PINT.Input0;
      --  Selects the input source for bit slice 5
      SRC5         : PMSRC_SRC5_Field := Interfaces.NXP.PINT.Input0;
      --  Selects the input source for bit slice 6
      SRC6         : PMSRC_SRC6_Field := Interfaces.NXP.PINT.Input0;
      --  Selects the input source for bit slice 7
      SRC7         : PMSRC_SRC7_Field := Interfaces.NXP.PINT.Input0;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type PMCFG_Register is record
      --  Determines whether slice 0 is an endpoint.
      PROD_ENDPTS0 : PMCFG_PROD_ENDPTS0_Field :=
                      Interfaces.NXP.PINT.No_Effect;
      --  Determines whether slice 1 is an endpoint.
      PROD_ENDPTS1 : PMCFG_PROD_ENDPTS1_Field :=
                      Interfaces.NXP.PINT.No_Effect;
      --  Determines whether slice 2 is an endpoint.
      PROD_ENDPTS2 : PMCFG_PROD_ENDPTS2_Field :=
                      Interfaces.NXP.PINT.No_Effect;
      --  Determines whether slice 3 is an endpoint.
      PROD_ENDPTS3 : PMCFG_PROD_ENDPTS3_Field :=
                      Interfaces.NXP.PINT.No_Effect;
      --  Determines whether slice 4 is an endpoint.
      PROD_ENDPTS4 : PMCFG_PROD_ENDPTS4_Field :=
                      Interfaces.NXP.PINT.No_Effect;
      --  Determines whether slice 5 is an endpoint.
      PROD_ENDPTS5 : PMCFG_PROD_ENDPTS5_Field :=
                      Interfaces.NXP.PINT.No_Effect;
      --  Determines whether slice 6 is an endpoint.
      PROD_ENDPTS6 : PMCFG_PROD_ENDPTS6_Field :=
                      Interfaces.NXP.PINT.No_Effect;
      --  unspecified
