...
package Interfaces.NXP.MRT is
   ...
   subtype INTVAL_CHANNEL_IVALUE_Field is Interfaces.Bit_Types.UInt24;
   ...
   type INTVAL_CHANNEL_Register is record
      ...
      --  returns 0.
      LOAD           : INTVAL_LOAD_Field := Interfaces.NXP.MRT.No_Force_Load;
   end record
   ...
   subtype TIMER_CHANNEL_VALUE_Field is Interfaces.Bit_Types.UInt24;
   ...
   type CTRL_CHANNEL_Register is record
      --  Enable the TIMERn interrupt.
      INTEN         : CTRL_INTEN_Field := Interfaces.NXP.MRT.Disabled;
      --  Selects timer mode.
      MODE          : CTRL_MODE_Field :=
                       Interfaces.NXP.MRT.Repeat_Interrupt_Mode;
      --  unspecified
   ...
   type STAT_CHANNEL_Register is record
      --  Monitors the interrupt flag.
      INTFLAG       : STAT_INTFLAG_Field :=
                       Interfaces.NXP.MRT.No_Pending_Interrupt;
      --  Indicates the state of TIMERn. This bit is read-only.
      RUN           : STAT_RUN_Field := Interfaces.NXP.MRT.Idle_State;
      --  Channel In Use flag. Operating details depend on the MULTITASK bit in
      --  the MODCFG register, and affects the use of IDLE_CH. See Idle channel
      --  register for details of the two operating modes.
      INUSE         : STAT_INUSE_Field := Interfaces.NXP.MRT.No;
      --  unspecified
      Reserved_3_31 : Interfaces.Bit_Types.UInt29 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype MODCFG_NOC_Field is Interfaces.Bit_Types.UInt4;
   subtype MODCFG_NOB_Field is Interfaces.Bit_Types.UInt5;
   ...
   type MODCFG_Register is record
      ...
      MULTITASK     : MODCFG_MULTITASK_Field :=
                       Interfaces.NXP.MRT.Hardware_Status_Mode;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype IDLE_CH_CHAN_Field is Interfaces.Bit_Types.UInt4;
