...
package Interfaces.NXP.FLEXCOMM is
   pragma Preelaborate;
   ...
   subtype PID_APERTURE_Field is Interfaces.Bit_Types.Byte;
   subtype PID_MINOR_REV_Field is Interfaces.Bit_Types.UInt4;
   subtype PID_MAJOR_REV_Field is Interfaces.Bit_Types.UInt4;
   subtype PID_ID_Field is Interfaces.Bit_Types.Short;
