...
package Interfaces.NXP.USBHSD is
   pragma Preelaborate;
   ...
   subtype DEVCMDSTAT_Speed_Field is Interfaces.Bit_Types.UInt2;
   subtype DEVCMDSTAT_PHY_TEST_MODE_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype INFO_ERR_CODE_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype EPLISTSTART_EP_LIST_PRG_Field is Interfaces.Bit_Types.UInt12;
   subtype EPLISTSTART_EP_LIST_FIXED_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype EPSKIP_SKIP_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype EPINUSE_BUF_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype EPBUFCFG_BUF_SB_Field is Interfaces.Bit_Types.UInt10;
   ...
   type INTSTAT_Register is record
      ...
      EP5IN          : Boolean := False;
      --  unspecified
      Reserved_12_29 : Interfaces.Bit_Types.UInt18 := 16#0#;
      --  Frame interrupt.
   ...
   subtype INTEN_EP_INT_EN_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype INTSETSTAT_EP_SET_INT_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype EPTOGGLE_TOGGLE_Field is Interfaces.Bit_Types.UInt30;
   ...
   type USBHSD_Peripheral is record
      ...
      DATABUFSTART : aliased Interfaces.Bit_Types.Word;
      --  USB Link Power Management register
