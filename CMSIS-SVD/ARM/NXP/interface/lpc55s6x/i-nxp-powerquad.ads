...
package Interfaces.NXP.POWERQUAD is
   pragma Preelaborate;
   ...
   subtype OUTFORMAT_out_formatint_Field is Interfaces.Bit_Types.UInt2;
   subtype OUTFORMAT_out_formatext_Field is Interfaces.Bit_Types.UInt2;
   subtype OUTFORMAT_out_scaler_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype TMPFORMAT_tmp_formatint_Field is Interfaces.Bit_Types.UInt2;
   subtype TMPFORMAT_tmp_formatext_Field is Interfaces.Bit_Types.UInt2;
   subtype TMPFORMAT_tmp_scaler_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype INAFORMAT_ina_formatint_Field is Interfaces.Bit_Types.UInt2;
   subtype INAFORMAT_ina_formatext_Field is Interfaces.Bit_Types.UInt2;
   subtype INAFORMAT_ina_scaler_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype INBFORMAT_inb_formatint_Field is Interfaces.Bit_Types.UInt2;
   subtype INBFORMAT_inb_formatext_Field is Interfaces.Bit_Types.UInt2;
   subtype INBFORMAT_inb_scaler_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype CONTROL_decode_opcode_Field is Interfaces.Bit_Types.UInt4;
   subtype CONTROL_decode_machine_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype CPPRE_cppre_in_Field is Interfaces.Bit_Types.Byte;
   subtype CPPRE_cppre_out_Field is Interfaces.Bit_Types.Byte;
   ...
   --  General purpose register bank N.
   type gpreg_Registers is array (0 .. 15) of Interfaces.Bit_Types.Word
     with Volatile;

   --  Compute register bank

   --  Compute register bank
   type compreg_Registers is array (0 .. 7) of Interfaces.Bit_Types.Word
     with Volatile;
