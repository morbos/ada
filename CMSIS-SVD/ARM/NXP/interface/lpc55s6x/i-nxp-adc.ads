...
package Interfaces.NXP.ADC is
   ...
   subtype VERID_MINOR_Field is Interfaces.Bit_Types.Byte;
   subtype VERID_MAJOR_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype PARAM_TRIG_NUM_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype PARAM_CV_NUM_Field is Interfaces.Bit_Types.Byte;
   subtype PARAM_CMD_NUM_Field is Interfaces.Bit_Types.Byte;
   ...
   type CTRL_Register is record
      --  ADC Enable
      ADCEN          : CTRL_ADCEN_Field := Interfaces.NXP.ADC.Adcen_0;
      --  Software Reset
      RST            : CTRL_RST_Field := Interfaces.NXP.ADC.Rst_0;
      --  Doze Enable
      DOZEN          : CTRL_DOZEN_Field := Interfaces.NXP.ADC.Dozen_0;
      --  Auto-Calibration Request
      CAL_REQ        : CTRL_CAL_REQ_Field := Interfaces.NXP.ADC.Cal_Req_0;
      --  Configure for offset calibration function
      CALOFS         : CTRL_CALOFS_Field := Interfaces.NXP.ADC.Calofs_0;
      --  unspecified
      Reserved_5_7   : Interfaces.Bit_Types.UInt3 := 16#0#;
      --  Reset FIFO 0
      RSTFIFO0       : CTRL_RSTFIFO0_Field := Interfaces.NXP.ADC.Rstfifo0_0;
      --  Reset FIFO 1
      RSTFIFO1       : CTRL_RSTFIFO1_Field := Interfaces.NXP.ADC.Rstfifo1_0;
      --  unspecified
      Reserved_10_15 : Interfaces.Bit_Types.UInt6 := 16#0#;
      --  Auto-Calibration Averages
      CAL_AVGS       : CTRL_CAL_AVGS_Field := Interfaces.NXP.ADC.Cal_Avgs_0;
      --  unspecified
   ...
   type STAT_Register is record
      ...
      RDY0           : STAT_RDY0_Field := Interfaces.NXP.ADC.Rdy0_0;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field. Result FIFO 0 Overflow Flag
      FOF0           : STAT_FOF0_Field := Interfaces.NXP.ADC.Fof0_0;
      --  Read-only. Result FIFO1 Ready Flag
      RDY1           : STAT_RDY1_Field := Interfaces.NXP.ADC.Rdy1_0;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field. Result FIFO1 Overflow Flag
      FOF1           : STAT_FOF1_Field := Interfaces.NXP.ADC.Fof1_0;
      --  unspecified
      Reserved_4_7   : Interfaces.Bit_Types.UInt4 := 16#0#;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field. Interrupt Flag For High Priority Trigger Exception
      TEXC_INT       : STAT_TEXC_INT_Field := Interfaces.NXP.ADC.Texc_Int_0;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field. Interrupt Flag For Trigger Completion
      TCOMP_INT      : STAT_TCOMP_INT_Field := Interfaces.NXP.ADC.Tcomp_Int_0;
      --  Read-only. Calibration Ready
      CAL_RDY        : STAT_CAL_RDY_Field := Interfaces.NXP.ADC.Cal_Rdy_0;
      --  Read-only. ADC Active
      ADC_ACTIVE     : STAT_ADC_ACTIVE_Field :=
                        Interfaces.NXP.ADC.Adc_Active_0;
      --  unspecified
      Reserved_12_15 : Interfaces.Bit_Types.UInt4 := 16#0#;
      --  Read-only. Trigger Active
      TRGACT         : STAT_TRGACT_Field := Interfaces.NXP.ADC.Trgact_0;
      --  unspecified
      Reserved_20_23 : Interfaces.Bit_Types.UInt4 := 16#0#;
      --  Read-only. Command Active
      CMDACT         : STAT_CMDACT_Field := Interfaces.NXP.ADC.Cmdact_0;
      --  unspecified
   ...
   type IE_Register is record
      --  FIFO 0 Watermark Interrupt Enable
      FWMIE0        : IE_FWMIE0_Field := Interfaces.NXP.ADC.Fwmie0_0;
      --  Result FIFO 0 Overflow Interrupt Enable
      FOFIE0        : IE_FOFIE0_Field := Interfaces.NXP.ADC.Fofie0_0;
      --  FIFO1 Watermark Interrupt Enable
      FWMIE1        : IE_FWMIE1_Field := Interfaces.NXP.ADC.Fwmie1_0;
      --  Result FIFO1 Overflow Interrupt Enable
      FOFIE1        : IE_FOFIE1_Field := Interfaces.NXP.ADC.Fofie1_0;
      --  unspecified
      Reserved_4_7  : Interfaces.Bit_Types.UInt4 := 16#0#;
      --  Trigger Exception Interrupt Enable
      TEXC_IE       : IE_TEXC_IE_Field := Interfaces.NXP.ADC.Texc_Ie_0;
      --  unspecified
      Reserved_9_15 : Interfaces.Bit_Types.UInt7 := 16#0#;
      --  Trigger Completion Interrupt Enable
      TCOMP_IE      : IE_TCOMP_IE_Field := Interfaces.NXP.ADC.Tcomp_Ie_0;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type DE_Register is record
      --  FIFO 0 Watermark DMA Enable
      FWMDE0        : DE_FWMDE0_Field := Interfaces.NXP.ADC.Fwmde0_0;
      --  FIFO1 Watermark DMA Enable
      FWMDE1        : DE_FWMDE1_Field := Interfaces.NXP.ADC.Fwmde1_0;
      --  unspecified
   ...
   subtype CFG_PUDLY_Field is Interfaces.Bit_Types.Byte;
   ...
   type CFG_Register is record
      --  ADC trigger priority control
      TPRICTRL       : CFG_TPRICTRL_Field := Interfaces.NXP.ADC.Tprictrl_0;
      --  unspecified
      Reserved_2_3   : Interfaces.Bit_Types.UInt2 := 16#0#;
      --  Power Configuration Select
      PWRSEL         : CFG_PWRSEL_Field := Interfaces.NXP.ADC.Pwrsel_0;
      --  Voltage Reference Selection
      REFSEL         : CFG_REFSEL_Field := Interfaces.NXP.ADC.Refsel_0;
      --  Trigger Resume Enable
      TRES           : CFG_TRES_Field := Interfaces.NXP.ADC.Tres_0;
      --  Trigger Command Resume
      TCMDRES        : CFG_TCMDRES_Field := Interfaces.NXP.ADC.Tcmdres_0;
      --  High Priority Trigger Exception Disable
      HPT_EXDI       : CFG_HPT_EXDI_Field := Interfaces.NXP.ADC.Hpt_Exdi_0;
      --  unspecified
      ...
      --  ADC Analog Pre-Enable
      PWREN          : CFG_PWREN_Field := Interfaces.NXP.ADC.Pwren_0;
      --  unspecified
   ...
   subtype PAUSE_PAUSEDLY_Field is Interfaces.Bit_Types.UInt9;
   ...
   type PAUSE_Register is record
      ...
      --  PAUSE Option Enable
      PAUSEEN       : PAUSE_PAUSEEN_Field := Interfaces.NXP.ADC.Pauseen_0;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type SWTRIG_Register is record
      --  Software trigger 0 event
      SWT0           : SWTRIG_SWT0_Field := Interfaces.NXP.ADC.Swt0_0;
      --  Software trigger 1 event
      SWT1           : SWTRIG_SWT1_Field := Interfaces.NXP.ADC.Swt1_0;
      --  Software trigger 2 event
      SWT2           : SWTRIG_SWT2_Field := Interfaces.NXP.ADC.Swt2_0;
      --  Software trigger 3 event
      SWT3           : SWTRIG_SWT3_Field := Interfaces.NXP.ADC.Swt3_0;
      --  Software trigger 4 event
      SWT4           : SWTRIG_SWT4_Field := Interfaces.NXP.ADC.Swt4_0;
      --  Software trigger 5 event
      SWT5           : SWTRIG_SWT5_Field := Interfaces.NXP.ADC.Swt5_0;
      --  Software trigger 6 event
      SWT6           : SWTRIG_SWT6_Field := Interfaces.NXP.ADC.Swt6_0;
      --  Software trigger 7 event
      SWT7           : SWTRIG_SWT7_Field := Interfaces.NXP.ADC.Swt7_0;
      --  Software trigger 8 event
      SWT8           : SWTRIG_SWT8_Field := Interfaces.NXP.ADC.Swt8_0;
      --  Software trigger 9 event
      SWT9           : SWTRIG_SWT9_Field := Interfaces.NXP.ADC.Swt9_0;
      --  Software trigger 10 event
      SWT10          : SWTRIG_SWT10_Field := Interfaces.NXP.ADC.Swt10_0;
      --  Software trigger 11 event
      SWT11          : SWTRIG_SWT11_Field := Interfaces.NXP.ADC.Swt11_0;
      --  Software trigger 12 event
      SWT12          : SWTRIG_SWT12_Field := Interfaces.NXP.ADC.Swt12_0;
      --  Software trigger 13 event
      SWT13          : SWTRIG_SWT13_Field := Interfaces.NXP.ADC.Swt13_0;
      --  Software trigger 14 event
      SWT14          : SWTRIG_SWT14_Field := Interfaces.NXP.ADC.Swt14_0;
      --  Software trigger 15 event
      SWT15          : SWTRIG_SWT15_Field := Interfaces.NXP.ADC.Swt15_0;
      --  unspecified
   ...
   type TSTAT_Register is record
      ...
      TEXC_NUM   : TSTAT_TEXC_NUM_Field := Interfaces.NXP.ADC.Texc_Num_0;
      --  Write data bit of one shall clear (set to zero) the corresponding bit
      --  in the field. Trigger Completion Flag
      TCOMP_FLAG : TSTAT_TCOMP_FLAG_Field := Interfaces.NXP.ADC.Tcomp_Flag_0;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OFSTRIM_OFSTRIM_A_Field is Interfaces.Bit_Types.UInt5;
   subtype OFSTRIM_OFSTRIM_B_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype TCTRL_TDLY_Field is Interfaces.Bit_Types.UInt4;
   ...
   type TCTRL_Register is record
      --  Trigger enable
      HTEN           : TCTRL_HTEN_Field := Interfaces.NXP.ADC.Hten_0;
      --  SAR Result Destination For Channel A
      FIFO_SEL_A     : TCTRL_FIFO_SEL_A_Field :=
                        Interfaces.NXP.ADC.Fifo_Sel_A_0;
      --  SAR Result Destination For Channel B
      FIFO_SEL_B     : TCTRL_FIFO_SEL_B_Field :=
                        Interfaces.NXP.ADC.Fifo_Sel_B_0;
      --  unspecified
      Reserved_3_7   : Interfaces.Bit_Types.UInt5 := 16#0#;
      --  Trigger priority setting
      TPRI           : TCTRL_TPRI_Field := Interfaces.NXP.ADC.Tpri_0;
      --  unspecified
      ...
      Reserved_20_23 : Interfaces.Bit_Types.UInt4 := 16#0#;
      --  Trigger command select
      TCMD           : TCTRL_TCMD_Field := Interfaces.NXP.ADC.Tcmd_0;
      --  unspecified
      Reserved_28_31 : Interfaces.Bit_Types.UInt4 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype FCTRL_FCOUNT_Field is Interfaces.Bit_Types.UInt5;
   subtype FCTRL_FWMARK_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype GCC_GAIN_CAL_Field is Interfaces.Bit_Types.Short;
   ...
   subtype GCR_GCALR_Field is Interfaces.Bit_Types.Short;
   ...
   type GCR_Register is record
      ...
      --  Gain Calculation Ready
      RDY            : GCR_RDY_Field := Interfaces.NXP.ADC.Rdy_0;
      --  unspecified
   ...
   type CMDL_Register is record
      --  Input channel select
      ADCH          : CMDL1_ADCH_Field := Interfaces.NXP.ADC.Adch_0;
      --  Conversion Type
      CTYPE         : CMDL1_CTYPE_Field := Interfaces.NXP.ADC.Ctype_0;
      --  Select resolution of conversions
      MODE          : CMDL1_MODE_Field := Interfaces.NXP.ADC.Mode_0;
      --  unspecified
   ...
   type CMDH_Register is record
      --  Compare Function Enable
      CMPEN          : CMDH1_CMPEN_Field := Interfaces.NXP.ADC.Cmpen_0;
      --  Wait for trigger assertion before execution.
      WAIT_TRIG      : CMDH1_WAIT_TRIG_Field :=
                        Interfaces.NXP.ADC.Wait_Trig_0;
      --  unspecified
      Reserved_3_6   : Interfaces.Bit_Types.UInt4 := 16#0#;
      --  Loop with Increment
      LWI            : CMDH1_LWI_Field := Interfaces.NXP.ADC.Lwi_0;
      --  Sample Time Select
      STS            : CMDH1_STS_Field := Interfaces.NXP.ADC.Sts_0;
      --  unspecified
      Reserved_11_11 : Interfaces.Bit_Types.Bit := 16#0#;
      --  Hardware Average Select
      AVGS           : CMDH1_AVGS_Field := Interfaces.NXP.ADC.Avgs_0;
      --  unspecified
      Reserved_15_15 : Interfaces.Bit_Types.Bit := 16#0#;
      --  Loop Count Select
      LOOP_k         : CMDH1_LOOP_Field := Interfaces.NXP.ADC.Loop_0;
      --  unspecified
      Reserved_20_23 : Interfaces.Bit_Types.UInt4 := 16#0#;
      --  Next Command Select
      NEXT           : CMDH1_NEXT_Field := Interfaces.NXP.ADC.Next_0;
      --  unspecified
      Reserved_28_31 : Interfaces.Bit_Types.UInt4 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type CMDH_Register_1 is record
      ...
      --  Wait for trigger assertion before execution.
      WAIT_TRIG      : CMDH5_WAIT_TRIG_Field :=
                        Interfaces.NXP.ADC.Wait_Trig_0;
      --  unspecified
      Reserved_3_6   : Interfaces.Bit_Types.UInt4 := 16#0#;
      --  Loop with Increment
      LWI            : CMDH5_LWI_Field := Interfaces.NXP.ADC.Lwi_0;
      --  Sample Time Select
      STS            : CMDH5_STS_Field := Interfaces.NXP.ADC.Sts_0;
      --  unspecified
      Reserved_11_11 : Interfaces.Bit_Types.Bit := 16#0#;
      --  Hardware Average Select
      AVGS           : CMDH5_AVGS_Field := Interfaces.NXP.ADC.Avgs_0;
      --  unspecified
      Reserved_15_15 : Interfaces.Bit_Types.Bit := 16#0#;
      --  Loop Count Select
      LOOP_k         : CMDH5_LOOP_Field := Interfaces.NXP.ADC.Loop_0;
      --  unspecified
      Reserved_20_23 : Interfaces.Bit_Types.UInt4 := 16#0#;
      --  Next Command Select
      NEXT           : CMDH5_NEXT_Field := Interfaces.NXP.ADC.Next_0;
      --  unspecified
      Reserved_28_31 : Interfaces.Bit_Types.UInt4 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype CV_CVL_Field is Interfaces.Bit_Types.Short;
   subtype CV_CVH_Field is Interfaces.Bit_Types.Short;
   ...
   subtype RESFIFO_D_Field is Interfaces.Bit_Types.Short;
   ...
   subtype CAL_GAR_CAL_GAR_VAL_Field is Interfaces.Bit_Types.Short;
   ...
   subtype CAL_GBR_CAL_GBR_VAL_Field is Interfaces.Bit_Types.Short;
   ...
   type TST_Register is record
      --  Calibration Sample Time Long
      CST_LONG       : TST_CST_LONG_Field := Interfaces.NXP.ADC.Cst_Long_0;
      --  unspecified
      Reserved_1_7   : Interfaces.Bit_Types.UInt7 := 16#0#;
      --  Force M-side positive offset
      FOFFM          : TST_FOFFM_Field := Interfaces.NXP.ADC.Foffm_0;
      --  Force P-side positive offset
      FOFFP          : TST_FOFFP_Field := Interfaces.NXP.ADC.Foffp_0;
      --  Force M-side negative offset
      FOFFM2         : TST_FOFFM2_Field := Interfaces.NXP.ADC.Foffm2_0;
      --  Force P-side negative offset
      FOFFP2         : TST_FOFFP2_Field := Interfaces.NXP.ADC.Foffp2_0;
      --  unspecified
      Reserved_12_22 : Interfaces.Bit_Types.UInt11 := 16#0#;
      --  Enable test configuration
      TESTEN         : TST_TESTEN_Field := Interfaces.NXP.ADC.Testen_0;
      --  unspecified
