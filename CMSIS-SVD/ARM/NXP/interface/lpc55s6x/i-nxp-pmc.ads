...
package Interfaces.NXP.PMC is
   ...
   type BODVBAT_Register is record
      --  BoD trigger level.
      TRIGLVL       : BODVBAT_TRIGLVL_Field := Interfaces.NXP.PMC.V_1P65;
      --  BoD Hysteresis control.
      HYST          : BODVBAT_HYST_Field := Interfaces.NXP.PMC.Hyst_75Mv;
      --  unspecified
   ...
   subtype COMP_VREF_Field is Interfaces.Bit_Types.UInt5;
   subtype COMP_FILTERCGF_SAMPLEMODE_Field is Interfaces.Bit_Types.UInt2;
   subtype COMP_FILTERCGF_CLKDIV_Field is Interfaces.Bit_Types.UInt3;
   ...
   type COMP_Register is record
      ...
      --  Hysteris when hyst = '1'.
      HYST                 : COMP_HYST_Field := Interfaces.NXP.PMC.Enable;
      --  Dedicated control bit to select between internal VREF and VDDA (for
      --  the resistive ladder).
      VREFINPUT            : COMP_VREFINPUT_Field :=
                              Interfaces.NXP.PMC.Internalref;
      --  Low power mode.
      LOWPOWER             : COMP_LOWPOWER_Field :=
                              Interfaces.NXP.PMC.Lowspeed;
      --  Control word for P multiplexer:.
      PMUX                 : COMP_PMUX_Field := Interfaces.NXP.PMC.Vref;
      --  Control word for N multiplexer:.
      NMUX                 : COMP_NMUX_Field := Interfaces.NXP.PMC.Vref;
   ...
   type WAKEIOCAUSE_Register is record
      ...
      WAKEUP0       : WAKEIOCAUSE_WAKEUP0_Field := Interfaces.NXP.PMC.Noevent;
      --  Allows to identify Wake up I/O 1 as the wake-up source from Deep
      --  Power Down mode.
      WAKEUP1       : WAKEIOCAUSE_WAKEUP1_Field := Interfaces.NXP.PMC.Noevent;
      --  Allows to identify Wake up I/O 2 as the wake-up source from Deep
      --  Power Down mode.
      WAKEUP2       : WAKEIOCAUSE_WAKEUP2_Field := Interfaces.NXP.PMC.Noevent;
      --  Allows to identify Wake up I/O 3 as the wake-up source from Deep
      --  Power Down mode.
      WAKEUP3       : WAKEIOCAUSE_WAKEUP3_Field := Interfaces.NXP.PMC.Noevent;
      --  unspecified
      Reserved_4_31 : Interfaces.Bit_Types.UInt28 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype AOREG1_BOOTERRORCOUNTER_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype RTCOSC32K_CLK1KHZDIV_Field is Interfaces.Bit_Types.UInt3;
   subtype RTCOSC32K_CLK1HZDIV_Field is Interfaces.Bit_Types.UInt11;
   ...
   type RTCOSC32K_Register is record
      ...
      SEL                 : RTCOSC32K_SEL_Field := Interfaces.NXP.PMC.Fro32K;
   ...
   type PDRUNCFG0_Register is record
      ...
      --  Controls power to VBAT Brown Out Detector (BOD).
      PDEN_BODVBAT   : PDRUNCFG0_PDEN_BODVBAT_Field :=
                        Interfaces.NXP.PMC.Poweredon;
      --  unspecified
      Reserved_4_5   : Interfaces.Bit_Types.UInt2 := 16#0#;
      --  Controls power to the Free Running Oscillator (FRO) 32 KHz.
      PDEN_FRO32K    : PDRUNCFG0_PDEN_FRO32K_Field :=
                        Interfaces.NXP.PMC.Poweredoff;
      --  Controls power to crystal 32 KHz.
      PDEN_XTAL32K   : PDRUNCFG0_PDEN_XTAL32K_Field :=
                        Interfaces.NXP.PMC.Poweredoff;
      --  Controls power to crystal 32 MHz.
      PDEN_XTAL32M   : PDRUNCFG0_PDEN_XTAL32M_Field :=
                        Interfaces.NXP.PMC.Poweredoff;
      --  Controls power to System PLL (also refered as PLL0).
      PDEN_PLL0      : PDRUNCFG0_PDEN_PLL0_Field :=
                        Interfaces.NXP.PMC.Poweredoff;
      --  Controls power to USB PLL (also refered as PLL1).
      PDEN_PLL1      : PDRUNCFG0_PDEN_PLL1_Field :=
                        Interfaces.NXP.PMC.Poweredoff;
      --  Controls power to USB Full Speed phy.
      ...
      PDEN_USBHSPHY  : PDRUNCFG0_PDEN_USBHSPHY_Field :=
                        Interfaces.NXP.PMC.Poweredoff;
      --  Controls power to Analog Comparator.
      PDEN_COMP      : PDRUNCFG0_PDEN_COMP_Field :=
                        Interfaces.NXP.PMC.Poweredoff;
      --  unspecified
      Reserved_14_17 : Interfaces.Bit_Types.UInt4 := 16#B#;
      --  Controls power to USB high speed LDO.
      PDEN_LDOUSBHS  : PDRUNCFG0_PDEN_LDOUSBHS_Field :=
                        Interfaces.NXP.PMC.Poweredoff;
      --  Controls power to auxiliary biasing (AUXBIAS)
      PDEN_AUXBIAS   : PDRUNCFG0_PDEN_AUXBIAS_Field :=
                        Interfaces.NXP.PMC.Poweredoff;
      --  Controls power to crystal 32 MHz LDO.
      ...
      --  sources.
      PDEN_RNG       : PDRUNCFG0_PDEN_RNG_Field :=
                        Interfaces.NXP.PMC.Poweredoff;
      --  Controls power to System PLL (PLL0) Spread Spectrum module.
   ...
   type PMC_Peripheral is record
      ...
      --  Reset, Brown Out Detectors Reset, Deep Power Down Reset, Software
      --  Reset]
      PDRUNCFGSET0 : aliased Interfaces.Bit_Types.Word;
      --  Controls the power to various analog blocks [Reset by: PoR, Pin
      --  Reset, Brown Out Detectors Reset, Deep Power Down Reset, Software
      --  Reset]
      PDRUNCFGCLR0 : aliased Interfaces.Bit_Types.Word;
   end record
     with Volatile;
