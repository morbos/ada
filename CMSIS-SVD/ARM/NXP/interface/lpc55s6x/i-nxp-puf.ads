...
package Interfaces.NXP.PUF is
   ...
   subtype KEYINDEX_KEYIDX_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype KEYSIZE_KEYSIZE_Field is Interfaces.Bit_Types.UInt6;
   ...
   subtype KEYOUTINDEX_KEYOUTIDX_Field is Interfaces.Bit_Types.UInt4;
   ...
   type PWRCTRL_Register is record
      ...
      --  unspecified
      Reserved_2_31 : Interfaces.Bit_Types.UInt30 := 16#3E#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype KEYLOCK_KEY_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype KEYENABLE_KEY_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype KEYRESET_KEY_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype IDXBLK_L_IDX_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype IDXBLK_L_LOCK_IDX_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype IDXBLK_H_DP_IDX_Element is Interfaces.Bit_Types.UInt2;
   ...
   --  Only reset in case of full IC reset
   type KEYMASK_Registers is array (0 .. 3) of Interfaces.Bit_Types.Word
     with Volatile;

   --  IDXBLK_H_IDX array element
   subtype IDXBLK_H_IDX_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype IDXBLK_H_LOCK_IDX_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype IDXBLK_L_DP_IDX_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype SHIFT_STATUS_KEY_Element is Interfaces.Bit_Types.UInt4;
   ...
   type PUF_Peripheral is record
      ...
      KEYINPUT     : aliased Interfaces.Bit_Types.Word;
      --  PUF Code Input register
      CODEINPUT    : aliased Interfaces.Bit_Types.Word;
      --  PUF Code Output register
      CODEOUTPUT   : aliased Interfaces.Bit_Types.Word;
      --  PUF Key Output Index register
      KEYOUTINDEX  : aliased KEYOUTINDEX_Register;
      --  PUF Key Output register
      KEYOUTPUT    : aliased Interfaces.Bit_Types.Word;
      --  PUF Interface Status and clear register
