...
package Interfaces.NXP.RTC is
   ...
   type CTRL_Register is record
      --  Software reset control
      SWRESET        : CTRL_SWRESET_Field := Interfaces.NXP.RTC.In_Reset;
      --  unspecified
      Reserved_1_1   : Interfaces.Bit_Types.Bit := 16#0#;
      --  RTC 1 Hz timer alarm flag status.
      ALARM1HZ       : CTRL_ALARM1HZ_Field := Interfaces.NXP.RTC.No_Match;
      --  RTC 1 kHz timer wake-up flag status.
      WAKE1KHZ       : CTRL_WAKE1KHZ_Field := Interfaces.NXP.RTC.Run;
      --  RTC 1 Hz timer alarm enable for Deep power-down.
      ALARMDPD_EN    : CTRL_ALARMDPD_EN_Field := Interfaces.NXP.RTC.Disable;
      --  RTC 1 kHz timer wake-up enable for Deep power-down.
      WAKEDPD_EN     : CTRL_WAKEDPD_EN_Field := Interfaces.NXP.RTC.Disable;
      --  RTC 1 kHz clock enable. This bit can be set to 0 to conserve power if
      --  the 1 kHz timer is not used. This bit has no effect when the RTC is
      --  disabled (bit 7 of this register is 0).
      RTC1KHZ_EN     : CTRL_RTC1KHZ_EN_Field := Interfaces.NXP.RTC.Disable;
      --  RTC enable.
      RTC_EN         : CTRL_RTC_EN_Field := Interfaces.NXP.RTC.Disable;
      --  RTC oscillator power-down control.
      RTC_OSC_PD     : CTRL_RTC_OSC_PD_Field := Interfaces.NXP.RTC.Power_Up;
      --  RTC oscillator bypass control.
      RTC_OSC_BYPASS : CTRL_RTC_OSC_BYPASS_Field := Interfaces.NXP.RTC.Used;
      --  RTC Sub-second counter control.
      RTC_SUBSEC_ENA : CTRL_RTC_SUBSEC_ENA_Field :=
                        Interfaces.NXP.RTC.Power_Up;
      --  unspecified
   ...
   subtype WAKE_VAL_Field is Interfaces.Bit_Types.Short;
   ...
   subtype SUBSEC_SUBSEC_Field is Interfaces.Bit_Types.UInt15;
   ...
   --  General Purpose register
   type GPREG_Registers is array (0 .. 7) of Interfaces.Bit_Types.Word
     with Volatile;
   ...
   type RTC_Peripheral is record
      ...
      --  RTC match register
      MATCH  : aliased Interfaces.Bit_Types.Word;
      --  RTC counter register
      COUNT  : aliased Interfaces.Bit_Types.Word;
      --  High-resolution/wake-up timer control register
