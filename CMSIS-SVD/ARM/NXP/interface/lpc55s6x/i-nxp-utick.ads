...
package Interfaces.NXP.UTICK is
   pragma Preelaborate;
   ...
   subtype CTRL_DELAYVAL_Field is Interfaces.Bit_Types.UInt31;
   ...
   subtype CAP_CAP_VALUE_Field is Interfaces.Bit_Types.UInt31;
