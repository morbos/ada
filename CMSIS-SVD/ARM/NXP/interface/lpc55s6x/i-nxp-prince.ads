...
package Interfaces.NXP.PRINCE is
   pragma Preelaborate;
   ...
   type ENC_ENABLE_Register is record
      --  Encryption Enable.
      EN            : ENC_ENABLE_EN_Field := Interfaces.NXP.PRINCE.Disabled;
      --  unspecified
   ...
   type LOCK_Register is record
      --  Lock Region 0 registers.
      LOCKREG0      : LOCK_LOCKREG0_Field := Interfaces.NXP.PRINCE.Disabled;
      --  Lock Region 1 registers.
      LOCKREG1      : LOCK_LOCKREG1_Field := Interfaces.NXP.PRINCE.Disabled;
      --  Lock Region 2 registers.
      LOCKREG2      : LOCK_LOCKREG2_Field := Interfaces.NXP.PRINCE.Disabled;
      --  unspecified
      Reserved_3_7  : Interfaces.Bit_Types.UInt5 := 16#0#;
      --  Lock the Mask registers.
      LOCKMASK      : LOCK_LOCKMASK_Field := Interfaces.NXP.PRINCE.Disabled;
      --  unspecified
   ...
   subtype BASE_ADDR_ADDR_FIXED_Field is Interfaces.Bit_Types.UInt18;
   subtype BASE_ADDR_ADDR_PRG_Field is Interfaces.Bit_Types.UInt2;
