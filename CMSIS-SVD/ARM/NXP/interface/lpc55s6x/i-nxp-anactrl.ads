...
package Interfaces.NXP.ANACTRL is
   pragma Preelaborate;
   ...
   type ANALOG_CTRL_STATUS_Register is record
      --  unspecified
      Reserved_0_11    : Interfaces.Bit_Types.UInt12;
   ...
   subtype FREQ_ME_CTRL_CAPVAL_SCALE_Field is Interfaces.Bit_Types.UInt31;
   ...
   subtype FRO192M_CTRL_DAC_TRIM_Field is Interfaces.Bit_Types.Byte;
   ...
   type FRO192M_CTRL_Register is record
      --  unspecified
      Reserved_0_13  : Interfaces.Bit_Types.UInt14 := 16#101A#;
      --  12 MHz clock control.
      ENA_12MHZCLK   : FRO192M_CTRL_ENA_12MHZCLK_Field :=
                        Interfaces.NXP.ANACTRL.Enable;
      --  48 MHz clock control.
      ...
      ENA_96MHZCLK   : FRO192M_CTRL_ENA_96MHZCLK_Field :=
                        Interfaces.NXP.ANACTRL.Disable;
      --  unspecified
   ...
   type XO32M_CTRL_Register is record
      --  unspecified
      Reserved_0_21         : Interfaces.Bit_Types.UInt22 := 16#21428A#;
      --  Bypass enable of XO AC buffer enable in pll and top level.
   ...
   subtype RINGO0_CTRL_DIVISOR_Field is Interfaces.Bit_Types.UInt4;

   --  First Ring Oscillator module control register.
   type RINGO0_CTRL_Register is record
      --  Select short or long ringo (for all ringos types).
      SL             : RINGO0_CTRL_SL_Field := Interfaces.NXP.ANACTRL.Short;
      --  Ringo frequency output divider.
      FS             : RINGO0_CTRL_FS_Field := Interfaces.NXP.ANACTRL.Fast;
      --  PN-Ringos (P-Transistor and N-Transistor processing) control.
      SWN_SWP        : RINGO0_CTRL_SWN_SWP_Field :=
                        Interfaces.NXP.ANACTRL.Normal;
      --  Ringo module Power control.
      PD             : RINGO0_CTRL_PD_Field :=
                        Interfaces.NXP.ANACTRL.Powered_On;
      --  First NAND2-based ringo control.
      E_ND0          : RINGO0_CTRL_E_ND0_Field :=
                        Interfaces.NXP.ANACTRL.Disable;
      --  Second NAND2-based ringo control.
      E_ND1          : RINGO0_CTRL_E_ND1_Field :=
                        Interfaces.NXP.ANACTRL.Enable;
      --  First NOR2-based ringo control.
      E_NR0          : RINGO0_CTRL_E_NR0_Field :=
                        Interfaces.NXP.ANACTRL.Disable;
      --  Second NOR2-based ringo control.
      E_NR1          : RINGO0_CTRL_E_NR1_Field :=
                        Interfaces.NXP.ANACTRL.Disable;
      --  First Inverter-based ringo control.
      E_IV0          : RINGO0_CTRL_E_IV0_Field :=
                        Interfaces.NXP.ANACTRL.Disable;
      --  Second Inverter-based ringo control.
      E_IV1          : RINGO0_CTRL_E_IV1_Field :=
                        Interfaces.NXP.ANACTRL.Disable;
      --  First PN (P-Transistor and N-Transistor processing) monitor control.
      E_PN0          : RINGO0_CTRL_E_PN0_Field :=
                        Interfaces.NXP.ANACTRL.Disable;
      --  Second PN (P-Transistor and N-Transistor processing) monitor control.
      E_PN1          : RINGO0_CTRL_E_PN1_Field :=
                        Interfaces.NXP.ANACTRL.Disable;
      --  unspecified
   ...
   subtype RINGO1_CTRL_DIVISOR_Field is Interfaces.Bit_Types.UInt4;

   --  Second Ring Oscillator module control register.
   type RINGO1_CTRL_Register is record
      --  Select short or long ringo (for all ringos types).
      S              : RINGO1_CTRL_S_Field := Interfaces.NXP.ANACTRL.Short;
      --  Ringo frequency output divider.
      FS             : RINGO1_CTRL_FS_Field := Interfaces.NXP.ANACTRL.Fast;
      --  Ringo module Power control.
      PD             : RINGO1_CTRL_PD_Field :=
                        Interfaces.NXP.ANACTRL.Powered_On;
      --  .
   ...
   subtype RINGO2_CTRL_DIVISOR_Field is Interfaces.Bit_Types.UInt4;

   --  Third Ring Oscillator module control register.
   type RINGO2_CTRL_Register is record
      --  Select short or long ringo (for all ringos types).
      S              : RINGO2_CTRL_S_Field := Interfaces.NXP.ANACTRL.Short;
      --  Ringo frequency output divider.
      FS             : RINGO2_CTRL_FS_Field := Interfaces.NXP.ANACTRL.Fast;
      --  Ringo module Power control.
      PD             : RINGO2_CTRL_PD_Field :=
                        Interfaces.NXP.ANACTRL.Powered_On;
      --  .
   ...
   type USBHS_PHY_CTRL_Register is record
      ...
      --  unspecified
      Reserved_2_31     : Interfaces.Bit_Types.UInt30 := 16#2#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
