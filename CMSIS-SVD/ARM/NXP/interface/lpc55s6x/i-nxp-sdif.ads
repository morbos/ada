...
package Interfaces.NXP.SDIF is
   pragma Preelaborate;
   ...
   type CTRL_Register is record
      ...
      --  unspecified
      Reserved_19_24                : Interfaces.Bit_Types.UInt6 := 16#0#;
      --  SD/MMC DMA use.
   ...
   subtype CLKDIV_CLK_DIVIDER0_Field is Interfaces.Bit_Types.Byte;
   ...
   --  Response register
   type RESP_Registers is array (0 .. 3) of Interfaces.Bit_Types.Word
     with Volatile;
   ...
   subtype FIFOTH_DMA_MTS_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype BMOD_PBL_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype CARDTHRCTL_CARDTHRESHOLD_Field is Interfaces.Bit_Types.Byte;
   ...
   --  SDIF FIFO
   type FIFO_Registers is array (0 .. 63) of Interfaces.Bit_Types.Word
     with Volatile;
   ...
   type SDIF_Peripheral is record
      ...
      --  Byte Count register
      BYTCNT     : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Mask register
      INTMASK    : aliased INTMASK_Register;
      --  Command Argument register
      CMDARG     : aliased Interfaces.Bit_Types.Word;
      --  Command register
      ...
      TCBCNT     : aliased Interfaces.Bit_Types.Word;
      --  Transferred Host to BIU-FIFO Byte Count register
      TBBCNT     : aliased Interfaces.Bit_Types.Word;
      --  Debounce Count register
      ...
      PLDMND     : aliased Interfaces.Bit_Types.Word;
      --  Descriptor List Base Address register
      DBADDR     : aliased Interfaces.Bit_Types.Word;
      --  Internal DMAC Status register
      IDSTS      : aliased IDSTS_Register;
      --  Internal DMAC Interrupt Enable register
      IDINTEN    : aliased IDINTEN_Register;
      --  Current Host Descriptor Address register
      DSCADDR    : aliased Interfaces.Bit_Types.Word;
      --  Current Buffer Descriptor Address register
      BUFADDR    : aliased Interfaces.Bit_Types.Word;
      --  Card Threshold Control
