...
package Interfaces.NXP.I2C is
   ...
   type CFG_Register is record
      ...
      --  reset.
      MSTEN         : CFG_MSTEN_Field := Interfaces.NXP.I2C.Disabled;
      --  Slave Enable. When disabled, configurations settings for the Slave
      --  function are not changed, but the Slave function is internally reset.
      SLVEN         : CFG_SLVEN_Field := Interfaces.NXP.I2C.Disabled;
      --  Monitor Enable. When disabled, configurations settings for the
      --  Monitor function are not changed, but the Monitor function is
      --  internally reset.
      MONEN         : CFG_MONEN_Field := Interfaces.NXP.I2C.Disabled;
      --  I2C bus Time-out Enable. When disabled, the time-out function is
      --  internally reset.
      TIMEOUTEN     : CFG_TIMEOUTEN_Field := Interfaces.NXP.I2C.Disabled;
      --  Monitor function Clock Stretching.
      MONCLKSTR     : CFG_MONCLKSTR_Field := Interfaces.NXP.I2C.Disabled;
      ...
      HSCAPABLE     : CFG_HSCAPABLE_Field :=
                       Interfaces.NXP.I2C.Fast_Mode_Plus;
      --  unspecified
   ...
   type STAT_Register is record
      ...
      MSTPENDING     : STAT_MSTPENDING_Field := Interfaces.NXP.I2C.Pending;
      ...
      MSTSTATE       : STAT_MSTSTATE_Field := Interfaces.NXP.I2C.Idle;
      --  Master Arbitration Loss flag. This flag can be cleared by software
      --  writing a 1 to this bit. It is also cleared automatically a 1 is
      --  written to MSTCONTINUE.
      MSTARBLOSS     : STAT_MSTARBLOSS_Field := Interfaces.NXP.I2C.No_Loss;
      --  unspecified
      Reserved_5_5   : Interfaces.Bit_Types.Bit := 16#0#;
      --  Master Start/Stop Error flag. This flag can be cleared by software
      --  writing a 1 to this bit. It is also cleared automatically a 1 is
      --  written to MSTCONTINUE.
      MSTSTSTPERR    : STAT_MSTSTSTPERR_Field := Interfaces.NXP.I2C.No_Error;
      --  unspecified
      ...
      SLVPENDING     : STAT_SLVPENDING_Field :=
                        Interfaces.NXP.I2C.In_Progress;
      ...
      SLVSTATE       : STAT_SLVSTATE_Field :=
                        Interfaces.NXP.I2C.Slave_Address;
      ...
      SLVNOTSTR      : STAT_SLVNOTSTR_Field :=
                        Interfaces.NXP.I2C.Not_Stretching;
      ...
      SLVIDX         : STAT_SLVIDX_Field := Interfaces.NXP.I2C.Address0;
      ...
      SLVSEL         : STAT_SLVSEL_Field := Interfaces.NXP.I2C.Not_Selected;
      --  Slave Deselected flag. This flag will cause an interrupt when set if
      --  enabled via INTENSET. This flag can be cleared by writing a 1 to this
      --  bit.
      SLVDESEL       : STAT_SLVDESEL_Field :=
                        Interfaces.NXP.I2C.Not_Deselected;
      --  Read-only. Monitor Ready. This flag is cleared when the MONRXDAT
      --  register is read.
      MONRDY         : STAT_MONRDY_Field := Interfaces.NXP.I2C.No_Data;
      --  Monitor Overflow flag.
      MONOV          : STAT_MONOV_Field := Interfaces.NXP.I2C.No_Overrun;
      ...
      --  than a bus Stop.
      MONACTIVE      : STAT_MONACTIVE_Field := Interfaces.NXP.I2C.Inactive;
      ...
      --  bit.
      MONIDLE        : STAT_MONIDLE_Field := Interfaces.NXP.I2C.Not_Idle;
      --  unspecified
      ...
      --  idle.
      EVENTTIMEOUT   : STAT_EVENTTIMEOUT_Field :=
                        Interfaces.NXP.I2C.No_Timeout;
      ...
      SCLTIMEOUT     : STAT_SCLTIMEOUT_Field := Interfaces.NXP.I2C.No_Timeout;
      --  unspecified
   ...
   type INTENSET_Register is record
      --  Master Pending interrupt Enable.
      MSTPENDINGEN   : INTENSET_MSTPENDINGEN_Field :=
                        Interfaces.NXP.I2C.Disabled;
      --  unspecified
      Reserved_1_3   : Interfaces.Bit_Types.UInt3 := 16#0#;
      --  Master Arbitration Loss interrupt Enable.
      MSTARBLOSSEN   : INTENSET_MSTARBLOSSEN_Field :=
                        Interfaces.NXP.I2C.Disabled;
      --  unspecified
      Reserved_5_5   : Interfaces.Bit_Types.Bit := 16#0#;
      --  Master Start/Stop Error interrupt Enable.
      MSTSTSTPERREN  : INTENSET_MSTSTSTPERREN_Field :=
                        Interfaces.NXP.I2C.Disabled;
      --  unspecified
      Reserved_7_7   : Interfaces.Bit_Types.Bit := 16#0#;
      --  Slave Pending interrupt Enable.
      SLVPENDINGEN   : INTENSET_SLVPENDINGEN_Field :=
                        Interfaces.NXP.I2C.Disabled;
      --  unspecified
      Reserved_9_10  : Interfaces.Bit_Types.UInt2 := 16#0#;
      --  Slave Not Stretching interrupt Enable.
      SLVNOTSTREN    : INTENSET_SLVNOTSTREN_Field :=
                        Interfaces.NXP.I2C.Disabled;
      --  unspecified
      Reserved_12_14 : Interfaces.Bit_Types.UInt3 := 16#0#;
      --  Slave Deselect interrupt Enable.
      SLVDESELEN     : INTENSET_SLVDESELEN_Field :=
                        Interfaces.NXP.I2C.Disabled;
      --  Monitor data Ready interrupt Enable.
      MONRDYEN       : INTENSET_MONRDYEN_Field := Interfaces.NXP.I2C.Disabled;
      --  Monitor Overrun interrupt Enable.
      MONOVEN        : INTENSET_MONOVEN_Field := Interfaces.NXP.I2C.Disabled;
      --  unspecified
      Reserved_18_18 : Interfaces.Bit_Types.Bit := 16#0#;
      --  Monitor Idle interrupt Enable.
      MONIDLEEN      : INTENSET_MONIDLEEN_Field :=
                        Interfaces.NXP.I2C.Disabled;
      --  unspecified
      Reserved_20_23 : Interfaces.Bit_Types.UInt4 := 16#0#;
      --  Event time-out interrupt Enable.
      EVENTTIMEOUTEN : INTENSET_EVENTTIMEOUTEN_Field :=
                        Interfaces.NXP.I2C.Disabled;
      --  SCL time-out interrupt Enable.
      SCLTIMEOUTEN   : INTENSET_SCLTIMEOUTEN_Field :=
                        Interfaces.NXP.I2C.Disabled;
      --  unspecified
      Reserved_26_31 : Interfaces.Bit_Types.UInt6 := 16#0#;
   end record
   ...
   subtype TIMEOUT_TOMIN_Field is Interfaces.Bit_Types.UInt4;
   subtype TIMEOUT_TO_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype CLKDIV_DIVVAL_Field is Interfaces.Bit_Types.Short;
   ...
   type MSTCTL_Register is record
      ...
      MSTCONTINUE   : MSTCTL_MSTCONTINUE_Field :=
                       Interfaces.NXP.I2C.No_Effect;
      --  Master Start control. This bit is write-only.
      MSTSTART      : MSTCTL_MSTSTART_Field := Interfaces.NXP.I2C.No_Effect;
      --  Master Stop control. This bit is write-only.
      MSTSTOP       : MSTCTL_MSTSTOP_Field := Interfaces.NXP.I2C.No_Effect;
      ...
      MSTDMA        : MSTCTL_MSTDMA_Field := Interfaces.NXP.I2C.Disabled;
      --  unspecified
   ...
   type MSTTIME_Register is record
      ...
      --  MSTSCLLOW.
      MSTSCLLOW     : MSTTIME_MSTSCLLOW_Field := Interfaces.NXP.I2C.Clocks_9;
      --  unspecified
      ...
      --  MSTSCLHIGH.
      MSTSCLHIGH    : MSTTIME_MSTSCLHIGH_Field := Interfaces.NXP.I2C.Clocks_9;
      --  unspecified
   ...
   subtype MSTDAT_DATA_Field is Interfaces.Bit_Types.Byte;
   ...
   type SLVCTL_Register is record
      --  Slave Continue.
      SLVCONTINUE    : SLVCTL_SLVCONTINUE_Field :=
                        Interfaces.NXP.I2C.No_Effect;
      --  Slave NACK.
      SLVNACK        : SLVCTL_SLVNACK_Field := Interfaces.NXP.I2C.No_Effect;
      --  unspecified
      Reserved_2_2   : Interfaces.Bit_Types.Bit := 16#0#;
      --  Slave DMA enable.
      SLVDMA         : SLVCTL_SLVDMA_Field := Interfaces.NXP.I2C.Disabled;
      --  unspecified
      ...
      AUTOACK        : SLVCTL_AUTOACK_Field := Interfaces.NXP.I2C.Normal;
      --  When AUTOACK is set, this bit controls whether it matches a read or
      ...
      --  direction needs to be specified. This bit allows a direction to be
      --  chosen for the next operation.
      AUTOMATCHREAD  : SLVCTL_AUTOMATCHREAD_Field :=
                        Interfaces.NXP.I2C.I2C_Write;
      --  unspecified
   ...
   subtype SLVDAT_DATA_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype SLVADR0_SLVADR_Field is Interfaces.Bit_Types.UInt7;
   ...
   type SLVADR0_Register is record
      --  Slave Address n Disable.
      SADISABLE      : SLVADR0_SADISABLE_Field := Interfaces.NXP.I2C.Disabled;
      ...
      --  AUTOMATCHREAD, allows software to ignore I2C traffic while handling
      --  previous I2C data or other operations.
      AUTONACK       : SLVADR0_AUTONACK_Field := Interfaces.NXP.I2C.Normal;
      --  unspecified
      Reserved_16_31 : Interfaces.Bit_Types.Short := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype SLVADR_SLVADR_Field is Interfaces.Bit_Types.UInt7;

   --  Slave address register.
   type SLVADR_Register is record
      --  Slave Address n Disable.
      SADISABLE     : SLVADR1_SADISABLE_Field := Interfaces.NXP.I2C.Disabled;
      --  Slave Address. Seven bit slave address that is compared to received
      --  addresses if enabled.
   ...
   subtype SLVQUAL0_SLVQUAL0_Field is Interfaces.Bit_Types.UInt7;

   --  Slave Qualification for address 0.
   type SLVQUAL0_Register is record
      --  Qualify mode for slave address 0.
      QUALMODE0     : SLVQUAL0_QUALMODE0_Field := Interfaces.NXP.I2C.Mask;
   ...
   subtype MONRXDAT_MONRXDAT_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype ID_APERTURE_Field is Interfaces.Bit_Types.Byte;
   subtype ID_MINOR_REV_Field is Interfaces.Bit_Types.UInt4;
   subtype ID_MAJOR_REV_Field is Interfaces.Bit_Types.UInt4;
   subtype ID_ID_Field is Interfaces.Bit_Types.Short;
