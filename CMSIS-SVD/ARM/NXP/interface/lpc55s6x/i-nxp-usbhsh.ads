...
package Interfaces.NXP.USBHSH is
   pragma Preelaborate;
   ...
   subtype CAPLENGTH_CHIPID_CAPLENGTH_Field is Interfaces.Bit_Types.Byte;
   subtype CAPLENGTH_CHIPID_CHIPID_Field is Interfaces.Bit_Types.Short;
   ...
   subtype FLADJ_FRINDEX_FLADJ_Field is Interfaces.Bit_Types.UInt6;
   subtype FLADJ_FRINDEX_FRINDEX_Field is Interfaces.Bit_Types.UInt14;
   ...
   subtype ATLPTD_ATL_CUR_Field is Interfaces.Bit_Types.UInt5;
   subtype ATLPTD_ATL_BASE_Field is Interfaces.Bit_Types.UInt23;
   ...
   subtype ISOPTD_ISO_FIRST_Field is Interfaces.Bit_Types.UInt5;
   subtype ISOPTD_ISO_BASE_Field is Interfaces.Bit_Types.UInt22;
   ...
   subtype INTPTD_INT_FIRST_Field is Interfaces.Bit_Types.UInt5;
   subtype INTPTD_INT_BASE_Field is Interfaces.Bit_Types.UInt22;
   ...
   subtype DATAPAYLOAD_DAT_BASE_Field is Interfaces.Bit_Types.Short;
   ...
   subtype USBCMD_FLS_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype PORTSC1_LS_Field is Interfaces.Bit_Types.UInt2;
   subtype PORTSC1_PIC_Field is Interfaces.Bit_Types.UInt2;
   subtype PORTSC1_PTC_Field is Interfaces.Bit_Types.UInt4;
   subtype PORTSC1_PSPD_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype LASTPTD_ATL_LAST_Field is Interfaces.Bit_Types.UInt5;
   subtype LASTPTD_ISO_LAST_Field is Interfaces.Bit_Types.UInt5;
   subtype LASTPTD_INT_LAST_Field is Interfaces.Bit_Types.UInt5;
   ...
   type USBHSH_Peripheral is record
      ...
      ATLPTDD          : aliased Interfaces.Bit_Types.Word;
      --  Skip map for each ATL PTD
      ATLPTDS          : aliased Interfaces.Bit_Types.Word;
      --  Done map for each ISO PTD
      ISOPTDD          : aliased Interfaces.Bit_Types.Word;
      --  Skip map for each ISO PTD
      ISOPTDS          : aliased Interfaces.Bit_Types.Word;
      --  Done map for each INT PTD
      INTPTDD          : aliased Interfaces.Bit_Types.Word;
      --  Skip map for each INT PTD
      INTPTDS          : aliased Interfaces.Bit_Types.Word;
      --  Marks the last PTD in the list for ISO, INT and ATL
