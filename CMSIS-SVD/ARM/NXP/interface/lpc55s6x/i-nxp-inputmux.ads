...
package Interfaces.NXP.INPUTMUX is
   pragma Preelaborate;
   ...
   type SCT0_INMUX_Register is record
      --  Input number to SCT0 inputs 0 to 6..
      INP_N         : SCT0_INMUX_INP_N_Field :=
                       Interfaces.NXP.INPUTMUX.VAL24_7;
      --  unspecified
   ...
   type TIMER0CAPTSEL_Register is record
      --  Input number to TIMER0 capture inputs 0 to 4
      CAPTSEL       : TIMER0CAPTSEL_CAPTSEL_Field :=
                       Interfaces.NXP.INPUTMUX.VAL25_6;
      --  unspecified
      Reserved_5_31 : Interfaces.Bit_Types.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type TIMER1CAPTSEL_Register is record
      --  Input number to TIMER1 capture inputs 0 to 4
      CAPTSEL       : TIMER1CAPTSEL_CAPTSEL_Field :=
                       Interfaces.NXP.INPUTMUX.VAL25_6;
      --  unspecified
      Reserved_5_31 : Interfaces.Bit_Types.UInt27 := 16#0#;
   end record
   ...
   type TIMER2CAPTSEL_Register is record
      --  Input number to TIMER2 capture inputs 0 to 4
      CAPTSEL       : TIMER2CAPTSEL_CAPTSEL_Field :=
                       Interfaces.NXP.INPUTMUX.VAL25_6;
      --  unspecified
      Reserved_5_31 : Interfaces.Bit_Types.UInt27 := 16#0#;
   end record
   ...
   subtype PINTSEL_INTPIN_Field is Interfaces.Bit_Types.UInt7;
   ...
   type DMA0_ITRIG_INMUX_Register is record
      --  Trigger input number (decimal value) for DMA channel n (n = 0 to 22).
      INP           : DMA0_ITRIG_INMUX_INP_Field :=
                       Interfaces.NXP.INPUTMUX.VAL22_9;
      --  unspecified
      Reserved_5_31 : Interfaces.Bit_Types.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype DMA0_OTRIG_INMUX_INP_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype FREQMEAS_REF_CLKIN_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype FREQMEAS_TARGET_CLKIN_Field is Interfaces.Bit_Types.UInt5;
   ...
   type TIMER3CAPTSEL_Register is record
      --  Input number to TIMER3 capture inputs 0 to 4
      CAPTSEL       : TIMER3CAPTSEL_CAPTSEL_Field :=
                       Interfaces.NXP.INPUTMUX.VAL25_6;
      --  unspecified
      Reserved_5_31 : Interfaces.Bit_Types.UInt27 := 16#0#;
   end record
   ...
   type TIMER4CAPTSEL_Register is record
      --  Input number to TIMER4 capture inputs 0 to 4
      CAPTSEL       : TIMER4CAPTSEL_CAPTSEL_Field :=
                       Interfaces.NXP.INPUTMUX.VAL25_6;
      --  unspecified
      Reserved_5_31 : Interfaces.Bit_Types.UInt27 := 16#0#;
   end record
   ...
   subtype PINTSECSEL_INTPIN_Field is Interfaces.Bit_Types.UInt6;
   ...
   type DMA1_ITRIG_INMUX_Register is record
      --  Trigger input number (decimal value) for DMA channel n (n = 0 to 9).
      INP           : DMA1_ITRIG_INMUX_INP_Field :=
                       Interfaces.NXP.INPUTMUX.VAL15;
      --  unspecified
   ...
   subtype DMA1_OTRIG_INMUX_INP_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype DMA0_REQ_ENA_REQ_ENA_Field is Interfaces.Bit_Types.UInt23;
   ...
   subtype DMA0_REQ_ENA_SET_SET_Field is Interfaces.Bit_Types.UInt23;
   ...
   subtype DMA0_REQ_ENA_CLR_CLR_Field is Interfaces.Bit_Types.UInt23;
   ...
   subtype DMA1_REQ_ENA_REQ_ENA_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype DMA1_REQ_ENA_SET_SET_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype DMA1_REQ_ENA_CLR_CLR_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype DMA0_ITRIG_ENA_ITRIG_ENA_Field is Interfaces.Bit_Types.UInt22;
   ...
   subtype DMA0_ITRIG_ENA_SET_SET_Field is Interfaces.Bit_Types.UInt22;
   ...
   subtype DMA0_ITRIG_ENA_CLR_CLR_Field is Interfaces.Bit_Types.UInt22;
   ...
   subtype DMA1_ITRIG_ENA_ITRIG_ENA_Field is Interfaces.Bit_Types.UInt15;
   ...
   subtype DMA1_ITRIG_ENA_SET_SET_Field is Interfaces.Bit_Types.UInt15;
   ...
   subtype DMA1_ITRIG_ENA_CLR_CLR_Field is Interfaces.Bit_Types.UInt15;
