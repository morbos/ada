...
package Interfaces.NXP.DMA is
   ...
   type CTRL_Register is record
      --  DMA controller master enable.
      ENABLE        : CTRL_ENABLE_Field := Interfaces.NXP.DMA.Disabled;
      --  unspecified
   ...
   subtype SRAMBASE_OFFSET_Field is Interfaces.Bit_Types.UInt23;
   ...
   subtype CFG_CHANNEL_BURSTPOWER_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype CFG_CHANNEL_CHPRIORITY_Field is Interfaces.Bit_Types.UInt3;
   ...
   type CFG_CHANNEL_Register is record
      ...
      --  peripheral and the DMA controller.
      PERIPHREQEN    : CFG_PERIPHREQEN_Field := Interfaces.NXP.DMA.Disabled;
      --  Hardware Triggering Enable for this channel.
      HWTRIGEN       : CFG_HWTRIGEN_Field := Interfaces.NXP.DMA.Disabled;
      --  unspecified
      Reserved_2_3   : Interfaces.Bit_Types.UInt2 := 16#0#;
      --  Trigger Polarity. Selects the polarity of a hardware trigger for this
      --  channel.
      TRIGPOL        : CFG_TRIGPOL_Field :=
                        Interfaces.NXP.DMA.Active_Low_Falling;
      --  Trigger Type. Selects hardware trigger as edge triggered or level
      --  triggered.
      TRIGTYPE       : CFG_TRIGTYPE_Field := Interfaces.NXP.DMA.Edge;
      --  Trigger Burst. Selects whether hardware triggers cause a single or
      --  burst transfer.
      TRIGBURST      : CFG_TRIGBURST_Field := Interfaces.NXP.DMA.Single;
      --  unspecified
      ...
      --  the same registers again for each burst.
      SRCBURSTWRAP   : CFG_SRCBURSTWRAP_Field := Interfaces.NXP.DMA.Disabled;
      ...
      DSTBURSTWRAP   : CFG_DSTBURSTWRAP_Field := Interfaces.NXP.DMA.Disabled;
   ...
   subtype XFERCFG_CHANNEL_XFERCOUNT_Field is Interfaces.Bit_Types.UInt10;
   ...
   type XFERCFG_CHANNEL_Register is record
      ...
      CFGVALID       : XFERCFG_CFGVALID_Field := Interfaces.NXP.DMA.Not_Valid;
      ...
      RELOAD         : XFERCFG_RELOAD_Field := Interfaces.NXP.DMA.Disabled;
      --  Software Trigger.
      SWTRIG         : XFERCFG_SWTRIG_Field := Interfaces.NXP.DMA.Not_Set;
      --  Clear Trigger.
      CLRTRIG        : XFERCFG_CLRTRIG_Field :=
                        Interfaces.NXP.DMA.Not_Cleared;
      ...
      SETINTA        : XFERCFG_SETINTA_Field := Interfaces.NXP.DMA.No_Effect;
      --  Set Interrupt flag B for this channel. There is no hardware
      --  distinction between interrupt A and B. They can be used by software
      --  to assist with more complex descriptor usage. By convention,
      --  interrupt A may be used when only one interrupt flag is needed.
      SETINTB        : XFERCFG_SETINTB_Field := Interfaces.NXP.DMA.No_Effect;
      --  unspecified
      Reserved_6_7   : Interfaces.Bit_Types.UInt2 := 16#0#;
      --  Transfer width used for this DMA channel.
      WIDTH          : XFERCFG_WIDTH_Field := Interfaces.NXP.DMA.Bit_8;
      --  unspecified
      Reserved_10_11 : Interfaces.Bit_Types.UInt2 := 16#0#;
      --  Determines whether the source address is incremented for each DMA
      --  transfer.
      SRCINC         : XFERCFG_SRCINC_Field :=
                        Interfaces.NXP.DMA.No_Increment;
      --  Determines whether the destination address is incremented for each
      --  DMA transfer.
      DSTINC         : XFERCFG_DSTINC_Field :=
                        Interfaces.NXP.DMA.No_Increment;
   ...
   type DMA_Peripheral is record
      ...
      ENABLESET0 : aliased Interfaces.Bit_Types.Word;
      --  Channel Enable Clear for all DMA channels.
      ENABLECLR0 : aliased Interfaces.Bit_Types.Word;
      --  Channel Active status for all DMA channels.
      ACTIVE0    : aliased Interfaces.Bit_Types.Word;
      --  Channel Busy status for all DMA channels.
      BUSY0      : aliased Interfaces.Bit_Types.Word;
      --  Error Interrupt status for all DMA channels.
      ERRINT0    : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Enable read and Set for all DMA channels.
      INTENSET0  : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Enable Clear for all DMA channels.
      INTENCLR0  : aliased Interfaces.Bit_Types.Word;
      --  Interrupt A status for all DMA channels.
      INTA0      : aliased Interfaces.Bit_Types.Word;
      --  Interrupt B status for all DMA channels.
      INTB0      : aliased Interfaces.Bit_Types.Word;
      --  Set ValidPending control bits for all DMA channels.
      SETVALID0  : aliased Interfaces.Bit_Types.Word;
      --  Set Trigger control bits for all DMA channels.
      SETTRIG0   : aliased Interfaces.Bit_Types.Word;
      --  Channel Abort control for all DMA channels.
      ABORT0     : aliased Interfaces.Bit_Types.Word;
      --  no description available
