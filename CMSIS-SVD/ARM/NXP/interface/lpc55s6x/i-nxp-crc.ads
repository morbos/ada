...
package Interfaces.NXP.CRC is
   ...
   subtype MODE_CRC_POLY_Field is Interfaces.Bit_Types.UInt2;
   ...
   is record
      ...
      --  CRC seed register
      SEED    : aliased Interfaces.Bit_Types.Word;
      case Discriminent is
         when Mode_1 =>
            --  CRC checksum register
            SUM : aliased Interfaces.Bit_Types.Word;
         when Mode_2 =>
            --  CRC data register
            WR_DATA : aliased Interfaces.Bit_Types.Word;
      end case;
   end record
