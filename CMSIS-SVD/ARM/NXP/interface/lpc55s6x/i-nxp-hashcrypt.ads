...
package Interfaces.NXP.HASHCRYPT is
   pragma Preelaborate;
   ...
   type CTRL_Register is record
      ...
      --  available.
      Mode           : CTRL_Mode_Field := Interfaces.NXP.HASHCRYPT.Disabled;
      --  unspecified
      ...
      DMA_I          : CTRL_DMA_I_Field := Interfaces.NXP.HASHCRYPT.Not_Used;
      --  Written to 1 to use DMA to drain the digest/output. If both DMA_I and
      --  DMA_O are set, the DMA has to know to switch direction and the
      --  locations. This can be used for crypto uses.
      DMA_O          : CTRL_DMA_O_Field := Interfaces.NXP.HASHCRYPT.Notused;
      --  unspecified
   ...
   subtype STATUS_ICBIDX_Field is Interfaces.Bit_Types.UInt6;

   --  Indicates status of Hash peripheral.
   type STATUS_Register is record
      --  Read-only. If 1, the block is waiting for more data to process.
      WAITING        : STATUS_WAITING_Field :=
                        Interfaces.NXP.HASHCRYPT.Not_Waiting;
      ...
      --  is disabled.
      DIGEST         : STATUS_DIGEST_Field :=
                        Interfaces.NXP.HASHCRYPT.Not_Ready;
      ...
      ERROR          : STATUS_ERROR_Field :=
                        Interfaces.NXP.HASHCRYPT.No_Error;
      --  unspecified
      Reserved_3_3   : Interfaces.Bit_Types.Bit := 16#0#;
      --  Read-only. Indicates the block wants the key to be written in (set
      --  along with WAITING)
      NEEDKEY        : STATUS_NEEDKEY_Field :=
                        Interfaces.NXP.HASHCRYPT.Not_Need;
      --  Read-only. Indicates the block wants an IV/NONE to be written in (set
      --  along with WAITING)
      NEEDIV         : STATUS_NEEDIV_Field :=
                        Interfaces.NXP.HASHCRYPT.Not_Need;
      --  unspecified
   ...
   type INTENSET_Register is record
      ...
      WAITING       : INTENSET_WAITING_Field :=
                       Interfaces.NXP.HASHCRYPT.No_Interrupt;
      --  Indicates if should interrupt when Digest (or Outdata) is ready
      --  (completed a hash/crypto or completed a full sequence).
      DIGEST        : INTENSET_DIGEST_Field :=
                       Interfaces.NXP.HASHCRYPT.No_Interrupt;
      --  Indicates if should interrupt on an ERROR (as defined in Status)
      ERROR         : INTENSET_ERROR_Field :=
                       Interfaces.NXP.HASHCRYPT.Not_Interrupt;
      --  unspecified
   ...
   subtype MEMCTRL_COUNT_Field is Interfaces.Bit_Types.UInt11;

   --  Setup Master to access memory (if available)
   type MEMCTRL_Register is record
      --  Enables mastering.
      MASTER         : MEMCTRL_MASTER_Field :=
                        Interfaces.NXP.HASHCRYPT.Not_Used;
      --  unspecified
   ...
   --  no description available
   type ALIAS_Registers is array (0 .. 6) of Interfaces.Bit_Types.Word
     with Volatile;

   --  no description available

   --  no description available
   type DIGEST0_Registers is array (0 .. 7) of Interfaces.Bit_Types.Word
     with Volatile;
   ...
   subtype CRYPTCFG_AESCTRPOS_Field is Interfaces.Bit_Types.UInt3;
   ...
   type CRYPTCFG_Register is record
      ...
      --  AES Cipher mode to use if plain AES
      AESMODE        : CRYPTCFG_AESMODE_Field := Interfaces.NXP.HASHCRYPT.Ecb;
      --  AES ECB direction. Only encryption used if CTR mode or manual modes
      --  such as CFB
      AESDECRYPT     : CRYPTCFG_AESDECRYPT_Field :=
                        Interfaces.NXP.HASHCRYPT.Encrypt;
      --  Selects the Hidden Secret key vs. User key, if provided. If security
      --  levels are used, only the highest level is permitted to select this.
      AESSECRET      : CRYPTCFG_AESSECRET_Field :=
                        Interfaces.NXP.HASHCRYPT.Normal_Way;
      --  Sets the AES key size
      AESKEYSZ       : CRYPTCFG_AESKEYSZ_Field :=
                        Interfaces.NXP.HASHCRYPT.Bits_128;
      ...
      --  of the IV.
      ICBSZ          : CRYPTCFG_ICBSZ_Field :=
                        Interfaces.NXP.HASHCRYPT.Bits_32;
      --  The size of the ICB-AES stream that can be pushed before needing to
      --  compute a new IV/ctr (counter start). This optimizes the performance
      --  of the stream of blocks after the 1st.
      ICBSTRM        : CRYPTCFG_ICBSTRM_Field :=
                        Interfaces.NXP.HASHCRYPT.Blocks_8;
      --  unspecified
   ...
   subtype LOCK_PATTERN_Field is Interfaces.Bit_Types.UInt12;
   ...
   type LOCK_Register is record
      ...
      --  lock level.
      SECLOCK        : LOCK_SECLOCK_Field := Interfaces.NXP.HASHCRYPT.Unlock;
      --  unspecified
   ...
   --  no description available
   type MASK_Registers is array (0 .. 3) of Interfaces.Bit_Types.Word
     with Volatile;
   ...
   type HASHCRYPT_Peripheral is record
      ...
      MEMADDR  : aliased Interfaces.Bit_Types.Word;
      --  Input of 16 words at a time to load up buffer.
      INDATA   : aliased Interfaces.Bit_Types.Word;
      --  no description available
