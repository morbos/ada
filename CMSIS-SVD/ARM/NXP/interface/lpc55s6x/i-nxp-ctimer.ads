...
package Interfaces.NXP.CTIMER is
   pragma Preelaborate;
   ...
   type TCR_Register is record
      --  Counter enable.
      CEN           : TCR_CEN_Field := Interfaces.NXP.CTIMER.Disabled;
      --  Counter reset.
      CRST          : TCR_CRST_Field := Interfaces.NXP.CTIMER.Disabled;
      --  unspecified
   ...
   type EMR_Register is record
      ...
      --  Match 0.
      EMC0           : EMR_EMC0_Field := Interfaces.NXP.CTIMER.Do_Nothing;
      --  External Match Control 1. Determines the functionality of External
      --  Match 1.
      EMC1           : EMR_EMC1_Field := Interfaces.NXP.CTIMER.Do_Nothing;
      --  External Match Control 2. Determines the functionality of External
      --  Match 2.
      EMC2           : EMR_EMC2_Field := Interfaces.NXP.CTIMER.Do_Nothing;
      --  External Match Control 3. Determines the functionality of External
      --  Match 3.
      EMC3           : EMR_EMC3_Field := Interfaces.NXP.CTIMER.Do_Nothing;
      --  unspecified
      Reserved_12_31 : Interfaces.Bit_Types.UInt20 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type CTCR_Register is record
      ...
      CTMODE        : CTCR_CTMODE_Field := Interfaces.NXP.CTIMER.Timer;
      ...
      CINSEL        : CTCR_CINSEL_Field := Interfaces.NXP.CTIMER.Channel_0;
      ...
      --  are reserved.
      SELCC         : CTCR_SELCC_Field :=
                       Interfaces.NXP.CTIMER.Channel_0_Rising;
      --  unspecified
      Reserved_8_31 : Interfaces.Bit_Types.UInt24 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type PWMC_Register is record
      --  PWM mode enable for channel0.
      PWMEN0        : PWMC_PWMEN0_Field := Interfaces.NXP.CTIMER.Match;
      --  PWM mode enable for channel1.
      PWMEN1        : PWMC_PWMEN1_Field := Interfaces.NXP.CTIMER.Match;
      --  PWM mode enable for channel2.
      PWMEN2        : PWMC_PWMEN2_Field := Interfaces.NXP.CTIMER.Match;
      --  PWM mode enable for channel3. Note: It is recommended to use match
      --  channel 3 to set the PWM cycle.
      PWMEN3        : PWMC_PWMEN3_Field := Interfaces.NXP.CTIMER.Match;
      --  unspecified
   ...
   --  Match Shadow Register
   type MSR_Registers is array (0 .. 3) of Interfaces.Bit_Types.Word
     with Volatile;
   ...
   type CTIMER_Peripheral is record
      ...
      --  Timer Counter
      TC   : aliased Interfaces.Bit_Types.Word;
      --  Prescale Register
      PR   : aliased Interfaces.Bit_Types.Word;
      --  Prescale Counter
      PC   : aliased Interfaces.Bit_Types.Word;
      --  Match Control Register
