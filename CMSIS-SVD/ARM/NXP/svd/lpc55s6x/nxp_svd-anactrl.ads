...
--  available).
      Noclkout,
      --  Clock is present (12 MHz, 48 MHz or 96 MHz can be output if they are enable
--  respectively by FRO192M_CTRL.ENA_12MHZCLK/ENA_48MHZCLK/ENA_96MHZCLK).
      Clkout)
     with Size => 1;
   ...
   ANACTRL_Periph : aliased ANACTRL_Peripheral
     with Import, Address => ANACTRL_Base;
