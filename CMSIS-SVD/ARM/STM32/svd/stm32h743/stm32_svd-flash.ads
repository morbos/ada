...
package STM32_SVD.Flash is
   ...
   subtype CRCSADD1R_CRC_START_ADDR_Field is HAL.UInt18;
   ...
   subtype CRCEADD1R_CRC_END_ADDR_Field is HAL.UInt18;
   ...
   subtype CRCSADD2R_CRC_START_ADDR_Field is HAL.UInt18;
   ...
   subtype CRCEADD2R_CRC_END_ADDR_Field is HAL.UInt18;
