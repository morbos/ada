...
package STM32_SVD.GPDMA is
   ...
   subtype LBAR_CH_LBA_Field is HAL.UInt16;

   --  GPDMA channel x linked-list base address register
   type LBAR_CH_Register is record
      --  unspecified
      Reserved_0_15 : HAL.UInt16 := 16#0#;
      --  linked-list base address of GPDMA channel x
      LBA           : LBAR_CH_LBA_Field := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;

   for LBAR_CH_Register use record
      Reserved_0_15 at 0 range 0 .. 15;
      LBA           at 0 range 16 .. 31;
   end record;

   --  GPDMA channel x flag clear register
   type FCR_CH_Register is record
      --  unspecified
   ...
   for FCR_CH_Register use record
   ...
   subtype SR_CH_FIFOL_Field is HAL.UInt8;

   --  GPDMA channel x status register
   type SR_CH_Register is record
   ...
   subtype CR_CH_PRIO_Field is HAL.UInt2;

   --  GPDMA channel x control register
   type CR_CH_Register is record
   ...
   subtype TR1_CH_SDW_LOG2_Field is HAL.UInt2;
   subtype TR1_CH_SBL_1_Field is HAL.UInt6;
   subtype TR1_CH_PAM_Field is HAL.UInt2;
   subtype TR1_CH_DDW_LOG2_Field is HAL.UInt2;
   subtype TR1_CH_DBL_1_Field is HAL.UInt6;

   --  GPDMA channel x transfer register 1
   type TR1_CH_Register is record
      ...
      --  transfer is issued.
      SDW_LOG2       : TR1_CH_SDW_LOG2_Field := 16#0#;
      --  unspecified
      ...
      --  transfer is issued.
      DDW_LOG2       : TR1_CH_DDW_LOG2_Field := 16#0#;
      --  unspecified
   ...
   for TR1_CH_Register use record
   ...
   subtype TR2_CH_REQSEL_Field is HAL.UInt7;
   subtype TR2_CH_TRIGM_Field is HAL.UInt2;
   subtype TR2_CH_TRIGSEL_Field is HAL.UInt6;
   subtype TR2_CH_TRIGPOL_Field is HAL.UInt2;
   subtype TR2_CH_TCEM_Field is HAL.UInt2;

   --  GPDMA channel x transfer register 2
   type TR2_CH_Register is record
      ...
      REQSEL         : TR2_CH_REQSEL_Field := 16#0#;
      --  unspecified
      ...
      TCEM           : TR2_CH_TCEM_Field := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;

   for TR2_CH_Register use record
   ...
   subtype BR1_CH_BNDT_Field is HAL.UInt16;

   --  GPDMA channel x block register 1
   type BR1_CH_Register is record
   ...
   for BR1_CH_Register use record
      BNDT           at 0 range 0 .. 15;
      Reserved_16_31 at 0 range 16 .. 31;
   end record;

   subtype LLR_CH_LA_Field is HAL.UInt14;

   --  GPDMA channel x linked-list address register
   type LLR_CH_Register is record
      --  unspecified
   ...
   for LLR_CH_Register use record
   ...
   type CH_Cluster is record
      --  GPDMA channel x linked-list base address register
      LBAR : aliased LBAR_CH_Register;
      --  GPDMA channel x flag clear register
      FCR  : aliased FCR_CH_Register;
      --  GPDMA channel x status register
      SR   : aliased SR_CH_Register;
      --  GPDMA channel x control register
      CR   : aliased CR_CH_Register;
      --  GPDMA channel x transfer register 1
      TR1  : aliased TR1_CH_Register;
      --  GPDMA channel x transfer register 2
      TR2  : aliased TR2_CH_Register;
      --  GPDMA channel x block register 1
      BR1  : aliased BR1_CH_Register;
   ...
   type CH_Clusters is array (0 .. 15) of CH_Cluster;
