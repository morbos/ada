--  This spec has been automatically generated from STM32U585_opt.svd
...
package STM32_SVD.RCC is
   ...
   subtype RCC_ICSCR1_MSICAL3_Field is HAL.UInt5;
   subtype RCC_ICSCR1_MSICAL2_Field is HAL.UInt5;
   subtype RCC_ICSCR1_MSICAL1_Field is HAL.UInt5;
   subtype RCC_ICSCR1_MSICAL0_Field is HAL.UInt5;
   subtype RCC_ICSCR1_MSIKRANGE_Field is HAL.UInt4;
   subtype RCC_ICSCR1_MSISRANGE_Field is HAL.UInt4;
   ...
   subtype RCC_ICSCR2_MSITRIM3_Field is HAL.UInt5;
   subtype RCC_ICSCR2_MSITRIM2_Field is HAL.UInt5;
   subtype RCC_ICSCR2_MSITRIM1_Field is HAL.UInt5;
   subtype RCC_ICSCR2_MSITRIM0_Field is HAL.UInt5;
   ...
   subtype RCC_ICSCR3_HSICAL_Field is HAL.UInt12;
   subtype RCC_ICSCR3_HSITRIM_Field is HAL.UInt5;
   ...
   subtype RCC_CFGR1_SW_Field is HAL.UInt2;
   subtype RCC_CFGR1_SWS_Field is HAL.UInt2;
   subtype RCC_CFGR1_MCOSEL_Field is HAL.UInt4;
   subtype RCC_CFGR1_MCOPRE_Field is HAL.UInt3;
   ...
   subtype RCC_CFGR2_HPRE_Field is HAL.UInt4;
   ...
   subtype RCC_CFGR3_PPRE3_Field is HAL.UInt3;
   ...
   subtype RCC_PLL1CFGR_PLL1SRC_Field is HAL.UInt2;
   subtype RCC_PLL1CFGR_PLL1RGE_Field is HAL.UInt2;
   subtype RCC_PLL1CFGR_PLL1M_Field is HAL.UInt4;
   subtype RCC_PLL1CFGR_PLL1MBOOST_Field is HAL.UInt4;
   ...
   subtype RCC_PLL2CFGR_PLL2SRC_Field is HAL.UInt2;
   subtype RCC_PLL2CFGR_PLL2RGE_Field is HAL.UInt2;
   subtype RCC_PLL2CFGR_PLL2M_Field is HAL.UInt4;
   ...
   subtype RCC_PLL3CFGR_PLL3SRC_Field is HAL.UInt2;
   subtype RCC_PLL3CFGR_PLL3RGE_Field is HAL.UInt2;
   subtype RCC_PLL3CFGR_PLL3M_Field is HAL.UInt4;
   ...
   subtype RCC_PLL1DIVR_PLL1N_Field is HAL.UInt9;
   subtype RCC_PLL1DIVR_PLL1P_Field is HAL.UInt7;
   subtype RCC_PLL1DIVR_PLL1Q_Field is HAL.UInt7;
   subtype RCC_PLL1DIVR_PLL1R_Field is HAL.UInt7;
   ...
   subtype RCC_PLL1FRACR_PLL1FRACN_Field is HAL.UInt13;
   ...
   subtype RCC_PLL2DIVR_PLL2N_Field is HAL.UInt9;
   subtype RCC_PLL2DIVR_PLL2P_Field is HAL.UInt7;
   subtype RCC_PLL2DIVR_PLL2Q_Field is HAL.UInt7;
   subtype RCC_PLL2DIVR_PLL2R_Field is HAL.UInt7;
   ...
   subtype RCC_PLL2FRACR_PLL2FRACN_Field is HAL.UInt13;
   ...
   subtype RCC_PLL3DIVR_PLL3N_Field is HAL.UInt9;
   subtype RCC_PLL3DIVR_PLL3P_Field is HAL.UInt7;
   subtype RCC_PLL3DIVR_PLL3Q_Field is HAL.UInt7;
   subtype RCC_PLL3DIVR_PLL3R_Field is HAL.UInt7;
   ...
   subtype RCC_PLL3FRACR_PLL3FRACN_Field is HAL.UInt13;
   ...
   type RCC_AHB3SMENR_Register is record
      ...
      --  unspecified
      Reserved_13_30 : HAL.UInt18 := 16#3FFFF#;
   ...
   type RCC_APB1SMENR1_Register is record
      ...
      --  unspecified
      Reserved_25_31 : HAL.UInt7 := 16#7F#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type RCC_APB2SMENR_Register is record
      --  unspecified
      Reserved_0_10  : HAL.UInt11 := 16#7FF#;
   ...
   subtype RCC_CCIPR1_USART1SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR1_USART2SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR1_USART3SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR1_UART4SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR1_UART5SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR1_I2C1SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR1_I2C2SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR1_I2C4SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR1_SPI2SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR1_LPTIM2SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR1_SPI1SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR1_SYSTICKSEL_Field is HAL.UInt2;
   subtype RCC_CCIPR1_FDCAN1SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR1_ICLKSEL_Field is HAL.UInt2;
   subtype RCC_CCIPR1_TIMICSEL_Field is HAL.UInt3;
   ...
   subtype RCC_CCIPR2_MDF1SEL_Field is HAL.UInt3;
   subtype RCC_CCIPR2_SAI1SEL_Field is HAL.UInt3;
   subtype RCC_CCIPR2_SAI2SEL_Field is HAL.UInt3;
   subtype RCC_CCIPR2_RNGSEL_Field is HAL.UInt2;
   subtype RCC_CCIPR2_OCTOSPISEL_Field is HAL.UInt2;
   ...
   subtype RCC_CCIPR3_LPUART1SEL_Field is HAL.UInt3;
   subtype RCC_CCIPR3_SPI3SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR3_I2C3SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR3_LPTIM34SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR3_LPTIM1SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR3_ADCDACSEL_Field is HAL.UInt3;
   subtype RCC_CCIPR3_ADF1SEL_Field is HAL.UInt3;
   ...
   subtype RCC_BDCR_RTCSEL_Field is HAL.UInt2;
   ...
   subtype RCC_CSR_MSIKSRANGE_Field is HAL.UInt4;
   subtype RCC_CSR_MSISSRANGE_Field is HAL.UInt4;
