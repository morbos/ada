...
package STM32_SVD.TIM11_S is
   ...
   subtype TIM11_CR1_CKD_Field is HAL.UInt2;
   ...
   subtype TIM11_CCMR1_Input_CC1S_Field is HAL.UInt2;
   subtype TIM11_CCMR1_Input_IC1PSC_Field is HAL.UInt2;
   subtype TIM11_CCMR1_Input_IC1F_Field is HAL.UInt4;
   ...
   subtype TIM11_CCMR1_Output_CC1S_Field is HAL.UInt2;
   subtype TIM11_CCMR1_Output_OC1M_Field is HAL.UInt3;
   ...
   subtype TIM11_CNT_CNT_Field is HAL.UInt16;
   ...
   subtype TIM11_ARR_ARR_Field is HAL.UInt20;
   ...
   subtype TIM11_CCR1_CCR1_Field is HAL.UInt20;
   ...
   subtype TIM11_TISEL_TI1SEL_Field is HAL.UInt4;
   ...
   type TIM11_S_Disc is
     (Input,
      Output);

   --  General-purpose timers
   type TIM11_S_Peripheral
     (Discriminent : TIM11_S_Disc := Input)
   is record
      --  TIM11 control register 1
   ...
   for TIM11_S_Peripheral use record
   ...
   --  General-purpose timers
   TIM11_S_Periph : aliased TIM11_S_Peripheral
     with Import, Address => TIM11_S_Base;

end STM32_SVD.TIM11_S;
