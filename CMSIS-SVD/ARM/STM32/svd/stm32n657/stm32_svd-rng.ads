...
package STM32_SVD.RNG is
   ...
   subtype CR_CONFIG3_Field is HAL.UInt4;
   subtype CR_CONFIG2_Field is HAL.UInt3;
   subtype CR_CLKDIV_Field is HAL.UInt4;
   subtype CR_CONFIG1_Field is HAL.UInt6;
   ...
   subtype NSCR_EN_OSC_Element is HAL.UInt3;
