...
package STM32_SVD.CACHEAXI is
   ...
   subtype CACHEAXI_CR2_CACHECMD_Field is HAL.UInt2;
   ...
   subtype CACHEAXI_CMDRSADDRR_CMDSTARTADDR_Field is HAL.UInt26;
   ...
   subtype CACHEAXI_CMDREADDRR_CMDENDADDR_Field is HAL.UInt26;
   ...
   type CACHEAXI_Peripheral is record
      ...
      CACHEAXI_RHMONR     : aliased HAL.UInt32;
      --  CACHEAXI read-miss monitor register
      CACHEAXI_RMMONR     : aliased HAL.UInt32;
      --  CACHEAXI read-allocate miss monitor register
      CACHEAXI_RAMMONR    : aliased HAL.UInt32;
      --  CACHEAXI eviction monitor register
      CACHEAXI_EVIMONR    : aliased HAL.UInt32;
      --  CACHEAXI write-hit monitor register
      CACHEAXI_WHMONR     : aliased HAL.UInt32;
      --  CACHEAXI write-miss monitor register
      CACHEAXI_WMMONR     : aliased HAL.UInt32;
      --  CACHEAXI write-allocate miss monitor register
      CACHEAXI_WAMMONR    : aliased HAL.UInt32;
      --  CACHEAXI write-through monitor register
      CACHEAXI_WTMONR     : aliased HAL.UInt32;
      --  CACHEAXI control register 2
