...
package STM32_SVD.DTS is
   ...
   subtype DTS_PVTTMR_CR_TMR_DELAY_Field is HAL.UInt16;
   ...
   subtype DTS_TSCCLKSYNTHR_CLK_SYNTH_LO_Field is HAL.UInt8;
   subtype DTS_TSCCLKSYNTHR_CLK_SYNTH_HI_Field is HAL.UInt8;
   subtype DTS_TSCCLKSYNTHR_CLK_SYNTH_HOLD_Field is HAL.UInt4;
   ...
   subtype DTS_TSCSDIF_CR_SDIF_WDATA_Field is HAL.UInt24;
   subtype DTS_TSCSDIF_CR_SDIF_ADDR_Field is HAL.UInt3;
   ...
   subtype DTS_TSCSDIF_CFGR_SDIF_INHIBIT_Field is HAL.UInt2;
   ...
   subtype DTS_TSCSMPLCNTR_SMPL_COUNT_Field is HAL.UInt16;
   ...
   subtype DTS_TS0SDIFRDATAR_SDIF_RDATA_Field is HAL.UInt24;
   ...
   subtype DTS_TS0SDIFDATAR_SAMPLE_DATA_Field is HAL.UInt16;
   ...
   subtype DTS_TS0ALARMA_CFGR_HYSTA_THRESH_Field is HAL.UInt16;
   subtype DTS_TS0ALARMA_CFGR_ALARMA_THRESH_Field is HAL.UInt16;
   ...
   subtype DTS_TS0ALARMB_CFGR_HYSTB_THRESH_Field is HAL.UInt16;
   subtype DTS_TS0ALARMB_CFGR_ALARMB_THRESH_Field is HAL.UInt16;
   ...
   subtype DTS_TS0HLSAMPLER_SMPL_LO_Field is HAL.UInt16;
   subtype DTS_TS0HLSAMPLER_SMPL_HI_Field is HAL.UInt16;
   ...
   subtype DTS_TS1SDIFRDATAR_SDIF_RDATA_Field is HAL.UInt24;
   ...
   subtype DTS_TS1SDIFDATAR_SAMPLE_DATA_Field is HAL.UInt16;
   ...
   subtype DTS_TS1ALARMA_CFGR_HYSTA_THRESH_Field is HAL.UInt16;
   subtype DTS_TS1ALARMA_CFGR_ALARMA_THRESH_Field is HAL.UInt16;
   ...
   subtype DTS_TS1ALARMB_CFGR_HYSTB_THRESH_Field is HAL.UInt16;
   subtype DTS_TS1ALARMB_CFGR_ALARMB_THRESH_Field is HAL.UInt16;
   ...
   subtype DTS_TS1HLSAMPLER_SMPL_LO_Field is HAL.UInt16;
   subtype DTS_TS1HLSAMPLER_SMPL_HI_Field is HAL.UInt16;
   ...
   type DTS_Peripheral is record
      ...
      DTS_PVTREG_LOCKR    : aliased HAL.UInt32;
      --  DTS PVT lock status register
