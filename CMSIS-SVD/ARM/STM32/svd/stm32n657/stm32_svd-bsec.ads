...
package STM32_SVD.BSEC is
   ...
   subtype BSEC_DBGCR_UNLOCK_Field is HAL.UInt8;
   subtype BSEC_DBGCR_AUTH_HDPL_Field is HAL.UInt8;
   subtype BSEC_DBGCR_AUTH_SEC_Field is HAL.UInt8;
   ...
   subtype BSEC_AP_UNLOCK_UNLOCK_Field is HAL.UInt8;
   ...
   subtype BSEC_HDPLSR_HDPL_Field is HAL.UInt8;
   ...
   subtype BSEC_NEXTLR_INCR_Field is HAL.UInt2;
   ...
   type BSEC_Peripheral is record
      ...
      --  BSEC epoch register
      BSEC_EPOCHR0    : aliased HAL.UInt32;
      --  BSEC epoch register
      BSEC_EPOCHR1    : aliased HAL.UInt32;
      --  BSEC epoch select register
      ...
      --  BSEC HDPL control
      BSEC_HDPLCR     : aliased HAL.UInt32;
      --  BSEC Next HDPL
