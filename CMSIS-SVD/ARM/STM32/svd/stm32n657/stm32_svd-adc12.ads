...
package STM32_SVD.ADC12 is
   ...
   subtype ADC12_CCR_DUAL_Field is HAL.UInt5;
   subtype ADC12_CCR_DELAY_Field is HAL.UInt4;
   subtype ADC12_CCR_DAMDF_Field is HAL.UInt2;
   ...
   subtype ADC12_CDR_RDATA_MST_Field is HAL.UInt16;
   subtype ADC12_CDR_RDATA_SLV_Field is HAL.UInt16;
