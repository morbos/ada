...
package STM32_SVD.UCPD is
   ...
   subtype UCPD_CFGR3_TRIM_CC1_RD_Field is HAL.UInt4;
   subtype UCPD_CFGR3_TRIM_CC1_RP_Field is HAL.UInt4;
   subtype UCPD_CFGR3_TRIM_CC2_RD_Field is HAL.UInt4;
   subtype UCPD_CFGR3_TRIM_CC2_RP_Field is HAL.UInt4;
   ...
   subtype UCPD_VERR_MINREV_Field is HAL.UInt4;
   subtype UCPD_VERR_MAJREV_Field is HAL.UInt4;
   ...
   type UCPD_Peripheral is record
      ...
      UCPD_IPIDR       : aliased HAL.UInt32;
      --  UCPD size identification register
      UCPD_SIDR        : aliased HAL.UInt32;
   end record
     with Volatile;
