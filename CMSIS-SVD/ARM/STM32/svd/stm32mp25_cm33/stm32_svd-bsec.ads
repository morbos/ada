...
package STM32_SVD.BSEC is
   ...
   subtype BSEC_OTPCR_ADDR_Field is HAL.UInt9;
   subtype BSEC_OTPCR_LASTCID_Field is HAL.UInt3;
   ...
   type BSEC_LOCKR_Register is record
      ...
      --  Debug enable register sticky lock
      DENLOCK       : Boolean := False;
      --  Hardware key lock
   ...
   for BSEC_LOCKR_Register use record
      ...
      DENLOCK       at 0 range 1 .. 1;
      HKLOCK        at 0 range 2 .. 2;
      Reserved_3_31 at 0 range 3 .. 31;
   end record;

   subtype BSEC_DENR_CP15SDIS_Field is HAL.UInt2;

   --  BSEC debug enable register
   type BSEC_DENR_Register is record
      --  unspecified
      Reserved_0_0   : HAL.Bit := 16#0#;
      --  Debug enable for Cortex-A
      DBGENA         : Boolean := False;
      --  Non invasive debug enable for Cortex-A
      NIDENA         : Boolean := False;
      --  Device debug enable
      DEVICEEN       : Boolean := False;
      --  Hardware debug port enable
      HDPEN          : Boolean := False;
      --  Secure privilege invasive debug enable for Cortex-A
      SPIDENA        : Boolean := False;
      --  Secure privilege non-invasive debug enable for Cortex-A
      SPNIDENA       : Boolean := False;
      --  Self-hosted debug enable
      DBGSWEN        : Boolean := False;
      --  Debug enable for Cortex-M
      DBGENM         : Boolean := False;
      --  Non invasive debug enable for Cortex-M
      NIDENM         : Boolean := False;
      --  Secure privilege invasive debug enable for Cortex-M
      SPIDENM        : Boolean := False;
      --  Secure privilege non-invasive debug enable for Cortex-M
      SPNIDENM       : Boolean := False;
      --  CFGSDISABLE
      CFGSDIS        : Boolean := False;
      --  CP15SDISABLE for core x (x = 0 or 1)
      CP15SDIS       : BSEC_DENR_CP15SDIS_Field := 16#0#;
      --  unspecified
   ...
   for BSEC_DENR_Register use record
      Reserved_0_0   at 0 range 0 .. 0;
      DBGENA         at 0 range 1 .. 1;
      NIDENA         at 0 range 2 .. 2;
      DEVICEEN       at 0 range 3 .. 3;
      HDPEN          at 0 range 4 .. 4;
      SPIDENA        at 0 range 5 .. 5;
      SPNIDENA       at 0 range 6 .. 6;
      DBGSWEN        at 0 range 7 .. 7;
      DBGENM         at 0 range 8 .. 8;
      NIDENM         at 0 range 9 .. 9;
      SPIDENM        at 0 range 10 .. 10;
      SPNIDENM       at 0 range 11 .. 11;
      CFGSDIS        at 0 range 12 .. 12;
      CP15SDIS       at 0 range 13 .. 14;
      Reserved_15_31 at 0 range 15 .. 31;
   end record;

   subtype BSEC_SR_NVSTATE_Field is HAL.UInt6;
   ...
   subtype BSEC_VERR_MINREV_Field is HAL.UInt4;
   subtype BSEC_VERR_MAJREV_Field is HAL.UInt4;

   --  BSEC version register
   type BSEC_VERR_Register is record
      --  Read-only. Minor revision
      MINREV        : BSEC_VERR_MINREV_Field;
      --  Read-only. Major revision
      MAJREV        : BSEC_VERR_MAJREV_Field;
      --  unspecified
   ...
   for BSEC_VERR_Register use record
   ...
   type BSEC_Peripheral is record
      ...
      BSEC_WDR       : aliased HAL.UInt32;
      --  BSEC scratch register 0
      BSEC_SCRATCHR0 : aliased HAL.UInt32;
      --  BSEC scratch register 1
      BSEC_SCRATCHR1 : aliased HAL.UInt32;
      --  BSEC scratch register 2
      BSEC_SCRATCHR2 : aliased HAL.UInt32;
      --  BSEC scratch register 3
      BSEC_SCRATCHR3 : aliased HAL.UInt32;
      --  BSEC lock register
      BSEC_LOCKR     : aliased BSEC_LOCKR_Register;
      --  BSEC JTAG input register
      BSEC_JTAGINR   : aliased HAL.UInt32;
      --  BSEC JTAG output register
      BSEC_JTAGOUTR  : aliased HAL.UInt32;
      --  BSEC debug enable register
      BSEC_DENR      : aliased BSEC_DENR_Register;
      --  BSEC unmap register
      BSEC_UNMAPR    : aliased HAL.UInt32;
      --  BSEC status register
      BSEC_SR        : aliased BSEC_SR_Register;
      --  BSEC OTP status register
      BSEC_OTPSR     : aliased BSEC_OTPSR_Register;
      --  BSEC write once scratch register 0
      BSEC_WOSCR0    : aliased HAL.UInt32;
      --  BSEC write once scratch register 1
      BSEC_WOSCR1    : aliased HAL.UInt32;
      --  BSEC write once scratch register 2
      BSEC_WOSCR2    : aliased HAL.UInt32;
      --  BSEC write once scratch register 3
      BSEC_WOSCR3    : aliased HAL.UInt32;
      --  BSEC write once scratch register 4
      BSEC_WOSCR4    : aliased HAL.UInt32;
      --  BSEC write once scratch register 5
      BSEC_WOSCR5    : aliased HAL.UInt32;
      --  BSEC write once scratch register 6
      BSEC_WOSCR6    : aliased HAL.UInt32;
      --  BSEC write once scratch register 7
      BSEC_WOSCR7    : aliased HAL.UInt32;
      --  BSEC hot reset count register
      BSEC_HRCR      : aliased HAL.UInt32;
      --  BSEC warm reset count register
      BSEC_WRCR      : aliased HAL.UInt32;
      --  BSEC version register
      BSEC_VERR      : aliased BSEC_VERR_Register;
      --  BSEC identification register
      BSEC_IPIDR     : aliased HAL.UInt32;
      --  BSEC size identification register
      BSEC_SIDR      : aliased HAL.UInt32;
   end record
     with Volatile;
   ...
   for BSEC_Peripheral use record
      ...
      BSEC_DENR      at 16#E20# range 0 .. 31;
      ...
      BSEC_VERR      at 16#FF4# range 0 .. 31;
      BSEC_IPIDR     at 16#FF8# range 0 .. 31;
      BSEC_SIDR      at 16#FFC# range 0 .. 31;
   end record;
