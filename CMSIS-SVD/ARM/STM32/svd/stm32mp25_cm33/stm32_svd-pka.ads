...
package STM32_SVD.PKA is
   ...
   subtype PKA_HWCFGR_CFG_Element is HAL.UInt4;
   ...
   subtype PKA_VERR_MINREV_Field is HAL.UInt4;
   subtype PKA_VERR_MAJREV_Field is HAL.UInt4;
   ...
   type PKA_Peripheral is record
      ...
      PKA_IPIDR  : aliased HAL.UInt32;
      --  PKA size identification register
      PKA_SIDR   : aliased HAL.UInt32;
   end record
     with Volatile;
