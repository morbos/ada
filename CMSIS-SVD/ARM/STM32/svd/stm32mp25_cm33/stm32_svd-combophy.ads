...
package STM32_SVD.COMBOPHY is
   ...
   subtype COMBOPHY_MPLL_LOOP_CTL_CR_INT_CNTRL_Field is HAL.UInt2;
   subtype COMBOPHY_MPLL_LOOP_CTL_CR_PROP_CNTRL_Field is HAL.UInt4;
