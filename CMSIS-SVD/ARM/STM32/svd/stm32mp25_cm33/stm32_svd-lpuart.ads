...
package STM32_SVD.LPUART is
   ...
   subtype LPUART_CR1_ALTERNATE1_DEDT_Field is HAL.UInt5;
   subtype LPUART_CR1_ALTERNATE1_DEAT_Field is HAL.UInt5;
   ...
   subtype LPUART_AUTOCR_TDN_Field is HAL.UInt16;
   subtype LPUART_AUTOCR_TRIGSEL_Field is HAL.UInt4;
   ...
   subtype LPUART_HWCFGR2_CFG_Element is HAL.UInt4;
   ...
   subtype LPUART_HWCFGR1_CFG_Element is HAL.UInt4;
   ...
   subtype LPUART_VERR_MINREV_Field is HAL.UInt4;
   subtype LPUART_VERR_MAJREV_Field is HAL.UInt4;
   ...
   is record
      ...
      LPUART_IPIDR          : aliased HAL.UInt32;
      --  LPUART size identification register
      LPUART_SIDR           : aliased HAL.UInt32;
