...
package STM32_SVD.USBH is
   ...
   subtype USBH_EHCI_INSNREG01_IN_THRESHOLD_Field is HAL.UInt8;
   subtype USBH_EHCI_INSNREG01_OUT_THRESHOLD_Field is HAL.UInt8;
   ...
   subtype USBH_OHCI_INSNREG06_SUC_BEATS_Field is HAL.UInt4;
   subtype USBH_OHCI_INSNREG06_EXP_BEATS_Field is HAL.UInt5;
   subtype USBH_OHCI_INSNREG06_HBURST_Field is HAL.UInt3;
   ...
   subtype USBH_EHCI_INSNREG02_PKT_BUF_Field is HAL.UInt8;
   ...
   subtype USBH_EHCI_INSNREG03_TIME_AVAIL_OFF_Field is HAL.UInt8;
   subtype USBH_EHCI_INSNREG03_TX_TRA_DELAY_Field is HAL.UInt3;
   ...
   subtype USBH_EHCI_INSNREG05_VSTATUS_Field is HAL.UInt8;
   subtype USBH_EHCI_INSNREG05_VCONTROL_Field is HAL.UInt4;
   subtype USBH_EHCI_INSNREG05_VPORT_Field is HAL.UInt4;
   ...
   subtype USBH_EHCI_INSNREG06_SUC_BEATS_Field is HAL.UInt4;
   subtype USBH_EHCI_INSNREG06_EXP_BEATS_Field is HAL.UInt5;
   subtype USBH_EHCI_INSNREG06_HBURST_Field is HAL.UInt3;
   ...
   is record
      ...
      USBH_EHCI_INSNREG07 : aliased HAL.UInt32;
      case Discriminent is
         ...
         when Ohci_Insnreg07 =>
            ...
            USBH_OHCI_INSNREG07 : aliased HAL.UInt32;
         when Ehci_Insnreg03 =>
            --  USBH EHCI implementation register #3
