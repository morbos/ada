...
package STM32_SVD.DDRCTRL is
   ...
   subtype DDRCTRL_REGS_MSTR_DATA_BUS_WIDTH_Field is HAL.UInt2;
   subtype DDRCTRL_REGS_MSTR_BURST_RDWR_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_MSTR_ACTIVE_RANKS_Field is HAL.UInt2;
   subtype DDRCTRL_REGS_MSTR_DEVICE_CONFIG_Field is HAL.UInt2;
   ...
   subtype DDRCTRL_REGS_STAT_OPERATING_MODE_Field is HAL.UInt3;
   subtype DDRCTRL_REGS_STAT_SELFREF_TYPE_Field is HAL.UInt2;
   subtype DDRCTRL_REGS_STAT_SELFREF_STATE_Field is HAL.UInt2;
   ...
   subtype DDRCTRL_REGS_MRCTRL0_MR_RANK_Field is HAL.UInt2;
   subtype DDRCTRL_REGS_MRCTRL0_MR_ADDR_Field is HAL.UInt4;
   ...
   subtype DDRCTRL_REGS_MRCTRL1_MR_DATA_Field is HAL.UInt18;
   ...
   subtype DDRCTRL_REGS_DERATEEN_DERATE_VALUE_Field is HAL.UInt2;
   subtype DDRCTRL_REGS_DERATEEN_DERATE_BYTE_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_DERATEEN_RC_DERATE_VALUE_Field is HAL.UInt3;
   ...
   subtype DDRCTRL_REGS_PWRTMG_POWERDOWN_TO_X32_Field is HAL.UInt5;
   subtype DDRCTRL_REGS_PWRTMG_SELFREF_TO_X32_Field is HAL.UInt8;
   ...
   type DDRCTRL_REGS_PWRTMG_Register is record
      ...
      --  unspecified
      Reserved_5_15    : HAL.UInt11 := 16#100#;
   ...
   subtype DDRCTRL_REGS_HWLPCTL_HW_LP_IDLE_X32_Field is HAL.UInt12;
   ...
   subtype DDRCTRL_REGS_RFSHCTL0_AUTO_REFAB_EN_Field is HAL.UInt2;
   subtype DDRCTRL_REGS_RFSHCTL0_REFRESH_BURST_Field is HAL.UInt6;
   subtype DDRCTRL_REGS_RFSHCTL0_REFRESH_TO_X1_X32_Field is HAL.UInt5;
   subtype DDRCTRL_REGS_RFSHCTL0_REFRESH_MARGIN_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_RFSHCTL0_REFRESH_TO_AB_X32_Field is HAL.UInt5;
   ...
   subtype DDRCTRL_REGS_RFSHCTL3_REFRESH_MODE_Field is HAL.UInt3;
   ...
   subtype DDRCTRL_REGS_RFSHTMG_T_RFC_MIN_Field is HAL.UInt10;
   subtype DDRCTRL_REGS_RFSHTMG_T_RFC_NOM_X1_X32_Field is HAL.UInt12;
   ...
   subtype DDRCTRL_REGS_RFSHTMG1_T_PBR2PBR_Field is HAL.UInt8;
   ...
   subtype DDRCTRL_REGS_INIT0_PRE_CKE_X1024_Field is HAL.UInt12;
   subtype DDRCTRL_REGS_INIT0_POST_CKE_X1024_Field is HAL.UInt10;
   subtype DDRCTRL_REGS_INIT0_SKIP_DRAM_INIT_Field is HAL.UInt2;
   ...
   subtype DDRCTRL_REGS_INIT1_PRE_OCD_X32_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_INIT1_DRAM_RSTN_X1024_Field is HAL.UInt9;
   ...
   subtype DDRCTRL_REGS_INIT3_EMR_Field is HAL.UInt16;
   subtype DDRCTRL_REGS_INIT3_MR_Field is HAL.UInt16;
   ...
   subtype DDRCTRL_REGS_INIT4_EMR3_Field is HAL.UInt16;
   subtype DDRCTRL_REGS_INIT4_EMR2_Field is HAL.UInt16;
   ...
   subtype DDRCTRL_REGS_INIT5_DEV_ZQINIT_X32_Field is HAL.UInt8;

   --  DDRCTRL SDRAM initialization 5 register
   type DDRCTRL_REGS_INIT5_Register is record
      --  unspecified
      Reserved_0_15  : HAL.UInt16 := 16#4#;
   ...
   subtype DDRCTRL_REGS_INIT6_MR5_Field is HAL.UInt16;
   subtype DDRCTRL_REGS_INIT6_MR4_Field is HAL.UInt16;
   ...
   subtype DDRCTRL_REGS_INIT7_MR_Element is HAL.UInt16;
   ...
   subtype DDRCTRL_REGS_RANKCTL_MAX_RANK_RD_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_RANKCTL_DIFF_RANK_RD_GAP_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_RANKCTL_DIFF_RANK_WR_GAP_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_RANKCTL_MAX_RANK_WR_Field is HAL.UInt4;
   ...
   subtype DDRCTRL_REGS_RANKCTL1_WR2RD_DR_Field is HAL.UInt6;
   ...
   subtype DDRCTRL_REGS_DRAMTMG0_T_RAS_MIN_Field is HAL.UInt6;
   subtype DDRCTRL_REGS_DRAMTMG0_T_RAS_MAX_Field is HAL.UInt7;
   subtype DDRCTRL_REGS_DRAMTMG0_T_FAW_Field is HAL.UInt6;
   subtype DDRCTRL_REGS_DRAMTMG0_WR2PRE_Field is HAL.UInt7;
   ...
   subtype DDRCTRL_REGS_DRAMTMG1_T_RC_Field is HAL.UInt7;
   subtype DDRCTRL_REGS_DRAMTMG1_RD2PRE_Field is HAL.UInt6;
   subtype DDRCTRL_REGS_DRAMTMG1_T_XP_Field is HAL.UInt5;
   ...
   subtype DDRCTRL_REGS_DRAMTMG2_WR2RD_Field is HAL.UInt6;
   subtype DDRCTRL_REGS_DRAMTMG2_RD2WR_Field is HAL.UInt6;
   subtype DDRCTRL_REGS_DRAMTMG2_READ_LATENCY_Field is HAL.UInt6;
   subtype DDRCTRL_REGS_DRAMTMG2_WRITE_LATENCY_Field is HAL.UInt6;
   ...
   subtype DDRCTRL_REGS_DRAMTMG3_T_MOD_Field is HAL.UInt10;
   subtype DDRCTRL_REGS_DRAMTMG3_T_MRD_Field is HAL.UInt6;
   subtype DDRCTRL_REGS_DRAMTMG3_T_MRW_Field is HAL.UInt10;
   ...
   subtype DDRCTRL_REGS_DRAMTMG4_T_RP_Field is HAL.UInt5;
   subtype DDRCTRL_REGS_DRAMTMG4_T_RRD_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_DRAMTMG4_T_CCD_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_DRAMTMG4_T_RCD_Field is HAL.UInt5;
   ...
   subtype DDRCTRL_REGS_DRAMTMG5_T_CKE_Field is HAL.UInt5;
   subtype DDRCTRL_REGS_DRAMTMG5_T_CKESR_Field is HAL.UInt6;
   subtype DDRCTRL_REGS_DRAMTMG5_T_CKSRE_Field is HAL.UInt7;
   subtype DDRCTRL_REGS_DRAMTMG5_T_CKSRX_Field is HAL.UInt4;
   ...
   subtype DDRCTRL_REGS_DRAMTMG6_T_CKCSX_Field is HAL.UInt4;
   ...
   type DDRCTRL_REGS_DRAMTMG6_Register is record
      ...
      --  unspecified
      Reserved_4_31 : HAL.UInt28 := 16#202000#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype DDRCTRL_REGS_DRAMTMG7_T_CKPDX_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_DRAMTMG7_T_CKPDE_Field is HAL.UInt4;
   ...
   subtype DDRCTRL_REGS_DRAMTMG8_T_XS_X32_Field is HAL.UInt7;
   subtype DDRCTRL_REGS_DRAMTMG8_T_XS_DLL_X32_Field is HAL.UInt7;
   subtype DDRCTRL_REGS_DRAMTMG8_T_XS_ABORT_X32_Field is HAL.UInt7;
   subtype DDRCTRL_REGS_DRAMTMG8_T_XS_FAST_X32_Field is HAL.UInt7;
   ...
   subtype DDRCTRL_REGS_DRAMTMG9_WR2RD_S_Field is HAL.UInt6;
   subtype DDRCTRL_REGS_DRAMTMG9_T_RRD_S_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_DRAMTMG9_T_CCD_S_Field is HAL.UInt3;
   ...
   subtype DDRCTRL_REGS_DRAMTMG10_T_GEAR_HOLD_Field is HAL.UInt2;
   subtype DDRCTRL_REGS_DRAMTMG10_T_GEAR_SETUP_Field is HAL.UInt2;
   subtype DDRCTRL_REGS_DRAMTMG10_T_CMD_GEAR_Field is HAL.UInt5;
   subtype DDRCTRL_REGS_DRAMTMG10_T_SYNC_GEAR_Field is HAL.UInt5;
   ...
   subtype DDRCTRL_REGS_DRAMTMG11_T_CKMPE_Field is HAL.UInt5;
   subtype DDRCTRL_REGS_DRAMTMG11_T_MPX_S_Field is HAL.UInt2;
   subtype DDRCTRL_REGS_DRAMTMG11_T_MPX_LH_Field is HAL.UInt5;
   subtype DDRCTRL_REGS_DRAMTMG11_POST_MPSM_GAP_X32_Field is HAL.UInt7;
   ...
   subtype DDRCTRL_REGS_DRAMTMG12_T_MRD_PDA_Field is HAL.UInt5;
   subtype DDRCTRL_REGS_DRAMTMG12_T_CMDCKE_Field is HAL.UInt2;
   subtype DDRCTRL_REGS_DRAMTMG12_T_WR_MPR_Field is HAL.UInt6;
   ...
   subtype DDRCTRL_REGS_DRAMTMG13_T_PPD_Field is HAL.UInt3;
   subtype DDRCTRL_REGS_DRAMTMG13_T_CCD_MW_Field is HAL.UInt6;
   subtype DDRCTRL_REGS_DRAMTMG13_ODTLOFF_Field is HAL.UInt7;
   ...
   subtype DDRCTRL_REGS_DRAMTMG14_T_XSR_Field is HAL.UInt12;
   ...
   subtype DDRCTRL_REGS_DRAMTMG15_T_STAB_X32_Field is HAL.UInt8;
   ...
   subtype DDRCTRL_REGS_ZQCTL0_T_ZQ_SHORT_NOP_Field is HAL.UInt10;
   subtype DDRCTRL_REGS_ZQCTL0_T_ZQ_LONG_NOP_Field is HAL.UInt11;
   ...
   subtype DDRCTRL_REGS_ZQCTL1_T_ZQ_SHORT_INTERVAL_X1024_Field is HAL.UInt20;
   subtype DDRCTRL_REGS_ZQCTL1_T_ZQ_RESET_NOP_Field is HAL.UInt10;
   ...
   subtype DDRCTRL_REGS_DFITMG0_DFI_TPHY_WRLAT_Field is HAL.UInt6;
   subtype DDRCTRL_REGS_DFITMG0_DFI_TPHY_WRDATA_Field is HAL.UInt6;
   subtype DDRCTRL_REGS_DFITMG0_DFI_T_RDDATA_EN_Field is HAL.UInt7;
   subtype DDRCTRL_REGS_DFITMG0_DFI_T_CTRL_DELAY_Field is HAL.UInt5;
   ...
   subtype DDRCTRL_REGS_DFITMG1_DFI_T_DRAM_CLK_ENABLE_Field is HAL.UInt5;
   subtype DDRCTRL_REGS_DFITMG1_DFI_T_DRAM_CLK_DISABLE_Field is HAL.UInt5;
   subtype DDRCTRL_REGS_DFITMG1_DFI_T_WRDATA_DELAY_Field is HAL.UInt5;
   subtype DDRCTRL_REGS_DFITMG1_DFI_T_CMD_LAT_Field is HAL.UInt4;
   ...
   subtype DDRCTRL_REGS_DFILPCFG0_DFI_LP_WAKEUP_PD_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_DFILPCFG0_DFI_LP_WAKEUP_SR_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_DFILPCFG0_DFI_TLP_RESP_Field is HAL.UInt5;
   ...
   subtype DDRCTRL_REGS_DFIUPD0_DFI_T_CTRLUP_MIN_Field is HAL.UInt10;
   subtype DDRCTRL_REGS_DFIUPD0_DFI_T_CTRLUP_MAX_Field is HAL.UInt10;
   ...
   subtype DDRCTRL_REGS_DFIMISC_DFI_FREQUENCY_Field is HAL.UInt5;
   ...
   subtype DDRCTRL_REGS_DFITMG2_DFI_TPHY_WRCSLAT_Field is HAL.UInt6;
   subtype DDRCTRL_REGS_DFITMG2_DFI_TPHY_RDCSLAT_Field is HAL.UInt7;
   ...
   subtype DDRCTRL_REGS_DFITMG3_DFI_T_GEARDOWN_DELAY_Field is HAL.UInt5;
   ...
   subtype DDRCTRL_REGS_DFIPHYMSTR_DFI_PHYMSTR_BLK_REF_X32_Field is HAL.UInt8;
   ...
   subtype DDRCTRL_REGS_ADDRMAP0_ADDRMAP_CS_BIT0_Field is HAL.UInt5;
   ...
   subtype DDRCTRL_REGS_ADDRMAP1_ADDRMAP_BANK_B0_Field is HAL.UInt6;
   subtype DDRCTRL_REGS_ADDRMAP1_ADDRMAP_BANK_B1_Field is HAL.UInt6;
   subtype DDRCTRL_REGS_ADDRMAP1_ADDRMAP_BANK_B2_Field is HAL.UInt6;
   ...
   subtype DDRCTRL_REGS_ADDRMAP2_ADDRMAP_COL_B2_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_ADDRMAP2_ADDRMAP_COL_B3_Field is HAL.UInt5;
   subtype DDRCTRL_REGS_ADDRMAP2_ADDRMAP_COL_B4_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_ADDRMAP2_ADDRMAP_COL_B5_Field is HAL.UInt4;
   ...
   subtype DDRCTRL_REGS_ADDRMAP3_ADDRMAP_COL_B6_Field is HAL.UInt5;
   subtype DDRCTRL_REGS_ADDRMAP3_ADDRMAP_COL_B7_Field is HAL.UInt5;
   subtype DDRCTRL_REGS_ADDRMAP3_ADDRMAP_COL_B8_Field is HAL.UInt5;
   subtype DDRCTRL_REGS_ADDRMAP3_ADDRMAP_COL_B9_Field is HAL.UInt5;
   ...
   subtype DDRCTRL_REGS_ADDRMAP4_ADDRMAP_COL_B10_Field is HAL.UInt5;
   subtype DDRCTRL_REGS_ADDRMAP4_ADDRMAP_COL_B11_Field is HAL.UInt5;
   ...
   subtype DDRCTRL_REGS_ADDRMAP5_ADDRMAP_ROW_B0_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_ADDRMAP5_ADDRMAP_ROW_B1_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_ADDRMAP5_ADDRMAP_ROW_B2_10_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_ADDRMAP5_ADDRMAP_ROW_B11_Field is HAL.UInt4;
   ...
   subtype DDRCTRL_REGS_ADDRMAP6_ADDRMAP_ROW_B12_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_ADDRMAP6_ADDRMAP_ROW_B13_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_ADDRMAP6_ADDRMAP_ROW_B14_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_ADDRMAP6_ADDRMAP_ROW_B15_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_ADDRMAP6_LPDDR34_3GB_6GB_12GB_Field is HAL.UInt3;
   ...
   subtype DDRCTRL_REGS_ADDRMAP7_ADDRMAP_ROW_B16_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_ADDRMAP7_ADDRMAP_ROW_B17_Field is HAL.UInt4;
   ...
   subtype DDRCTRL_REGS_ADDRMAP8_ADDRMAP_BG_B0_Field is HAL.UInt6;
   subtype DDRCTRL_REGS_ADDRMAP8_ADDRMAP_BG_B1_Field is HAL.UInt6;
   ...
   subtype DDRCTRL_REGS_ADDRMAP9_ADDRMAP_ROW_B2_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_ADDRMAP9_ADDRMAP_ROW_B3_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_ADDRMAP9_ADDRMAP_ROW_B4_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_ADDRMAP9_ADDRMAP_ROW_B5_Field is HAL.UInt4;
   ...
   subtype DDRCTRL_REGS_ADDRMAP10_ADDRMAP_ROW_B6_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_ADDRMAP10_ADDRMAP_ROW_B7_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_ADDRMAP10_ADDRMAP_ROW_B8_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_ADDRMAP10_ADDRMAP_ROW_B9_Field is HAL.UInt4;
   ...
   subtype DDRCTRL_REGS_ADDRMAP11_ADDRMAP_ROW_B10_Field is HAL.UInt4;
   ...
   subtype DDRCTRL_REGS_ODTCFG_RD_ODT_DELAY_Field is HAL.UInt5;
   subtype DDRCTRL_REGS_ODTCFG_RD_ODT_HOLD_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_ODTCFG_WR_ODT_DELAY_Field is HAL.UInt5;
   subtype DDRCTRL_REGS_ODTCFG_WR_ODT_HOLD_Field is HAL.UInt4;
   ...
   subtype DDRCTRL_REGS_ODTMAP_RANK0_WR_ODT_Field is HAL.UInt2;
   subtype DDRCTRL_REGS_ODTMAP_RANK0_RD_ODT_Field is HAL.UInt2;
   subtype DDRCTRL_REGS_ODTMAP_RANK1_WR_ODT_Field is HAL.UInt2;
   subtype DDRCTRL_REGS_ODTMAP_RANK1_RD_ODT_Field is HAL.UInt2;
   ...
   subtype DDRCTRL_REGS_SCHED_LPR_NUM_ENTRIES_Field is HAL.UInt5;
   subtype DDRCTRL_REGS_SCHED_GO2CRITICAL_HYSTERESIS_Field is HAL.UInt8;
   subtype DDRCTRL_REGS_SCHED_RDWR_IDLE_GAP_Field is HAL.UInt7;
   ...
   subtype DDRCTRL_REGS_SCHED1_PAGECLOSE_TIMER_Field is HAL.UInt8;
   subtype DDRCTRL_REGS_SCHED1_DELAY_SWITCH_WRITE_Field is HAL.UInt4;
   subtype DDRCTRL_REGS_SCHED1_VISIBLE_WINDOW_LIMIT_WR_Field is HAL.UInt3;
   subtype DDRCTRL_REGS_SCHED1_VISIBLE_WINDOW_LIMIT_RD_Field is HAL.UInt3;
   subtype DDRCTRL_REGS_SCHED1_PAGE_HIT_LIMIT_WR_Field is HAL.UInt3;
   subtype DDRCTRL_REGS_SCHED1_PAGE_HIT_LIMIT_RD_Field is HAL.UInt3;
   ...
   subtype DDRCTRL_REGS_PERFHPR1_HPR_MAX_STARVE_Field is HAL.UInt16;
   subtype DDRCTRL_REGS_PERFHPR1_HPR_XACT_RUN_LENGTH_Field is HAL.UInt8;
   ...
   subtype DDRCTRL_REGS_PERFLPR1_LPR_MAX_STARVE_Field is HAL.UInt16;
   subtype DDRCTRL_REGS_PERFLPR1_LPR_XACT_RUN_LENGTH_Field is HAL.UInt8;
   ...
   subtype DDRCTRL_REGS_PERFWR1_W_MAX_STARVE_Field is HAL.UInt16;
   subtype DDRCTRL_REGS_PERFWR1_W_XACT_RUN_LENGTH_Field is HAL.UInt8;
   ...
   subtype DDRCTRL_REGS_SCHED3_WRCAM_LOWTHRESH_Field is HAL.UInt5;
   subtype DDRCTRL_REGS_SCHED3_WRCAM_HIGHTHRESH_Field is HAL.UInt5;
   subtype DDRCTRL_REGS_SCHED3_WR_PGHIT_NUM_THRESH_Field is HAL.UInt5;
   subtype DDRCTRL_REGS_SCHED3_RD_PGHIT_NUM_THRESH_Field is HAL.UInt5;
   ...
   subtype DDRCTRL_REGS_SCHED4_RD_ACT_IDLE_GAP_Field is HAL.UInt8;
   subtype DDRCTRL_REGS_SCHED4_WR_ACT_IDLE_GAP_Field is HAL.UInt8;
   subtype DDRCTRL_REGS_SCHED4_RD_PAGE_EXP_CYCLES_Field is HAL.UInt8;
   subtype DDRCTRL_REGS_SCHED4_WR_PAGE_EXP_CYCLES_Field is HAL.UInt8;
   ...
   subtype DDRCTRL_REGS_DBGCAM_DBG_HPR_Q_DEPTH_Field is HAL.UInt6;
   subtype DDRCTRL_REGS_DBGCAM_DBG_LPR_Q_DEPTH_Field is HAL.UInt6;
   subtype DDRCTRL_REGS_DBGCAM_DBG_W_Q_DEPTH_Field is HAL.UInt6;
   ...
   subtype DDRCTRL_MP_PCFGR_0_RD_PORT_PRIORITY_Field is HAL.UInt10;
   subtype DDRCTRL_MP_PCFGR_0_RRB_LOCK_THRESHOLD_Field is HAL.UInt4;
   ...
   subtype DDRCTRL_MP_PCFGW_0_WR_PORT_PRIORITY_Field is HAL.UInt10;
   ...
   subtype DDRCTRL_MP_PCFGQOS0_0_RQOS_MAP_LEVEL1_Field is HAL.UInt4;
   subtype DDRCTRL_MP_PCFGQOS0_0_RQOS_MAP_REGION0_Field is HAL.UInt2;
   subtype DDRCTRL_MP_PCFGQOS0_0_RQOS_MAP_REGION1_Field is HAL.UInt2;
   ...
   subtype DDRCTRL_MP_PCFGQOS1_0_RQOS_MAP_TIMEOUTB_Field is HAL.UInt11;
   subtype DDRCTRL_MP_PCFGQOS1_0_RQOS_MAP_TIMEOUTR_Field is HAL.UInt11;
   ...
   subtype DDRCTRL_MP_PCFGWQOS0_0_WQOS_MAP_LEVEL1_Field is HAL.UInt4;
   subtype DDRCTRL_MP_PCFGWQOS0_0_WQOS_MAP_LEVEL2_Field is HAL.UInt4;
   subtype DDRCTRL_MP_PCFGWQOS0_0_WQOS_MAP_REGION0_Field is HAL.UInt2;
   subtype DDRCTRL_MP_PCFGWQOS0_0_WQOS_MAP_REGION1_Field is HAL.UInt2;
   subtype DDRCTRL_MP_PCFGWQOS0_0_WQOS_MAP_REGION2_Field is HAL.UInt2;
   ...
   subtype DDRCTRL_MP_PCFGWQOS1_0_WQOS_MAP_TIMEOUT1_Field is HAL.UInt11;
   subtype DDRCTRL_MP_PCFGWQOS1_0_WQOS_MAP_TIMEOUT2_Field is HAL.UInt11;
   ...
   subtype DDRCTRL_MP_PCFGR_1_RD_PORT_PRIORITY_Field is HAL.UInt10;
   subtype DDRCTRL_MP_PCFGR_1_RRB_LOCK_THRESHOLD_Field is HAL.UInt4;
   ...
   subtype DDRCTRL_MP_PCFGW_1_WR_PORT_PRIORITY_Field is HAL.UInt10;
   ...
   subtype DDRCTRL_MP_PCFGQOS0_1_RQOS_MAP_LEVEL1_Field is HAL.UInt4;
   subtype DDRCTRL_MP_PCFGQOS0_1_RQOS_MAP_REGION0_Field is HAL.UInt2;
   subtype DDRCTRL_MP_PCFGQOS0_1_RQOS_MAP_REGION1_Field is HAL.UInt2;
   ...
   subtype DDRCTRL_MP_PCFGQOS1_1_RQOS_MAP_TIMEOUTB_Field is HAL.UInt11;
   subtype DDRCTRL_MP_PCFGQOS1_1_RQOS_MAP_TIMEOUTR_Field is HAL.UInt11;
   ...
   subtype DDRCTRL_MP_PCFGWQOS0_1_WQOS_MAP_LEVEL1_Field is HAL.UInt4;
   subtype DDRCTRL_MP_PCFGWQOS0_1_WQOS_MAP_LEVEL2_Field is HAL.UInt4;
   subtype DDRCTRL_MP_PCFGWQOS0_1_WQOS_MAP_REGION0_Field is HAL.UInt2;
   subtype DDRCTRL_MP_PCFGWQOS0_1_WQOS_MAP_REGION1_Field is HAL.UInt2;
   subtype DDRCTRL_MP_PCFGWQOS0_1_WQOS_MAP_REGION2_Field is HAL.UInt2;
   ...
   subtype DDRCTRL_MP_PCFGWQOS1_1_WQOS_MAP_TIMEOUT1_Field is HAL.UInt11;
   subtype DDRCTRL_MP_PCFGWQOS1_1_WQOS_MAP_TIMEOUT2_Field is HAL.UInt11;
   ...
   type DDRCTRL_Peripheral is record
      ...
      DDRCTRL_MP_DDRCTRL_VER_NUMBER : aliased HAL.UInt32;
      --  DDRCTRL version type register
      DDRCTRL_MP_DDRCTRL_VER_TYPE   : aliased HAL.UInt32;
   end record
     with Volatile;
