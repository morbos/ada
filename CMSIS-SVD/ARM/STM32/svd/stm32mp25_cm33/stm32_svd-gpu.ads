...
package STM32_SVD.GPU is
   ...
   subtype GPU_AQHICLOCKCONTROL_FSCALE_VAL_Field is HAL.UInt7;
   subtype GPU_AQHICLOCKCONTROL_MULTI_PIPE_REG_SELECT_Field is HAL.UInt4;
   ...
   subtype GPU_AQAXISTATUS_WR_ERR_ID_Field is HAL.UInt4;
   subtype GPU_AQAXISTATUS_RD_ERR_ID_Field is HAL.UInt4;
   ...
   subtype GPU_GCREGHICHIPPATCHREV_PATCH_REV_Field is HAL.UInt8;
   ...
   subtype GPU_GCPRODUCTID_GRADE_LEVEL_Field is HAL.UInt4;
   subtype GPU_GCPRODUCTID_NUM_Field is HAL.UInt20;
   subtype GPU_GCPRODUCTID_TYPE_Field is HAL.UInt4;
   ...
   subtype GPU_GCECOID_ID_Field is HAL.UInt8;
   subtype GPU_GCECOID_CONV_COUNT_Field is HAL.UInt24;
   ...
   subtype GPU_GCMODULEPOWERCONTROLS_TURN_ON_COUNTER_Field is HAL.UInt4;
   subtype GPU_GCMODULEPOWERCONTROLS_TURN_OFF_COUNTER_Field is HAL.UInt16;
   ...
   subtype GPU_GCREGMMUAHBTABLEARRAYSIZE_SIZE_Field is HAL.UInt16;
   ...
   subtype GPU_GCREGCMDBUFFERAHBCTRL_PREFETCH_Field is HAL.UInt16;
   ...
   subtype GPU_GCREGAXIAHBCONFIG_AWID_Field is HAL.UInt4;
   subtype GPU_GCREGAXIAHBCONFIG_ARID_Field is HAL.UInt4;
   subtype GPU_GCREGAXIAHBCONFIG_AWCACHE_Field is HAL.UInt4;
   subtype GPU_GCREGAXIAHBCONFIG_ARCACHE_Field is HAL.UInt4;
   subtype GPU_GCREGAXIAHBCONFIG_AXDOMAIN_SHARED_Field is HAL.UInt2;
   subtype GPU_GCREGAXIAHBCONFIG_AXDOMAIN_NON_SHARED_Field is HAL.UInt2;
   subtype GPU_GCREGAXIAHBCONFIG_AXCACHE_OVERRIDE_SHARED_Field is HAL.UInt4;
   ...
   subtype GPU_AQMEMORYDEBUG_MAX_OUTSTANDING_READS_Field is HAL.UInt8;
   ...
   subtype GPU_AQREGISTERTIMINGCONTROL_FOR_RF1P_Field is HAL.UInt8;
   subtype GPU_AQREGISTERTIMINGCONTROL_FOR_RF2P_Field is HAL.UInt8;
   subtype GPU_AQREGISTERTIMINGCONTROL_FAST_RTC_Field is HAL.UInt2;
   subtype GPU_AQREGISTERTIMINGCONTROL_FAST_WTC_Field is HAL.UInt2;
   ...
   subtype GPU_AQCMDBUFFERADDR_ADDRESS_Field is HAL.UInt31;
   ...
   subtype GPU_AQFEDEBUGCURCMDADR_CUR_CMD_ADR_Field is HAL.UInt29;
   ...
   type GPU_Peripheral is record
      ...
      GPU_AQINTRACKNOWLEDGE                    : aliased HAL.UInt32;
      --  GPU AQ interrupt enable register
      GPU_AQINTRENBL                           : aliased HAL.UInt32;
      --  GPU GC chip revision register
      GPU_GCCHIPREV                            : aliased HAL.UInt32;
      --  GPU GC chip date register
      GPU_GCCHIPDATE                           : aliased HAL.UInt32;
      --  GPU GC total cycles register
      GPU_GCTOTALCYCLES                        : aliased HAL.UInt32;
      --  GPU GC registration Hi chip patch revision register
      ...
      GPU_GCREGMMUAHBTABLEARRAYBASEADDRESSLOW  : aliased HAL.UInt32;
      --  GPU GC MMU AHB table array base address high register
      ...
      GPU_GCREGMMUAHBSAFENONSECUREADDRESS      : aliased HAL.UInt32;
      --  GPU GC MMU AHB safe secure address register
      GPU_GCREGMMUAHBSAFESECUREADDRESS         : aliased HAL.UInt32;
      --  GPU GC command buffer AHB control register
