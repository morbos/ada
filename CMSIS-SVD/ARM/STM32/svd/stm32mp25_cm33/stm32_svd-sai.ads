...
package STM32_SVD.SAI is
   ...
   subtype SAI_HWCFGR_FIFO_SIZE_Field is HAL.UInt8;
   subtype SAI_HWCFGR_SPDIF_PDM_Field is HAL.UInt4;
   subtype SAI_HWCFGR_OPTION_REGOUT_Field is HAL.UInt8;
   ...
   subtype SAI_VERR_MINREV_Field is HAL.UInt4;
   subtype SAI_VERR_MAJREV_Field is HAL.UInt4;
   ...
   type SAI_Peripheral is record
      ...
      SAI_IPIDR  : aliased HAL.UInt32;
      --  SAI size identification register
      SAI_SIDR   : aliased HAL.UInt32;
   end record
     with Volatile;
