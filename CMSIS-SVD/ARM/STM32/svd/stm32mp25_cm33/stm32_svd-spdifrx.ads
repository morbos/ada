...
package STM32_SVD.SPDIFRX is
   ...
   subtype SPDIFRX_VERR_MINREV_Field is HAL.UInt4;
   subtype SPDIFRX_VERR_MAJREV_Field is HAL.UInt4;
   ...
   is record
      ...
      SPDIFRX_IPIDR   : aliased HAL.UInt32;
      --  SPDIFRX size identification register
      SPDIFRX_SIDR    : aliased HAL.UInt32;
