...
package STM32_SVD.IWDG is
   ...
   subtype IWDG_HWCFGR_WINDOW_Field is HAL.UInt4;
   subtype IWDG_HWCFGR_PR_DEFAULT_Field is HAL.UInt4;
   ...
   subtype IWDG_VERR_MINREV_Field is HAL.UInt4;
   subtype IWDG_VERR_MAJREV_Field is HAL.UInt4;
   ...
   type IWDG_Peripheral is record
      ...
      IWDG_IDR    : aliased HAL.UInt32;
      --  IWDG size identification register
      IWDG_SIDR   : aliased HAL.UInt32;
   end record
     with Volatile;
