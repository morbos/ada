...
package STM32_SVD.ADCC12 is
   ...
   subtype ADCC12_CCR_PRESC_Field is HAL.UInt4;
   ...
   subtype ADCC12_HWCFGR1_ADCNUM_Field is HAL.UInt4;
   subtype ADCC12_HWCFGR1_OPBITS_Field is HAL.UInt4;
   subtype ADCC12_HWCFGR1_ANAIP_Field is HAL.UInt4;
   ...
   subtype ADCC12_VERR_MINREV_Field is HAL.UInt4;
   subtype ADCC12_VERR_MAJREV_Field is HAL.UInt4;
   ...
   type ADCC12_Peripheral is record
      ...
      ADCC12_IPIDR   : aliased HAL.UInt32;
      --  ADC12 size identification register
      ADCC12_SIDR    : aliased HAL.UInt32;
   end record
     with Volatile;
