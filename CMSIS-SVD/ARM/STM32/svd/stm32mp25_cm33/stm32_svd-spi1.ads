...
package STM32_SVD.SPI1 is
   ...
   subtype SPI1_CR2_TSIZE_Field is HAL.UInt16;
   ...
   subtype SPI1_CFG1_DSIZE_Field is HAL.UInt5;
   subtype SPI1_CFG1_FTHLV_Field is HAL.UInt4;
   subtype SPI1_CFG1_CRCSIZE_Field is HAL.UInt5;
   subtype SPI1_CFG1_MBR_Field is HAL.UInt3;
   ...
   subtype SPI1_CFG2_MSSI_Field is HAL.UInt4;
   subtype SPI1_CFG2_MIDI_Field is HAL.UInt4;
   subtype SPI1_CFG2_COMM_Field is HAL.UInt2;
   subtype SPI1_CFG2_SP_Field is HAL.UInt3;
   ...
   subtype SPI1_SR_RXPLVL_Field is HAL.UInt2;
   subtype SPI1_SR_CTSIZE_Field is HAL.UInt16;
   ...
   subtype SPI1_AUTOCR_TRIGSEL_Field is HAL.UInt4;
   ...
   subtype SPI1_I2SCFGR_I2SCFG_Field is HAL.UInt3;
   subtype SPI1_I2SCFGR_I2SSTD_Field is HAL.UInt2;
   subtype SPI1_I2SCFGR_DATLEN_Field is HAL.UInt2;
   subtype SPI1_I2SCFGR_I2SDIV_Field is HAL.UInt8;
   ...
   subtype SPI1_HWCFGR2_OPBCFG_Field is HAL.UInt8;
   ...
   subtype SPI1_HWCFGR1_TXFCFG_Field is HAL.UInt4;
   subtype SPI1_HWCFGR1_RXFCFG_Field is HAL.UInt4;
   subtype SPI1_HWCFGR1_CRCCFG_Field is HAL.UInt4;
   subtype SPI1_HWCFGR1_I2SCFG_Field is HAL.UInt4;
   subtype SPI1_HWCFGR1_DSCFG_Field is HAL.UInt4;
   subtype SPI1_HWCFGR1_TRGCFG_Field is HAL.UInt4;
   subtype SPI1_HWCFGR1_FULLCFG_Field is HAL.UInt4;
   ...
   subtype SPI1_VERR_MINREV_Field is HAL.UInt4;
   subtype SPI1_VERR_MAJREV_Field is HAL.UInt4;
   ...
   type SPI1_Peripheral is record
      ...
      SPI1_TXDR    : aliased HAL.UInt32;
      --  SPI/I2S receive data register
      SPI1_RXDR    : aliased HAL.UInt32;
      --  SPI/I2S polynomial register
      SPI1_CRCPOLY : aliased HAL.UInt32;
      --  SPI/I2S transmitter CRC register
      SPI1_TXCRC   : aliased HAL.UInt32;
      --  SPI/I2S receiver CRC register
      SPI1_RXCRC   : aliased HAL.UInt32;
      --  SPI/I2S underrun data register
      SPI1_UDRDR   : aliased HAL.UInt32;
      --  SPI/I2S configuration register
      ...
      SPI1_IPIDR   : aliased HAL.UInt32;
      --  SPI/I2S size identification register
      SPI1_SIDR    : aliased HAL.UInt32;
   end record
     with Volatile;
