...
package STM32_SVD.GPIOE is
   ...
   subtype GPIOE_DELAYRL_DLY_Element is HAL.UInt4;
   ...
   subtype GPIOE_DELAYRH_DLY_Element is HAL.UInt4;
   ...
   subtype GPIOE_CIDCFGR_SCID_Field is HAL.UInt2;
   ...
   subtype GPIOE_SEMCR_SEMCID_Field is HAL.UInt2;
   ...
   subtype GPIOE_HWCFGR11_AHB_IOP_Field is HAL.UInt4;
   subtype GPIOE_HWCFGR11_AFSIZE_CFG_Field is HAL.UInt4;
   subtype GPIOE_HWCFGR11_SPEED_CFG_Field is HAL.UInt4;
   subtype GPIOE_HWCFGR11_LOCK_CFG_Field is HAL.UInt4;
   subtype GPIOE_HWCFGR11_SEC_CFG_Field is HAL.UInt4;
   subtype GPIOE_HWCFGR11_OR_CFG_Field is HAL.UInt4;
   subtype GPIOE_HWCFGR11_PRIV_CFG_Field is HAL.UInt4;
   ...
   subtype GPIOE_HWCFGR10_EN_IO_Field is HAL.UInt16;
   ...
   subtype GPIOE_HWCFGR9_FAST_AF_IO_Element is HAL.UInt4;
   ...
   subtype GPIOE_HWCFGR4_ODR_RES_Field is HAL.UInt16;
   subtype GPIOE_HWCFGR4_OTYPER_RES_Field is HAL.UInt16;
   ...
   subtype GPIOE_HWCFGR1_OR_RES_Field is HAL.UInt16;
   ...
   type GPIOE_Peripheral is record
      ...
      GPIOE_HWCFGR7   : aliased HAL.UInt32;
      ...
      GPIOE_HWCFGR3   : aliased HAL.UInt32;
