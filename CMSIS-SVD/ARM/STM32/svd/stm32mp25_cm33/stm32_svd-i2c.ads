...
package STM32_SVD.I2C is
   ...
   subtype I2C_AUTOCR_TRIGSEL_Field is HAL.UInt4;
   ...
   subtype I2C_HWCFGR_SMBUS_Field is HAL.UInt4;
   subtype I2C_HWCFGR_ASYN_Field is HAL.UInt4;
   subtype I2C_HWCFGR_WKP_Field is HAL.UInt4;
   subtype I2C_HWCFGR_AUTON_Field is HAL.UInt4;
   ...
   subtype I2C_VERR_MINREV_Field is HAL.UInt4;
   subtype I2C_VERR_MAJREV_Field is HAL.UInt4;
   ...
   type I2C_Peripheral is record
      ...
      I2C_IPIDR    : aliased HAL.UInt32;
      --  I2C size identification register
      I2C_SIDR     : aliased HAL.UInt32;
   end record
     with Volatile;
