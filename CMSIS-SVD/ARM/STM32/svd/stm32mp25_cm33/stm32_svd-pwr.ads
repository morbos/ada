...
package STM32_SVD.PWR is
   ...
   subtype PWR_CR10_RETRBSEN_Field is HAL.UInt2;
   ...
   subtype PWR_D1CR_POPL_D1_Field is HAL.UInt5;
   ...
   subtype PWR_D2CR_POPL_D2_Field is HAL.UInt5;
   subtype PWR_D2CR_LPLVDLY_D2_Field is HAL.UInt3;
   subtype PWR_D2CR_PODH_D2_Field is HAL.UInt4;
   ...
   subtype PWR_WKUPCR_WKUPPUPD_Field is HAL.UInt2;
   ...
   subtype PWR_R0CIDCFGR_SCID_Field is HAL.UInt3;
   ...
   subtype PWR_R1CIDCFGR_SCID_Field is HAL.UInt3;
   ...
   subtype PWR_R2CIDCFGR_SCID_Field is HAL.UInt3;
   ...
   subtype PWR_R3CIDCFGR_SCID_Field is HAL.UInt3;
   ...
   subtype PWR_R4CIDCFGR_SCID_Field is HAL.UInt3;
   ...
   subtype PWR_R5CIDCFGR_SCID_Field is HAL.UInt3;
   ...
   subtype PWR_R6CIDCFGR_SCID_Field is HAL.UInt3;
   ...
   subtype PWR_WIO1CIDCFGR_SCID_Field is HAL.UInt3;
   ...
   subtype PWR_WIO1SEMCR_SEMCID_Field is HAL.UInt3;
   ...
   subtype PWR_WIO2CIDCFGR_SCID_Field is HAL.UInt3;
   ...
   subtype PWR_WIO2SEMCR_SEMCID_Field is HAL.UInt3;
   ...
   subtype PWR_WIO3CIDCFGR_SCID_Field is HAL.UInt3;
   ...
   subtype PWR_WIO3SEMCR_SEMCID_Field is HAL.UInt3;
   ...
   subtype PWR_WIO4CIDCFGR_SCID_Field is HAL.UInt3;
   ...
   subtype PWR_WIO4SEMCR_SEMCID_Field is HAL.UInt3;
   ...
   subtype PWR_WIO5CIDCFGR_SCID_Field is HAL.UInt3;
   ...
   subtype PWR_WIO5SEMCR_SEMCID_Field is HAL.UInt3;
   ...
   subtype PWR_WIO6CIDCFGR_SCID_Field is HAL.UInt3;
   ...
   subtype PWR_WIO6SEMCR_SEMCID_Field is HAL.UInt3;
   ...
   subtype PWR_CPU1D1SR_CSTATE_Field is HAL.UInt2;
   subtype PWR_CPU1D1SR_DSTATE_Field is HAL.UInt3;
   ...
   subtype PWR_CPU2D2SR_CSTATE_Field is HAL.UInt2;
   subtype PWR_CPU2D2SR_DSTATE_Field is HAL.UInt3;
   ...
   subtype PWR_CPU3D3SR_CSTATE_Field is HAL.UInt2;
   subtype PWR_CPU3D3SR_DSTATE_Field is HAL.UInt3;
   ...
   subtype PWR_VERR_MINREV_Field is HAL.UInt4;
   subtype PWR_VERR_MAJREV_Field is HAL.UInt4;
   ...
   type PWR_Peripheral is record
      ...
      PWR_IPIDR       : aliased HAL.UInt32;
      --  PWR size identification register
      PWR_SIDR        : aliased HAL.UInt32;
   end record
     with Volatile;
