...
package STM32_SVD.HSEM is
   ...
   subtype HSEM_R_LOCKID_Field is HAL.UInt4;
   ...
   subtype HSEM_RLR_LOCKID_Field is HAL.UInt4;
   ...
   subtype HSEM_C1IER_ISE_Field is HAL.UInt16;
   ...
   subtype HSEM_C1ICR_ISC_Field is HAL.UInt16;
   ...
   subtype HSEM_C1ISR_ISF_Field is HAL.UInt16;
   ...
   subtype HSEM_C1MISR_MISF_Field is HAL.UInt16;
   ...
   subtype HSEM_C2IER_ISE_Field is HAL.UInt16;
   ...
   subtype HSEM_C2ICR_ISC_Field is HAL.UInt16;
   ...
   subtype HSEM_C2ISR_ISF_Field is HAL.UInt16;
   ...
   subtype HSEM_C2MISR_MISF_Field is HAL.UInt16;
   ...
   subtype HSEM_C3IER_ISE_Field is HAL.UInt16;
   ...
   subtype HSEM_C3ICR_ISC_Field is HAL.UInt16;
   ...
   subtype HSEM_C3ISR_ISF_Field is HAL.UInt16;
   ...
   subtype HSEM_C3MISR_MISF_Field is HAL.UInt16;
   ...
   subtype HSEM_SC1IER_SISE_Field is HAL.UInt16;
   ...
   subtype HSEM_SC1ICR_SISC_Field is HAL.UInt16;
   ...
   subtype HSEM_SC1ISR_SISF_Field is HAL.UInt16;
   ...
   subtype HSEM_SC1MISR_SMISF_Field is HAL.UInt16;
   ...
   subtype HSEM_SC2IER_SISE_Field is HAL.UInt16;
   ...
   subtype HSEM_SC2ICR_SISC_Field is HAL.UInt16;
   ...
   subtype HSEM_SC2ISR_SISF_Field is HAL.UInt16;
   ...
   subtype HSEM_SC2MISR_SMISF_Field is HAL.UInt16;
   ...
   subtype HSEM_SC3IER_SISE_Field is HAL.UInt16;
   ...
   subtype HSEM_SC3ICR_SISC_Field is HAL.UInt16;
   ...
   subtype HSEM_SC3ISR_SISF_Field is HAL.UInt16;
   ...
   subtype HSEM_SC3MISR_SMISF_Field is HAL.UInt16;
   ...
   subtype HSEM_SECCFGR_SEC_Field is HAL.UInt16;
   ...
   subtype HSEM_PRIVCFGR_PRIV_Field is HAL.UInt16;
   ...
   subtype HSEM_C1CIDCFGR_CID_Field is HAL.UInt3;
   ...
   subtype HSEM_C2CIDCFGR_CID_Field is HAL.UInt3;
   ...
   subtype HSEM_C3CIDCFGR_CID_Field is HAL.UInt3;
   ...
   subtype HSEM_CR_LOCKID_Field is HAL.UInt4;
   ...
   subtype HSEM_G0CIDCFGR_SEM_WLIST_C_Field is HAL.UInt3;
   ...
   subtype HSEM_G1CIDCFGR_SEM_WLIST_C_Field is HAL.UInt3;
   ...
   subtype HSEM_G2CIDCFGR_SEM_WLIST_C_Field is HAL.UInt3;
   ...
   subtype HSEM_G3CIDCFGR_SEM_WLIST_C_Field is HAL.UInt3;
   ...
   subtype HSEM_HWCFGR2_MASTERID_Element is HAL.UInt4;
   ...
   subtype HSEM_HWCFGR1_NBSEM_Field is HAL.UInt8;
   subtype HSEM_HWCFGR1_NBINT_Field is HAL.UInt4;
   subtype HSEM_HWCFGR1_CID_WIDTH_Field is HAL.UInt4;
   ...
   subtype HSEM_VERR_MINREV_Field is HAL.UInt4;
   subtype HSEM_VERR_MAJREV_Field is HAL.UInt4;
   ...
   type HSEM_Peripheral is record
      ...
      HSEM_IPIDR     : aliased HAL.UInt32;
      --  HSEM size identification register
      HSEM_SIDR      : aliased HAL.UInt32;
   end record
     with Volatile;
