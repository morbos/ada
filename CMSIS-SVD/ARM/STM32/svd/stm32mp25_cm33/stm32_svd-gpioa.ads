...
package STM32_SVD.GPIOA is
   ...
   subtype GPIOA_DELAYRL_DLY_Element is HAL.UInt4;
   ...
   subtype GPIOA_DELAYRH_DLY_Element is HAL.UInt4;
   ...
   subtype GPIOA_CIDCFGR_SCID_Field is HAL.UInt2;
   ...
   subtype GPIOA_SEMCR_SEMCID_Field is HAL.UInt2;
   ...
   subtype GPIOA_HWCFGR11_AHB_IOP_Field is HAL.UInt4;
   subtype GPIOA_HWCFGR11_AFSIZE_CFG_Field is HAL.UInt4;
   subtype GPIOA_HWCFGR11_SPEED_CFG_Field is HAL.UInt4;
   subtype GPIOA_HWCFGR11_LOCK_CFG_Field is HAL.UInt4;
   subtype GPIOA_HWCFGR11_SEC_CFG_Field is HAL.UInt4;
   subtype GPIOA_HWCFGR11_OR_CFG_Field is HAL.UInt4;
   subtype GPIOA_HWCFGR11_PRIV_CFG_Field is HAL.UInt4;
   ...
   subtype GPIOA_HWCFGR10_EN_IO_Field is HAL.UInt16;
   ...
   subtype GPIOA_HWCFGR9_FAST_AF_IO_Element is HAL.UInt4;
   ...
   subtype GPIOA_HWCFGR4_ODR_RES_Field is HAL.UInt16;
   subtype GPIOA_HWCFGR4_OTYPER_RES_Field is HAL.UInt16;
   ...
   subtype GPIOA_HWCFGR1_OR_RES_Field is HAL.UInt16;
   ...
   type GPIOA_Peripheral is record
      ...
      GPIOA_HWCFGR7   : aliased HAL.UInt32;
      ...
      GPIOA_HWCFGR3   : aliased HAL.UInt32;
