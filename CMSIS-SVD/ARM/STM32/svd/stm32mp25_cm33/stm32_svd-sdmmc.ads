...
package STM32_SVD.SDMMC is
   ...
   subtype SDMMC_FIFOTHRR_THR_Field is HAL.UInt4;
   ...
   subtype SDMMC_IDMABSIZER_IDMABNDT_Field is HAL.UInt11;
   ...
   subtype SDMMC_HWCFGR1_FIFOSIZE_Field is HAL.UInt4;
   ...
   subtype SDMMC_VERR_MINREV_Field is HAL.UInt4;
   subtype SDMMC_VERR_MAJREV_Field is HAL.UInt4;
   ...
   type SDMMC_Peripheral is record
      ...
      SDMMC_FIFOR0     : aliased HAL.UInt32;
      --  SDMMC data FIFO registers 1
      SDMMC_FIFOR1     : aliased HAL.UInt32;
      --  SDMMC data FIFO registers 2
      SDMMC_FIFOR2     : aliased HAL.UInt32;
      --  SDMMC data FIFO registers 3
      SDMMC_FIFOR3     : aliased HAL.UInt32;
      --  SDMMC data FIFO registers 4
      SDMMC_FIFOR4     : aliased HAL.UInt32;
      --  SDMMC data FIFO registers 5
      SDMMC_FIFOR5     : aliased HAL.UInt32;
      --  SDMMC data FIFO registers 6
      SDMMC_FIFOR6     : aliased HAL.UInt32;
      --  SDMMC data FIFO registers 7
      SDMMC_FIFOR7     : aliased HAL.UInt32;
      --  SDMMC data FIFO registers 8
      SDMMC_FIFOR8     : aliased HAL.UInt32;
      --  SDMMC data FIFO registers 9
      SDMMC_FIFOR9     : aliased HAL.UInt32;
      --  SDMMC data FIFO registers 10
      SDMMC_FIFOR10    : aliased HAL.UInt32;
      --  SDMMC data FIFO registers 11
      SDMMC_FIFOR11    : aliased HAL.UInt32;
      --  SDMMC data FIFO registers 12
      SDMMC_FIFOR12    : aliased HAL.UInt32;
      --  SDMMC data FIFO registers 13
      SDMMC_FIFOR13    : aliased HAL.UInt32;
      --  SDMMC data FIFO registers 14
      SDMMC_FIFOR14    : aliased HAL.UInt32;
      --  SDMMC data FIFO registers 15
      SDMMC_FIFOR15    : aliased HAL.UInt32;
      --  SDMMC hardware configuration register 1
      SDMMC_HWCFGR1    : aliased SDMMC_HWCFGR1_Register;
      --  SDMMC version register
      SDMMC_VERR       : aliased SDMMC_VERR_Register;
      --  SDMMC identification register
      SDMMC_IPIDR      : aliased HAL.UInt32;
      --  SDMMC size identification register
      SDMMC_SIDR       : aliased HAL.UInt32;
   end record
     with Volatile;
