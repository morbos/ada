...
package STM32_SVD.OCTOSPI is
   ...
   subtype OCTOSPI_CR_FTHRES_Field is HAL.UInt6;
   ...
   subtype OCTOSPI_DCR3_MAXTRAN_Field is HAL.UInt8;
   ...
   subtype OCTOSPI_SR_FLEVEL_Field is HAL.UInt7;
   ...
   subtype OCTOSPI_HWCFGR2_FRCK_Field is HAL.UInt4;
   subtype OCTOSPI_HWCFGR2_RDFT_Field is HAL.UInt4;
   subtype OCTOSPI_HWCFGR2_ARBM_Field is HAL.UInt4;
   subtype OCTOSPI_HWCFGR2_MEM16_Field is HAL.UInt4;
   subtype OCTOSPI_HWCFGR2_HSINT_Field is HAL.UInt4;
   ...
   subtype OCTOSPI_HWCFGR_AXI_Field is HAL.UInt4;
   subtype OCTOSPI_HWCFGR_FIFO_Field is HAL.UInt8;
   subtype OCTOSPI_HWCFGR_PRES_Field is HAL.UInt8;
   subtype OCTOSPI_HWCFGR_IDL_Field is HAL.UInt4;
   subtype OCTOSPI_HWCFGR_MMW_Field is HAL.UInt4;
   subtype OCTOSPI_HWCFGR_CSSRV_Field is HAL.UInt4;
   ...
   subtype OCTOSPI_VERR_VER_Field is HAL.UInt8;
   ...
   type OCTOSPI_Peripheral is record
      ...
      OCTOSPI_IDR     : aliased HAL.UInt32;
      --  OCTOSPI hardware magic identification register
      OCTOSPI_MIDR    : aliased HAL.UInt32;
   end record
     with Volatile;
