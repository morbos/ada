...
package STM32_SVD.HDP is
   ...
   subtype HDP_MUX_MUX_Element is HAL.UInt4;
   ...
   subtype HDP_VAL_HDPVAL_Field is HAL.UInt8;
   ...
   subtype HDP_GPOSET_HDPGPOSET_Field is HAL.UInt8;
   ...
   subtype HDP_GPOCLR_HDPGPOCLR_Field is HAL.UInt8;
   ...
   subtype HDP_GPOVAL_HDPGPOVAL_Field is HAL.UInt8;
   ...
   subtype HDP_VERR_MINREV_Field is HAL.UInt4;
   subtype HDP_VERR_MAJREV_Field is HAL.UInt4;
   ...
   type HDP_Peripheral is record
      ...
      HDP_IPIDR  : aliased HAL.UInt32;
      --  HDP size identification register
      HDP_SIDR   : aliased HAL.UInt32;
   end record
     with Volatile;
