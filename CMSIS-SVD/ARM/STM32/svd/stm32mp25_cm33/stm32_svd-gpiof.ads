...
package STM32_SVD.GPIOF is
   ...
   subtype GPIOF_DELAYRL_DLY_Element is HAL.UInt4;
   ...
   subtype GPIOF_DELAYRH_DLY_Element is HAL.UInt4;
   ...
   subtype GPIOF_CIDCFGR_SCID_Field is HAL.UInt2;
   ...
   subtype GPIOF_SEMCR_SEMCID_Field is HAL.UInt2;
   ...
   subtype GPIOF_HWCFGR11_AHB_IOP_Field is HAL.UInt4;
   subtype GPIOF_HWCFGR11_AFSIZE_CFG_Field is HAL.UInt4;
   subtype GPIOF_HWCFGR11_SPEED_CFG_Field is HAL.UInt4;
   subtype GPIOF_HWCFGR11_LOCK_CFG_Field is HAL.UInt4;
   subtype GPIOF_HWCFGR11_SEC_CFG_Field is HAL.UInt4;
   subtype GPIOF_HWCFGR11_OR_CFG_Field is HAL.UInt4;
   subtype GPIOF_HWCFGR11_PRIV_CFG_Field is HAL.UInt4;
   ...
   subtype GPIOF_HWCFGR10_EN_IO_Field is HAL.UInt16;
   ...
   subtype GPIOF_HWCFGR9_FAST_AF_IO_Element is HAL.UInt4;
   ...
   subtype GPIOF_HWCFGR4_ODR_RES_Field is HAL.UInt16;
   subtype GPIOF_HWCFGR4_OTYPER_RES_Field is HAL.UInt16;
   ...
   subtype GPIOF_HWCFGR1_OR_RES_Field is HAL.UInt16;
   ...
   type GPIOF_Peripheral is record
      ...
      GPIOF_HWCFGR7   : aliased HAL.UInt32;
      ...
      GPIOF_HWCFGR3   : aliased HAL.UInt32;
