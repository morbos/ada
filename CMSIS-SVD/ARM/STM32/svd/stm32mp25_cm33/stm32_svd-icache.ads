...
package STM32_SVD.ICACHE is
   ...
   subtype ICACHE_HWCFGR_WAYS_Field is HAL.UInt2;
   subtype ICACHE_HWCFGR_SIZE_Field is HAL.UInt3;
   subtype ICACHE_HWCFGR_LWIDTH_Field is HAL.UInt2;
   subtype ICACHE_HWCFGR_RANGE_Field is HAL.UInt4;
   subtype ICACHE_HWCFGR_REGION_Field is HAL.UInt3;
   subtype ICACHE_HWCFGR_FMASTER_Field is HAL.UInt2;
   subtype ICACHE_HWCFGR_SMASTER_Field is HAL.UInt2;
   subtype ICACHE_HWCFGR_GSWIDTH_Field is HAL.UInt2;
   ...
   subtype ICACHE_VERR_MINREV_Field is HAL.UInt4;
   subtype ICACHE_VERR_MAJREV_Field is HAL.UInt4;
   ...
   type ICACHE_Peripheral is record
      ...
      ICACHE_IPIDR  : aliased HAL.UInt32;
      --  ICACHE size identification register
      ICACHE_SIDR   : aliased HAL.UInt32;
   end record
     with Volatile;
