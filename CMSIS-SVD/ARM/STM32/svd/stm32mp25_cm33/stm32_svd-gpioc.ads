...
package STM32_SVD.GPIOC is
   ...
   subtype GPIOC_DELAYRL_DLY_Element is HAL.UInt4;
   ...
   subtype GPIOC_DELAYRH_DLY_Element is HAL.UInt4;
   ...
   subtype GPIOC_CIDCFGR_SCID_Field is HAL.UInt2;
   ...
   subtype GPIOC_SEMCR_SEMCID_Field is HAL.UInt2;
   ...
   subtype GPIOC_HWCFGR11_AHB_IOP_Field is HAL.UInt4;
   subtype GPIOC_HWCFGR11_AFSIZE_CFG_Field is HAL.UInt4;
   subtype GPIOC_HWCFGR11_SPEED_CFG_Field is HAL.UInt4;
   subtype GPIOC_HWCFGR11_LOCK_CFG_Field is HAL.UInt4;
   subtype GPIOC_HWCFGR11_SEC_CFG_Field is HAL.UInt4;
   subtype GPIOC_HWCFGR11_OR_CFG_Field is HAL.UInt4;
   subtype GPIOC_HWCFGR11_PRIV_CFG_Field is HAL.UInt4;
   ...
   subtype GPIOC_HWCFGR10_EN_IO_Field is HAL.UInt16;
   ...
   subtype GPIOC_HWCFGR9_FAST_AF_IO_Element is HAL.UInt4;
   ...
   subtype GPIOC_HWCFGR4_ODR_RES_Field is HAL.UInt16;
   subtype GPIOC_HWCFGR4_OTYPER_RES_Field is HAL.UInt16;
   ...
   subtype GPIOC_HWCFGR1_OR_RES_Field is HAL.UInt16;
   ...
   type GPIOC_Peripheral is record
      ...
      GPIOC_HWCFGR7   : aliased HAL.UInt32;
      ...
      GPIOC_HWCFGR3   : aliased HAL.UInt32;
