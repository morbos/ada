...
package STM32_SVD.RCC is
   ...
   subtype RCC_CR_MSIRANGE_Field is HAL.UInt4;
   ...
   subtype RCC_ICSCR_MSICAL_Field is HAL.UInt8;
   subtype RCC_ICSCR_MSITRIM_Field is HAL.UInt8;
   ...
   subtype RCC_PLLCFGR_PLLSRC_Field is HAL.UInt2;
   subtype RCC_PLLCFGR_PLLM_Field is HAL.UInt3;
   subtype RCC_PLLCFGR_PLLN_Field is HAL.UInt7;
   subtype RCC_PLLCFGR_PLLP_Field is HAL.UInt5;
   subtype RCC_PLLCFGR_PLLQ_Field is HAL.UInt3;
   subtype RCC_PLLCFGR_PLLR_Field is HAL.UInt3;
   ...
   subtype RCC_CCIPR_USART2SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR_LPUART3SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR_LPUART2SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR_LPUART1SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR_I2C1SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR_I2C3SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR_LPTIM1SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR_LPTIM2SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR_LPTIM3SEL_Field is HAL.UInt2;
   subtype RCC_CCIPR_CLK48SEL_Field is HAL.UInt2;
   ...
   subtype RCC_CSR_MSISRANGE_Field is HAL.UInt4;
