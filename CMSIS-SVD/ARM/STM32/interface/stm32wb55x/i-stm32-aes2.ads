...
package Interfaces.STM32.AES2 is
   pragma Preelaborate;
   ...
   type AES2_Peripheral is record
   ...
   for AES2_Peripheral use record
   ...
   AES2_Periph : aliased AES2_Peripheral
     with Import, Address => AES2_Base;

end Interfaces.STM32.AES2;
