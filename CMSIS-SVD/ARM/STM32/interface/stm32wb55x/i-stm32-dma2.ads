...
package Interfaces.STM32.DMA2 is
   pragma Preelaborate;
   ...
   subtype CNDTR_NDTR_Field is Interfaces.Bit_Types.UInt16;
   ...
   type DMA2_Peripheral is record
   ...
   for DMA2_Peripheral use record
   ...
   DMA2_Periph : aliased DMA2_Peripheral
     with Import, Address => DMA2_Base;

end Interfaces.STM32.DMA2;
