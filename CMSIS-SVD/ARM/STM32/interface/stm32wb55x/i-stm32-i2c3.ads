...
package Interfaces.STM32.I2C3 is
   pragma Preelaborate;
   ...
   type I2C3_Peripheral is record
   ...
   for I2C3_Peripheral use record
   ...
   I2C3_Periph : aliased I2C3_Peripheral
     with Import, Address => I2C3_Base;

end Interfaces.STM32.I2C3;
