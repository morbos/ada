...
package Interfaces.STM32.AES1 is
   pragma Preelaborate;
   ...
   type AES1_Peripheral is record
   ...
   for AES1_Peripheral use record
   ...
   AES1_Periph : aliased AES1_Peripheral
     with Import, Address => AES1_Base;

end Interfaces.STM32.AES1;
