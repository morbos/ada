...
package Interfaces.STM32.TSC is
   ...
   subtype IOHCR_G8_IO_Element is Interfaces.Bit_Types.Bit;
   ...
   subtype IOASCR_G8_IO_Element is Interfaces.Bit_Types.Bit;
   ...
   subtype IOSCR_G8_IO_Element is Interfaces.Bit_Types.Bit;
   ...
   subtype IOCCR_G8_IO_Element is Interfaces.Bit_Types.Bit;
   ...
   subtype IOGCSR_G8E_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype IOGCSR_G8S_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype IOG8CR_CNT_Field is Interfaces.Bit_Types.UInt14;
