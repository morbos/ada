...
package Interfaces.STM32.CAN is
   ...
   subtype FMR_FINIT_Field is Interfaces.Bit_Types.Bit;
   ...
   type FMR_Register is record
      ...
      --  unspecified
      Reserved_1_31 : Interfaces.Bit_Types.UInt31 := 16#150E0700#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype FM1R_FBM_Element is Interfaces.Bit_Types.Bit;
   ...
   subtype FS1R_FSC_Element is Interfaces.Bit_Types.Bit;
   ...
   subtype FFA1R_FFA_Element is Interfaces.Bit_Types.Bit;
   ...
   subtype FA1R_FACT_Element is Interfaces.Bit_Types.Bit;
