...
package Interfaces.STM32.RCC is
   ...
   subtype PLLSAI2CFGR_PLLSAI2R_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype CCIPR_UART4SEL_Field is Interfaces.Bit_Types.UInt2;
   subtype CCIPR_UART5SEL_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype CCIPR_SAI2SEL_Field is Interfaces.Bit_Types.UInt2;
