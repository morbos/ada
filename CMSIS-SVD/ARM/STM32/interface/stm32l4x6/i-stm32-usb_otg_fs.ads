...
package Interfaces.STM32.USB_OTG_FS is
   ...
   subtype FS_DAINT_IEPINT_Field is Interfaces.Bit_Types.UInt16;
   subtype FS_DAINT_OEPINT_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype FS_DAINTMSK_IEPM_Field is Interfaces.Bit_Types.UInt16;
   subtype FS_DAINTMSK_OEPINT_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype FS_GRXFSIZ_RXFD_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype FS_GNPTXFSIZ_Device_TX0FSA_Field is Interfaces.Bit_Types.UInt16;
   subtype FS_GNPTXFSIZ_Device_TX0FD_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype FS_GNPTXFSIZ_Host_NPTXFSA_Field is Interfaces.Bit_Types.UInt16;
   subtype FS_GNPTXFSIZ_Host_NPTXFD_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype FS_GNPTXSTS_NPTXFSAV_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype FS_HPTXFSIZ_PTXSA_Field is Interfaces.Bit_Types.UInt16;
   subtype FS_HPTXFSIZ_PTXFSIZ_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype FS_DIEPTXF_INEPTXSA_Field is Interfaces.Bit_Types.UInt16;
   subtype FS_DIEPTXF_INEPTXFD_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype FS_HFNUM_FRNUM_Field is Interfaces.Bit_Types.UInt16;
   subtype FS_HFNUM_FTREM_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype FS_HPTXSTS_PTXFSAVL_Field is Interfaces.Bit_Types.UInt16;
   ...
   is record
      ...
      --  core ID register
      FS_CID              : aliased Interfaces.Bit_Types.UInt32;
      --  OTG_FS Host periodic transmit FIFO size register (OTG_FS_HPTXFSIZ)
