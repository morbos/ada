...
package Interfaces.STM32.DLYB is
   ...
   subtype DLYB_CFGR_SEL_Field is Interfaces.Bit_Types.UInt4;
   subtype DLYB_CFGR_UNIT_Field is Interfaces.Bit_Types.UInt7;
   subtype DLYB_CFGR_LNG_Field is Interfaces.Bit_Types.UInt12;
