...
package Interfaces.STM32.RAMCFG is
   ...
   subtype RAM1CR_WSC_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype RAM1ERKEYR_ERASEKEY_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype RAM2CR_WSC_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype RAM2ECCKEYR_ECCKEY_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype RAM2ERKEYR_ERASEKEY_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype RAM3CR_WSC_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype RAM3ECCKEYR_ECCKEY_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype RAM3ERKEYR_ERASEKEY_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype RAM4CR_WSC_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype RAM4ERKEYR_ERASEKEY_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype RAM5CR_WSC_Field is Interfaces.Bit_Types.UInt3;
   ...
   type RAMCFG_Peripheral is record
      ...
      RAM2SEAR    : aliased Interfaces.Bit_Types.UInt32;
      --  RAMCFG RAM x ECC double error address register
      RAM2DEAR    : aliased Interfaces.Bit_Types.UInt32;
      --  RAMCFG RAM x interrupt clear register x
      ...
      --  RAMCFG RAM x ECC single error address register
      RAM3SEAR    : aliased Interfaces.Bit_Types.UInt32;
      --  RAMCFG RAM x ECC double error address register
      RAM3DEAR    : aliased Interfaces.Bit_Types.UInt32;
      --  RAMCFG RAM x interrupt clear register x
      ...
      --  RAMCFG RAM x ECC single error address register
      RAM5SEAR    : aliased Interfaces.Bit_Types.UInt32;
      --  RAMCFG RAM x ECC double error address register
      RAM5DEAR    : aliased Interfaces.Bit_Types.UInt32;
      --  RAMCFG RAM x interrupt clear register x
