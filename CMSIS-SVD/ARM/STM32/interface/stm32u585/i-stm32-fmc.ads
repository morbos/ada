...
package Interfaces.STM32.FMC is
   ...
   subtype BCR_NBLSET_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype BTR_DATAHLD_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype PCSCNTR_CSCOUNT_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype PCR_TAR_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype BWTR_DATAHLD_Field is Interfaces.Bit_Types.UInt2;
