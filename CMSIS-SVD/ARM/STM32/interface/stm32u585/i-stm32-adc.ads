...
package Interfaces.STM32.ADC is
   ...
   subtype ADC_CR_CALINDEX_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype ADC_CFGR1_DMNGT_Field is Interfaces.Bit_Types.UInt2;
   subtype ADC_CFGR1_RES_Field is Interfaces.Bit_Types.UInt2;
   subtype ADC_CFGR1_EXTSEL_Field is Interfaces.Bit_Types.UInt5;
   subtype ADC_CFGR1_EXTEN_Field is Interfaces.Bit_Types.UInt2;
   subtype ADC_CFGR1_DISCNUM_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype ADC_CFGR2_OVSS_Field is Interfaces.Bit_Types.UInt4;
   subtype ADC_CFGR2_OSR_Field is Interfaces.Bit_Types.UInt10;
   subtype ADC_CFGR2_LSHIFT_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype ADC_SMPR1_SMP_Element is Interfaces.Bit_Types.UInt3;
   ...
   subtype ADC_SMPR2_SMP_Element is Interfaces.Bit_Types.UInt3;
   ...
   subtype ADC_SQR1_L_Field is Interfaces.Bit_Types.UInt4;
   subtype ADC_SQR1_SQ1_Field is Interfaces.Bit_Types.UInt5;
   subtype ADC_SQR1_SQ2_Field is Interfaces.Bit_Types.UInt5;
   subtype ADC_SQR1_SQ3_Field is Interfaces.Bit_Types.UInt5;
   subtype ADC_SQR1_SQ4_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype ADC_SQR2_SQ5_Field is Interfaces.Bit_Types.UInt5;
   subtype ADC_SQR2_SQ6_Field is Interfaces.Bit_Types.UInt5;
   subtype ADC_SQR2_SQ7_Field is Interfaces.Bit_Types.UInt5;
   subtype ADC_SQR2_SQ8_Field is Interfaces.Bit_Types.UInt5;
   subtype ADC_SQR2_SQ9_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype ADC_SQR3_SQ10_Field is Interfaces.Bit_Types.UInt5;
   subtype ADC_SQR3_SQ11_Field is Interfaces.Bit_Types.UInt5;
   subtype ADC_SQR3_SQ12_Field is Interfaces.Bit_Types.UInt5;
   subtype ADC_SQR3_SQ13_Field is Interfaces.Bit_Types.UInt5;
   subtype ADC_SQR3_SQ14_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype ADC_SQR4_SQ15_Field is Interfaces.Bit_Types.UInt5;
   subtype ADC_SQR4_SQ16_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype ADC_JSQR_JL_Field is Interfaces.Bit_Types.UInt2;
   subtype ADC_JSQR_JEXTSEL_Field is Interfaces.Bit_Types.UInt5;
   subtype ADC_JSQR_JEXTEN_Field is Interfaces.Bit_Types.UInt2;
   subtype ADC_JSQR_JSQ1_Field is Interfaces.Bit_Types.UInt5;
   subtype ADC_JSQR_JSQ2_Field is Interfaces.Bit_Types.UInt5;
   subtype ADC_JSQR_JSQ3_Field is Interfaces.Bit_Types.UInt5;
   subtype ADC_JSQR_JSQ4_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype ADC_OFR_OFFSET_Field is Interfaces.Bit_Types.UInt24;
   subtype ADC_OFR_OFFSET_CH_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype ADC_GCOMP_GCOMPCOEFF_Field is Interfaces.Bit_Types.UInt14;
   ...
   type ADC_GCOMP_Register is record
      ...
      --  unspecified
      Reserved_14_30 : Interfaces.Bit_Types.UInt17 := 16#0#;
   ...
   subtype ADC_AWD2CR_AWD2CH_Field is Interfaces.Bit_Types.UInt20;
   ...
   subtype ADC_AWD3CR_AWD3CH_Field is Interfaces.Bit_Types.UInt20;
   ...
   subtype ADC_LTR1_LTR1_Field is Interfaces.Bit_Types.UInt25;
   ...
   subtype ADC_HTR1_HTR1_Field is Interfaces.Bit_Types.UInt25;
   subtype ADC_HTR1_AWDFILT1_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype ADC_LTR2_LTR2_Field is Interfaces.Bit_Types.UInt25;
   ...
   subtype ADC_HTR2_HTR2_Field is Interfaces.Bit_Types.UInt25;
   ...
   subtype ADC_LTR3_LTR3_Field is Interfaces.Bit_Types.UInt25;
   ...
   subtype ADC_HTR3_HTR3_Field is Interfaces.Bit_Types.UInt25;
   ...
   subtype ADC_DIFSEL_DIFSEL_Field is Interfaces.Bit_Types.UInt20;
   ...
   subtype ADC_CALFACT_I_APB_ADDR_Field is Interfaces.Bit_Types.Byte;
   subtype ADC_CALFACT_I_APB_DATA_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype ADC_CFGR1_EXTSEL_Field_1 is Interfaces.Bit_Types.UInt3;
   ...
   subtype ADC_CFGR2_OVSR_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype ADC_CHSELRMOD0_CHSEL_Field is Interfaces.Bit_Types.UInt24;
   ...
   subtype ADC_CHSELRMOD1_SQ_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype ADC_CCR_PRESC_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype ADC12_CCR_PRESC_Field is Interfaces.Bit_Types.UInt4;
   ...
   type ADC1_Peripheral is record
      ...
      ADC_DR       : aliased Interfaces.Bit_Types.UInt32;
      --  ADC injected sequence register
      ...
      ADC_JDR1     : aliased Interfaces.Bit_Types.UInt32;
      --  ADC injected data register
      ADC_JDR2     : aliased Interfaces.Bit_Types.UInt32;
      --  ADC injected data register
      ADC_JDR3     : aliased Interfaces.Bit_Types.UInt32;
      --  ADC injected data register
      ADC_JDR4     : aliased Interfaces.Bit_Types.UInt32;
      --  ADC analog watchdog 2 configuration register	
      ...
      ADC_CALFACT2 : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
