...
package Interfaces.STM32.LPTIM is
   ...
   subtype CFGR2_IN1SEL_Field is Interfaces.Bit_Types.UInt2;
   subtype CFGR2_IN2SEL_Field is Interfaces.Bit_Types.UInt2;
   subtype CFGR2_IC1SEL_Field is Interfaces.Bit_Types.UInt2;
   subtype CFGR2_IC2SEL_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype CCMR1_CC1P_Field is Interfaces.Bit_Types.UInt2;
   subtype CCMR1_IC1PSC_Field is Interfaces.Bit_Types.UInt2;
   subtype CCMR1_IC1F_Field is Interfaces.Bit_Types.UInt2;
   subtype CCMR1_CC2P_Field is Interfaces.Bit_Types.UInt2;
   subtype CCMR1_IC2PSC_Field is Interfaces.Bit_Types.UInt2;
   subtype CCMR1_IC2F_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype HWCFGR2_CFG1_Field is Interfaces.Bit_Types.UInt4;
   subtype HWCFGR2_CFG2_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype HWCFGR1_CFG_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype HWCFGR1_CFG3_Field is Interfaces.Bit_Types.UInt4;
   subtype HWCFGR1_CFG4_Field is Interfaces.Bit_Types.Byte;
