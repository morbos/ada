...
package Interfaces.STM32.FMAC is
   ...
   subtype X1BUFCFG_X1_BASE_Field is Interfaces.Bit_Types.Byte;
   subtype X1BUFCFG_X1_BUF_SIZE_Field is Interfaces.Bit_Types.Byte;
   subtype X1BUFCFG_FULL_WM_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype X2BUFCFG_X2_BASE_Field is Interfaces.Bit_Types.Byte;
   subtype X2BUFCFG_X2_BUF_SIZE_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype YBUFCFG_Y_BASE_Field is Interfaces.Bit_Types.Byte;
   subtype YBUFCFG_Y_BUF_SIZE_Field is Interfaces.Bit_Types.Byte;
   subtype YBUFCFG_EMPTY_WM_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype PARAM_P_Field is Interfaces.Bit_Types.Byte;
   subtype PARAM_Q_Field is Interfaces.Bit_Types.Byte;
   subtype PARAM_R_Field is Interfaces.Bit_Types.Byte;
   subtype PARAM_FUNC_Field is Interfaces.Bit_Types.UInt7;
   ...
   subtype WDATA_WDATA_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype RDATA_RDATA_Field is Interfaces.Bit_Types.UInt16;
