...
package STM32_SVD.GPIO is
   ...
   subtype OTYPER_OT_Element is HAL.Bit;
   ...
   --  IDR array element
   subtype IDR_Element is HAL.Bit;
   ...
   --  ODR array element
   subtype ODR_Element is HAL.Bit;
   ...
   subtype BSRR_BS_Element is HAL.Bit;
   ...
   subtype BSRR_BR_Element is HAL.Bit;
   ...
   subtype LCKR_LCK_Element is HAL.Bit;
   ...
   subtype LCKR_LCKK_Field is HAL.Bit;
   ...
   subtype BRR_BR_Element is HAL.Bit;
   ...
   --  OTYPER_OT array
   type OTYPER_OT_Field_Array_1 is array (0 .. 6) of OTYPER_OT_Element
   ...
   --  OTYPER_OT array
   type OTYPER_OT_Field_Array_2 is array (13 .. 15) of OTYPER_OT_Element
   ...
   --  IDR array
   type IDR_Field_Array_1 is array (0 .. 6) of IDR_Element
     with Component_Size => 1, Size => 7;
   ...
   --  IDR array
   type IDR_Field_Array_2 is array (13 .. 15) of IDR_Element
     with Component_Size => 1, Size => 3;
   ...
   --  ODR array
   type ODR_Field_Array_1 is array (0 .. 6) of ODR_Element
     with Component_Size => 1, Size => 7;
   ...
   --  ODR array
   type ODR_Field_Array_2 is array (13 .. 15) of ODR_Element
     with Component_Size => 1, Size => 3;
   ...
   --  BSRR_BS array
   type BSRR_BS_Field_Array_1 is array (0 .. 6) of BSRR_BS_Element
     with Component_Size => 1, Size => 7;
   ...
   --  BSRR_BS array
   type BSRR_BS_Field_Array_2 is array (13 .. 15) of BSRR_BS_Element
     with Component_Size => 1, Size => 3;
   ...
   --  BSRR_BR array
   type BSRR_BR_Field_Array_1 is array (0 .. 6) of BSRR_BR_Element
     with Component_Size => 1, Size => 7;
   ...
   --  BSRR_BR array
   type BSRR_BR_Field_Array_2 is array (13 .. 15) of BSRR_BR_Element
     with Component_Size => 1, Size => 3;
   ...
   --  LCKR_LCK array
   type LCKR_LCK_Field_Array_1 is array (0 .. 6) of LCKR_LCK_Element
     with Component_Size => 1, Size => 7;
   ...
   --  LCKR_LCK array
   type LCKR_LCK_Field_Array_2 is array (13 .. 15) of LCKR_LCK_Element
     with Component_Size => 1, Size => 3;
   ...
   --  BRR_BR array
   type BRR_BR_Field_Array_1 is array (0 .. 6) of BRR_BR_Element
     with Component_Size => 1, Size => 7;
   ...
   --  BRR_BR array
   type BRR_BR_Field_Array_2 is array (13 .. 15) of BRR_BR_Element
     with Component_Size => 1, Size => 3;
   ...
   subtype MODER_MODER3_Field is HAL.UInt2;
   ...
   subtype OTYPER_OT3_Field is HAL.Bit;
   ...
   subtype OSPEEDR_OSPEEDR3_Field is HAL.UInt2;
   ...
   subtype PUPDR_PUPDR3_Field is HAL.UInt2;
   ...
   subtype IDR_IDR3_Field is HAL.Bit;
   ...
   subtype ODR_ODR3_Field is HAL.Bit;
   ...
   subtype BSRR_BS3_Field is HAL.Bit;
   subtype BSRR_BR3_Field is HAL.Bit;
   ...
   subtype LCKR_LCK3_Field is HAL.Bit;
   ...
   subtype AFRL_AFRL3_Field is HAL.UInt4;
   ...
   subtype BRR_BR3_Field is HAL.Bit;
