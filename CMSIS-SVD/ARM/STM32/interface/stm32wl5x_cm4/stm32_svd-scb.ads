...
package STM32_SVD.SCB is
   ...
   subtype ICSR_RETTOBASE_Field is HAL.Bit;
   subtype ICSR_VECTPENDING_Field is HAL.UInt7;
   subtype ICSR_ISRPENDING_Field is HAL.Bit;
   subtype ICSR_PENDSTCLR_Field is HAL.Bit;
   subtype ICSR_PENDSTSET_Field is HAL.Bit;
   subtype ICSR_PENDSVCLR_Field is HAL.Bit;
   subtype ICSR_PENDSVSET_Field is HAL.Bit;
   subtype ICSR_NMIPENDSET_Field is HAL.Bit;
   ...
   subtype AIRCR_VECTRESET_Field is HAL.Bit;
   subtype AIRCR_VECTCLRACTIVE_Field is HAL.Bit;
   subtype AIRCR_SYSRESETREQ_Field is HAL.Bit;
   subtype AIRCR_PRIGROUP_Field is HAL.UInt3;
   subtype AIRCR_ENDIANESS_Field is HAL.Bit;
   ...
   subtype SCR_SLEEPONEXIT_Field is HAL.Bit;
   subtype SCR_SLEEPDEEP_Field is HAL.Bit;
   subtype SCR_SEVEONPEND_Field is HAL.Bit;
   ...
   subtype CCR_NONBASETHRDENA_Field is HAL.Bit;
   subtype CCR_USERSETMPEND_Field is HAL.Bit;
   subtype CCR_UNALIGN_TRP_Field is HAL.Bit;
   subtype CCR_DIV_0_TRP_Field is HAL.Bit;
   subtype CCR_BFHFNMIGN_Field is HAL.Bit;
   subtype CCR_STKALIGN_Field is HAL.Bit;
   ...
   subtype SHCSR_MEMFAULTACT_Field is HAL.Bit;
   subtype SHCSR_BUSFAULTACT_Field is HAL.Bit;
   subtype SHCSR_USGFAULTACT_Field is HAL.Bit;
   subtype SHCSR_SVCALLACT_Field is HAL.Bit;
   subtype SHCSR_MONITORACT_Field is HAL.Bit;
   subtype SHCSR_PENDSVACT_Field is HAL.Bit;
   subtype SHCSR_SYSTICKACT_Field is HAL.Bit;
   subtype SHCSR_USGFAULTPENDED_Field is HAL.Bit;
   subtype SHCSR_MEMFAULTPENDED_Field is HAL.Bit;
   subtype SHCSR_BUSFAULTPENDED_Field is HAL.Bit;
   subtype SHCSR_SVCALLPENDED_Field is HAL.Bit;
   subtype SHCSR_MEMFAULTENA_Field is HAL.Bit;
   subtype SHCSR_BUSFAULTENA_Field is HAL.Bit;
   subtype SHCSR_USGFAULTENA_Field is HAL.Bit;
   ...
   subtype CFSR_UFSR_BFSR_MMFSR_IACCVIOL_Field is HAL.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_MUNSTKERR_Field is HAL.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_MSTKERR_Field is HAL.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_MLSPERR_Field is HAL.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_MMARVALID_Field is HAL.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_IBUSERR_Field is HAL.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_PRECISERR_Field is HAL.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_IMPRECISERR_Field is HAL.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_UNSTKERR_Field is HAL.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_STKERR_Field is HAL.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_LSPERR_Field is HAL.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_BFARVALID_Field is HAL.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_UNDEFINSTR_Field is HAL.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_INVSTATE_Field is HAL.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_INVPC_Field is HAL.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_NOCP_Field is HAL.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_UNALIGNED_Field is HAL.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_DIVBYZERO_Field is HAL.Bit;
   ...
   subtype HFSR_VECTTBL_Field is HAL.Bit;
   subtype HFSR_FORCED_Field is HAL.Bit;
   subtype HFSR_DEBUG_VT_Field is HAL.Bit;
   ...
   subtype ACTRL_DISMCYCINT_Field is HAL.Bit;
   subtype ACTRL_DISDEFWBUF_Field is HAL.Bit;
   subtype ACTRL_DISFOLD_Field is HAL.Bit;
   subtype ACTRL_DISFPCA_Field is HAL.Bit;
   subtype ACTRL_DISOOFP_Field is HAL.Bit;
