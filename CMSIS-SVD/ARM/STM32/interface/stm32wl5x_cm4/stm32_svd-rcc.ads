...
package STM32_SVD.RCC is
   ...
   subtype CR_MSION_Field is HAL.Bit;
   subtype CR_MSIRDY_Field is HAL.Bit;
   subtype CR_MSIPLLEN_Field is HAL.Bit;
   subtype CR_MSIRGSEL_Field is HAL.Bit;
   subtype CR_MSIRANGE_Field is HAL.UInt4;
   subtype CR_HSION_Field is HAL.Bit;
   subtype CR_HSIKERON_Field is HAL.Bit;
   subtype CR_HSIRDY_Field is HAL.Bit;
   subtype CR_HSIASFS_Field is HAL.Bit;
   subtype CR_HSIKERDY_Field is HAL.Bit;
   subtype CR_HSEON_Field is HAL.Bit;
   subtype CR_HSERDY_Field is HAL.Bit;
   subtype CR_CSSON_Field is HAL.Bit;
   subtype CR_HSEPRE_Field is HAL.Bit;
   subtype CR_HSEBYPPWR_Field is HAL.Bit;
   subtype CR_PLLON_Field is HAL.Bit;
   subtype CR_PLLRDY_Field is HAL.Bit;
   ...
   subtype CFGR_STOPWUCK_Field is HAL.Bit;
   subtype CFGR_HPREF_Field is HAL.Bit;
   subtype CFGR_PPRE1F_Field is HAL.Bit;
   subtype CFGR_PPRE2F_Field is HAL.Bit;
   ...
   subtype PLLCFGR_PLLPEN_Field is HAL.Bit;
   subtype PLLCFGR_PLLP_Field is HAL.UInt5;
   subtype PLLCFGR_PLLQEN_Field is HAL.Bit;
   subtype PLLCFGR_PLLQ_Field is HAL.UInt3;
   subtype PLLCFGR_PLLREN_Field is HAL.Bit;
   ...
   subtype CIER_LSIRDYIE_Field is HAL.Bit;
   subtype CIER_LSERDYIE_Field is HAL.Bit;
   subtype CIER_MSIRDYIE_Field is HAL.Bit;
   subtype CIER_HSIRDYIE_Field is HAL.Bit;
   subtype CIER_HSERDYIE_Field is HAL.Bit;
   subtype CIER_PLLRDYIE_Field is HAL.Bit;
   subtype CIER_LSECSSIE_Field is HAL.Bit;
   ...
   subtype CIFR_LSIRDYF_Field is HAL.Bit;
   subtype CIFR_LSERDYF_Field is HAL.Bit;
   subtype CIFR_MSIRDYF_Field is HAL.Bit;
   subtype CIFR_HSIRDYF_Field is HAL.Bit;
   subtype CIFR_HSERDYF_Field is HAL.Bit;
   subtype CIFR_PLLRDYF_Field is HAL.Bit;
   subtype CIFR_CSSF_Field is HAL.Bit;
   subtype CIFR_LSECSSF_Field is HAL.Bit;
   ...
   subtype CICR_LSIRDYC_Field is HAL.Bit;
   subtype CICR_LSERDYC_Field is HAL.Bit;
   subtype CICR_MSIRDYC_Field is HAL.Bit;
   subtype CICR_HSIRDYC_Field is HAL.Bit;
   subtype CICR_HSERDYC_Field is HAL.Bit;
   subtype CICR_PLLRDYC_Field is HAL.Bit;
   subtype CICR_CSSC_Field is HAL.Bit;
   subtype CICR_LSECSSC_Field is HAL.Bit;
   ...
   subtype AHB1RSTR_DMA1RST_Field is HAL.Bit;
   subtype AHB1RSTR_DMA2RST_Field is HAL.Bit;
   subtype AHB1RSTR_DMAMUX1RST_Field is HAL.Bit;
   subtype AHB1RSTR_CRCRST_Field is HAL.Bit;
   ...
   subtype AHB2RSTR_GPIOARST_Field is HAL.Bit;
   subtype AHB2RSTR_GPIOBRST_Field is HAL.Bit;
   subtype AHB2RSTR_GPIOCRST_Field is HAL.Bit;
   subtype AHB2RSTR_GPIOHRST_Field is HAL.Bit;
   ...
   subtype AHB3RSTR_PKARST_Field is HAL.Bit;
   subtype AHB3RSTR_AESRST_Field is HAL.Bit;
   subtype AHB3RSTR_RNGRST_Field is HAL.Bit;
   subtype AHB3RSTR_HSEMRST_Field is HAL.Bit;
   subtype AHB3RSTR_IPCCRST_Field is HAL.Bit;
   subtype AHB3RSTR_FLASHRST_Field is HAL.Bit;
   ...
   subtype APB1RSTR1_TIM2RST_Field is HAL.Bit;
   subtype APB1RSTR1_SPI2S2RST_Field is HAL.Bit;
   subtype APB1RSTR1_USART2RST_Field is HAL.Bit;
   subtype APB1RSTR1_I2C1RST_Field is HAL.Bit;
   subtype APB1RSTR1_I2C2RST_Field is HAL.Bit;
   subtype APB1RSTR1_I2C3RST_Field is HAL.Bit;
   subtype APB1RSTR1_DACRST_Field is HAL.Bit;
   subtype APB1RSTR1_LPTIM1RST_Field is HAL.Bit;
   ...
   subtype APB1RSTR2_LPUART1RST_Field is HAL.Bit;
   subtype APB1RSTR2_LPTIM2RST_Field is HAL.Bit;
   subtype APB1RSTR2_LPTIM3RST_Field is HAL.Bit;
   ...
   subtype APB2RSTR_ADCRST_Field is HAL.Bit;
   subtype APB2RSTR_TIM1RST_Field is HAL.Bit;
   subtype APB2RSTR_SPI1RST_Field is HAL.Bit;
   subtype APB2RSTR_USART1RST_Field is HAL.Bit;
   subtype APB2RSTR_TIM16RST_Field is HAL.Bit;
   subtype APB2RSTR_TIM17RST_Field is HAL.Bit;
   ...
   subtype APB3RSTR_SUBGHZSPIRST_Field is HAL.Bit;
   ...
   subtype AHB1ENR_DMA1EN_Field is HAL.Bit;
   subtype AHB1ENR_DMA2EN_Field is HAL.Bit;
   subtype AHB1ENR_DMAMUX1EN_Field is HAL.Bit;
   subtype AHB1ENR_CRCEN_Field is HAL.Bit;
   ...
   subtype AHB2ENR_GPIOAEN_Field is HAL.Bit;
   subtype AHB2ENR_GPIOBEN_Field is HAL.Bit;
   subtype AHB2ENR_GPIOCEN_Field is HAL.Bit;
   subtype AHB2ENR_GPIOHEN_Field is HAL.Bit;
   ...
   subtype AHB3ENR_PKAEN_Field is HAL.Bit;
   subtype AHB3ENR_AESEN_Field is HAL.Bit;
   subtype AHB3ENR_RNGEN_Field is HAL.Bit;
   subtype AHB3ENR_HSEMEN_Field is HAL.Bit;
   subtype AHB3ENR_IPCCEN_Field is HAL.Bit;
   subtype AHB3ENR_FLASHEN_Field is HAL.Bit;
   ...
   subtype APB1ENR1_TIM2EN_Field is HAL.Bit;
   subtype APB1ENR1_RTCAPBEN_Field is HAL.Bit;
   subtype APB1ENR1_WWDGEN_Field is HAL.Bit;
   subtype APB1ENR1_SPI2S2EN_Field is HAL.Bit;
   subtype APB1ENR1_USART2EN_Field is HAL.Bit;
   subtype APB1ENR1_I2C1EN_Field is HAL.Bit;
   subtype APB1ENR1_I2C2EN_Field is HAL.Bit;
   subtype APB1ENR1_I2C3EN_Field is HAL.Bit;
   subtype APB1ENR1_DAC1EN_Field is HAL.Bit;
   subtype APB1ENR1_LPTIM1EN_Field is HAL.Bit;
   ...
   subtype APB1ENR2_LPUART1EN_Field is HAL.Bit;
   subtype APB1ENR2_LPTIM2EN_Field is HAL.Bit;
   subtype APB1ENR2_LPTIM3EN_Field is HAL.Bit;
   ...
   subtype APB2ENR_ADCEN_Field is HAL.Bit;
   subtype APB2ENR_TIM1EN_Field is HAL.Bit;
   subtype APB2ENR_SPI1EN_Field is HAL.Bit;
   subtype APB2ENR_USART1EN_Field is HAL.Bit;
   subtype APB2ENR_TIM16EN_Field is HAL.Bit;
   subtype APB2ENR_TIM17EN_Field is HAL.Bit;
   ...
   subtype APB3ENR_SUBGHZSPIEN_Field is HAL.Bit;
   ...
   subtype AHB1SMENR_DMA1SMEN_Field is HAL.Bit;
   subtype AHB1SMENR_DMA2SMEN_Field is HAL.Bit;
   subtype AHB1SMENR_DMAMUX1SMEN_Field is HAL.Bit;
   subtype AHB1SMENR_CRCSMEN_Field is HAL.Bit;
   ...
   subtype AHB2SMENR_GPIOASMEN_Field is HAL.Bit;
   subtype AHB2SMENR_GPIOBSMEN_Field is HAL.Bit;
   subtype AHB2SMENR_GPIOCSMEN_Field is HAL.Bit;
   subtype AHB2SMENR_GPIOHSMEN_Field is HAL.Bit;
   ...
   subtype AHB3SMENR_PKASMEN_Field is HAL.Bit;
   subtype AHB3SMENR_AESSMEN_Field is HAL.Bit;
   subtype AHB3SMENR_RNGSMEN_Field is HAL.Bit;
   subtype AHB3SMENR_SRAM1SMEN_Field is HAL.Bit;
   subtype AHB3SMENR_SRAM2SMEN_Field is HAL.Bit;
   subtype AHB3SMENR_FLASHSMEN_Field is HAL.Bit;
   ...
   subtype APB1SMENR1_TIM2SMEN_Field is HAL.Bit;
   subtype APB1SMENR1_RTCAPBSMEN_Field is HAL.Bit;
   subtype APB1SMENR1_WWDGSMEN_Field is HAL.Bit;
   subtype APB1SMENR1_SPI2S2SMEN_Field is HAL.Bit;
   subtype APB1SMENR1_USART2SMEN_Field is HAL.Bit;
   subtype APB1SMENR1_I2C1SMEN_Field is HAL.Bit;
   subtype APB1SMENR1_I2C2SMEN_Field is HAL.Bit;
   subtype APB1SMENR1_I2C3SMEN_Field is HAL.Bit;
   subtype APB1SMENR1_DACSMEN_Field is HAL.Bit;
   subtype APB1SMENR1_LPTIM1SMEN_Field is HAL.Bit;
   ...
   subtype APB1SMENR2_LPUART1SMEN_Field is HAL.Bit;
   subtype APB1SMENR2_LPTIM2SMEN_Field is HAL.Bit;
   subtype APB1SMENR2_LPTIM3SMEN_Field is HAL.Bit;
   ...
   subtype APB2SMENR_ADCSMEN_Field is HAL.Bit;
   subtype APB2SMENR_TIM1SMEN_Field is HAL.Bit;
   subtype APB2SMENR_SPI1SMEN_Field is HAL.Bit;
   subtype APB2SMENR_USART1SMEN_Field is HAL.Bit;
   subtype APB2SMENR_TIM16SMEN_Field is HAL.Bit;
   subtype APB2SMENR_TIM17SMEN_Field is HAL.Bit;
   ...
   subtype APB3SMENR_SUBGHZSPISMEN_Field is HAL.Bit;
   ...
   subtype BDCR_LSEON_Field is HAL.Bit;
   subtype BDCR_LSERDY_Field is HAL.Bit;
   subtype BDCR_LSEBYP_Field is HAL.Bit;
   subtype BDCR_LSEDRV_Field is HAL.UInt2;
   subtype BDCR_LSECSSON_Field is HAL.Bit;
   subtype BDCR_LSECSSD_Field is HAL.Bit;
   subtype BDCR_LSESYSEN_Field is HAL.Bit;
   subtype BDCR_RTCSEL_Field is HAL.UInt2;
   subtype BDCR_LSESYSRDY_Field is HAL.Bit;
   subtype BDCR_RTCEN_Field is HAL.Bit;
   subtype BDCR_BDRST_Field is HAL.Bit;
   subtype BDCR_LSCOEN_Field is HAL.Bit;
   subtype BDCR_LSCOSEL_Field is HAL.Bit;
   ...
   subtype CSR_LSION_Field is HAL.Bit;
   subtype CSR_LSIRDY_Field is HAL.Bit;
   subtype CSR_LSIPRE_Field is HAL.Bit;
   subtype CSR_MSISRANGE_Field is HAL.UInt4;
   subtype CSR_RFRSTF_Field is HAL.Bit;
   subtype CSR_RFRST_Field is HAL.Bit;
   subtype CSR_RMVF_Field is HAL.Bit;
   subtype CSR_RFILARSTF_Field is HAL.Bit;
   subtype CSR_OBLRSTF_Field is HAL.Bit;
   subtype CSR_PINRSTF_Field is HAL.Bit;
   subtype CSR_BORRSTF_Field is HAL.Bit;
   subtype CSR_SFTRSTF_Field is HAL.Bit;
   subtype CSR_IWDGRSTF_Field is HAL.Bit;
   subtype CSR_WWDGRSTF_Field is HAL.Bit;
   subtype CSR_LPWRRSTF_Field is HAL.Bit;
   ...
   subtype EXTCFGR_SHDHPREF_Field is HAL.Bit;
   subtype EXTCFGR_C2HPREF_Field is HAL.Bit;
   ...
   subtype C2AHB1ENR_DMA1EN_Field is HAL.Bit;
   subtype C2AHB1ENR_DMA2EN_Field is HAL.Bit;
   subtype C2AHB1ENR_DMAMUX1EN_Field is HAL.Bit;
   subtype C2AHB1ENR_CRCEN_Field is HAL.Bit;
   ...
   subtype C2AHB2ENR_GPIOAEN_Field is HAL.Bit;
   subtype C2AHB2ENR_GPIOBEN_Field is HAL.Bit;
   subtype C2AHB2ENR_GPIOCEN_Field is HAL.Bit;
   subtype C2AHB2ENR_GPIOHEN_Field is HAL.Bit;
   ...
   subtype C2AHB3ENR_PKAEN_Field is HAL.Bit;
   subtype C2AHB3ENR_AESEN_Field is HAL.Bit;
   subtype C2AHB3ENR_RNGEN_Field is HAL.Bit;
   subtype C2AHB3ENR_HSEMEN_Field is HAL.Bit;
   subtype C2AHB3ENR_IPCCEN_Field is HAL.Bit;
   subtype C2AHB3ENR_FLASHEN_Field is HAL.Bit;
   ...
   subtype C2APB1ENR1_TIM2EN_Field is HAL.Bit;
   subtype C2APB1ENR1_RTCAPBEN_Field is HAL.Bit;
   subtype C2APB1ENR1_SPI2S2EN_Field is HAL.Bit;
   subtype C2APB1ENR1_USART2EN_Field is HAL.Bit;
   subtype C2APB1ENR1_I2C1EN_Field is HAL.Bit;
   subtype C2APB1ENR1_I2C2EN_Field is HAL.Bit;
   subtype C2APB1ENR1_I2C3EN_Field is HAL.Bit;
   subtype C2APB1ENR1_DAC1EN_Field is HAL.Bit;
   subtype C2APB1ENR1_LPTIM1EN_Field is HAL.Bit;
   ...
   subtype C2APB1ENR2_LPUART1EN_Field is HAL.Bit;
   subtype C2APB1ENR2_LPTIM2EN_Field is HAL.Bit;
   subtype C2APB1ENR2_LPTIM3EN_Field is HAL.Bit;
   ...
   subtype C2APB2ENR_ADCEN_Field is HAL.Bit;
   subtype C2APB2ENR_TIM1EN_Field is HAL.Bit;
   subtype C2APB2ENR_SPI1EN_Field is HAL.Bit;
   subtype C2APB2ENR_USART1EN_Field is HAL.Bit;
   subtype C2APB2ENR_TIM16EN_Field is HAL.Bit;
   subtype C2APB2ENR_TIM17EN_Field is HAL.Bit;
   ...
   subtype C2APB3ENR_SUBGHZSPIEN_Field is HAL.Bit;
   ...
   subtype C2AHB1SMENR_DMA1SMEN_Field is HAL.Bit;
   subtype C2AHB1SMENR_DMA2SMEN_Field is HAL.Bit;
   subtype C2AHB1SMENR_DMAMUX1SMEN_Field is HAL.Bit;
   subtype C2AHB1SMENR_CRCSMEN_Field is HAL.Bit;
   ...
   subtype C2AHB2SMENR_GPIOASMEN_Field is HAL.Bit;
   subtype C2AHB2SMENR_GPIOBSMEN_Field is HAL.Bit;
   subtype C2AHB2SMENR_GPIOCSMEN_Field is HAL.Bit;
   subtype C2AHB2SMENR_GPIOHSMEN_Field is HAL.Bit;
   ...
   subtype C2AHB3SMENR_PKASMEN_Field is HAL.Bit;
   subtype C2AHB3SMENR_AESSMEN_Field is HAL.Bit;
   subtype C2AHB3SMENR_RNGSMEN_Field is HAL.Bit;
   subtype C2AHB3SMENR_SRAM1SMEN_Field is HAL.Bit;
   subtype C2AHB3SMENR_SRAM2SMEN_Field is HAL.Bit;
   subtype C2AHB3SMENR_FLASHSMEN_Field is HAL.Bit;
   ...
   subtype C2APB1SMENR1_TIM2SMEN_Field is HAL.Bit;
   subtype C2APB1SMENR1_RTCAPBSMEN_Field is HAL.Bit;
   subtype C2APB1SMENR1_SPI2S2SMEN_Field is HAL.Bit;
   subtype C2APB1SMENR1_USART2SMEN_Field is HAL.Bit;
   subtype C2APB1SMENR1_I2C1SMEN_Field is HAL.Bit;
   subtype C2APB1SMENR1_I2C2SMEN_Field is HAL.Bit;
   subtype C2APB1SMENR1_I2C3SMEN_Field is HAL.Bit;
   subtype C2APB1SMENR1_DAC1SMEN_Field is HAL.Bit;
   subtype C2APB1SMENR1_LPTIM1SMEN_Field is HAL.Bit;
   ...
   subtype C2APB1SMENR2_LPUART1SMEN_Field is HAL.Bit;
   subtype C2APB1SMENR2_LPTIM2SMEN_Field is HAL.Bit;
   subtype C2APB1SMENR2_LPTIM3SMEN_Field is HAL.Bit;
   ...
   subtype C2APB2SMENR_ADCSMEN_Field is HAL.Bit;
   subtype C2APB2SMENR_TIM1SMEN_Field is HAL.Bit;
   subtype C2APB2SMENR_SPI1SMEN_Field is HAL.Bit;
   subtype C2APB2SMENR_USART1SMEN_Field is HAL.Bit;
   subtype C2APB2SMENR_TIM16SMEN_Field is HAL.Bit;
   subtype C2APB2SMENR_TIM17SMEN_Field is HAL.Bit;
   ...
   subtype C2APB3SMENR_SUBGHZSPISMEN_Field is HAL.Bit;
