...
package STM32_SVD.DBGMCU is
   ...
   subtype CR_DBG_SLEEP_Field is HAL.Bit;
   subtype CR_DBG_STOP_Field is HAL.Bit;
   subtype CR_DBG_STANDBY_Field is HAL.Bit;
   ...
   subtype APB1FZR1_DBG_TIM2_STOP_Field is HAL.Bit;
   subtype APB1FZR1_DBG_RTC_STOP_Field is HAL.Bit;
   subtype APB1FZR1_DBG_WWDG_STOP_Field is HAL.Bit;
   subtype APB1FZR1_DBG_IWDG_STOP_Field is HAL.Bit;
   subtype APB1FZR1_DBG_I2C1_STOP_Field is HAL.Bit;
   subtype APB1FZR1_DBG_I2C2_STOP_Field is HAL.Bit;
   subtype APB1FZR1_DBG_I2C3_STOP_Field is HAL.Bit;
   subtype APB1FZR1_DBG_LPTIM1_STOP_Field is HAL.Bit;
   ...
   subtype C2APB1FZR1_DBG_TIM2_STOP_Field is HAL.Bit;
   subtype C2APB1FZR1_DBG_RTC_STOP_Field is HAL.Bit;
   subtype C2APB1FZR1_DBG_IWDG_STOP_Field is HAL.Bit;
   subtype C2APB1FZR1_DBG_I2C1_STOP_Field is HAL.Bit;
   subtype C2APB1FZR1_DBG_I2C2_STOP_Field is HAL.Bit;
   subtype C2APB1FZR1_DBG_I2C3_STOP_Field is HAL.Bit;
   subtype C2APB1FZR1_DBG_LPTIM1_STOP_Field is HAL.Bit;

   --  DBGMCU CPU2 APB1 Peripheral Freeze Register 1 [dual core device
   type C2APB1FZR1_Register is record
      --  DBG_TIM2_STOP
      DBG_TIM2_STOP   : C2APB1FZR1_DBG_TIM2_STOP_Field := 16#0#;
      --  unspecified
      Reserved_1_9    : HAL.UInt9 := 16#0#;
      --  DBG_RTC_STOP
      DBG_RTC_STOP    : C2APB1FZR1_DBG_RTC_STOP_Field := 16#0#;
      --  unspecified
      Reserved_11_11  : HAL.Bit := 16#0#;
      --  DBG_IWDG_STOP
      DBG_IWDG_STOP   : C2APB1FZR1_DBG_IWDG_STOP_Field := 16#0#;
      --  unspecified
      Reserved_13_20  : HAL.UInt8 := 16#0#;
      --  DBG_I2C1_STOP
      DBG_I2C1_STOP   : C2APB1FZR1_DBG_I2C1_STOP_Field := 16#0#;
      --  DBG_I2C2_STOP
      DBG_I2C2_STOP   : C2APB1FZR1_DBG_I2C2_STOP_Field := 16#0#;
      --  DBG_I2C3_STOP
      DBG_I2C3_STOP   : C2APB1FZR1_DBG_I2C3_STOP_Field := 16#0#;
      --  unspecified
      Reserved_24_30  : HAL.UInt7 := 16#0#;
      --  DBG_LPTIM1_STOP
      DBG_LPTIM1_STOP : C2APB1FZR1_DBG_LPTIM1_STOP_Field := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype APB1FZR2_DBG_LPTIM2_STOP_Field is HAL.Bit;
   subtype APB1FZR2_DBG_LPTIM3_STOP_Field is HAL.Bit;
   ...
   type APB1FZR2_Register is record
      ...
      --  DBG_LPTIM3_STOP
      DBG_LPTIM3_STOP : APB1FZR2_DBG_LPTIM3_STOP_Field := 16#0#;
      --  unspecified
   ...
   subtype C2APB1FZR2_DBG_LPTIM2_STOP_Field is HAL.Bit;
   subtype C2APB1FZR2_DBG_LPTIM3_STOP_Field is HAL.Bit;
   ...
   type C2APB1FZR2_Register is record
      ...
      Reserved_0_4    : HAL.UInt5 := 16#0#;
      --  DBG_LPTIM2_STOP
      DBG_LPTIM2_STOP : C2APB1FZR2_DBG_LPTIM2_STOP_Field := 16#0#;
      --  DBG_LPTIM3_STOP
      DBG_LPTIM3_STOP : C2APB1FZR2_DBG_LPTIM3_STOP_Field := 16#0#;
      --  unspecified
      Reserved_7_31   : HAL.UInt25 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype APB2FZR_DBG_TIM1_STOP_Field is HAL.Bit;
   subtype APB2FZR_DBG_TIM16_STOP_Field is HAL.Bit;
   subtype APB2FZR_DBG_TIM17_STOP_Field is HAL.Bit;
   ...
   type APB2FZR_Register is record
      ...
      --  DBG_TIM17_STOP
      DBG_TIM17_STOP : APB2FZR_DBG_TIM17_STOP_Field := 16#0#;
      --  unspecified
   ...
   subtype C2APB2FZR_DBG_TIM1_STOP_Field is HAL.Bit;
   subtype C2APB2FZR_DBG_TIM16_STOP_Field is HAL.Bit;
   subtype C2APB2FZR_DBG_TIM17_STOP_Field is HAL.Bit;
   ...
   type C2APB2FZR_Register is record
      ...
      Reserved_0_10  : HAL.UInt11 := 16#0#;
      --  DBG_TIM1_STOP
      DBG_TIM1_STOP  : C2APB2FZR_DBG_TIM1_STOP_Field := 16#0#;
      --  unspecified
      Reserved_12_16 : HAL.UInt5 := 16#0#;
      --  DBG_TIM16_STOP
      DBG_TIM16_STOP : C2APB2FZR_DBG_TIM16_STOP_Field := 16#0#;
      --  DBG_TIM17_STOP
      DBG_TIM17_STOP : C2APB2FZR_DBG_TIM17_STOP_Field := 16#0#;
      --  unspecified
      Reserved_19_31 : HAL.UInt13 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
