...
package STM32_SVD.PKA is
   ...
   subtype CR_EN_Field is HAL.Bit;
   subtype CR_START_Field is HAL.Bit;
   subtype CR_MODE_Field is HAL.UInt6;
   subtype CR_PROCENDIE_Field is HAL.Bit;
   subtype CR_RAMERRIE_Field is HAL.Bit;
   subtype CR_ADDRERRIE_Field is HAL.Bit;
   ...
   subtype SR_BUSY_Field is HAL.Bit;
   subtype SR_PROCENDF_Field is HAL.Bit;
   subtype SR_RAMERRF_Field is HAL.Bit;
   subtype SR_ADDRERRF_Field is HAL.Bit;
   ...
   subtype CLRFR_PROCENDFC_Field is HAL.Bit;
   subtype CLRFR_RAMERRFC_Field is HAL.Bit;
   subtype CLRFR_ADDRERRFC_Field is HAL.Bit;
