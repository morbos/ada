...
package STM32_SVD.DAC is
   ...
   subtype CR_EN1_Field is HAL.Bit;
   subtype CR_TEN1_Field is HAL.Bit;
   --  CR_TSEL array element
   subtype CR_TSEL_Element is HAL.Bit;
   ...
   subtype CR_DMAEN1_Field is HAL.Bit;
   subtype CR_DMAUDRIE1_Field is HAL.Bit;
   subtype CR_CEN1_Field is HAL.Bit;
   ...
   subtype SWTRGR_SWTRIG1_Field is HAL.Bit;
   ...
   subtype SR_DMAUDR1_Field is HAL.Bit;
   subtype SR_CAL_FLAG1_Field is HAL.Bit;
   subtype SR_BWST1_Field is HAL.Bit;
