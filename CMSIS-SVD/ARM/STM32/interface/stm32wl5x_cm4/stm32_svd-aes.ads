...
package STM32_SVD.AES is
   ...
   subtype CR_CCFC_Field is HAL.Bit;
   subtype CR_ERRC_Field is HAL.Bit;
   subtype CR_CCFIE_Field is HAL.Bit;
   subtype CR_ERRIE_Field is HAL.Bit;
   subtype CR_DMAINEN_Field is HAL.Bit;
   subtype CR_DMAOUTEN_Field is HAL.Bit;
   subtype CR_GCMPH_Field is HAL.UInt2;
   subtype CR_CHMOD2_Field is HAL.Bit;
   subtype CR_KEYSIZE_Field is HAL.Bit;
   ...
   subtype SR_CCF_Field is HAL.Bit;
   subtype SR_RDERR_Field is HAL.Bit;
   subtype SR_WRERR_Field is HAL.Bit;
