...
package STM32_SVD.COMP is
   ...
   subtype COMP1_CSR_EN_Field is HAL.Bit;
   ...
   subtype COMP1_CSR_POLARITY_Field is HAL.Bit;
   subtype COMP1_CSR_HYST_Field is HAL.UInt2;
   subtype COMP1_CSR_BLANKING_Field is HAL.UInt3;
   subtype COMP1_CSR_BRGEN_Field is HAL.Bit;
   subtype COMP1_CSR_SCALEN_Field is HAL.Bit;
   subtype COMP1_CSR_INMESEL_Field is HAL.UInt2;
   subtype COMP1_CSR_VALUE_Field is HAL.Bit;
   subtype COMP1_CSR_LOCK_Field is HAL.Bit;
   ...
   subtype COMP2_CSR_EN_Field is HAL.Bit;
   ...
   subtype COMP2_CSR_WINMODE_Field is HAL.Bit;
   subtype COMP2_CSR_POLARITY_Field is HAL.Bit;
   subtype COMP2_CSR_HYST_Field is HAL.UInt2;
   subtype COMP2_CSR_BLANKING_Field is HAL.UInt3;
   subtype COMP2_CSR_BRGEN_Field is HAL.Bit;
   subtype COMP2_CSR_SCALEN_Field is HAL.Bit;
   subtype COMP2_CSR_INMESEL_Field is HAL.UInt2;
   subtype COMP2_CSR_VALUE_Field is HAL.Bit;
   subtype COMP2_CSR_LOCK_Field is HAL.Bit;
