...
package STM32_SVD.SPI is
   ...
   subtype CR1_CPHA_Field is HAL.Bit;
   subtype CR1_CPOL_Field is HAL.Bit;
   subtype CR1_MSTR_Field is HAL.Bit;
   subtype CR1_BR_Field is HAL.UInt3;
   subtype CR1_SPE_Field is HAL.Bit;
   subtype CR1_LSBFIRST_Field is HAL.Bit;
   subtype CR1_SSI_Field is HAL.Bit;
   subtype CR1_SSM_Field is HAL.Bit;
   subtype CR1_RXONLY_Field is HAL.Bit;
   subtype CR1_DFF_Field is HAL.Bit;
   subtype CR1_CRCNEXT_Field is HAL.Bit;
   subtype CR1_CRCEN_Field is HAL.Bit;
   subtype CR1_BIDIOE_Field is HAL.Bit;
   subtype CR1_BIDIMODE_Field is HAL.Bit;
   ...
   subtype CR2_RXDMAEN_Field is HAL.Bit;
   subtype CR2_TXDMAEN_Field is HAL.Bit;
   subtype CR2_SSOE_Field is HAL.Bit;
   subtype CR2_NSSP_Field is HAL.Bit;
   subtype CR2_FRF_Field is HAL.Bit;
   subtype CR2_ERRIE_Field is HAL.Bit;
   subtype CR2_RXNEIE_Field is HAL.Bit;
   subtype CR2_TXEIE_Field is HAL.Bit;
   subtype CR2_DS_Field is HAL.UInt4;
   subtype CR2_FRXTH_Field is HAL.Bit;
   subtype CR2_LDMA_RX_Field is HAL.Bit;
   subtype CR2_LDMA_TX_Field is HAL.Bit;
   ...
   subtype SR_RXNE_Field is HAL.Bit;
   subtype SR_TXE_Field is HAL.Bit;
   subtype SR_CHSIDE_Field is HAL.Bit;
   subtype SR_UDR_Field is HAL.Bit;
   subtype SR_CRCERR_Field is HAL.Bit;
   subtype SR_MODF_Field is HAL.Bit;
   subtype SR_OVR_Field is HAL.Bit;
   subtype SR_BSY_Field is HAL.Bit;
   subtype SR_TIFRFE_Field is HAL.Bit;
   ...
   subtype I2SCFGR_CHLEN_Field is HAL.Bit;
   subtype I2SCFGR_DATLEN_Field is HAL.UInt2;
   subtype I2SCFGR_CKPOL_Field is HAL.Bit;
   subtype I2SCFGR_I2SSTD_Field is HAL.UInt2;
   subtype I2SCFGR_PCMSYNC_Field is HAL.Bit;
   subtype I2SCFGR_I2SCFG_Field is HAL.UInt2;
   subtype I2SCFGR_I2SE_Field is HAL.Bit;
   subtype I2SCFGR_I2SMOD_Field is HAL.Bit;
   subtype I2SCFGR_ASTRTEN_Field is HAL.Bit;
   ...
   subtype I2SPR_ODD_Field is HAL.Bit;
   subtype I2SPR_MCKOE_Field is HAL.Bit;
