...
package STM32_SVD.STK is
   ...
   subtype CTRL_ENABLE_Field is HAL.Bit;
   subtype CTRL_TICKINT_Field is HAL.Bit;
   subtype CTRL_CLKSOURCE_Field is HAL.Bit;
   subtype CTRL_COUNTFLAG_Field is HAL.Bit;
   ...
   subtype CALIB_SKEW_Field is HAL.Bit;
   subtype CALIB_NOREF_Field is HAL.Bit;
