...
package STM32_SVD.AdavanceTIM is
   ...
   subtype CR2_OIS2_Field is HAL.Bit;
   subtype CR2_OIS2N_Field is HAL.Bit;
   subtype CR2_OIS3_Field is HAL.Bit;
   subtype CR2_OIS3N_Field is HAL.Bit;
   subtype CR2_OIS4_Field is HAL.Bit;
   subtype CR2_OIS5_Field is HAL.Bit;
   subtype CR2_OIS6_Field is HAL.Bit;
   ...
   subtype DIER_TDE_Field is HAL.Bit;
   ...
   subtype SR_B2IF_Field is HAL.Bit;
   ...
   subtype SR_SBIF_Field is HAL.Bit;
   subtype SR_CC5IF_Field is HAL.Bit;
   subtype SR_CC6IF_Field is HAL.Bit;
   ...
   subtype EGR_COM_Field is HAL.Bit;
   subtype EGR_TG_Field is HAL.Bit;
   subtype EGR_BG_Field is HAL.Bit;
   subtype EGR_B2G_Field is HAL.Bit;
   ...
   subtype CCER_CC2NE_Field is HAL.Bit;
   subtype CCER_CC2NP_Field is HAL.Bit;
   subtype CCER_CC3E_Field is HAL.Bit;
   subtype CCER_CC3P_Field is HAL.Bit;
   subtype CCER_CC3NE_Field is HAL.Bit;
   subtype CCER_CC3NP_Field is HAL.Bit;
   subtype CCER_CC4E_Field is HAL.Bit;
   subtype CCER_CC4P_Field is HAL.Bit;
   subtype CCER_CC5E_Field is HAL.Bit;
   subtype CCER_CC5P_Field is HAL.Bit;
   subtype CCER_CC6E_Field is HAL.Bit;
   subtype CCER_CC6P_Field is HAL.Bit;
   ...
   subtype CNT_UIFCPY_Field is HAL.Bit;
   ...
   subtype BDTR_BK2E_Field is HAL.Bit;
   subtype BDTR_BK2P_Field is HAL.Bit;
   subtype BDTR_BKDSRM_Field is HAL.Bit;
   subtype BDTR_BK2DSRM_Field is HAL.Bit;
   subtype BDTR_BKBID_Field is HAL.Bit;
   subtype BDTR_BK2BID_Field is HAL.Bit;
   ...
   subtype OR1_TI1_RMP_Field is HAL.Bit;
   ...
   subtype CCMR3OutputComparemode_OC5FE_Field is HAL.Bit;
   subtype CCMR3OutputComparemode_OC5PE_Field is HAL.Bit;
   subtype CCMR3OutputComparemode_OC5M_Field is HAL.UInt3;
   subtype CCMR3OutputComparemode_OC5CE_Field is HAL.Bit;
   subtype CCMR3OutputComparemode_OC6FE_Field is HAL.Bit;
   subtype CCMR3OutputComparemode_OC6PE_Field is HAL.Bit;
   subtype CCMR3OutputComparemode_OC6M_Field is HAL.UInt3;
   subtype CCMR3OutputComparemode_OC6CE_Field is HAL.Bit;
   subtype CCMR3OutputComparemode_OC5M_3_Field is HAL.Bit;
   subtype CCMR3OutputComparemode_OC6M_3_Field is HAL.Bit;
   ...
   subtype CCR5_GC5C_Element is HAL.Bit;
   ...
   subtype AF1_BKINE_Field is HAL.Bit;
   subtype AF1_BKCMP1E_Field is HAL.Bit;
   subtype AF1_BKCMP2E_Field is HAL.Bit;
   subtype AF1_BKINP_Field is HAL.Bit;
   subtype AF1_BKCMP1P_Field is HAL.Bit;
   subtype AF1_BKCMP2P_Field is HAL.Bit;
   ...
   subtype AF2_BK2INE_Field is HAL.Bit;
   subtype AF2_BK2CMP1E_Field is HAL.Bit;
   subtype AF2_BK2CMP2E_Field is HAL.Bit;
   subtype AF2_BK2INP_Field is HAL.Bit;
   subtype AF2_BK2CMP1P_Field is HAL.Bit;
   subtype AF2_BK2CMP2P_Field is HAL.Bit;
