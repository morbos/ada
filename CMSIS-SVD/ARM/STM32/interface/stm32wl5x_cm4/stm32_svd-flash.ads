...
package STM32_SVD.Flash is
   ...
   subtype ACR_PRFTEN_Field is HAL.Bit;
   subtype ACR_ICEN_Field is HAL.Bit;
   subtype ACR_DCEN_Field is HAL.Bit;
   subtype ACR_ICRST_Field is HAL.Bit;
   subtype ACR_DCRST_Field is HAL.Bit;
   subtype ACR_PES_Field is HAL.Bit;
   subtype ACR_EMPTY_Field is HAL.Bit;
   ...
   subtype ACR2_PRIVMODE_Field is HAL.Bit;
   subtype ACR2_HDPADIS_Field is HAL.Bit;
   subtype ACR2_C2SWDBGEN_Field is HAL.Bit;
   ...
   subtype SR_EOP_Field is HAL.Bit;
   subtype SR_OPERR_Field is HAL.Bit;
   subtype SR_PROGERR_Field is HAL.Bit;
   subtype SR_WRPERR_Field is HAL.Bit;
   subtype SR_PGAERR_Field is HAL.Bit;
   subtype SR_SIZERR_Field is HAL.Bit;
   subtype SR_PGSERR_Field is HAL.Bit;
   subtype SR_MISERR_Field is HAL.Bit;
   subtype SR_FASTERR_Field is HAL.Bit;
   subtype SR_OPTVN_Field is HAL.Bit;
   subtype SR_RDERR_Field is HAL.Bit;
   subtype SR_OPTVERR_Field is HAL.Bit;
   subtype SR_BSY_Field is HAL.Bit;
   subtype SR_CFGBSY_Field is HAL.Bit;
   subtype SR_PESD_Field is HAL.Bit;
   ...
   subtype CR_PG_Field is HAL.Bit;
   subtype CR_PER_Field is HAL.Bit;
   subtype CR_MER_Field is HAL.Bit;
   subtype CR_PNB_Field is HAL.UInt7;
   subtype CR_STRT_Field is HAL.Bit;
   subtype CR_OPTSTRT_Field is HAL.Bit;
   subtype CR_FSTPG_Field is HAL.Bit;
   subtype CR_EOPIE_Field is HAL.Bit;
   subtype CR_ERRIE_Field is HAL.Bit;
   subtype CR_RDERRIE_Field is HAL.Bit;
   subtype CR_OBL_LAUNCH_Field is HAL.Bit;
   subtype CR_OPTLOCK_Field is HAL.Bit;
   subtype CR_LOCK_Field is HAL.Bit;
   ...
   subtype ECCR_SYSF_ECC_Field is HAL.Bit;
   subtype ECCR_ECCCIE_Field is HAL.Bit;
   subtype ECCR_CPUID_Field is HAL.UInt3;
   subtype ECCR_ECCC_Field is HAL.Bit;
   subtype ECCR_ECCD_Field is HAL.Bit;
   ...
   subtype OPTR_ESE_Field is HAL.Bit;
   subtype OPTR_BOR_LEV_Field is HAL.UInt3;
   subtype OPTR_nRST_STOP_Field is HAL.Bit;
   subtype OPTR_nRST_STDBY_Field is HAL.Bit;
   subtype OPTR_nRST_SHDW_Field is HAL.Bit;
   subtype OPTR_IWDG_SW_Field is HAL.Bit;
   subtype OPTR_IWDG_STOP_Field is HAL.Bit;
   subtype OPTR_IWDG_STDBY_Field is HAL.Bit;
   subtype OPTR_WWDG_SW_Field is HAL.Bit;
   subtype OPTR_nBOOT1_Field is HAL.Bit;
   subtype OPTR_SRAM2_PE_Field is HAL.Bit;
   subtype OPTR_SRAM2_RST_Field is HAL.Bit;
   subtype OPTR_nSWBOOT0_Field is HAL.Bit;
   subtype OPTR_nBOOT0_Field is HAL.Bit;
   subtype OPTR_BOOT_LOCK_Field is HAL.Bit;
   subtype OPTR_C2BOOT_LOCK_Field is HAL.Bit;
   ...
   subtype PCROP1ASR_PCROP1A_STRT_Field is HAL.UInt8;
   ...
   subtype PCROP1AER_PCROP1A_END_Field is HAL.UInt8;
   subtype PCROP1AER_PCROP_RDP_Field is HAL.Bit;
   ...
   type PCROP1AER_Register is record
      ...
      --  unspecified
      Reserved_8_30 : HAL.UInt23 := 16#7FFFFF#;
   ...
   type WRP1AR_Register is record
      ...
      --  unspecified
      Reserved_7_15  : HAL.UInt9 := 16#1FF#;
   ...
   subtype PCROP1BSR_PCROP1B_STRT_Field is HAL.UInt8;
   ...
   subtype PCROP1BER_PCROP1B_END_Field is HAL.UInt8;
   ...
   subtype C2ACR_PRFTEN_Field is HAL.Bit;
   subtype C2ACR_ICEN_Field is HAL.Bit;
   subtype C2ACR_ICRST_Field is HAL.Bit;
   subtype C2ACR_PES_Field is HAL.Bit;
   ...
   subtype C2SR_EOP_Field is HAL.Bit;
   subtype C2SR_OPERR_Field is HAL.Bit;
   subtype C2SR_PROGERR_Field is HAL.Bit;
   subtype C2SR_WRPERR_Field is HAL.Bit;
   subtype C2SR_PGAERR_Field is HAL.Bit;
   subtype C2SR_SIZERR_Field is HAL.Bit;
   subtype C2SR_PGSERR_Field is HAL.Bit;
   subtype C2SR_MISERR_Field is HAL.Bit;
   subtype C2SR_FASTERR_Field is HAL.Bit;
   subtype C2SR_RDERR_Field is HAL.Bit;
   subtype C2SR_BSY_Field is HAL.Bit;
   subtype C2SR_CFGBSY_Field is HAL.Bit;
   subtype C2SR_PESD_Field is HAL.Bit;
   ...
   subtype C2CR_PG_Field is HAL.Bit;
   subtype C2CR_PER_Field is HAL.Bit;
   subtype C2CR_MER_Field is HAL.Bit;
   subtype C2CR_PNB_Field is HAL.UInt7;
   subtype C2CR_STRT_Field is HAL.Bit;
   subtype C2CR_FSTPG_Field is HAL.Bit;
   subtype C2CR_EOPIE_Field is HAL.Bit;
   subtype C2CR_ERRIE_Field is HAL.Bit;
   subtype C2CR_RDERRIE_Field is HAL.Bit;
   ...
   type C2CR_Register is record
      ...
      --  unspecified
      Reserved_27_31 : HAL.UInt5 := 16#18#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype SFR_SFSA_Field is HAL.UInt7;
   subtype SFR_FSD_Field is HAL.Bit;
   subtype SFR_DDS_Field is HAL.Bit;
   subtype SFR_HDPSA_Field is HAL.UInt7;
   subtype SFR_HDPAD_Field is HAL.Bit;
   subtype SFR_SUBGHSPISD_Field is HAL.Bit;
   ...
   type SFR_Register is record
      ...
      --  unspecified
      Reserved_24_30 : HAL.UInt7 := 16#7F#;
   ...
   subtype SRRVR_SBRV_Field is HAL.UInt16;
   subtype SRRVR_SBRSA_Field is HAL.UInt5;
   subtype SRRVR_BRSD_Field is HAL.Bit;
   subtype SRRVR_SNBRSA_Field is HAL.UInt5;
   subtype SRRVR_NBRSD_Field is HAL.Bit;
   subtype SRRVR_C2OPT_Field is HAL.Bit;
