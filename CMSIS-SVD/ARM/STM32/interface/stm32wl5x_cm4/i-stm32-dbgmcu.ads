...
package Interfaces.STM32.DBGMCU is
   ...
   subtype IDCODER_DEV_ID_Field is Interfaces.Bit_Types.UInt12;
   subtype IDCODER_REV_ID_Field is Interfaces.Bit_Types.UInt16;
   ...
   type APB2FZR_Register is record
      ...
      --  unspecified
      Reserved_12_16 : Interfaces.Bit_Types.UInt5 := 16#0#;
      --  DBG_TIM16_STOP
