...
package STM32_SVD.DMAMUX is
   ...
   subtype C0CR_SOIE_Field is HAL.Bit;
   subtype C0CR_EGE_Field is HAL.Bit;
   subtype C0CR_SE_Field is HAL.Bit;
   ...
   subtype C1CR_SOIE_Field is HAL.Bit;
   subtype C1CR_EGE_Field is HAL.Bit;
   subtype C1CR_SE_Field is HAL.Bit;
   ...
   subtype C2CR_SOIE_Field is HAL.Bit;
   subtype C2CR_EGE_Field is HAL.Bit;
   subtype C2CR_SE_Field is HAL.Bit;
   ...
   subtype C3CR_SOIE_Field is HAL.Bit;
   subtype C3CR_EGE_Field is HAL.Bit;
   subtype C3CR_SE_Field is HAL.Bit;
   ...
   subtype C4CR_SOIE_Field is HAL.Bit;
   subtype C4CR_EGE_Field is HAL.Bit;
   subtype C4CR_SE_Field is HAL.Bit;
   ...
   subtype C5CR_SOIE_Field is HAL.Bit;
   subtype C5CR_EGE_Field is HAL.Bit;
   subtype C5CR_SE_Field is HAL.Bit;
   ...
   subtype C6CR_SOIE_Field is HAL.Bit;
   subtype C6CR_EGE_Field is HAL.Bit;
   subtype C6CR_SE_Field is HAL.Bit;
   ...
   subtype C7CR_SOIE_Field is HAL.Bit;
   subtype C7CR_EGE_Field is HAL.Bit;
   subtype C7CR_SE_Field is HAL.Bit;
   ...
   subtype C8CR_SOIE_Field is HAL.Bit;
   subtype C8CR_EGE_Field is HAL.Bit;
   subtype C8CR_SE_Field is HAL.Bit;
   ...
   subtype C9CR_SOIE_Field is HAL.Bit;
   subtype C9CR_EGE_Field is HAL.Bit;
   subtype C9CR_SE_Field is HAL.Bit;
   ...
   subtype C10CR_SOIE_Field is HAL.Bit;
   subtype C10CR_EGE_Field is HAL.Bit;
   subtype C10CR_SE_Field is HAL.Bit;
   ...
   subtype C11CR_SOIE_Field is HAL.Bit;
   subtype C11CR_EGE_Field is HAL.Bit;
   subtype C11CR_SE_Field is HAL.Bit;
   ...
   subtype C12CR_SOIE_Field is HAL.Bit;
   subtype C12CR_EGE_Field is HAL.Bit;
   subtype C12CR_SE_Field is HAL.Bit;
   ...
   subtype C13CR_SOIE_Field is HAL.Bit;
   subtype C13CR_EGE_Field is HAL.Bit;
   subtype C13CR_SE_Field is HAL.Bit;
   ...
   subtype CSR_SOF_Element is HAL.Bit;
   ...
   --  CCFR_CSOF array element
   subtype CCFR_CSOF_Element is HAL.Bit;

   --  CCFR_CSOF array
   type CCFR_CSOF_Field_Array is array (0 .. 13) of CCFR_CSOF_Element
     with Component_Size => 1, Size => 14;
   ...
   subtype RG0CR_OIE_Field is HAL.Bit;
   subtype RG0CR_GE_Field is HAL.Bit;
   ...
   subtype RG1CR_OIE_Field is HAL.Bit;
   subtype RG1CR_GE_Field is HAL.Bit;
   ...
   subtype RG2CR_OIE_Field is HAL.Bit;
   subtype RG2CR_GE_Field is HAL.Bit;
   ...
   subtype RG3CR_OIE_Field is HAL.Bit;
   subtype RG3CR_GE_Field is HAL.Bit;
   ...
   subtype RGSR_OF_Element is HAL.Bit;
   ...
   subtype RGCFR_COF_Element is HAL.Bit;
