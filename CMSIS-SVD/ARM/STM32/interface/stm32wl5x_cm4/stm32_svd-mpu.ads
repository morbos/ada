...
package STM32_SVD.MPU is
   ...
   subtype MPU_TYPER_SEPARATE_Field is HAL.Bit;
   ...
   subtype MPU_CTRL_ENABLE_Field is HAL.Bit;
   subtype MPU_CTRL_HFNMIENA_Field is HAL.Bit;
   subtype MPU_CTRL_PRIVDEFENA_Field is HAL.Bit;
   ...
   subtype MPU_RBAR_VALID_Field is HAL.Bit;
   ...
   subtype MPU_RASR_ENABLE_Field is HAL.Bit;
   subtype MPU_RASR_SIZE_Field is HAL.UInt5;
   subtype MPU_RASR_SRD_Field is HAL.UInt8;
   subtype MPU_RASR_B_Field is HAL.Bit;
   subtype MPU_RASR_C_Field is HAL.Bit;
   subtype MPU_RASR_S_Field is HAL.Bit;
   subtype MPU_RASR_TEX_Field is HAL.UInt3;
   subtype MPU_RASR_AP_Field is HAL.UInt3;
   subtype MPU_RASR_XN_Field is HAL.Bit;
