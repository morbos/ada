...
package STM32_SVD.I2C is
   ...
   subtype CR1_PE_Field is HAL.Bit;
   subtype CR1_TXIE_Field is HAL.Bit;
   subtype CR1_RXIE_Field is HAL.Bit;
   subtype CR1_ADDRIE_Field is HAL.Bit;
   subtype CR1_NACKIE_Field is HAL.Bit;
   subtype CR1_STOPIE_Field is HAL.Bit;
   subtype CR1_TCIE_Field is HAL.Bit;
   subtype CR1_ERRIE_Field is HAL.Bit;
   subtype CR1_DNF_Field is HAL.UInt4;
   subtype CR1_ANFOFF_Field is HAL.Bit;
   subtype CR1_TXDMAEN_Field is HAL.Bit;
   subtype CR1_RXDMAEN_Field is HAL.Bit;
   subtype CR1_SBC_Field is HAL.Bit;
   subtype CR1_NOSTRETCH_Field is HAL.Bit;
   subtype CR1_WUPEN_Field is HAL.Bit;
   subtype CR1_GCEN_Field is HAL.Bit;
   subtype CR1_SMBHEN_Field is HAL.Bit;
   subtype CR1_SMBDEN_Field is HAL.Bit;
   subtype CR1_ALERTEN_Field is HAL.Bit;
   subtype CR1_PECEN_Field is HAL.Bit;
   ...
   subtype CR2_RD_WRN_Field is HAL.Bit;
   subtype CR2_ADD10_Field is HAL.Bit;
   subtype CR2_HEAD10R_Field is HAL.Bit;
   subtype CR2_START_Field is HAL.Bit;
   subtype CR2_STOP_Field is HAL.Bit;
   subtype CR2_NACK_Field is HAL.Bit;
   subtype CR2_NBYTES_Field is HAL.UInt8;
   subtype CR2_RELOAD_Field is HAL.Bit;
   subtype CR2_AUTOEND_Field is HAL.Bit;
   subtype CR2_PECBYTE_Field is HAL.Bit;
   ...
   subtype OAR1_OA1MODE_Field is HAL.Bit;
   subtype OAR1_OA1EN_Field is HAL.Bit;
   ...
   subtype OAR2_OA2EN_Field is HAL.Bit;
   ...
   subtype TIMEOUTR_TIDLE_Field is HAL.Bit;
   subtype TIMEOUTR_TIMOUTEN_Field is HAL.Bit;
   subtype TIMEOUTR_TIMEOUTB_Field is HAL.UInt12;
   subtype TIMEOUTR_TEXTEN_Field is HAL.Bit;
   ...
   subtype ISR_TXIS_Field is HAL.Bit;
   subtype ISR_RXNE_Field is HAL.Bit;
   subtype ISR_ADDR_Field is HAL.Bit;
   subtype ISR_NACKF_Field is HAL.Bit;
   subtype ISR_STOPF_Field is HAL.Bit;
   subtype ISR_TC_Field is HAL.Bit;
   subtype ISR_TCR_Field is HAL.Bit;
   subtype ISR_BERR_Field is HAL.Bit;
   subtype ISR_ARLO_Field is HAL.Bit;
   subtype ISR_OVR_Field is HAL.Bit;
   subtype ISR_PECERR_Field is HAL.Bit;
   subtype ISR_TIMEOUT_Field is HAL.Bit;
   subtype ISR_ALERT_Field is HAL.Bit;
   subtype ISR_BUSY_Field is HAL.Bit;
   subtype ISR_DIR_Field is HAL.Bit;
   ...
   subtype ICR_ADDRCF_Field is HAL.Bit;
   subtype ICR_NACKCF_Field is HAL.Bit;
   subtype ICR_STOPCF_Field is HAL.Bit;
   subtype ICR_BERRCF_Field is HAL.Bit;
   subtype ICR_ARLOCF_Field is HAL.Bit;
   subtype ICR_OVRCF_Field is HAL.Bit;
   subtype ICR_PECCF_Field is HAL.Bit;
   subtype ICR_TIMOUTCF_Field is HAL.Bit;
   subtype ICR_ALERTCF_Field is HAL.Bit;
