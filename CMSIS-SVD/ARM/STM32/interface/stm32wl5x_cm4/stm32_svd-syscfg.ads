...
package STM32_SVD.SYSCFG is
   ...
   subtype CFGR1_BOOSTEN_Field is HAL.Bit;
   subtype CFGR1_I2C_PB6_FMP_Field is HAL.Bit;
   subtype CFGR1_I2C_PB7_FMP_Field is HAL.Bit;
   subtype CFGR1_I2C_PB8_FMP_Field is HAL.Bit;
   subtype CFGR1_I2C_PB9_FMP_Field is HAL.Bit;
   subtype CFGR1_I2C1_FMP_Field is HAL.Bit;
   subtype CFGR1_I2C2_FMP_Field is HAL.Bit;
   subtype CFGR1_I2C3_FMP_Field is HAL.Bit;
   ...
   type CFGR1_Register is record
      ...
      --  unspecified
      Reserved_23_31 : HAL.UInt9 := 16#F8#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype SCSR_SRAM2ER_Field is HAL.Bit;
   subtype SCSR_SRAMBSY_Field is HAL.Bit;
   subtype SCSR_PKASRAMBSY_Field is HAL.Bit;
   ...
   subtype CFGR2_CLL_Field is HAL.Bit;
   subtype CFGR2_SPL_Field is HAL.Bit;
   subtype CFGR2_PVDL_Field is HAL.Bit;
   subtype CFGR2_ECCL_Field is HAL.Bit;
   subtype CFGR2_SPF_Field is HAL.Bit;
   ...
   subtype SWPR_P0WP_Field is HAL.Bit;
   subtype SWPR_P1WP_Field is HAL.Bit;
   subtype SWPR_P2WP_Field is HAL.Bit;
   subtype SWPR_P3WP_Field is HAL.Bit;
   subtype SWPR_P4WP_Field is HAL.Bit;
   subtype SWPR_P5WP_Field is HAL.Bit;
   subtype SWPR_P6WP_Field is HAL.Bit;
   subtype SWPR_P7WP_Field is HAL.Bit;
   subtype SWPR_P8WP_Field is HAL.Bit;
   subtype SWPR_P9WP_Field is HAL.Bit;
   subtype SWPR_P10WP_Field is HAL.Bit;
   subtype SWPR_P11WP_Field is HAL.Bit;
   subtype SWPR_P12WP_Field is HAL.Bit;
   subtype SWPR_P13WP_Field is HAL.Bit;
   subtype SWPR_P14WP_Field is HAL.Bit;
   subtype SWPR_P15WP_Field is HAL.Bit;
   subtype SWPR_P16WP_Field is HAL.Bit;
   subtype SWPR_P17WP_Field is HAL.Bit;
   subtype SWPR_P18WP_Field is HAL.Bit;
   subtype SWPR_P19WP_Field is HAL.Bit;
   subtype SWPR_P20WP_Field is HAL.Bit;
   subtype SWPR_P21WP_Field is HAL.Bit;
   subtype SWPR_P22WP_Field is HAL.Bit;
   subtype SWPR_P23WP_Field is HAL.Bit;
   subtype SWPR_P24WP_Field is HAL.Bit;
   subtype SWPR_P25WP_Field is HAL.Bit;
   subtype SWPR_P26WP_Field is HAL.Bit;
   subtype SWPR_P27WP_Field is HAL.Bit;
   subtype SWPR_P28WP_Field is HAL.Bit;
   subtype SWPR_P29WP_Field is HAL.Bit;
   subtype SWPR_P30WP_Field is HAL.Bit;
   subtype SWPR_P31WP_Field is HAL.Bit;
   ...
   subtype IMR1_RTCSTAMPTAMPLSECSSIM_Field is HAL.Bit;
   subtype IMR1_RTCSSRUIM_Field is HAL.Bit;
   subtype IMR1_EXTI5IM_Field is HAL.Bit;
   subtype IMR1_EXTI6IM_Field is HAL.Bit;
   subtype IMR1_EXTI7IM_Field is HAL.Bit;
   subtype IMR1_EXTI8IM_Field is HAL.Bit;
   subtype IMR1_EXTI9IM_Field is HAL.Bit;
   subtype IMR1_EXTI10IM_Field is HAL.Bit;
   subtype IMR1_EXTI11IM_Field is HAL.Bit;
   subtype IMR1_EXTI12IM_Field is HAL.Bit;
   subtype IMR1_EXTI13IM_Field is HAL.Bit;
   subtype IMR1_EXTI14IM_Field is HAL.Bit;
   subtype IMR1_EXTI15IM_Field is HAL.Bit;
   ...
   subtype IMR2_PVM3IM_Field is HAL.Bit;
   subtype IMR2_PVDIM_Field is HAL.Bit;
   ...
   subtype C2IMR1_RTCSTAMPTAMPLSECSSIM_Field is HAL.Bit;
   subtype C2IMR1_RTCALARMIM_Field is HAL.Bit;
   subtype C2IMR1_RTCSSRUIM_Field is HAL.Bit;
   subtype C2IMR1_RTCWKUPIM_Field is HAL.Bit;
   subtype C2IMR1_RCCIM_Field is HAL.Bit;
   subtype C2IMR1_FLASHIM_Field is HAL.Bit;
   subtype C2IMR1_PKAIM_Field is HAL.Bit;
   subtype C2IMR1_AESIM_Field is HAL.Bit;
   subtype C2IMR1_COMPIM_Field is HAL.Bit;
   subtype C2IMR1_ADCIM_Field is HAL.Bit;
   subtype C2IMR1_DACIM_Field is HAL.Bit;
   subtype C2IMR1_EXTI0IM_Field is HAL.Bit;
   subtype C2IMR1_EXTI1IM_Field is HAL.Bit;
   subtype C2IMR1_EXTI2IM_Field is HAL.Bit;
   subtype C2IMR1_EXTI3IM_Field is HAL.Bit;
   subtype C2IMR1_EXTI4IM_Field is HAL.Bit;
   subtype C2IMR1_EXTI5IM_Field is HAL.Bit;
   subtype C2IMR1_EXTI6IM_Field is HAL.Bit;
   subtype C2IMR1_EXTI7IM_Field is HAL.Bit;
   subtype C2IMR1_EXTI8IM_Field is HAL.Bit;
   subtype C2IMR1_EXTI9IM_Field is HAL.Bit;
   subtype C2IMR1_EXTI10IM_Field is HAL.Bit;
   subtype C2IMR1_EXTI11IM_Field is HAL.Bit;
   subtype C2IMR1_EXTI12IM_Field is HAL.Bit;
   subtype C2IMR1_EXTI13IM_Field is HAL.Bit;
   subtype C2IMR1_EXTI14IM_Field is HAL.Bit;
   subtype C2IMR1_EXTI15IM_Field is HAL.Bit;
   ...
   subtype C2IMR2_DMA1CH1IM_Field is HAL.Bit;
   subtype C2IMR2_DMA1CH2IM_Field is HAL.Bit;
   subtype C2IMR2_DMA1CH3IM_Field is HAL.Bit;
   subtype C2IMR2_DMA1CH4IM_Field is HAL.Bit;
   subtype C2IMR2_DMA1CH5IM_Field is HAL.Bit;
   subtype C2IMR2_DMA1CH6IM_Field is HAL.Bit;
   subtype C2IMR2_DMA1CH7IM_Field is HAL.Bit;
   subtype C2IMR2_DMA2CH1IM_Field is HAL.Bit;
   subtype C2IMR2_DMA2CH2IM_Field is HAL.Bit;
   subtype C2IMR2_DMA2CH3IM_Field is HAL.Bit;
   subtype C2IMR2_DMA2CH4IM_Field is HAL.Bit;
   subtype C2IMR2_DMA2CH5IM_Field is HAL.Bit;
   subtype C2IMR2_DMA2CH6IM_Field is HAL.Bit;
   subtype C2IMR2_DMA2CH7IM_Field is HAL.Bit;
   subtype C2IMR2_DMAMUX1IM_Field is HAL.Bit;
   subtype C2IMR2_PVM3IM_Field is HAL.Bit;
   subtype C2IMR2_PVDIM_Field is HAL.Bit;
   ...
   subtype RFDCR_RFTBSEL_Field is HAL.Bit;
   ...
   subtype C2IMR1_AES1IM_Field is HAL.Bit;
   subtype C2IMR1_DAC1IM_Field is HAL.Bit;
