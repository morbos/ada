...
package Interfaces.STM32.SAU is
   pragma Preelaborate;
   ...
   subtype SAU_TYPE_SREGION_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype SAU_RNR_REGION_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype SAU_RBAR_BADDR_Field is Interfaces.Bit_Types.UInt27;
   ...
   subtype SAU_RLAR_LADDR_Field is Interfaces.Bit_Types.UInt27;
   ...
   type SAU_Peripheral is record
      ...
      --  violation
      SFAR     : aliased Interfaces.Bit_Types.Word;
   end record
     with Volatile;
