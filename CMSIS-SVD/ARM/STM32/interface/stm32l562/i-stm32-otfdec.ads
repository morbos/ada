...
package Interfaces.STM32.OTFDEC is
   ...
   subtype R1CFGR_REGx_VERSION_Field is Interfaces.Bit_Types.Short;
   ...
   subtype R2CFGR_REGx_VERSION_Field is Interfaces.Bit_Types.Short;
   ...
   subtype R3CFGR_REGx_VERSION_Field is Interfaces.Bit_Types.Short;
   ...
   subtype R4CFGR_REGx_VERSION_Field is Interfaces.Bit_Types.Short;
   ...
   type OTFDEC_Peripheral is record
      ...
      R1STARTADDR : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x end address register
      R1ENDADDR   : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x nonce register 0
      R1NONCER0   : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x nonce register 1
      R1NONCER1   : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x key register 0
      R1KEYR0     : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x key register 1
      R1KEYR1     : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x key register 2
      R1KEYR2     : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x key register 3
      R1KEYR3     : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x configuration register
      R2CFGR      : aliased R2CFGR_Register;
      --  OTFDEC region x start address register
      R2STARTADDR : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x end address register
      R2ENDADDR   : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x nonce register 0
      R2NONCER0   : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x nonce register 1
      R2NONCER1   : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x key register 0
      R2KEYR0     : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x key register 1
      R2KEYR1     : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x key register 2
      R2KEYR2     : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x key register 3
      R2KEYR3     : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x configuration register
      R3CFGR      : aliased R3CFGR_Register;
      --  OTFDEC region x start address register
      R3STARTADDR : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x end address register
      R3ENDADDR   : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x nonce register 0
      R3NONCER0   : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x nonce register 1
      R3NONCER1   : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x key register 0
      R3KEYR0     : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x key register 1
      R3KEYR1     : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x key register 2
      R3KEYR2     : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x key register 3
      R3KEYR3     : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x configuration register
      R4CFGR      : aliased R4CFGR_Register;
      --  OTFDEC region x start address register
      R4STARTADDR : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x end address register
      R4ENDADDR   : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x nonce register 0
      R4NONCER0   : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x nonce register 1
      R4NONCER1   : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x key register 0
      R4KEYR0     : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x key register 1
      R4KEYR1     : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x key register 2
      R4KEYR2     : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC region x key register 3
      R4KEYR3     : aliased Interfaces.Bit_Types.Word;
      --  OTFDEC interrupt status register
