...
package Interfaces.STM32.TAMP is
   ...
   type CR1_Register is record
      ...
      --  unspecified
      Reserved_21_22 : Interfaces.Bit_Types.UInt2 := 16#3#;
      --  ITAMP5E
   ...
   subtype ATCR1_ATOSEL_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype ATCR1_ATCKSEL_Field is Interfaces.Bit_Types.UInt2;
   subtype ATCR1_ATPER_Field is Interfaces.Bit_Types.UInt2;
   ...
   type ATCR1_Register is record
      ...
      --  unspecified
      Reserved_18_23 : Interfaces.Bit_Types.UInt6 := 16#1#;
      --  ATPER
   ...
   subtype ATOR_PRNG_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype ATCR2_ATOSEL_Element is Interfaces.Bit_Types.UInt3;
   ...
   subtype SMCR_BKPRWDPROT_Field is Interfaces.Bit_Types.Byte;
   subtype SMCR_BKPWDPROT_Field is Interfaces.Bit_Types.Byte;
   ...
   type PRIVCR_Register is record
      --  unspecified
      Reserved_0_28 : Interfaces.Bit_Types.UInt29 := 16#0#;
   ...
   type TAMP_Peripheral is record
      ...
      ATSEEDR : aliased Interfaces.Bit_Types.Word;
      --  TAMP active tamper output register
      ...
      COUNTR  : aliased Interfaces.Bit_Types.Word;
      --  TAMP configuration register
