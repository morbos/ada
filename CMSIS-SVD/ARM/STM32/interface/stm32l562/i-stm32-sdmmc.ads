...
package Interfaces.STM32.SDMMC is
   ...
   subtype SDMMC_IDMABSIZER_IDMABNDT_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype SDMMC_VER_MINREV_Field is Interfaces.Bit_Types.UInt4;
   subtype SDMMC_VER_MAJREV_Field is Interfaces.Bit_Types.UInt4;
   ...
   type SDMMC_Peripheral is record
      ...
      SDMMC_ARGR       : aliased Interfaces.Bit_Types.Word;
      --  The SDMMC_CMDR register contains the command index and command type
      ...
      SDMMC_RESP1R     : aliased Interfaces.Bit_Types.Word;
      --  The SDMMC_RESP1/2/3/4R registers contain the status of a card, which
      --  is part of the received response.
      SDMMC_RESP2R     : aliased Interfaces.Bit_Types.Word;
      --  The SDMMC_RESP1/2/3/4R registers contain the status of a card, which
      --  is part of the received response.
      SDMMC_RESP3R     : aliased Interfaces.Bit_Types.Word;
      --  The SDMMC_RESP1/2/3/4R registers contain the status of a card, which
      --  is part of the received response.
      SDMMC_RESP4R     : aliased Interfaces.Bit_Types.Word;
      ...
      --  set.
      SDMMC_DTIMER     : aliased Interfaces.Bit_Types.Word;
      --  The SDMMC_DLENR register contains the number of data bytes to be
      --  transferred. The value is loaded into the data counter when data
      --  transfer starts.
      ...
      SDMMC_FIFOR      : aliased Interfaces.Bit_Types.Word;
      --  SDMMC IP version register
      SDMMC_VER        : aliased SDMMC_VER_Register;
      --  SDMMC IP identification register
      SDMMC_ID         : aliased Interfaces.Bit_Types.Word;
   end record
     with Volatile;
   ...
   SDMMC1_Periph : aliased SDMMC_Peripheral
     with Import, Address => System'To_Address (16#420C8000#);

   --  SDMMC1
   SEC_SDMMC1_Periph : aliased SDMMC_Peripheral
     with Import, Address => System'To_Address (16#520C8000#);
