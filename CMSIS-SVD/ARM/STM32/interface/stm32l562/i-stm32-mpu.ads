...
package Interfaces.STM32.MPU is
   ...
   subtype MPU_RBAR_AP_Field is Interfaces.Bit_Types.UInt2;
   subtype MPU_RBAR_SH_Field is Interfaces.Bit_Types.UInt2;
   subtype MPU_RBAR_BADDR_Field is Interfaces.Bit_Types.UInt27;
   ...
   subtype MPU_RLAR_AttrIndx_Field is Interfaces.Bit_Types.UInt3;
   subtype MPU_RLAR_LIMIT_Field is Interfaces.Bit_Types.UInt27;
   ...
   subtype MPU_RBAR_ALIAS_AP_Field is Interfaces.Bit_Types.UInt2;
   subtype MPU_RBAR_ALIAS_SH_Field is Interfaces.Bit_Types.UInt2;
   subtype MPU_RBAR_ALIAS_BADDR_Field is Interfaces.Bit_Types.UInt27;
   ...
   subtype MPU_RLAR_ALIAS_AttrIndx_Field is Interfaces.Bit_Types.UInt3;
   subtype MPU_RLAR_ALIAS_LIMIT_Field is Interfaces.Bit_Types.UInt27;
   ...
   subtype MPU_MAIR0_Attr_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype MPU_MAIR1_Attr_Element is Interfaces.Bit_Types.Byte;
