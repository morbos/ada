...
package Interfaces.STM32.FMC is
   ...
   subtype PCSCNTR_CSCOUNT_Field is Interfaces.Bit_Types.Short;
   ...
   subtype FMC_PCR_ECCPS_Field is Interfaces.Bit_Types.UInt3;
   ...
   type FMC_BWTR_Register is record
      ...
      --  unspecified
      Reserved_20_27 : Interfaces.Bit_Types.Byte := 16#FF#;
   ...
   type FMC_Peripheral is record
      ...
      FMC_ECCR  : aliased Interfaces.Bit_Types.Word;
      --  This register contains the control information of each memory bank.
   ...
   FMC_Periph : aliased FMC_Peripheral
     with Import, Address => System'To_Address (16#44020000#);

   --  FMC
   SEC_FMC_Periph : aliased FMC_Peripheral
     with Import, Address => System'To_Address (16#54020000#);
