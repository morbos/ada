...
package Interfaces.STM32.ADC is
   ...
   subtype ADC_CFGR2_OVSR_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype ADC_AWD2CR_AWDCH_Field is Interfaces.Bit_Types.UInt20;
   ...
   subtype ADC_AWD3CR_AWDCH_Field is Interfaces.Bit_Types.UInt20;
