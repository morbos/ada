...
package Interfaces.STM32.BSEC is
   ...
   subtype BSEC_DENR_CP15SDIS_Field is Interfaces.Bit_Types.UInt2;
   ...
   type BSEC_SR_Register is record
      ...
      HVALID        : Boolean;
      --  unspecified
      Reserved_2_25 : Interfaces.Bit_Types.UInt24;
   ...
   subtype BSEC_VERR_MINREV_Field is Interfaces.Bit_Types.UInt4;
   subtype BSEC_VERR_MAJREV_Field is Interfaces.Bit_Types.UInt4;
   ...
   type BSEC_Peripheral is record
      ...
      BSEC_IPIDR     : aliased Interfaces.Bit_Types.UInt32;
      --  BSEC size identification register
      BSEC_SIDR      : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
