...
package Interfaces.STM32.DSI is
   pragma Preelaborate;
   ...
   subtype DSI_CCR_TXECKDIV_Field is Interfaces.Bit_Types.Byte;
   subtype DSI_CCR_TOCKDIV_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype DSI_VPCR_VPSIZE_Field is Interfaces.Bit_Types.UInt14;
   ...
   subtype DSI_VCCR_NUMC_Field is Interfaces.Bit_Types.UInt13;
   ...
   subtype DSI_VNPCR_NPSIZE_Field is Interfaces.Bit_Types.UInt13;
   ...
   subtype DSI_VHSACR_HSA_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype DSI_VHBPCR_HBP_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype DSI_LCCR_CMDSIZE_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype DSI_TCCR0_LPRX_TOCNT_Field is Interfaces.Bit_Types.UInt16;
   subtype DSI_TCCR0_HSTX_TOCNT_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype DSI_TCCR1_HSRD_TOCNT_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype DSI_TCCR2_LPRD_TOCNT_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype DSI_TCCR3_HSWR_TOCNT_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype DSI_TCCR4_LPWR_TOCNT_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype DSI_TCCR5_BTA_TOCNT_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype DSI_TDCR_M3D_Field is Interfaces.Bit_Types.UInt2;
   subtype DSI_TDCR_F3D_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype DSI_DLTCR_LP2HS_TIME_Field is Interfaces.Bit_Types.UInt10;
   subtype DSI_DLTCR_HS2LP_TIME_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype DSI_PCONFR_NL_Field is Interfaces.Bit_Types.UInt2;
   subtype DSI_PCONFR_SW_TIME_Field is Interfaces.Bit_Types.Byte;
   ...
   type DSI_PCONFR_Register is record
      ...
      --  unspecified
      Reserved_2_7   : Interfaces.Bit_Types.UInt6 := 16#4#;
   ...
   subtype DSI_PTCR1_TDI_Field is Interfaces.Bit_Types.Byte;
   subtype DSI_PTCR1_TDO_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype DSI_DLTRCR_MRD_TIME_Field is Interfaces.Bit_Types.UInt15;
   ...
   subtype DSI_VPCCR_VPSIZE_Field is Interfaces.Bit_Types.UInt14;
   ...
   subtype DSI_VCCCR_NUMC_Field is Interfaces.Bit_Types.UInt13;
   ...
   subtype DSI_VNPCCR_NPSIZE_Field is Interfaces.Bit_Types.UInt13;
   ...
   subtype DSI_VHSACCR_HSA_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype DSI_VHBPCCR_HBP_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype DSI_TDCCR_M3D_Field is Interfaces.Bit_Types.UInt2;
   subtype DSI_TDCCR_F3D_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype DSI_WPCR0_RXTRG_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype DSI_WPCR1_CCF_Field is Interfaces.Bit_Types.UInt6;
   subtype DSI_WPCR1_HSFR_Field is Interfaces.Bit_Types.UInt7;
   ...
   subtype DSI_WRPCR0_IDF_Field is Interfaces.Bit_Types.UInt4;
   subtype DSI_WRPCR0_NDIV_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype DSI_WRPCR1_PROP_Field is Interfaces.Bit_Types.UInt6;
   subtype DSI_WRPCR1_GMP_Field is Interfaces.Bit_Types.UInt2;
   subtype DSI_WRPCR1_INT_Field is Interfaces.Bit_Types.UInt6;
   subtype DSI_WRPCR1_BIAS_Field is Interfaces.Bit_Types.UInt7;
   subtype DSI_WRPCR1_VCO_Field is Interfaces.Bit_Types.UInt4;
   subtype DSI_WRPCR1_ODF_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype DSI_WRPCR2_SEL_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype DSI_WRPSR0_IDF_Field is Interfaces.Bit_Types.UInt4;
   subtype DSI_WRPSR0_NDIV_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype DSI_WRPSR1_PROP_Field is Interfaces.Bit_Types.UInt6;
   subtype DSI_WRPSR1_GMP_Field is Interfaces.Bit_Types.UInt2;
   subtype DSI_WRPSR1_INT_Field is Interfaces.Bit_Types.UInt6;
   subtype DSI_WRPSR1_BIAS_Field is Interfaces.Bit_Types.UInt7;
   subtype DSI_WRPSR1_VCO_Field is Interfaces.Bit_Types.UInt4;
   subtype DSI_WRPSR1_ODF_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype DSI_HWCFGR_TECHNO_Field is Interfaces.Bit_Types.UInt4;
   subtype DSI_HWCFGR_FIFOSIZE_Field is Interfaces.Bit_Types.UInt12;
   subtype DSI_HWCFGR_LANES_Field is Interfaces.Bit_Types.UInt4;
   subtype DSI_HWCFGR_LINKS_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype DSI_VERR_MINREV_Field is Interfaces.Bit_Types.UInt4;
   subtype DSI_VERR_MAJREV_Field is Interfaces.Bit_Types.UInt4;
   ...
   type DSI_Peripheral is record
      ...
      DSI_VR      : aliased Interfaces.Bit_Types.UInt32;
      --  DSI Host control register
      ...
      DSI_IPIDR   : aliased Interfaces.Bit_Types.UInt32;
      --  DSI size identification register
      DSI_SIDR    : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
