...
package Interfaces.STM32.GPIOI is
   pragma Preelaborate;
   ...
   subtype GPIOI_MODER_MODE_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOI_OSPEEDR_OSPEED_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOI_PUPDR_PUPD_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOI_AFRL_AFSEL_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOI_AFRH_AFSEL_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOI_DELAYRL_DLY_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOI_DELAYRH_DLY_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOI_CIDCFGR_SCID_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOI_SEMCR_SEMCID_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOI_HWCFGR11_AHB_IOP_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOI_HWCFGR11_AFSIZE_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOI_HWCFGR11_SPEED_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOI_HWCFGR11_LOCK_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOI_HWCFGR11_SEC_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOI_HWCFGR11_OR_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOI_HWCFGR11_PRIV_CFG_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOI_HWCFGR10_EN_IO_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOI_HWCFGR9_FAST_AF_IO_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOI_HWCFGR8_FAST_AF_IO_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOI_HWCFGR4_ODR_RES_Field is Interfaces.Bit_Types.UInt16;
   subtype GPIOI_HWCFGR4_OTYPER_RES_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOI_HWCFGR1_OR_RES_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOI_VERR_MINREV_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOI_VERR_MAJREV_Field is Interfaces.Bit_Types.UInt4;
