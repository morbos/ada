...
package Interfaces.STM32.ADCC3 is
   pragma Preelaborate;
   ...
   subtype ADCC3_CCR_PRESC_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype ADCC3_HWCFGR1_ADCNUM_Field is Interfaces.Bit_Types.UInt4;
   subtype ADCC3_HWCFGR1_OPBITS_Field is Interfaces.Bit_Types.UInt4;
   subtype ADCC3_HWCFGR1_ANAIP_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype ADCC3_VERR_MINREV_Field is Interfaces.Bit_Types.UInt4;
   subtype ADCC3_VERR_MAJREV_Field is Interfaces.Bit_Types.UInt4;
   ...
   type ADCC3_Peripheral is record
      ...
      ADCC3_IPIDR   : aliased Interfaces.Bit_Types.UInt32;
      --  ADC3 size identification register
      ADCC3_SIDR    : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
