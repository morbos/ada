...
package Interfaces.STM32.OCTOSPIM is
   pragma Preelaborate;
   ...
   subtype OCTOSPIM_CR_REQ2ACK_TIME_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype OCTOSPIM_HWCFGR_NUM_PORT_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype OCTOSPIM_VERR_MINVER_Field is Interfaces.Bit_Types.UInt4;
   subtype OCTOSPIM_VERR_MAJVER_Field is Interfaces.Bit_Types.UInt4;
   ...
   type OCTOSPIM_Peripheral is record
      ...
      OCTOSPIM_IDR    : aliased Interfaces.Bit_Types.UInt32;
      --  OCTOSPIM size identification register
      OCTOSPIM_SIDR   : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
