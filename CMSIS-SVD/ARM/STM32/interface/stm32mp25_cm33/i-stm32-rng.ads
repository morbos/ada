...
package Interfaces.STM32.RNG is
   ...
   subtype RNG_CR_RNG_CONFIG3_Field is Interfaces.Bit_Types.UInt4;
   subtype RNG_CR_RNG_CONFIG2_Field is Interfaces.Bit_Types.UInt3;
   subtype RNG_CR_CLKDIV_Field is Interfaces.Bit_Types.UInt4;
   subtype RNG_CR_RNG_CONFIG1_Field is Interfaces.Bit_Types.UInt6;
   ...
   subtype RNG_NSCR_EN_OSC_Element is Interfaces.Bit_Types.UInt3;
   ...
   subtype RNG_HWCFGR_CFG_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype RNG_VERR_MINREV_Field is Interfaces.Bit_Types.UInt4;
   subtype RNG_VERR_MAJREV_Field is Interfaces.Bit_Types.UInt4;
