...
package Interfaces.STM32.GPIOK is
   pragma Preelaborate;
   ...
   subtype GPIOK_MODER_MODE_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOK_OSPEEDR_OSPEED_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOK_PUPDR_PUPD_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOK_AFRL_AFSEL_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOK_AFRH_AFSEL_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOK_DELAYRL_DLY_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOK_DELAYRH_DLY_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOK_CIDCFGR_SCID_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOK_SEMCR_SEMCID_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOK_HWCFGR11_AHB_IOP_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOK_HWCFGR11_AFSIZE_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOK_HWCFGR11_SPEED_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOK_HWCFGR11_LOCK_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOK_HWCFGR11_SEC_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOK_HWCFGR11_OR_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOK_HWCFGR11_PRIV_CFG_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOK_HWCFGR10_EN_IO_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOK_HWCFGR9_FAST_AF_IO_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOK_HWCFGR8_FAST_AF_IO_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOK_HWCFGR4_ODR_RES_Field is Interfaces.Bit_Types.UInt16;
   subtype GPIOK_HWCFGR4_OTYPER_RES_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOK_HWCFGR1_OR_RES_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOK_VERR_MINREV_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOK_VERR_MAJREV_Field is Interfaces.Bit_Types.UInt4;
