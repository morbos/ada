...
package Interfaces.STM32.GICV2M is
   pragma Preelaborate;
   ...
   subtype GICV2M_TYPER_NUMBER_OF_SPIS_Field is Interfaces.Bit_Types.UInt10;
   subtype GICV2M_TYPER_BASE_SPI_NUMBER_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype GICV2M_SETSPI_SPI1_NUM_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype GICV2M_IIDR_IMPLEMENTER_Field is Interfaces.Bit_Types.UInt12;
   subtype GICV2M_IIDR_REVISION_Field is Interfaces.Bit_Types.UInt4;
   subtype GICV2M_IIDR_ARCH_VERSION_Field is Interfaces.Bit_Types.UInt4;
   subtype GICV2M_IIDR_PRODUCT_ID_Field is Interfaces.Bit_Types.UInt12;
