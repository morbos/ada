...
package Interfaces.STM32.ADF is
   pragma Preelaborate;
   ...
   subtype ADF_CKGCR_TRGSRC_Field is Interfaces.Bit_Types.UInt4;
   subtype ADF_CKGCR_CCKDIV_Field is Interfaces.Bit_Types.UInt4;
   subtype ADF_CKGCR_PROCDIV_Field is Interfaces.Bit_Types.UInt7;
   ...
   subtype ADF_SITF0CR_SCKSRC_Field is Interfaces.Bit_Types.UInt2;
   subtype ADF_SITF0CR_SITFMOD_Field is Interfaces.Bit_Types.UInt2;
   subtype ADF_SITF0CR_STH_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype ADF_BSMX0CR_BSSEL_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype ADF_DFLT0CR_ACQMOD_Field is Interfaces.Bit_Types.UInt3;
   subtype ADF_DFLT0CR_TRGSRC_Field is Interfaces.Bit_Types.UInt4;
   subtype ADF_DFLT0CR_NBDIS_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype ADF_DFLT0CICR_DATSRC_Field is Interfaces.Bit_Types.UInt2;
   subtype ADF_DFLT0CICR_CICMOD_Field is Interfaces.Bit_Types.UInt3;
   subtype ADF_DFLT0CICR_MCICD_Field is Interfaces.Bit_Types.Byte;
   subtype ADF_DFLT0CICR_SCALE_Field is Interfaces.Bit_Types.UInt6;
   ...
   subtype ADF_DFLT0RSFR_HPFC_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype ADF_DLY0CR_SKPDLY_Field is Interfaces.Bit_Types.UInt7;
   ...
   subtype ADF_SADCR_DATCAP_Field is Interfaces.Bit_Types.UInt2;
   subtype ADF_SADCR_SADST_Field is Interfaces.Bit_Types.UInt2;
   subtype ADF_SADCR_FRSIZE_Field is Interfaces.Bit_Types.UInt3;
   subtype ADF_SADCR_SADMOD_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype ADF_SADCFGR_SNTHR_Field is Interfaces.Bit_Types.UInt4;
   subtype ADF_SADCFGR_ANSLP_Field is Interfaces.Bit_Types.UInt3;
   subtype ADF_SADCFGR_LFRNB_Field is Interfaces.Bit_Types.UInt3;
   subtype ADF_SADCFGR_HGOVR_Field is Interfaces.Bit_Types.UInt3;
   subtype ADF_SADCFGR_ANMIN_Field is Interfaces.Bit_Types.UInt13;
   ...
   subtype ADF_SADSDLVR_SDLVL_Field is Interfaces.Bit_Types.UInt15;
   ...
   subtype ADF_SADANLVR_ANLVL_Field is Interfaces.Bit_Types.UInt15;
   ...
   subtype ADF_DFLT0DR_DR_Field is Interfaces.Bit_Types.UInt24;
   ...
   subtype ADF_HWCFGR_FIFO_SIZE_Field is Interfaces.Bit_Types.Byte;
   subtype ADF_HWCFGR_NBF_Field is Interfaces.Bit_Types.Byte;
   subtype ADF_HWCFGR_FLT_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype ADF_HWCFGR_SAD_Field is Interfaces.Bit_Types.UInt4;
   subtype ADF_HWCFGR_OPTION_REGOUT_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype ADF_VERR_MINREV_Field is Interfaces.Bit_Types.UInt4;
   subtype ADF_VERR_MAJREV_Field is Interfaces.Bit_Types.UInt4;
   ...
   type ADF_Peripheral is record
      ...
      ADF_IPIDR     : aliased Interfaces.Bit_Types.UInt32;
      --  ADF size identification register
      ADF_SIDR      : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
