...
package Interfaces.STM32.GPIOA is
   pragma Preelaborate;
   ...
   --  GPIOA_DELAYRL_DLY array element
   subtype GPIOA_DELAYRL_DLY_Element is Interfaces.Bit_Types.UInt4;

   --  GPIOA_DELAYRL_DLY array
   type GPIOA_DELAYRL_DLY_Field_Array is array (0 .. 7)
     of GPIOA_DELAYRL_DLY_Element
     with Component_Size => 4, Size => 32;
   ...
   is record
      case As_Array is
         ...
         when True =>
            --  DLY as an array
            Arr : GPIOA_DELAYRL_DLY_Field_Array;
      end case;
   end record
     with Unchecked_Union, Size => 32, Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   --  GPIOA_DELAYRH_DLY array element
   subtype GPIOA_DELAYRH_DLY_Element is Interfaces.Bit_Types.UInt4;

   --  GPIOA_DELAYRH_DLY array
   type GPIOA_DELAYRH_DLY_Field_Array is array (8 .. 15)
     of GPIOA_DELAYRH_DLY_Element
     with Component_Size => 4, Size => 32;
   ...
   is record
      case As_Array is
         ...
         when True =>
            --  DLY as an array
            Arr : GPIOA_DELAYRH_DLY_Field_Array;
      end case;
   end record
     with Unchecked_Union, Size => 32, Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   --  GPIO port A advanced configuration low register
   type GPIOA_ADVCFGRL_Register is record
   ...
   for GPIOA_ADVCFGRL_Register use record
   ...
   --  GPIO port A advanced configuration high register
   type GPIOA_ADVCFGRH_Register is record
      --  Controls which path contains the configurable delay, input or output
      --  y (y=15to8)
   ...
   for GPIOA_ADVCFGRH_Register use record
   ...
   subtype GPIOA_CIDCFGR_SCID_Field is Interfaces.Bit_Types.UInt2;

   --  GPIOA_CIDCFGR_SEMWLC array
   type GPIOA_CIDCFGR_SEMWLC_Field_Array is array (0 .. 3) of Boolean
     with Component_Size => 1, Size => 4;

   --  Type definition for GPIOA_CIDCFGR_SEMWLC
   type GPIOA_CIDCFGR_SEMWLC_Field
     (As_Array : Boolean := False)
   is record
      case As_Array is
         when False =>
         ...
         when True =>
            --  SEMWLC as an array
            Arr : GPIOA_CIDCFGR_SEMWLC_Field_Array;
      end case;
   end record
     with Unchecked_Union, Size => 4;

   for GPIOA_CIDCFGR_SEMWLC_Field use record
      Val at 0 range 0 .. 3;
      Arr at 0 range 0 .. 3;
   end record;

   --  GPIO port A CID configuration register for I/O pin 0
   type GPIOA_CIDCFGR_Register is record
   ...
   for GPIOA_CIDCFGR_Register use record
      CFEN           at 0 range 0 .. 0;
   ...
   subtype GPIOA_SEMCR_SEMCID_Field is Interfaces.Bit_Types.UInt2;

   --  GPIO port A semaphore control register for I/O pin 0
   type GPIOA_SEMCR_Register is record
      --  Semaphore mutex
      SEM_MUTEX     : Boolean := False;
      --  unspecified
      Reserved_1_3  : Interfaces.Bit_Types.UInt3 := 16#0#;
      --  Read-only. Semaphore current CID
      SEMCID        : GPIOA_SEMCR_SEMCID_Field := 16#0#;
      --  unspecified
   ...
   for GPIOA_SEMCR_Register use record
   ...
   subtype GPIOA_HWCFGR11_AHB_IOP_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOA_HWCFGR11_AFSIZE_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOA_HWCFGR11_SPEED_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOA_HWCFGR11_LOCK_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOA_HWCFGR11_SEC_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOA_HWCFGR11_OR_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOA_HWCFGR11_PRIV_CFG_Field is Interfaces.Bit_Types.UInt4;

   --  GPIO port A hardware configuration register 11
   type GPIOA_HWCFGR11_Register is record
      --  Read-only. Bus interface selection
      AHB_IOP        : GPIOA_HWCFGR11_AHB_IOP_Field;
      --  Read-only. Number of AF available for each I/O
      AFSIZE_CFG     : GPIOA_HWCFGR11_AFSIZE_CFG_Field;
      --  Read-only. Number of speed lines for each I/O
      SPEED_CFG      : GPIOA_HWCFGR11_SPEED_CFG_Field;
      --  Read-only. Lock mechanism activation
      LOCK_CFG       : GPIOA_HWCFGR11_LOCK_CFG_Field;
      --  Read-only. Security activation
      SEC_CFG        : GPIOA_HWCFGR11_SEC_CFG_Field;
      --  Read-only. Option register configuration
      OR_CFG         : GPIOA_HWCFGR11_OR_CFG_Field;
      --  Read-only. Privilege mechanism activation
      PRIV_CFG       : GPIOA_HWCFGR11_PRIV_CFG_Field;
      --  unspecified
   ...
   for GPIOA_HWCFGR11_Register use record
   ...
   subtype GPIOA_HWCFGR10_EN_IO_Field is Interfaces.Bit_Types.UInt16;
   ...
   type GPIOA_HWCFGR10_Register is record
      ...
      EN_IO          : GPIOA_HWCFGR10_EN_IO_Field;
      --  unspecified
      Reserved_16_31 : Interfaces.Bit_Types.UInt16;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   --  GPIOA_HWCFGR9_FAST_AF_IO array element
   subtype GPIOA_HWCFGR9_FAST_AF_IO_Element is Interfaces.Bit_Types.UInt4;

   --  GPIOA_HWCFGR9_FAST_AF_IO array
   type GPIOA_HWCFGR9_FAST_AF_IO_Field_Array is array (8 .. 15)
     of GPIOA_HWCFGR9_FAST_AF_IO_Element
     with Component_Size => 4, Size => 32;

   --  GPIO port A hardware configuration register 9
   type GPIOA_HWCFGR9_Register
     (As_Array : Boolean := False)
   is record
      case As_Array is
         when False =>
         ...
         when True =>
            ...
            Arr : GPIOA_HWCFGR9_FAST_AF_IO_Field_Array;
      end case;
   end record
     with Unchecked_Union, Size => 32, Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype GPIOA_HWCFGR8_FAST_AF_IO_Element is Interfaces.Bit_Types.UInt4;

   --  GPIOA_HWCFGR8_FAST_AF_IO array
   type GPIOA_HWCFGR8_FAST_AF_IO_Field_Array is array (0 .. 7)
   ...
   subtype GPIOA_HWCFGR4_ODR_RES_Field is Interfaces.Bit_Types.UInt16;
   subtype GPIOA_HWCFGR4_OTYPER_RES_Field is Interfaces.Bit_Types.UInt16;

   --  GPIO port A hardware configuration register 4
   type GPIOA_HWCFGR4_Register is record
      --  Read-only. Output data register reset value
      ODR_RES    : GPIOA_HWCFGR4_ODR_RES_Field;
      --  Read-only. Output type register reset value
      OTYPER_RES : GPIOA_HWCFGR4_OTYPER_RES_Field;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;

   for GPIOA_HWCFGR4_Register use record
      ODR_RES    at 0 range 0 .. 15;
      OTYPER_RES at 0 range 16 .. 31;
   end record;

   subtype GPIOA_HWCFGR1_OR_RES_Field is Interfaces.Bit_Types.UInt16;

   --  GPIO port A hardware configuration register 1
   type GPIOA_HWCFGR1_Register is record
      --  Read-only. Option register reset value
      OR_RES         : GPIOA_HWCFGR1_OR_RES_Field;
      --  unspecified
      Reserved_16_31 : Interfaces.Bit_Types.UInt16;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   for GPIOA_HWCFGR1_Register use record
      OR_RES         at 0 range 0 .. 15;
      Reserved_16_31 at 0 range 16 .. 31;
   end record;

   subtype GPIOA_VERR_MINREV_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOA_VERR_MAJREV_Field is Interfaces.Bit_Types.UInt4;
   ...
   type GPIOA_Peripheral is record
      ...
      --  GPIO port A advanced configuration low register
      GPIOA_ADVCFGRL  : aliased GPIOA_ADVCFGRL_Register;
      --  GPIO port A advanced configuration high register
      GPIOA_ADVCFGRH  : aliased GPIOA_ADVCFGRH_Register;
      --  GPIO port A CID configuration register for I/O pin 0
      GPIOA_CIDCFGR0  : aliased GPIOA_CIDCFGR_Register;
      --  GPIO port A semaphore control register for I/O pin 0
      GPIOA_SEMCR0    : aliased GPIOA_SEMCR_Register;
      --  GPIO port A CID configuration register for I/O pin 1
      GPIOA_CIDCFGR1  : aliased GPIOA_CIDCFGR_Register;
      --  GPIO port A semaphore control register for I/O pin 1
      GPIOA_SEMCR1    : aliased GPIOA_SEMCR_Register;
      --  GPIO port A CID configuration register for I/O pin 2
      GPIOA_CIDCFGR2  : aliased GPIOA_CIDCFGR_Register;
      --  GPIO port A semaphore control register for I/O pin 2
      GPIOA_SEMCR2    : aliased GPIOA_SEMCR_Register;
      --  GPIO port A CID configuration register for I/O pin 3
      GPIOA_CIDCFGR3  : aliased GPIOA_CIDCFGR_Register;
      --  GPIO port A semaphore control register for I/O pin 3
      GPIOA_SEMCR3    : aliased GPIOA_SEMCR_Register;
      --  GPIO port A CID configuration register for I/O pin 4
      GPIOA_CIDCFGR4  : aliased GPIOA_CIDCFGR_Register;
      --  GPIO port A semaphore control register for I/O pin 4
      GPIOA_SEMCR4    : aliased GPIOA_SEMCR_Register;
      --  GPIO port A CID configuration register for I/O pin 5
      GPIOA_CIDCFGR5  : aliased GPIOA_CIDCFGR_Register;
      --  GPIO port A semaphore control register for I/O pin 5
      GPIOA_SEMCR5    : aliased GPIOA_SEMCR_Register;
      --  GPIO port A CID configuration register for I/O pin 6
      GPIOA_CIDCFGR6  : aliased GPIOA_CIDCFGR_Register;
      --  GPIO port A semaphore control register for I/O pin 6
      GPIOA_SEMCR6    : aliased GPIOA_SEMCR_Register;
      --  GPIO port A CID configuration register for I/O pin 7
      GPIOA_CIDCFGR7  : aliased GPIOA_CIDCFGR_Register;
      --  GPIO port A semaphore control register for I/O pin 7
      GPIOA_SEMCR7    : aliased GPIOA_SEMCR_Register;
      --  GPIO port A CID configuration register for I/O pin 8
      GPIOA_CIDCFGR8  : aliased GPIOA_CIDCFGR_Register;
      --  GPIO port A semaphore control register for I/O pin 8
      GPIOA_SEMCR8    : aliased GPIOA_SEMCR_Register;
      --  GPIO port A CID configuration register for I/O pin 9
      GPIOA_CIDCFGR9  : aliased GPIOA_CIDCFGR_Register;
      --  GPIO port A semaphore control register for I/O pin 9
      GPIOA_SEMCR9    : aliased GPIOA_SEMCR_Register;
      --  GPIO port A CID configuration register for I/O pin 10
      GPIOA_CIDCFGR10 : aliased GPIOA_CIDCFGR_Register;
      --  GPIO port A semaphore control register for I/O pin 10
      GPIOA_SEMCR10   : aliased GPIOA_SEMCR_Register;
      --  GPIO port A CID configuration register for I/O pin 11
      GPIOA_CIDCFGR11 : aliased GPIOA_CIDCFGR_Register;
      --  GPIO port A semaphore control register for I/O pin 11
      GPIOA_SEMCR11   : aliased GPIOA_SEMCR_Register;
      --  GPIO port A CID configuration register for I/O pin 12
      GPIOA_CIDCFGR12 : aliased GPIOA_CIDCFGR_Register;
      --  GPIO port A semaphore control register for I/O pin 12
      GPIOA_SEMCR12   : aliased GPIOA_SEMCR_Register;
      --  GPIO port A CID configuration register for I/O pin 13
      GPIOA_CIDCFGR13 : aliased GPIOA_CIDCFGR_Register;
      --  GPIO port A semaphore control register for I/O pin 13
      GPIOA_SEMCR13   : aliased GPIOA_SEMCR_Register;
      --  GPIO port A CID configuration register for I/O pin 14
      GPIOA_CIDCFGR14 : aliased GPIOA_CIDCFGR_Register;
      --  GPIO port A semaphore control register for I/O pin 14
      GPIOA_SEMCR14   : aliased GPIOA_SEMCR_Register;
      --  GPIO port A CID configuration register for I/O pin 15
      GPIOA_CIDCFGR15 : aliased GPIOA_CIDCFGR_Register;
      --  GPIO port A semaphore control register for I/O pin 15
      GPIOA_SEMCR15   : aliased GPIOA_SEMCR_Register;
      --  GPIO port A hardware configuration register 11
      GPIOA_HWCFGR11  : aliased GPIOA_HWCFGR11_Register;
      --  GPIO port A hardware configuration register 10
      ...
      GPIOA_HWCFGR7   : aliased Interfaces.Bit_Types.UInt32;
      --  GPIO port A hardware configuration register 6
      GPIOA_HWCFGR6   : aliased Interfaces.Bit_Types.UInt32;
      --  GPIO port A hardware configuration register 5
      GPIOA_HWCFGR5   : aliased Interfaces.Bit_Types.UInt32;
      --  GPIO port A hardware configuration register 4
      GPIOA_HWCFGR4   : aliased GPIOA_HWCFGR4_Register;
      --  GPIO port A hardware configuration register 3
      GPIOA_HWCFGR3   : aliased Interfaces.Bit_Types.UInt32;
      --  GPIO port A hardware configuration register 2
      GPIOA_HWCFGR2   : aliased Interfaces.Bit_Types.UInt32;
      --  GPIO port A hardware configuration register 1
      GPIOA_HWCFGR1   : aliased GPIOA_HWCFGR1_Register;
      --  GPIO port A version register
      GPIOA_VERR      : aliased GPIOA_VERR_Register;
      --  GPIO port A identification register
      GPIOA_IPIDR     : aliased Interfaces.Bit_Types.UInt32;
      --  GPIO port A size identification register
      GPIOA_SIDR      : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
   ...
   for GPIOA_Peripheral use record
      ...
      GPIOA_ADVCFGRL  at 16#48# range 0 .. 31;
      GPIOA_ADVCFGRH  at 16#4C# range 0 .. 31;
      GPIOA_CIDCFGR0  at 16#50# range 0 .. 31;
      GPIOA_SEMCR0    at 16#54# range 0 .. 31;
      GPIOA_CIDCFGR1  at 16#58# range 0 .. 31;
      GPIOA_SEMCR1    at 16#5C# range 0 .. 31;
      GPIOA_CIDCFGR2  at 16#60# range 0 .. 31;
      GPIOA_SEMCR2    at 16#64# range 0 .. 31;
      GPIOA_CIDCFGR3  at 16#68# range 0 .. 31;
      GPIOA_SEMCR3    at 16#6C# range 0 .. 31;
      GPIOA_CIDCFGR4  at 16#70# range 0 .. 31;
      GPIOA_SEMCR4    at 16#74# range 0 .. 31;
      GPIOA_CIDCFGR5  at 16#78# range 0 .. 31;
      GPIOA_SEMCR5    at 16#7C# range 0 .. 31;
      GPIOA_CIDCFGR6  at 16#80# range 0 .. 31;
      GPIOA_SEMCR6    at 16#84# range 0 .. 31;
      GPIOA_CIDCFGR7  at 16#88# range 0 .. 31;
      GPIOA_SEMCR7    at 16#8C# range 0 .. 31;
      GPIOA_CIDCFGR8  at 16#90# range 0 .. 31;
      GPIOA_SEMCR8    at 16#94# range 0 .. 31;
      GPIOA_CIDCFGR9  at 16#98# range 0 .. 31;
      GPIOA_SEMCR9    at 16#9C# range 0 .. 31;
      GPIOA_CIDCFGR10 at 16#A0# range 0 .. 31;
      GPIOA_SEMCR10   at 16#A4# range 0 .. 31;
      GPIOA_CIDCFGR11 at 16#A8# range 0 .. 31;
      GPIOA_SEMCR11   at 16#AC# range 0 .. 31;
      GPIOA_CIDCFGR12 at 16#B0# range 0 .. 31;
      GPIOA_SEMCR12   at 16#B4# range 0 .. 31;
      GPIOA_CIDCFGR13 at 16#B8# range 0 .. 31;
      GPIOA_SEMCR13   at 16#BC# range 0 .. 31;
      GPIOA_CIDCFGR14 at 16#C0# range 0 .. 31;
      GPIOA_SEMCR14   at 16#C4# range 0 .. 31;
      GPIOA_CIDCFGR15 at 16#C8# range 0 .. 31;
      GPIOA_SEMCR15   at 16#CC# range 0 .. 31;
      GPIOA_HWCFGR11  at 16#3C8# range 0 .. 31;
      GPIOA_HWCFGR10  at 16#3CC# range 0 .. 31;
      GPIOA_HWCFGR9   at 16#3D0# range 0 .. 31;
      GPIOA_HWCFGR8   at 16#3D4# range 0 .. 31;
      GPIOA_HWCFGR7   at 16#3D8# range 0 .. 31;
      GPIOA_HWCFGR6   at 16#3DC# range 0 .. 31;
      GPIOA_HWCFGR5   at 16#3E0# range 0 .. 31;
      GPIOA_HWCFGR4   at 16#3E4# range 0 .. 31;
      GPIOA_HWCFGR3   at 16#3E8# range 0 .. 31;
      GPIOA_HWCFGR2   at 16#3EC# range 0 .. 31;
      GPIOA_HWCFGR1   at 16#3F0# range 0 .. 31;
   ...
   --  Control of ioport A
   GPIOA_S_Periph : aliased GPIOA_Peripheral
     with Import, Address => GPIOA_S_Base;

end Interfaces.STM32.GPIOA;
