...
package Interfaces.STM32.STGENC is
   pragma Preelaborate;
   ...
   subtype STGENC_PIDR4_DES_2_Field is Interfaces.Bit_Types.UInt4;
   subtype STGENC_PIDR4_SIZE_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype STGENC_PIDR0_PART_0_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype STGENC_PIDR1_PART_1_Field is Interfaces.Bit_Types.UInt4;
   subtype STGENC_PIDR1_DES_0_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype STGENC_PIDR2_DES_1_Field is Interfaces.Bit_Types.UInt3;
   subtype STGENC_PIDR2_REVISION_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype STGENC_PIDR3_CMOD_Field is Interfaces.Bit_Types.UInt4;
   subtype STGENC_PIDR3_REVAND_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype STGENC_CIDR0_PRMBL_0_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype STGENC_CIDR1_PRMBL_1_Field is Interfaces.Bit_Types.UInt4;
   subtype STGENC_CIDR1_CLASS_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype STGENC_CIDR2_PRMBL_2_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype STGENC_CIDR3_PRMBL_3_Field is Interfaces.Bit_Types.Byte;
   ...
   type STGENC_Peripheral is record
      ...
      STGENC_CNTCVL  : aliased Interfaces.Bit_Types.UInt32;
      --  STGENC value upper register
      STGENC_CNTCVU  : aliased Interfaces.Bit_Types.UInt32;
      --  STGENC base frequency register
      STGENC_CNTFID0 : aliased Interfaces.Bit_Types.UInt32;
      --  STGENC peripheral ID4 register
      STGENC_PIDR4   : aliased STGENC_PIDR4_Register;
      --  STGENC peripheral ID5 register
      STGENC_PIDR5   : aliased Interfaces.Bit_Types.UInt32;
      --  STGENC peripheral ID6 register
      STGENC_PIDR6   : aliased Interfaces.Bit_Types.UInt32;
      --  STGENC peripheral ID7 register
      STGENC_PIDR7   : aliased Interfaces.Bit_Types.UInt32;
      --  STGENC peripheral ID0 register
