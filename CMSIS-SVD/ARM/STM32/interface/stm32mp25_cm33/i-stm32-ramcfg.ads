...
package Interfaces.STM32.RAMCFG is
   pragma Preelaborate;
   ...
   subtype RAMCFG_SYSRAMERKEYR_ERASEKEY_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype RAMCFG_SRAM1ERKEYR_ERASEKEY_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype RAMCFG_SRAM2ERKEYR_ERASEKEY_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype RAMCFG_RETRAMSEAR_ESEA_Field is Interfaces.Bit_Types.UInt15;
   ...
   subtype RAMCFG_RETRAMDEAR_EDEA_Field is Interfaces.Bit_Types.UInt15;
   ...
   subtype RAMCFG_RETRAMECCKEYR_ECCKEY_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype RAMCFG_RETRAMERKEYR_ERASEKEY_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype RAMCFG_RETRAMCCR1_CRCC_Field is Interfaces.Bit_Types.UInt2;
   subtype RAMCFG_RETRAMCCR1_CRCBS_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype RAMCFG_LPSRAM1ERKEYR_ERASEKEY_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype RAMCFG_LPSRAM1CCR1_CRCC_Field is Interfaces.Bit_Types.UInt2;
   subtype RAMCFG_LPSRAM1CCR1_CRCBS_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype RAMCFG_LPSRAM2ERKEYR_ERASEKEY_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype RAMCFG_LPSRAM3ERKEYR_ERASEKEY_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype RAMCFG_BKPSRAMEEAR_ESEA_Field is Interfaces.Bit_Types.UInt11;
   ...
   subtype RAMCFG_BKPSRAMDEAR_EDEA_Field is Interfaces.Bit_Types.UInt11;
   ...
   subtype RAMCFG_BKPSRAMECCKEYR_ECCKEY_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype RAMCFG_BKPSRAMERKEYR_ERASEKEY_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype RAMCFG_VDERAMERKEYR_ERASEKEY_Field is Interfaces.Bit_Types.Byte;
   ...
   type RAMCFG_Peripheral is record
      ...
      RAMCFG_RETRAMCRSR     : aliased Interfaces.Bit_Types.UInt32;
      --  RAMCFG RETRAM CRC status register
      RAMCFG_RETRAMCSR      : aliased RAMCFG_RETRAMCSR_Register;
      --  RAMCFG RETRAM CRC calculated signature register
      RAMCFG_RETRAMCCSR     : aliased Interfaces.Bit_Types.UInt32;
      --  RAMCFG LPSRAM1 control register
      ...
      RAMCFG_LPSRAM1CRSR    : aliased Interfaces.Bit_Types.UInt32;
      --  RAMCFG LPSRAM1 CRC status register
      RAMCFG_LPSRAM1CSR     : aliased RAMCFG_LPSRAM1CSR_Register;
      --  RAMCFG LPSRAM1 CRC calculated signature register
      RAMCFG_LPSRAM1CCSR    : aliased Interfaces.Bit_Types.UInt32;
      --  RAMCFG LPSRAM2 control register
