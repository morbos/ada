...
package Interfaces.STM32.RTC is
   ...
   subtype RTC_OR_LSCOEN_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype RTC_R0CIDCFGR_CID_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype RTC_R1CIDCFGR_CID_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype RTC_R2CIDCFGR_CID_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype RTC_R3CIDCFGR_CID_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype RTC_R4CIDCFGR_CID_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype RTC_R5CIDCFGR_CID_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype RTC_HWCFGR2_RIF_Field is Interfaces.Bit_Types.UInt4;
   subtype RTC_HWCFGR2_CID_WIDTH_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype RTC_HWCFGR1_ALARMB_Field is Interfaces.Bit_Types.UInt4;
   subtype RTC_HWCFGR1_WAKEUP_Field is Interfaces.Bit_Types.UInt4;
   subtype RTC_HWCFGR1_SMOOTH_CALIB_Field is Interfaces.Bit_Types.UInt4;
   subtype RTC_HWCFGR1_TIMESTAMP_Field is Interfaces.Bit_Types.UInt4;
   subtype RTC_HWCFGR1_OPTIONREG_OUT_Field is Interfaces.Bit_Types.Byte;
   subtype RTC_HWCFGR1_TRUST_ZONE_Field is Interfaces.Bit_Types.UInt4;
   subtype RTC_HWCFGR1_BINARY_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype RTC_VERR_MINREV_Field is Interfaces.Bit_Types.UInt4;
   subtype RTC_VERR_MAJREV_Field is Interfaces.Bit_Types.UInt4;
   ...
   type RTC_Peripheral is record
      ...
      RTC_IPIDR     : aliased Interfaces.Bit_Types.UInt32;
      --  RTC size identification register
      RTC_SIDR      : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
