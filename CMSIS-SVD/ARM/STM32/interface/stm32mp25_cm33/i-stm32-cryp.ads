...
package Interfaces.STM32.CRYP is
   pragma Preelaborate;
   ...
   subtype CRYP_CR_ALGOMODE_Field is Interfaces.Bit_Types.UInt3;
   subtype CRYP_CR_DATATYPE_Field is Interfaces.Bit_Types.UInt2;
   subtype CRYP_CR_KEYSIZE_Field is Interfaces.Bit_Types.UInt2;
   subtype CRYP_CR_GCM_CCMPH_Field is Interfaces.Bit_Types.UInt2;
   subtype CRYP_CR_NPBLB_Field is Interfaces.Bit_Types.UInt4;
   subtype CRYP_CR_KMOD_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype CRYP_HWCFGR_CFG_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype CRYP_VERR_MINVER_Field is Interfaces.Bit_Types.UInt4;
   subtype CRYP_VERR_MAJVER_Field is Interfaces.Bit_Types.UInt4;
   ...
   type CRYP_Peripheral is record
      ...
      CRYP_DINR       : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP data output register
      CRYP_DOUTR      : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP DMA control register
      ...
      CRYP_K0LR       : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP key register 0R
      CRYP_K0RR       : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP key register 1L
      CRYP_K1LR       : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP key register 1R
      CRYP_K1RR       : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP key register 2L
      CRYP_K2LR       : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP key register 2R
      CRYP_K2RR       : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP key register 3L
      CRYP_K3LR       : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP key register 3R
      CRYP_K3RR       : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP initialization vector register 0L
      CRYP_IV0LR      : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP initialization vector register 0R
      CRYP_IV0RR      : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP initialization vector register 1L
      CRYP_IV1LR      : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP initialization vector register 1R
      CRYP_IV1RR      : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP context swap GCM-CCM registers
      CRYP_CSGCMCCM0R : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP context swap GCM-CCM registers
      CRYP_CSGCMCCM1R : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP context swap GCM-CCM registers
      CRYP_CSGCMCCM2R : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP context swap GCM-CCM registers
      CRYP_CSGCMCCM3R : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP context swap GCM-CCM registers
      CRYP_CSGCMCCM4R : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP context swap GCM-CCM registers
      CRYP_CSGCMCCM5R : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP context swap GCM-CCM registers
      CRYP_CSGCMCCM6R : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP context swap GCM-CCM registers
      CRYP_CSGCMCCM7R : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP context swap GCM registers
      CRYP_CSGCM0R    : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP context swap GCM registers
      CRYP_CSGCM1R    : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP context swap GCM registers
      CRYP_CSGCM2R    : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP context swap GCM registers
      CRYP_CSGCM3R    : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP context swap GCM registers
      CRYP_CSGCM4R    : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP context swap GCM registers
      CRYP_CSGCM5R    : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP context swap GCM registers
      CRYP_CSGCM6R    : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP context swap GCM registers
      CRYP_CSGCM7R    : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP hardware configuration register
      CRYP_HWCFGR     : aliased CRYP_HWCFGR_Register;
      --  CRYP version register
      CRYP_VERR       : aliased CRYP_VERR_Register;
      --  CRYP identification
      CRYP_IPIDR      : aliased Interfaces.Bit_Types.UInt32;
      --  CRYP size identification register
      CRYP_SIDR       : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
