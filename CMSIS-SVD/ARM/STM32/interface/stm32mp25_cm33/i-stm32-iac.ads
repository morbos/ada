...
package Interfaces.STM32.IAC is
   pragma Preelaborate;
   ...
   subtype IAC_HWCFGR2_CFG_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype IAC_HWCFGR1_CFG_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype IAC_HWCFGR1_CFG5_Field is Interfaces.Bit_Types.UInt9;
   ...
   subtype IAC_VERR_MINREV_Field is Interfaces.Bit_Types.UInt4;
   subtype IAC_VERR_MAJREV_Field is Interfaces.Bit_Types.UInt4;
   ...
   type IAC_Peripheral is record
      ...
      IAC_IPIDR   : aliased Interfaces.Bit_Types.UInt32;
      --  IAC size identification register
      IAC_SIDR    : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
