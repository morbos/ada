...
package Interfaces.STM32.GPIOD is
   pragma Preelaborate;
   ...
   subtype GPIOD_DELAYRL_DLY_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOD_DELAYRH_DLY_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOD_CIDCFGR_SCID_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOD_SEMCR_SEMCID_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOD_HWCFGR11_AHB_IOP_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOD_HWCFGR11_AFSIZE_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOD_HWCFGR11_SPEED_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOD_HWCFGR11_LOCK_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOD_HWCFGR11_SEC_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOD_HWCFGR11_OR_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOD_HWCFGR11_PRIV_CFG_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOD_HWCFGR10_EN_IO_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOD_HWCFGR9_FAST_AF_IO_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOD_HWCFGR4_ODR_RES_Field is Interfaces.Bit_Types.UInt16;
   subtype GPIOD_HWCFGR4_OTYPER_RES_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOD_HWCFGR1_OR_RES_Field is Interfaces.Bit_Types.UInt16;
   ...
   type GPIOD_Peripheral is record
      ...
      GPIOD_HWCFGR7   : aliased Interfaces.Bit_Types.UInt32;
      ...
      GPIOD_HWCFGR3   : aliased Interfaces.Bit_Types.UInt32;
