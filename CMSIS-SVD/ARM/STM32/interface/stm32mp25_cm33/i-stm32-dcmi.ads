...
package Interfaces.STM32.DCMI is
   ...
   subtype DCMI_CR_FCRC_Field is Interfaces.Bit_Types.UInt2;
   subtype DCMI_CR_EDM_Field is Interfaces.Bit_Types.UInt2;
   subtype DCMI_CR_BSM_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype DCMI_ESCR_FSC_Field is Interfaces.Bit_Types.Byte;
   subtype DCMI_ESCR_LSC_Field is Interfaces.Bit_Types.Byte;
   subtype DCMI_ESCR_LEC_Field is Interfaces.Bit_Types.Byte;
   subtype DCMI_ESCR_FEC_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype DCMI_ESUR_FSU_Field is Interfaces.Bit_Types.Byte;
   subtype DCMI_ESUR_LSU_Field is Interfaces.Bit_Types.Byte;
   subtype DCMI_ESUR_LEU_Field is Interfaces.Bit_Types.Byte;
   subtype DCMI_ESUR_FEU_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype DCMI_CWSTRT_HOFFCNT_Field is Interfaces.Bit_Types.UInt14;
   subtype DCMI_CWSTRT_VST_Field is Interfaces.Bit_Types.UInt13;
   ...
   subtype DCMI_CWSIZE_CAPCNT_Field is Interfaces.Bit_Types.UInt14;
   subtype DCMI_CWSIZE_VLINE_Field is Interfaces.Bit_Types.UInt14;
   ...
   subtype DCMI_DR_BYTE_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype DCMI_HWCFGR_FIFO_8_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype DCMI_VERR_MINREV_Field is Interfaces.Bit_Types.UInt4;
   subtype DCMI_VERR_MAJREV_Field is Interfaces.Bit_Types.UInt4;
   ...
   type DCMI_Peripheral is record
      ...
      DCMI_IPIDR  : aliased Interfaces.Bit_Types.UInt32;
      --  DCMI size identification register
      DCMI_SIDR   : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
