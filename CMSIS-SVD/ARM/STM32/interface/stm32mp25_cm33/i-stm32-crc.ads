...
package Interfaces.STM32.CRC is
   ...
   subtype CRC_CR_POLYSIZE_Field is Interfaces.Bit_Types.UInt2;
   subtype CRC_CR_REV_IN_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype CRC_HWCFGR_FULL_POLY_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype CRC_VERR_MINREV_Field is Interfaces.Bit_Types.UInt4;
   subtype CRC_VERR_MAJREV_Field is Interfaces.Bit_Types.UInt4;
   ...
   type CRC_Peripheral is record
      --  CRC data register
      CRC_DR     : aliased Interfaces.Bit_Types.UInt32;
      --  CRC independent data register
      CRC_IDR    : aliased Interfaces.Bit_Types.UInt32;
      --  CRC control register
      CRC_CR     : aliased CRC_CR_Register;
      --  CRC initial value
      CRC_INIT   : aliased Interfaces.Bit_Types.UInt32;
      --  CRC polynomial
      CRC_POL    : aliased Interfaces.Bit_Types.UInt32;
      --  CRC hardware configuration register
      CRC_HWCFGR : aliased CRC_HWCFGR_Register;
      --  CRC version register
      CRC_VERR   : aliased CRC_VERR_Register;
      --  CRC identification register
      CRC_IPIDR  : aliased Interfaces.Bit_Types.UInt32;
      --  CRC size identification register
      CRC_SIDR   : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
