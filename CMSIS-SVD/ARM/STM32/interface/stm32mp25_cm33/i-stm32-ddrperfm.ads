...
package Interfaces.STM32.DDRPERFM is
   pragma Preelaborate;
   ...
   subtype DDRPERFM_CLR_CNTCLR_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype DDRPERFM_CFG0_SEL_EVENT0_Field is Interfaces.Bit_Types.UInt6;
   subtype DDRPERFM_CFG0_SEL_EVENT1_Field is Interfaces.Bit_Types.UInt6;
   subtype DDRPERFM_CFG0_SEL_EVENT2_Field is Interfaces.Bit_Types.UInt6;
   subtype DDRPERFM_CFG0_SEL_EVENT3_Field is Interfaces.Bit_Types.UInt6;
   ...
   subtype DDRPERFM_CFG1_SEL_EVENT4_Field is Interfaces.Bit_Types.UInt6;
   subtype DDRPERFM_CFG1_SEL_EVENT5_Field is Interfaces.Bit_Types.UInt6;
   subtype DDRPERFM_CFG1_SEL_EVENT6_Field is Interfaces.Bit_Types.UInt6;
   subtype DDRPERFM_CFG1_SEL_EVENT7_Field is Interfaces.Bit_Types.UInt6;
   ...
   subtype DDRPERFM_CFG2_FILT_RBG0_Field is Interfaces.Bit_Types.UInt5;
   subtype DDRPERFM_CFG2_FILT_POL0_Field is Interfaces.Bit_Types.UInt3;
   subtype DDRPERFM_CFG2_FILT_RBG1_Field is Interfaces.Bit_Types.UInt5;
   subtype DDRPERFM_CFG2_FILT_POL1_Field is Interfaces.Bit_Types.UInt3;
   subtype DDRPERFM_CFG2_FILT_RBG2_Field is Interfaces.Bit_Types.UInt5;
   subtype DDRPERFM_CFG2_FILT_POL2_Field is Interfaces.Bit_Types.UInt3;
   subtype DDRPERFM_CFG2_FILT_RBG3_Field is Interfaces.Bit_Types.UInt5;
   subtype DDRPERFM_CFG2_FILT_POL3_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype DDRPERFM_CFG3_FILT_RBG4_Field is Interfaces.Bit_Types.UInt5;
   subtype DDRPERFM_CFG3_FILT_POL4_Field is Interfaces.Bit_Types.UInt3;
   subtype DDRPERFM_CFG3_FILT_RBG5_Field is Interfaces.Bit_Types.UInt5;
   subtype DDRPERFM_CFG3_FILT_POL5_Field is Interfaces.Bit_Types.UInt3;
   subtype DDRPERFM_CFG3_FILT_RBG6_Field is Interfaces.Bit_Types.UInt5;
   subtype DDRPERFM_CFG3_FILT_POL6_Field is Interfaces.Bit_Types.UInt3;
   subtype DDRPERFM_CFG3_FILT_RBG7_Field is Interfaces.Bit_Types.UInt5;
   subtype DDRPERFM_CFG3_FILT_POL7_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype DDRPERFM_CFG5_EVCNT_EN_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype DDRPERFM_DRAMINF_DRAM_TYPE_Field is Interfaces.Bit_Types.UInt2;
   ...
   type DDRPERFM_STATUS_Register is record
      ...
      TCNT_OVFL      : Boolean;
      --  unspecified
      Reserved_17_30 : Interfaces.Bit_Types.UInt14;
   ...
   type DDRPERFM_Peripheral is record
      ...
      DDRPERFM_CFG4    : aliased Interfaces.Bit_Types.UInt32;
      --  DDRPERFM event counter enable register
      ...
      DDRPERFM_EVCNT0  : aliased Interfaces.Bit_Types.UInt32;
      --  DDRPERFM event counter 1 register
      DDRPERFM_EVCNT1  : aliased Interfaces.Bit_Types.UInt32;
      --  DDRPERFM event counter 2 register
      DDRPERFM_EVCNT2  : aliased Interfaces.Bit_Types.UInt32;
      --  DDRPERFM event counter 3 register
      DDRPERFM_EVCNT3  : aliased Interfaces.Bit_Types.UInt32;
      --  DDRPERFM event counter 4 register
      DDRPERFM_EVCNT4  : aliased Interfaces.Bit_Types.UInt32;
      --  DDRPERFM event counter 5 register
      DDRPERFM_EVCNT5  : aliased Interfaces.Bit_Types.UInt32;
      --  DDRPERFM event counter 6 register
      DDRPERFM_EVCNT6  : aliased Interfaces.Bit_Types.UInt32;
      --  DDRPERFM event counter 7 register
      DDRPERFM_EVCNT7  : aliased Interfaces.Bit_Types.UInt32;
      --  DDRPERFM time counter register
      DDRPERFM_TCNT    : aliased Interfaces.Bit_Types.UInt32;
      --  DDRPERFM status register
