...
package Interfaces.STM32.GPIOH is
   ...
   subtype GPIOH_DELAYRL_DLY_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOH_DELAYRH_DLY_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOH_CIDCFGR_SCID_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOH_SEMCR_SEMCID_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOH_HWCFGR11_AHB_IOP_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOH_HWCFGR11_AFSIZE_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOH_HWCFGR11_SPEED_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOH_HWCFGR11_LOCK_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOH_HWCFGR11_SEC_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOH_HWCFGR11_OR_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOH_HWCFGR11_PRIV_CFG_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOH_HWCFGR10_EN_IO_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOH_HWCFGR9_FAST_AF_IO_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOH_HWCFGR4_ODR_RES_Field is Interfaces.Bit_Types.UInt16;
   subtype GPIOH_HWCFGR4_OTYPER_RES_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOH_HWCFGR1_OR_RES_Field is Interfaces.Bit_Types.UInt16;
   ...
   type GPIOH_Peripheral is record
      ...
      GPIOH_HWCFGR7   : aliased Interfaces.Bit_Types.UInt32;
      ...
      GPIOH_HWCFGR3   : aliased Interfaces.Bit_Types.UInt32;
