...
package Interfaces.STM32.DCMIPP is
   ...
   type DCMIPP_IPC1R2_Register is record
      ...
      WLRU           : DCMIPP_IPC1R2_WLRU_Field := 16#4#;
      --  unspecified
   ...
   subtype DCMIPP_IPC1R3_DPREGSTART_Field is Interfaces.Bit_Types.UInt11;
   subtype DCMIPP_IPC1R3_DPREGEND_Field is Interfaces.Bit_Types.UInt11;
   ...
   type DCMIPP_IPC1R3_Register is record
      ...
      DPREGEND       : DCMIPP_IPC1R3_DPREGEND_Field := 16#17F#;
      --  unspecified
   ...
   for DCMIPP_IPC1R3_Register use record
      DPREGSTART     at 0 range 0 .. 10;
      Reserved_11_15 at 0 range 11 .. 15;
      DPREGEND       at 0 range 16 .. 26;
   ...
   type DCMIPP_IPC2R2_Register is record
      ...
      Reserved_0_15  : Interfaces.Bit_Types.UInt16 := 16#0#;
      --  Ratio for WLRU[3:0] arbitration
      WLRU           : DCMIPP_IPC2R2_WLRU_Field := 16#2#;
      --  unspecified
      Reserved_20_31 : Interfaces.Bit_Types.UInt12 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype DCMIPP_IPC2R3_DPREGSTART_Field is Interfaces.Bit_Types.UInt11;
   subtype DCMIPP_IPC2R3_DPREGEND_Field is Interfaces.Bit_Types.UInt11;

   --  DCMIPP IP-Plug Clientx register 3
   type DCMIPP_IPC2R3_Register is record
      --  Start word (AXI width = 64 bits) of the FIFO of Clientx.
      DPREGSTART     : DCMIPP_IPC2R3_DPREGSTART_Field := 16#180#;
      --  unspecified
      Reserved_11_15 : Interfaces.Bit_Types.UInt5 := 16#0#;
      --  End word (AXI width = 64 bits) of the FIFO of Clientx.
      DPREGEND       : DCMIPP_IPC2R3_DPREGEND_Field := 16#2FF#;
      --  unspecified
      Reserved_27_31 : Interfaces.Bit_Types.UInt5 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype DCMIPP_IPC3R3_DPREGSTART_Field is Interfaces.Bit_Types.UInt11;
   subtype DCMIPP_IPC3R3_DPREGEND_Field is Interfaces.Bit_Types.UInt11;

   --  DCMIPP IP-Plug Clientx register 3
   type DCMIPP_IPC3R3_Register is record
      --  Start word (AXI width = 64 bits) of the FIFO of Clientx.
      DPREGSTART     : DCMIPP_IPC3R3_DPREGSTART_Field := 16#300#;
      --  unspecified
      Reserved_11_15 : Interfaces.Bit_Types.UInt5 := 16#0#;
      --  End word (AXI width = 64 bits) of the FIFO of Clientx.
      DPREGEND       : DCMIPP_IPC3R3_DPREGEND_Field := 16#3BF#;
      --  unspecified
      Reserved_27_31 : Interfaces.Bit_Types.UInt5 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype DCMIPP_IPC4R3_DPREGSTART_Field is Interfaces.Bit_Types.UInt11;
   subtype DCMIPP_IPC4R3_DPREGEND_Field is Interfaces.Bit_Types.UInt11;

   --  DCMIPP IP-Plug Clientx register 3
   type DCMIPP_IPC4R3_Register is record
      --  Start word (AXI width = 64 bits) of the FIFO of Clientx.
      DPREGSTART     : DCMIPP_IPC4R3_DPREGSTART_Field := 16#3C0#;
      --  unspecified
      Reserved_11_15 : Interfaces.Bit_Types.UInt5 := 16#0#;
      --  End word (AXI width = 64 bits) of the FIFO of Clientx.
      DPREGEND       : DCMIPP_IPC4R3_DPREGEND_Field := 16#41F#;
      --  unspecified
      Reserved_27_31 : Interfaces.Bit_Types.UInt5 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type DCMIPP_IPC5R2_Register is record
      ...
      Reserved_0_15  : Interfaces.Bit_Types.UInt16 := 16#0#;
      --  Ratio for WLRU[3:0] arbitration
      WLRU           : DCMIPP_IPC5R2_WLRU_Field := 16#7#;
      --  unspecified
      Reserved_20_31 : Interfaces.Bit_Types.UInt12 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype DCMIPP_IPC5R3_DPREGSTART_Field is Interfaces.Bit_Types.UInt11;
   subtype DCMIPP_IPC5R3_DPREGEND_Field is Interfaces.Bit_Types.UInt11;

   --  DCMIPP IP-Plug Clientx register 3
   type DCMIPP_IPC5R3_Register is record
      --  Start word (AXI width = 64 bits) of the FIFO of Clientx.
      DPREGSTART     : DCMIPP_IPC5R3_DPREGSTART_Field := 16#420#;
      --  unspecified
      Reserved_11_15 : Interfaces.Bit_Types.UInt5 := 16#0#;
      --  End word (AXI width = 64 bits) of the FIFO of Clientx.
      DPREGEND       : DCMIPP_IPC5R3_DPREGEND_Field := 16#59F#;
      --  unspecified
      Reserved_27_31 : Interfaces.Bit_Types.UInt5 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type DCMIPP_PRSR_Register is record
      ...
      --  register and if the pixel clock is received.
      HSYNC          : Boolean;
   ...
   subtype DCMIPP_CMHWCFGR_CPIPES_Field is Interfaces.Bit_Types.UInt2;

   --  DCMIPP common IP HW configuration register
   type DCMIPP_CMHWCFGR_Register is record
      --  unspecified
      Reserved_0_1  : Interfaces.Bit_Types.UInt2;
      --  Read-only. Amount of instantiated pipes (either dump or pixel pipes)
      CPIPES        : DCMIPP_CMHWCFGR_CPIPES_Field;
      --  Read-only. Presence of the parallel interface
      CPAR          : Boolean;
      --  Read-only. Presence of the CSI-2 host interface
      CCSI          : Boolean;
      --  unspecified
   ...
   for DCMIPP_CMHWCFGR_Register use record
      Reserved_0_1  at 0 range 0 .. 1;
      CPIPES        at 0 range 2 .. 3;
      CPAR          at 0 range 4 .. 4;
      CCSI          at 0 range 5 .. 5;
   ...
   subtype DCMIPP_CMTPGCR1_WIDTH_Field is Interfaces.Bit_Types.UInt14;
   subtype DCMIPP_CMTPGCR1_HEIGHT_Field is Interfaces.Bit_Types.UInt14;

   --  DCMIPP common test pattern generator configuration register 1
   type DCMIPP_CMTPGCR1_Register is record
      --  Width of the visible pixels of the generated frame
      WIDTH          : DCMIPP_CMTPGCR1_WIDTH_Field := 16#0#;
      --  unspecified
      Reserved_14_15 : Interfaces.Bit_Types.UInt2 := 16#0#;
      --  Height of the visible pixels of the generated frame
      HEIGHT         : DCMIPP_CMTPGCR1_HEIGHT_Field := 16#0#;
      --  unspecified
   ...
   for DCMIPP_CMTPGCR1_Register use record
      WIDTH          at 0 range 0 .. 13;
      Reserved_14_15 at 0 range 14 .. 15;
      HEIGHT         at 0 range 16 .. 29;
      Reserved_30_31 at 0 range 30 .. 31;
   end record;

   subtype DCMIPP_CMTPGCR2_YT_Field is Interfaces.Bit_Types.UInt2;
   subtype DCMIPP_CMTPGCR2_RT_Field is Interfaces.Bit_Types.UInt2;
   subtype DCMIPP_CMTPGCR2_FORMAT_Field is Interfaces.Bit_Types.Byte;
   subtype DCMIPP_CMTPGCR2_VBL_Field is Interfaces.Bit_Types.UInt16;

   --  DCMIPP common test pattern generator configuration register 2
   type DCMIPP_CMTPGCR2_Register is record
      ...
      --  Gray scale enable
      GSEN    : Boolean := False;
      --  Pattern selection, between color bars and color squares
      PATTERN : Boolean := False;
      --  YUV type
      YT      : DCMIPP_CMTPGCR2_YT_Field := 16#0#;
      --  Raw Bayer type
      RT      : DCMIPP_CMTPGCR2_RT_Field := 16#0#;
      --  Pixel format generated:
      FORMAT  : DCMIPP_CMTPGCR2_FORMAT_Field := 16#0#;
      --  Amount of lines of the vertical blanking
      VBL     : DCMIPP_CMTPGCR2_VBL_Field := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;

   for DCMIPP_CMTPGCR2_Register use record
      TPGEN   at 0 range 0 .. 0;
      LFLEN   at 0 range 1 .. 1;
      GSEN    at 0 range 2 .. 2;
      PATTERN at 0 range 3 .. 3;
      YT      at 0 range 4 .. 5;
      RT      at 0 range 6 .. 7;
      FORMAT  at 0 range 8 .. 15;
      VBL     at 0 range 16 .. 31;
   end record;
   ...
   type DCMIPP_CMSR1_Register is record
      ...
      --  into the DCMIPP_PRCR register and if the pixel clock is received.
      PRHSYNC        : Boolean;
      --  Read-only. This bit gives the state of the VSYNC pin with the correct
      --  programmed polarity on the parallel interface if ENABLE bit is set
      --  into the DCMIPP_PRCR register and if the pixel clock is received.
   ...
   type DCMIPP_CMSR2_Register is record
      ...
      --  Read-only. AXI transfer error interrupt status flag for the IP-Plug.
      ATXERRF        : Boolean;
   ...
   subtype DCMIPP_P0HWCFGR_CPLA_Field is Interfaces.Bit_Types.UInt2;
   subtype DCMIPP_P0HWCFGR_CRB_Field is Interfaces.Bit_Types.UInt2;
   subtype DCMIPP_P0HWCFGR_CGM_Field is Interfaces.Bit_Types.UInt2;
   subtype DCMIPP_P0HWCFGR_CROI_Field is Interfaces.Bit_Types.UInt4;

   --  DCMIPP Pipe0 HW configuration register
   type DCMIPP_P0HWCFGR_Register is record
      --  Read-only. Capability for planar buffers
      CPLA           : DCMIPP_P0HWCFGR_CPLA_Field;
      --  Read-only. Capability for downsize filter
      CDS            : Boolean;
      --  Read-only. Double buffer mode
      DBM            : Boolean;
      --  Read-only. Capability for demosaicing
      CRB            : DCMIPP_P0HWCFGR_CRB_Field;
      --  Read-only. Capability for gamma conversions
      CGM            : DCMIPP_P0HWCFGR_CGM_Field;
      --  Read-only. Capability for ROI: defines the number of ROIs in the pipe
      CROI           : DCMIPP_P0HWCFGR_CROI_Field;
      --  unspecified
      Reserved_12_12 : Interfaces.Bit_Types.Bit;
      --  Read-only. Capability for pipeline virtualization
      CVP            : Boolean;
      --  unspecified
   ...
   for DCMIPP_P0HWCFGR_Register use record
      CPLA           at 0 range 0 .. 1;
      CDS            at 0 range 2 .. 2;
      DBM            at 0 range 3 .. 3;
      CRB            at 0 range 4 .. 5;
      CGM            at 0 range 6 .. 7;
      CROI           at 0 range 8 .. 11;
      Reserved_12_12 at 0 range 12 .. 12;
      CVP            at 0 range 13 .. 13;
   ...
   --  DCMIPP Pipe0 statistic/crop start register
   ...
   --  DCMIPP Pipe0 statistic/crop size register
   ...
   type DCMIPP_P0PPCR_Register is record
      --  Swaps, within a 32-bit word, byte 0-vs-1 and byte 2-vs-3.
      SWAPYUV        : Boolean := False;
      --  unspecified
      Reserved_1_4   : Interfaces.Bit_Types.UInt4 := 16#0#;
      --  Pad mode for monochrome and raw Bayer 10/12/14 bpp (MSB vs.
      PAD            : Boolean := False;
   ...
   --  DCMIPP Pipe0 current statistic/crop start register
   ...
   --  DCMIPP Pipe0 current statistic/crop size register
   ...
   type DCMIPP_P0CPPCR_Register is record
      --  Read-only. Swaps, within a 32-bit word, byte 0 vs.
      SWAPYUV        : Boolean;
      --  unspecified
      Reserved_1_4   : Interfaces.Bit_Types.UInt4;
      --  Read-only. Current Pad mode for monochrome and raw Bayer 10/12/14 bpp
      --  (MSB vs.
      PAD            : Boolean;
   ...
   subtype DCMIPP_P1HWCFGR_CPLA_Field is Interfaces.Bit_Types.UInt2;
   subtype DCMIPP_P1HWCFGR_CRB_Field is Interfaces.Bit_Types.UInt2;
   subtype DCMIPP_P1HWCFGR_CGM_Field is Interfaces.Bit_Types.UInt2;
   subtype DCMIPP_P1HWCFGR_CROI_Field is Interfaces.Bit_Types.UInt4;

   --  DCMIPP Pipex HW configuration register
   type DCMIPP_P1HWCFGR_Register is record
      --  Read-only. Capability for planar buffers
      CPLA           : DCMIPP_P1HWCFGR_CPLA_Field;
      --  Read-only. Capability for downsize filter
      CDS            : Boolean;
      --  Read-only. Double buffer mode
      DBM            : Boolean;
      --  Read-only. Capability for demosaicing
      CRB            : DCMIPP_P1HWCFGR_CRB_Field;
      --  Read-only. Capability for gamma conversions
      CGM            : DCMIPP_P1HWCFGR_CGM_Field;
      --  Read-only. Capability for ROI: defines the number of ROIs in the pipe
      CROI           : DCMIPP_P1HWCFGR_CROI_Field;
      --  unspecified
      Reserved_12_12 : Interfaces.Bit_Types.Bit;
      --  Read-only. Capability for pipeline virtualization
      CVP            : Boolean;
      --  unspecified
      Reserved_14_15 : Interfaces.Bit_Types.UInt2;
      --  Read-only. Capability to extract histograms
      CHS            : Boolean;
      --  Read-only. Capability for lens shading
      CLS            : Boolean;
      --  Read-only. Capability for focus extraction
      CFOC           : Boolean;
      --  unspecified
   ...
   for DCMIPP_P1HWCFGR_Register use record
      CPLA           at 0 range 0 .. 1;
      CDS            at 0 range 2 .. 2;
      DBM            at 0 range 3 .. 3;
      CRB            at 0 range 4 .. 5;
      ...
      CVP            at 0 range 13 .. 13;
      Reserved_14_15 at 0 range 14 .. 15;
      CHS            at 0 range 16 .. 16;
      CLS            at 0 range 17 .. 17;
      CFOC           at 0 range 18 .. 18;
   ...
   type DCMIPP_P1SRCR_Register is record
      --  Amount of following lines to keep when CROPEN = 1.
   ...
   type DCMIPP_P1CFSCR_Register is record
      ...
      --  Read-only. Current differentiates Pipe2 vs.
      PIPEDIFF       : Boolean;
      --  Read-only. Current flow selection mode
   ...
   type DCMIPP_P1CDCCR_Register is record
      --  Read-only. None
      ENABLE        : Boolean;
      --  Read-only. Horizontal decimation ratio
      HDEC          : DCMIPP_P1CDCCR_HDEC_Field;
      --  Read-only. Vertical decimation ratio
      VDEC          : DCMIPP_P1CDCCR_VDEC_Field;
      --  unspecified
   ...
   subtype DCMIPP_P2HWCFGR_CPLA_Field is Interfaces.Bit_Types.UInt2;
   subtype DCMIPP_P2HWCFGR_CRB_Field is Interfaces.Bit_Types.UInt2;
   subtype DCMIPP_P2HWCFGR_CGM_Field is Interfaces.Bit_Types.UInt2;
   subtype DCMIPP_P2HWCFGR_CROI_Field is Interfaces.Bit_Types.UInt4;

   --  DCMIPP Pipex HW configuration register
   type DCMIPP_P2HWCFGR_Register is record
      --  Read-only. Capability for planar buffers
      CPLA           : DCMIPP_P2HWCFGR_CPLA_Field;
      --  Read-only. Capability for downsize filter
      CDS            : Boolean;
      --  Read-only. Double buffer mode
      DBM            : Boolean;
      --  Read-only. Capability for demosaicing
      CRB            : DCMIPP_P2HWCFGR_CRB_Field;
      --  Read-only. Capability for gamma conversions
      CGM            : DCMIPP_P2HWCFGR_CGM_Field;
      --  Read-only. Capability for ROI: defines the number of ROIs in the pipe
      CROI           : DCMIPP_P2HWCFGR_CROI_Field;
      --  unspecified
      Reserved_12_12 : Interfaces.Bit_Types.Bit;
      --  Read-only. Capability for pipeline virtualization
      CVP            : Boolean;
   ...
   for DCMIPP_P2HWCFGR_Register use record
      CPLA           at 0 range 0 .. 1;
      CDS            at 0 range 2 .. 2;
      DBM            at 0 range 3 .. 3;
      CRB            at 0 range 4 .. 5;
   ...
   type DCMIPP_P2CDCCR_Register is record
      ...
      ENABLE        : Boolean;
      --  Read-only. Horizontal decimation ratio
      HDEC          : DCMIPP_P2CDCCR_HDEC_Field;
      --  Read-only. Vertical decimation ratio
      VDEC          : DCMIPP_P2CDCCR_VDEC_Field;
      --  unspecified
      Reserved_5_31 : Interfaces.Bit_Types.UInt27;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype DCMIPP_P2CPPM0PR_PITCH_Field is Interfaces.Bit_Types.UInt15;

   --  DCMIPP Pipex current pixel packer Memory0 pitch register
   type DCMIPP_P2CPPM0PR_Register is record
      --  Read-only. Current number of bytes between the address of two
      --  consecutive lines.
      PITCH          : DCMIPP_P2CPPM0PR_PITCH_Field;
      --  unspecified
      Reserved_15_31 : Interfaces.Bit_Types.UInt17;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   for DCMIPP_P2CPPM0PR_Register use record
      PITCH          at 0 range 0 .. 14;
      Reserved_15_31 at 0 range 15 .. 31;
   end record;

   --  DCMIPP hardware configuration register 3
   type DCMIPP_HWCFGR3_Register is record
      --  Read-only. Lens shading
      LSF           : Boolean;
      --  unspecified
      Reserved_1_31 : Interfaces.Bit_Types.UInt31;
   end record
   ...
   for DCMIPP_HWCFGR3_Register use record
      LSF           at 0 range 0 .. 0;
      Reserved_1_31 at 0 range 1 .. 31;
   end record;

   subtype DCMIPP_HWCFGR2_VPFT_Field is Interfaces.Bit_Types.UInt3;

   --  DCMIPP hardware configuration register 2
   type DCMIPP_HWCFGR2_Register is record
      --  Read-only. Virtual pipe function
      VPFT           : DCMIPP_HWCFGR2_VPFT_Field;
      --  unspecified
      Reserved_3_3   : Interfaces.Bit_Types.Bit;
      --  Read-only. Double buffer mode featured
      DBMFT          : Boolean;
      --  unspecified
      Reserved_5_7   : Interfaces.Bit_Types.UInt3;
      --  Read-only. Processing clock linked to AXI clock featured
      PROCCLK        : Boolean;
      --  unspecified
      Reserved_9_11  : Interfaces.Bit_Types.UInt3;
      --  Read-only. Address modulo computation to access a small buffer in
      --  streaming featured
      ADDMOD         : Boolean;
      --  unspecified
      Reserved_13_19 : Interfaces.Bit_Types.UInt7;
      --  Read-only. Macroblock unit as pixel format
      MCU            : Boolean;
      --  unspecified
      Reserved_21_23 : Interfaces.Bit_Types.UInt3;
      --  Read-only. Test pattern generator
      TPG            : Boolean;
      --  unspecified
      Reserved_25_27 : Interfaces.Bit_Types.UInt3;
      --  Read-only. Statistic version
      STV            : Boolean;
      --  unspecified
   ...
   for DCMIPP_HWCFGR2_Register use record
      VPFT           at 0 range 0 .. 2;
      Reserved_3_3   at 0 range 3 .. 3;
      DBMFT          at 0 range 4 .. 4;
      Reserved_5_7   at 0 range 5 .. 7;
      PROCCLK        at 0 range 8 .. 8;
      Reserved_9_11  at 0 range 9 .. 11;
      ADDMOD         at 0 range 12 .. 12;
      Reserved_13_19 at 0 range 13 .. 19;
      MCU            at 0 range 20 .. 20;
      Reserved_21_23 at 0 range 21 .. 23;
      TPG            at 0 range 24 .. 24;
      Reserved_25_27 at 0 range 25 .. 27;
      STV            at 0 range 28 .. 28;
      Reserved_29_31 at 0 range 29 .. 31;
   end record;

   subtype DCMIPP_HWCFGR1_PIPENB_Field is Interfaces.Bit_Types.UInt2;
   subtype DCMIPP_HWCFGR1_PLANARFT_Field is Interfaces.Bit_Types.UInt2;
   subtype DCMIPP_HWCFGR1_ROI1NB_Field is Interfaces.Bit_Types.UInt4;
   subtype DCMIPP_HWCFGR1_ROI2NB_Field is Interfaces.Bit_Types.UInt4;

   --  DCMIPP hardware configuration register 1
   type DCMIPP_HWCFGR1_Register is record
      --  Read-only. CSI2 host protocol compliant
      CSIFT          : Boolean;
      --  unspecified
      Reserved_1_3   : Interfaces.Bit_Types.UInt3;
      --  Read-only. Number of pipes
      PIPENB         : DCMIPP_HWCFGR1_PIPENB_Field;
      --  unspecified
      Reserved_6_7   : Interfaces.Bit_Types.UInt2;
      --  Read-only. IP-Plug configuration
      IPPLUGCFG      : Boolean;
      --  unspecified
      Reserved_9_11  : Interfaces.Bit_Types.UInt3;
      --  Read-only. Down-sampling feature for the pixel Pipe1
      DSP1FT         : Boolean;
      --  Read-only. Down-sampling feature for the pixel Pipe2
      DSP2FT         : Boolean;
      --  unspecified
      Reserved_14_15 : Interfaces.Bit_Types.UInt2;
      --  Read-only. Raw Bayer to RGB feature (demosaicer)
      RB2RGB         : Boolean;
      --  unspecified
      Reserved_17_19 : Interfaces.Bit_Types.UInt3;
      --  Read-only. Buffer features for Pipe1
      PLANARFT       : DCMIPP_HWCFGR1_PLANARFT_Field;
      --  unspecified
      Reserved_22_23 : Interfaces.Bit_Types.UInt2;
      --  Read-only. Number of ROIs for Pipe1
      ROI1NB         : DCMIPP_HWCFGR1_ROI1NB_Field;
      --  Read-only. Number of ROIs for Pipe2
      ROI2NB         : DCMIPP_HWCFGR1_ROI2NB_Field;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;

   for DCMIPP_HWCFGR1_Register use record
      CSIFT          at 0 range 0 .. 0;
      Reserved_1_3   at 0 range 1 .. 3;
      PIPENB         at 0 range 4 .. 5;
      Reserved_6_7   at 0 range 6 .. 7;
      IPPLUGCFG      at 0 range 8 .. 8;
      Reserved_9_11  at 0 range 9 .. 11;
      DSP1FT         at 0 range 12 .. 12;
      DSP2FT         at 0 range 13 .. 13;
      Reserved_14_15 at 0 range 14 .. 15;
      RB2RGB         at 0 range 16 .. 16;
      Reserved_17_19 at 0 range 17 .. 19;
      PLANARFT       at 0 range 20 .. 21;
      Reserved_22_23 at 0 range 22 .. 23;
      ROI1NB         at 0 range 24 .. 27;
      ROI2NB         at 0 range 28 .. 31;
   end record;

   subtype DCMIPP_VERR_MINREV_Field is Interfaces.Bit_Types.UInt4;
   subtype DCMIPP_VERR_MAJREV_Field is Interfaces.Bit_Types.UInt4;

   --  DCMIPP version register
   type DCMIPP_VERR_Register is record
      --  Read-only. DCMIPP minor revision
      MINREV        : DCMIPP_VERR_MINREV_Field;
      --  Read-only. DCMIPP major revision
      MAJREV        : DCMIPP_VERR_MAJREV_Field;
      --  unspecified
   ...
   for DCMIPP_VERR_Register use record
   ...
   type DCMIPP_Peripheral is record
      ...
      --  DCMIPP common IP HW configuration register
      DCMIPP_CMHWCFGR   : aliased DCMIPP_CMHWCFGR_Register;
      --  DCMIPP common configuration register
      ...
      --  DCMIPP common test pattern generator configuration register 1
      DCMIPP_CMTPGCR1   : aliased DCMIPP_CMTPGCR1_Register;
      --  DCMIPP common test pattern generator configuration register 2
      DCMIPP_CMTPGCR2   : aliased DCMIPP_CMTPGCR2_Register;
      --  DCMIPP common interrupt enable register
      ...
      --  DCMIPP Pipe0 HW configuration register
      DCMIPP_P0HWCFGR   : aliased DCMIPP_P0HWCFGR_Register;
      --  DCMIPP Pipe0 flow selection configuration register
      ...
      --  DCMIPP Pipex HW configuration register
      DCMIPP_P1HWCFGR   : aliased DCMIPP_P1HWCFGR_Register;
      --  DCMIPP Pipe1 flow selection configuration register
      ...
      --  DCMIPP Pipex HW configuration register
      DCMIPP_P2HWCFGR   : aliased DCMIPP_P2HWCFGR_Register;
      --  DCMIPP Pipe2 flow selection configuration register
      ...
      --  DCMIPP Pipex current pixel packer Memory0 pitch register
      DCMIPP_P2CPPM0PR  : aliased DCMIPP_P2CPPM0PR_Register;
      --  DCMIPP hardware configuration register 3
      DCMIPP_HWCFGR3    : aliased DCMIPP_HWCFGR3_Register;
      --  DCMIPP hardware configuration register 2
      DCMIPP_HWCFGR2    : aliased DCMIPP_HWCFGR2_Register;
      --  DCMIPP hardware configuration register 1
      DCMIPP_HWCFGR1    : aliased DCMIPP_HWCFGR1_Register;
      --  DCMIPP version register
      DCMIPP_VERR       : aliased DCMIPP_VERR_Register;
      --  DCMIPP identification register
      DCMIPP_IPIDR      : aliased Interfaces.Bit_Types.UInt32;
      --  DCMIPP size identification register
      DCMIPP_SIDR       : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
   ...
   for DCMIPP_Peripheral use record
      ...
      DCMIPP_CMHWCFGR   at 16#200# range 0 .. 31;
      DCMIPP_CMCR       at 16#204# range 0 .. 31;
      DCMIPP_CMFRCR     at 16#208# range 0 .. 31;
      DCMIPP_CMTPGCR1   at 16#210# range 0 .. 31;
      DCMIPP_CMTPGCR2   at 16#214# range 0 .. 31;
      ...
      DCMIPP_P0HWCFGR   at 16#400# range 0 .. 31;
      ...
      DCMIPP_P1HWCFGR   at 16#800# range 0 .. 31;
      ...
      DCMIPP_P2HWCFGR   at 16#C00# range 0 .. 31;
      ...
      DCMIPP_P2CPPM0PR  at 16#FCC# range 0 .. 31;
      DCMIPP_HWCFGR3    at 16#FE8# range 0 .. 31;
      DCMIPP_HWCFGR2    at 16#FEC# range 0 .. 31;
      DCMIPP_HWCFGR1    at 16#FF0# range 0 .. 31;
      DCMIPP_VERR       at 16#FF4# range 0 .. 31;
      DCMIPP_IPIDR      at 16#FF8# range 0 .. 31;
      DCMIPP_SIDR       at 16#FFC# range 0 .. 31;
   end record;
