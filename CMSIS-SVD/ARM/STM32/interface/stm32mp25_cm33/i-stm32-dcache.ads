...
package Interfaces.STM32.DCACHE is
   ...
   subtype DCACHE_RMMONR_RMISSMON_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype DCACHE_CMDRSADDRR_CMDSTARTADDR_Field is Interfaces.Bit_Types.UInt27;
   ...
   subtype DCACHE_CMDREADDRR_CMDENDADDR_Field is Interfaces.Bit_Types.UInt27;
   ...
   subtype DCACHE_HWCFGR_WAYS_Field is Interfaces.Bit_Types.UInt2;
   subtype DCACHE_HWCFGR_SIZE_Field is Interfaces.Bit_Types.UInt3;
   subtype DCACHE_HWCFGR_LWIDTH_Field is Interfaces.Bit_Types.UInt2;
   subtype DCACHE_HWCFGR_MASTERSIZE_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype DCACHE_VERR_MINREV_Field is Interfaces.Bit_Types.UInt4;
   subtype DCACHE_VERR_MAJREV_Field is Interfaces.Bit_Types.UInt4;
   ...
   type DCACHE_Peripheral is record
      ...
      DCACHE_IPIDR      : aliased Interfaces.Bit_Types.UInt32;
      --  DCACHE size identification register
      DCACHE_SIDR       : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
