...
package Interfaces.STM32.DDRDBG is
   pragma Preelaborate;
   ...
   subtype DDRDBG_DDRC_AUTO_SR_DELAY_DELAY_CYCLES_Field is
   ...
   subtype DDRDBG_OBSP_CTRL_OBSP0_SEL_Field is Interfaces.Bit_Types.UInt5;
   subtype DDRDBG_OBSP_CTRL_OBSP1_SEL_Field is Interfaces.Bit_Types.UInt5;
   subtype DDRDBG_OBSP_CTRL_OBSP2_SEL_Field is Interfaces.Bit_Types.UInt5;
   subtype DDRDBG_OBSP_CTRL_OBSP3_SEL_Field is Interfaces.Bit_Types.UInt5;
