...
package Interfaces.STM32.PSSI is
   ...
   type PSSI_CR_Register is record
      ...
      --  unspecified
      Reserved_21_29 : Interfaces.Bit_Types.UInt9 := 16#0#;
      --  DMA enable bit
      DMAEN          : Boolean := True;
   ...
   subtype PSSI_HWCFGR_FIFO_8_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype PSSI_VERR_MINREV_Field is Interfaces.Bit_Types.UInt4;
   subtype PSSI_VERR_MAJREV_Field is Interfaces.Bit_Types.UInt4;
   ...
   type PSSI_Peripheral is record
      ...
      --  PSSI ID register
      PSSI_IPIDR  : aliased Interfaces.Bit_Types.UInt32;
      --  PSSI size identification register
      PSSI_SIDR   : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
