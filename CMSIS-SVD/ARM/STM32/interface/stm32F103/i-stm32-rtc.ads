...
package Interfaces.STM32.RTC is
   ...
   subtype CRH_SECIE_Field is Interfaces.Bit_Types.Bit;
   subtype CRH_ALRIE_Field is Interfaces.Bit_Types.Bit;
   subtype CRH_OWIE_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CRL_SECF_Field is Interfaces.Bit_Types.Bit;
   subtype CRL_ALRF_Field is Interfaces.Bit_Types.Bit;
   subtype CRL_OWF_Field is Interfaces.Bit_Types.Bit;
   subtype CRL_RSF_Field is Interfaces.Bit_Types.Bit;
   subtype CRL_CNF_Field is Interfaces.Bit_Types.Bit;
   subtype CRL_RTOFF_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype PRLH_PRLH_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype PRLL_PRLL_Field is Interfaces.Bit_Types.Short;
   ...
   subtype DIVH_DIVH_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype DIVL_DIVL_Field is Interfaces.Bit_Types.Short;
   ...
   subtype CNTH_CNTH_Field is Interfaces.Bit_Types.Short;
   ...
   subtype CNTL_CNTL_Field is Interfaces.Bit_Types.Short;
   ...
   subtype ALRH_ALRH_Field is Interfaces.Bit_Types.Short;
   ...
   subtype ALRL_ALRL_Field is Interfaces.Bit_Types.Short;
