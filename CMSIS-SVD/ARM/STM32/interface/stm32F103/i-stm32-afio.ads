...
package Interfaces.STM32.AFIO is
   ...
   subtype EVCR_PIN_Field is Interfaces.Bit_Types.UInt4;
   subtype EVCR_PORT_Field is Interfaces.Bit_Types.UInt3;
   subtype EVCR_EVOE_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype MAPR_SPI1_REMAP_Field is Interfaces.Bit_Types.Bit;
   subtype MAPR_I2C1_REMAP_Field is Interfaces.Bit_Types.Bit;
   subtype MAPR_USART1_REMAP_Field is Interfaces.Bit_Types.Bit;
   subtype MAPR_USART2_REMAP_Field is Interfaces.Bit_Types.Bit;
   subtype MAPR_USART3_REMAP_Field is Interfaces.Bit_Types.UInt2;
   subtype MAPR_TIM1_REMAP_Field is Interfaces.Bit_Types.UInt2;
   subtype MAPR_TIM2_REMAP_Field is Interfaces.Bit_Types.UInt2;
   subtype MAPR_TIM3_REMAP_Field is Interfaces.Bit_Types.UInt2;
   subtype MAPR_TIM4_REMAP_Field is Interfaces.Bit_Types.Bit;
   subtype MAPR_CAN_REMAP_Field is Interfaces.Bit_Types.UInt2;
   subtype MAPR_PD01_REMAP_Field is Interfaces.Bit_Types.Bit;
   subtype MAPR_TIM5CH4_IREMAP_Field is Interfaces.Bit_Types.Bit;
   subtype MAPR_ADC1_ETRGINJ_REMAP_Field is Interfaces.Bit_Types.Bit;
   subtype MAPR_ADC1_ETRGREG_REMAP_Field is Interfaces.Bit_Types.Bit;
   subtype MAPR_ADC2_ETRGINJ_REMAP_Field is Interfaces.Bit_Types.Bit;
   subtype MAPR_ADC2_ETRGREG_REMAP_Field is Interfaces.Bit_Types.Bit;
   subtype MAPR_SWJ_CFG_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype MAPR2_TIM9_REMAP_Field is Interfaces.Bit_Types.Bit;
   subtype MAPR2_TIM10_REMAP_Field is Interfaces.Bit_Types.Bit;
   subtype MAPR2_TIM11_REMAP_Field is Interfaces.Bit_Types.Bit;
   subtype MAPR2_TIM13_REMAP_Field is Interfaces.Bit_Types.Bit;
   subtype MAPR2_TIM14_REMAP_Field is Interfaces.Bit_Types.Bit;
   subtype MAPR2_FSMC_NADV_Field is Interfaces.Bit_Types.Bit;
