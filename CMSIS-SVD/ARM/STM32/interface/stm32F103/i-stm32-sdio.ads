...
package Interfaces.STM32.SDIO is
   ...
   subtype DCTRL_PWSTART_Field is Interfaces.Bit_Types.Bit;
   subtype DCTRL_PWSTOP_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype MASK_DBACKENDIE_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype MASK_CEATENDIE_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype FIFOCNT_FIF0COUNT_Field is Interfaces.Bit_Types.UInt24;
   ...
   type SDIO_Peripheral is record
      ...
      RESPI1  : aliased Interfaces.Bit_Types.Word;
