...
package Interfaces.STM32.ADC is
   ...
   subtype SR_AWD_Field is Interfaces.Bit_Types.Bit;
   subtype SR_EOC_Field is Interfaces.Bit_Types.Bit;
   subtype SR_JEOC_Field is Interfaces.Bit_Types.Bit;
   subtype SR_JSTRT_Field is Interfaces.Bit_Types.Bit;
   subtype SR_STRT_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CR1_EOCIE_Field is Interfaces.Bit_Types.Bit;
   subtype CR1_AWDIE_Field is Interfaces.Bit_Types.Bit;
   subtype CR1_JEOCIE_Field is Interfaces.Bit_Types.Bit;
   subtype CR1_SCAN_Field is Interfaces.Bit_Types.Bit;
   subtype CR1_AWDSGL_Field is Interfaces.Bit_Types.Bit;
   subtype CR1_JAUTO_Field is Interfaces.Bit_Types.Bit;
   subtype CR1_DISCEN_Field is Interfaces.Bit_Types.Bit;
   subtype CR1_JDISCEN_Field is Interfaces.Bit_Types.Bit;
   subtype CR1_DISCNUM_Field is Interfaces.Bit_Types.UInt3;
   subtype CR1_DUALMOD_Field is Interfaces.Bit_Types.UInt4;
   subtype CR1_JAWDEN_Field is Interfaces.Bit_Types.Bit;
   subtype CR1_AWDEN_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CR2_ADON_Field is Interfaces.Bit_Types.Bit;
   subtype CR2_CONT_Field is Interfaces.Bit_Types.Bit;
   subtype CR2_CAL_Field is Interfaces.Bit_Types.Bit;
   subtype CR2_RSTCAL_Field is Interfaces.Bit_Types.Bit;
   subtype CR2_DMA_Field is Interfaces.Bit_Types.Bit;
   subtype CR2_ALIGN_Field is Interfaces.Bit_Types.Bit;
   subtype CR2_JEXTSEL_Field is Interfaces.Bit_Types.UInt3;
   subtype CR2_JEXTTRIG_Field is Interfaces.Bit_Types.Bit;
   subtype CR2_EXTSEL_Field is Interfaces.Bit_Types.UInt3;
   subtype CR2_EXTTRIG_Field is Interfaces.Bit_Types.Bit;
   subtype CR2_JSWSTART_Field is Interfaces.Bit_Types.Bit;
   subtype CR2_SWSTART_Field is Interfaces.Bit_Types.Bit;
   subtype CR2_TSVREFE_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype DR_ADC2DATA_Field is Interfaces.Bit_Types.Short;
