...
package Interfaces.STM32.DBG is
   ...
   subtype CR_DBG_IWDG_STOP_Field is Interfaces.Bit_Types.Bit;
   subtype CR_DBG_WWDG_STOP_Field is Interfaces.Bit_Types.Bit;
   subtype CR_DBG_TIM1_STOP_Field is Interfaces.Bit_Types.Bit;
   subtype CR_DBG_TIM2_STOP_Field is Interfaces.Bit_Types.Bit;
   subtype CR_DBG_TIM3_STOP_Field is Interfaces.Bit_Types.Bit;
   subtype CR_DBG_TIM4_STOP_Field is Interfaces.Bit_Types.Bit;
   subtype CR_DBG_CAN1_STOP_Field is Interfaces.Bit_Types.Bit;
   subtype CR_DBG_I2C1_SMBUS_TIMEOUT_Field is Interfaces.Bit_Types.Bit;
   subtype CR_DBG_I2C2_SMBUS_TIMEOUT_Field is Interfaces.Bit_Types.Bit;
   subtype CR_DBG_TIM8_STOP_Field is Interfaces.Bit_Types.Bit;
   subtype CR_DBG_TIM5_STOP_Field is Interfaces.Bit_Types.Bit;
   subtype CR_DBG_TIM6_STOP_Field is Interfaces.Bit_Types.Bit;
   subtype CR_DBG_TIM7_STOP_Field is Interfaces.Bit_Types.Bit;
   subtype CR_DBG_CAN2_STOP_Field is Interfaces.Bit_Types.Bit;
