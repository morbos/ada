...
package Interfaces.STM32.CAN is
   ...
   subtype CAN_MCR_INRQ_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_MCR_SLEEP_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_MCR_TXFP_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_MCR_RFLM_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_MCR_NART_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_MCR_AWUM_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_MCR_ABOM_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_MCR_TTCM_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_MCR_RESET_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_MCR_DBF_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CAN_MSR_INAK_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_MSR_SLAK_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_MSR_ERRI_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_MSR_WKUI_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_MSR_SLAKI_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_MSR_TXM_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_MSR_RXM_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_MSR_SAMP_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_MSR_RX_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CAN_TSR_RQCP0_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TSR_TXOK0_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TSR_ALST0_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TSR_TERR0_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TSR_ABRQ0_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TSR_RQCP1_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TSR_TXOK1_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TSR_ALST1_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TSR_TERR1_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TSR_ABRQ1_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TSR_RQCP2_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TSR_TXOK2_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TSR_ALST2_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TSR_TERR2_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TSR_ABRQ2_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TSR_CODE_Field is Interfaces.Bit_Types.UInt2;
   --  CAN_TSR_TME array element
   subtype CAN_TSR_TME_Element is Interfaces.Bit_Types.Bit;
   ...
   subtype CAN_TSR_LOW_Element is Interfaces.Bit_Types.Bit;
   ...
   subtype CAN_RF0R_FMP0_Field is Interfaces.Bit_Types.UInt2;
   subtype CAN_RF0R_FULL0_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_RF0R_FOVR0_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_RF0R_RFOM0_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CAN_RF1R_FMP1_Field is Interfaces.Bit_Types.UInt2;
   subtype CAN_RF1R_FULL1_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_RF1R_FOVR1_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_RF1R_RFOM1_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CAN_IER_TMEIE_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_IER_FMPIE0_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_IER_FFIE0_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_IER_FOVIE0_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_IER_FMPIE1_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_IER_FFIE1_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_IER_FOVIE1_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_IER_EWGIE_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_IER_EPVIE_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_IER_BOFIE_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_IER_LECIE_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_IER_ERRIE_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_IER_WKUIE_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_IER_SLKIE_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CAN_ESR_EWGF_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_ESR_EPVF_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_ESR_BOFF_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_ESR_LEC_Field is Interfaces.Bit_Types.UInt3;
   subtype CAN_ESR_TEC_Field is Interfaces.Bit_Types.Byte;
   subtype CAN_ESR_REC_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype CAN_BTR_BRP_Field is Interfaces.Bit_Types.UInt10;
   subtype CAN_BTR_TS1_Field is Interfaces.Bit_Types.UInt4;
   subtype CAN_BTR_TS2_Field is Interfaces.Bit_Types.UInt3;
   subtype CAN_BTR_SJW_Field is Interfaces.Bit_Types.UInt2;
   subtype CAN_BTR_LBKM_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_BTR_SILM_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CAN_TI0R_TXRQ_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TI0R_RTR_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TI0R_IDE_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TI0R_EXID_Field is Interfaces.Bit_Types.UInt18;
   subtype CAN_TI0R_STID_Field is Interfaces.Bit_Types.UInt11;
   ...
   subtype CAN_TDT0R_DLC_Field is Interfaces.Bit_Types.UInt4;
   subtype CAN_TDT0R_TGT_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TDT0R_TIME_Field is Interfaces.Bit_Types.Short;
   ...
   subtype CAN_TDL0R_DATA_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype CAN_TDH0R_DATA_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype CAN_TI1R_TXRQ_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TI1R_RTR_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TI1R_IDE_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TI1R_EXID_Field is Interfaces.Bit_Types.UInt18;
   subtype CAN_TI1R_STID_Field is Interfaces.Bit_Types.UInt11;
   ...
   subtype CAN_TDT1R_DLC_Field is Interfaces.Bit_Types.UInt4;
   subtype CAN_TDT1R_TGT_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TDT1R_TIME_Field is Interfaces.Bit_Types.Short;
   ...
   subtype CAN_TDL1R_DATA_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype CAN_TDH1R_DATA_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype CAN_TI2R_TXRQ_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TI2R_RTR_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TI2R_IDE_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TI2R_EXID_Field is Interfaces.Bit_Types.UInt18;
   subtype CAN_TI2R_STID_Field is Interfaces.Bit_Types.UInt11;
   ...
   subtype CAN_TDT2R_DLC_Field is Interfaces.Bit_Types.UInt4;
   subtype CAN_TDT2R_TGT_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_TDT2R_TIME_Field is Interfaces.Bit_Types.Short;
   ...
   subtype CAN_TDL2R_DATA_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype CAN_TDH2R_DATA_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype CAN_RI0R_RTR_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_RI0R_IDE_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_RI0R_EXID_Field is Interfaces.Bit_Types.UInt18;
   subtype CAN_RI0R_STID_Field is Interfaces.Bit_Types.UInt11;
   ...
   subtype CAN_RDT0R_DLC_Field is Interfaces.Bit_Types.UInt4;
   subtype CAN_RDT0R_FMI_Field is Interfaces.Bit_Types.Byte;
   subtype CAN_RDT0R_TIME_Field is Interfaces.Bit_Types.Short;
   ...
   subtype CAN_RDL0R_DATA_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype CAN_RDH0R_DATA_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype CAN_RI1R_RTR_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_RI1R_IDE_Field is Interfaces.Bit_Types.Bit;
   subtype CAN_RI1R_EXID_Field is Interfaces.Bit_Types.UInt18;
   subtype CAN_RI1R_STID_Field is Interfaces.Bit_Types.UInt11;
   ...
   subtype CAN_RDT1R_DLC_Field is Interfaces.Bit_Types.UInt4;
   subtype CAN_RDT1R_FMI_Field is Interfaces.Bit_Types.Byte;
   subtype CAN_RDT1R_TIME_Field is Interfaces.Bit_Types.Short;
   ...
   subtype CAN_RDL1R_DATA_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype CAN_RDH1R_DATA_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype CAN_FMR_FINIT_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CAN_FM1R_FBM_Element is Interfaces.Bit_Types.Bit;
   ...
   subtype CAN_FS1R_FSC_Element is Interfaces.Bit_Types.Bit;
   ...
   subtype CAN_FFA1R_FFA_Element is Interfaces.Bit_Types.Bit;
   ...
   subtype CAN_FA1R_FACT_Element is Interfaces.Bit_Types.Bit;
