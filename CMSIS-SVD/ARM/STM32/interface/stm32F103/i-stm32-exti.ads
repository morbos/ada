...
package Interfaces.STM32.EXTI is
   ...
   subtype IMR_MR_Element is Interfaces.Bit_Types.Bit;
   ...
   subtype EMR_MR_Element is Interfaces.Bit_Types.Bit;
   ...
   subtype RTSR_TR_Element is Interfaces.Bit_Types.Bit;
   ...
   subtype FTSR_TR_Element is Interfaces.Bit_Types.Bit;
   ...
   --  SWIER array element
   subtype SWIER_Element is Interfaces.Bit_Types.Bit;
   ...
   --  PR array element
   subtype PR_Element is Interfaces.Bit_Types.Bit;
