...
package Interfaces.STM32.TIM is
   ...
   subtype TIM1_OR1_OCREF_CLR_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype TIM1_CCR5_CCR5_Field is Interfaces.Bit_Types.UInt16;
   ...
   is record
      ...
      TIM1_ARR          : aliased Interfaces.Bit_Types.UInt16;
      --  TIM1 repetition counter register
      TIM1_RCR          : aliased Interfaces.Bit_Types.UInt16;
      --  TIM1 capture/compare register 1
      TIM1_CCR1         : aliased Interfaces.Bit_Types.UInt16;
      --  TIM1 capture/compare register 2
      TIM1_CCR2         : aliased Interfaces.Bit_Types.UInt16;
      --  TIM1 capture/compare register 3
      TIM1_CCR3         : aliased Interfaces.Bit_Types.UInt16;
      --  TIM1 capture/compare register 4
      TIM1_CCR4         : aliased Interfaces.Bit_Types.UInt16;
      --  TIM1 break and dead-time register
      ...
      TIM1_CCR6         : aliased Interfaces.Bit_Types.UInt16;
      --  TIM1 alternate function option register 1
   ...
   type TIM6_Peripheral is record
      ...
      TIM6_ARR  : aliased Interfaces.Bit_Types.UInt16;
   end record
     with Volatile;
   ...
   type TIM7_Peripheral is record
      ...
      TIM7_ARR  : aliased Interfaces.Bit_Types.UInt16;
   end record
     with Volatile;
