...
package Interfaces.STM32.SPI is
   ...
   subtype SPI_CR1_BR_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype SPI_CR2_DS_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype SPI_SR_FRLVL_Field is Interfaces.Bit_Types.UInt2;
   subtype SPI_SR_FTLVL_Field is Interfaces.Bit_Types.UInt2;
   ...
   type SPI_Peripheral is record
      ...
      --  SPI data register
      SPI_DR     : aliased Interfaces.Bit_Types.UInt16;
      --  SPI CRC polynomial register
      SPI_CRCPR  : aliased Interfaces.Bit_Types.UInt16;
      --  SPI Rx CRC register
      SPI_RXCRCR : aliased Interfaces.Bit_Types.UInt16;
      --  SPI Tx CRC register
      SPI_TXCRCR : aliased Interfaces.Bit_Types.UInt16;
   end record
     with Volatile;
