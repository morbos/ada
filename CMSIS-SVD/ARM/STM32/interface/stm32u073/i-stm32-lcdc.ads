...
package Interfaces.STM32.LCDC is
   pragma Preelaborate;
   ...
   subtype LCD_CR_DUTY_Field is Interfaces.Bit_Types.UInt3;
   subtype LCD_CR_BIAS_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype LCD_FCR_PON_Field is Interfaces.Bit_Types.UInt3;
   subtype LCD_FCR_DEAD_Field is Interfaces.Bit_Types.UInt3;
   subtype LCD_FCR_CC_Field is Interfaces.Bit_Types.UInt3;
   subtype LCD_FCR_BLINKF_Field is Interfaces.Bit_Types.UInt3;
   subtype LCD_FCR_BLINK_Field is Interfaces.Bit_Types.UInt2;
   subtype LCD_FCR_DIV_Field is Interfaces.Bit_Types.UInt4;
   subtype LCD_FCR_PS_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype LCD_RAM_SEGMENT_DATA_Field is Interfaces.Bit_Types.UInt20;
   ...
   subtype LCD_RAM_SEGMENT_DATA_Field_1 is Interfaces.Bit_Types.UInt16;
   ...
   type LCD_Peripheral is record
      ...
      --  LCD display memory
      LCD_RAM0  : aliased Interfaces.Bit_Types.UInt32;
      --  LCD display memory
      LCD_RAM1  : aliased LCD_RAM_Register;
      --  LCD display memory
      LCD_RAM2  : aliased Interfaces.Bit_Types.UInt32;
      --  LCD display memory
      LCD_RAM3  : aliased LCD_RAM_Register;
      --  LCD display memory
      LCD_RAM4  : aliased Interfaces.Bit_Types.UInt32;
      --  LCD display memory
      LCD_RAM5  : aliased LCD_RAM_Register;
      --  LCD display memory
      LCD_RAM6  : aliased Interfaces.Bit_Types.UInt32;
      --  LCD display memory
      LCD_RAM7  : aliased LCD_RAM_Register;
      --  LCD display memory
      LCD_RAM8  : aliased Interfaces.Bit_Types.UInt32;
      --  LCD display memory
      LCD_RAM9  : aliased LCD_RAM_Register_1;
      --  LCD display memory
      LCD_RAM10 : aliased Interfaces.Bit_Types.UInt32;
      --  LCD display memory
      LCD_RAM11 : aliased LCD_RAM_Register_1;
      --  LCD display memory
      LCD_RAM12 : aliased Interfaces.Bit_Types.UInt32;
      --  LCD display memory
      LCD_RAM13 : aliased LCD_RAM_Register_1;
      --  LCD display memory
      LCD_RAM14 : aliased Interfaces.Bit_Types.UInt32;
      --  LCD display memory
