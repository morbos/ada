...
package Interfaces.STM32.SYSCFG is
   ...
   subtype SYSCFG_CFGR1_MEM_MODE_Field is Interfaces.Bit_Types.UInt2;
   subtype SYSCFG_CFGR1_IR_MOD_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype SYSCFG_SKR_KEY_Field is Interfaces.Bit_Types.Byte;
