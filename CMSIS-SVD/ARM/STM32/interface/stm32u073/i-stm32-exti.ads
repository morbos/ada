...
package Interfaces.STM32.EXTI is
   ...
   subtype EXTI_EXTICR1_EXTI_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype EXTI_EXTICR2_EXTI_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype EXTI_EXTICR3_EXTI_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype EXTI_EXTICR4_EXTI_Element is Interfaces.Bit_Types.Byte;
