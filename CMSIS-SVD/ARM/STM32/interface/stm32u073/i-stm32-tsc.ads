...
package Interfaces.STM32.TSC is
   ...
   subtype TSC_CR_MCV_Field is Interfaces.Bit_Types.UInt3;
   subtype TSC_CR_PGPSC_Field is Interfaces.Bit_Types.UInt3;
   subtype TSC_CR_SSD_Field is Interfaces.Bit_Types.UInt7;
   subtype TSC_CR_CTPL_Field is Interfaces.Bit_Types.UInt4;
   subtype TSC_CR_CTPH_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype TSC_IOG1CR_CNT_Field is Interfaces.Bit_Types.UInt14;
   ...
   subtype TSC_IOG2CR_CNT_Field is Interfaces.Bit_Types.UInt14;
   ...
   subtype TSC_IOG3CR_CNT_Field is Interfaces.Bit_Types.UInt14;
   ...
   subtype TSC_IOG4CR_CNT_Field is Interfaces.Bit_Types.UInt14;
   ...
   subtype TSC_IOG5CR_CNT_Field is Interfaces.Bit_Types.UInt14;
   ...
   subtype TSC_IOG6CR_CNT_Field is Interfaces.Bit_Types.UInt14;
   ...
   subtype TSC_IOG7CR_CNT_Field is Interfaces.Bit_Types.UInt14;
