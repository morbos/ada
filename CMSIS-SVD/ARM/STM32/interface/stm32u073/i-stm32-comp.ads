...
package Interfaces.STM32.COMP is
   ...
   subtype COMP1_CSR_INMSEL_Field is Interfaces.Bit_Types.UInt4;
   subtype COMP1_CSR_INPSEL_Field is Interfaces.Bit_Types.UInt3;
   subtype COMP1_CSR_HYST_Field is Interfaces.Bit_Types.UInt2;
   subtype COMP1_CSR_PWRMODE_Field is Interfaces.Bit_Types.UInt2;
   subtype COMP1_CSR_BLANKSEL_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype COMP2_CSR_INMSEL_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype COMP2_CSR_BLANKSEL_Field is Interfaces.Bit_Types.UInt5;
