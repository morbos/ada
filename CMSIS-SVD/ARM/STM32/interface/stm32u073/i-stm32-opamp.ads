...
package Interfaces.STM32.OPAMP is
   ...
   subtype OPAMP_CSR_OPAMODE_Field is Interfaces.Bit_Types.UInt2;
   subtype OPAMP_CSR_PGA_GAIN_Field is Interfaces.Bit_Types.UInt2;
   subtype OPAMP_CSR_VM_SEL_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype OPAMP_OTR_TRIMOFFSETN_Field is Interfaces.Bit_Types.UInt5;
   subtype OPAMP_OTR_TRIMOFFSETP_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype OPAMP_LPOTR_TRIMLPOFFSETN_Field is Interfaces.Bit_Types.UInt5;
   subtype OPAMP_LPOTR_TRIMLPOFFSETP_Field is Interfaces.Bit_Types.UInt5;
