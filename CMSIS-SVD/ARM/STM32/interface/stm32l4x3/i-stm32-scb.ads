...
package Interfaces.STM32.SCB is
   ...
   subtype AIRCR_VECTKEYSTAT_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype SHCSR_MEMFAULTACT_Field is Interfaces.Bit_Types.Bit;
   subtype SHCSR_BUSFAULTACT_Field is Interfaces.Bit_Types.Bit;
   subtype SHCSR_USGFAULTACT_Field is Interfaces.Bit_Types.Bit;
   subtype SHCSR_SVCALLACT_Field is Interfaces.Bit_Types.Bit;
   subtype SHCSR_MONITORACT_Field is Interfaces.Bit_Types.Bit;
   subtype SHCSR_PENDSVACT_Field is Interfaces.Bit_Types.Bit;
   subtype SHCSR_SYSTICKACT_Field is Interfaces.Bit_Types.Bit;
   subtype SHCSR_USGFAULTPENDED_Field is Interfaces.Bit_Types.Bit;
   subtype SHCSR_MEMFAULTPENDED_Field is Interfaces.Bit_Types.Bit;
   subtype SHCSR_BUSFAULTPENDED_Field is Interfaces.Bit_Types.Bit;
   subtype SHCSR_SVCALLPENDED_Field is Interfaces.Bit_Types.Bit;
   subtype SHCSR_MEMFAULTENA_Field is Interfaces.Bit_Types.Bit;
   subtype SHCSR_BUSFAULTENA_Field is Interfaces.Bit_Types.Bit;
   subtype SHCSR_USGFAULTENA_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype ACTRL_DISMCYCINT_Field is Interfaces.Bit_Types.Bit;
   subtype ACTRL_DISDEFWBUF_Field is Interfaces.Bit_Types.Bit;
   subtype ACTRL_DISFOLD_Field is Interfaces.Bit_Types.Bit;
   subtype ACTRL_DISFPCA_Field is Interfaces.Bit_Types.Bit;
   subtype ACTRL_DISOOFP_Field is Interfaces.Bit_Types.Bit;
   ...
   type SCB_Peripheral is record
      ...
      MMFAR                : aliased Interfaces.Bit_Types.UInt32;
      --  Bus fault address register
      BFAR                 : aliased Interfaces.Bit_Types.UInt32;
      --  Auxiliary fault status register
      AFSR                 : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
