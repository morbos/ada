...
package Interfaces.STM32.ADC is
   ...
   subtype CFGR2_TOVS_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype DR_regularDATA_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype JDR1_JDATA1_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype JDR2_JDATA2_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype JDR3_JDATA3_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype JDR4_JDATA4_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype DIFSEL_DIFSEL_0_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CSR_ADDRDY_MST_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CSR_ADRDY_SLV_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_EOSMP_SLV_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_EOC_SLV_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_EOS_SLV_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_OVR_SLV_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_JEOC_SLV_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_JEOS_SLV_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_AWD1_SLV_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_AWD2_SLV_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_AWD3_SLV_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_JQOVF_SLV_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CCR_DMACFG_Field is Interfaces.Bit_Types.Bit;
