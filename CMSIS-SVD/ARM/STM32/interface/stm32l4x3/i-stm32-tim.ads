...
package Interfaces.STM32.TIM is
   ...
   subtype OR1_ETR_ADC1_RMP_Field is Interfaces.Bit_Types.UInt2;
   subtype OR1_ETR_ADC3_RMP_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype CCMR3_Output_OC5M_bit3_Field is Interfaces.Bit_Types.UInt3;
   subtype CCMR3_Output_OC6M_bit3_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype OR2_BKINE_Field is Interfaces.Bit_Types.Bit;
   subtype OR2_BKCMP1E_Field is Interfaces.Bit_Types.Bit;
   subtype OR2_BKCMP2E_Field is Interfaces.Bit_Types.Bit;
   subtype OR2_BKDFBK0E_Field is Interfaces.Bit_Types.Bit;
   subtype OR2_BKINP_Field is Interfaces.Bit_Types.Bit;
   subtype OR2_BKCMP1P_Field is Interfaces.Bit_Types.Bit;
   subtype OR2_BKCMP2P_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype OR3_BK2INE_Field is Interfaces.Bit_Types.Bit;
   subtype OR3_BK2CMP1E_Field is Interfaces.Bit_Types.Bit;
   subtype OR3_BK2CMP2E_Field is Interfaces.Bit_Types.Bit;
   subtype OR3_BK2DFBK0E_Field is Interfaces.Bit_Types.Bit;
   subtype OR3_BK2INP_Field is Interfaces.Bit_Types.Bit;
   subtype OR3_BK2CMP1P_Field is Interfaces.Bit_Types.Bit;
   subtype OR3_BK2CMP2P_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CCMR1_Output_OC1M_2_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype OR1_TI1_RMP_Field_1 is Interfaces.Bit_Types.UInt2;
   ...
   subtype OR2_BKDFBK1E_Field is Interfaces.Bit_Types.Bit;
