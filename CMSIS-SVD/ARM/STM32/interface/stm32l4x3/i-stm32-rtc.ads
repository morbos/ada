...
package Interfaces.STM32.RTC is
   ...
   subtype SSR_SS_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype TSSSR_SS_Field is Interfaces.Bit_Types.UInt16;
   ...
   type RTC_Peripheral is record
      ...
      --  backup register
      BKP20R   : aliased Interfaces.Bit_Types.UInt32;
      --  backup register
      BKP21R   : aliased Interfaces.Bit_Types.UInt32;
      --  backup register
      BKP22R   : aliased Interfaces.Bit_Types.UInt32;
      --  backup register
      BKP23R   : aliased Interfaces.Bit_Types.UInt32;
      --  backup register
      BKP24R   : aliased Interfaces.Bit_Types.UInt32;
      --  backup register
      BKP25R   : aliased Interfaces.Bit_Types.UInt32;
      --  backup register
      BKP26R   : aliased Interfaces.Bit_Types.UInt32;
      --  backup register
      BKP27R   : aliased Interfaces.Bit_Types.UInt32;
      --  backup register
      BKP28R   : aliased Interfaces.Bit_Types.UInt32;
      --  backup register
      BKP29R   : aliased Interfaces.Bit_Types.UInt32;
      --  backup register
      BKP30R   : aliased Interfaces.Bit_Types.UInt32;
      --  backup register
      BKP31R   : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
