...
package Interfaces.STM32.EXTI is
   ...
   subtype IMR1_MR_Element is Interfaces.Bit_Types.Bit;
   ...
   subtype EMR1_MR_Element is Interfaces.Bit_Types.Bit;
   ...
   subtype RTSR1_TR_Element is Interfaces.Bit_Types.Bit;
   ...
   is record
      case As_Array is
         when False =>
            --  TR as a value
            Val : Interfaces.Bit_Types.UInt17;
         when True =>
            --  TR as an array
   ...
   subtype FTSR1_TR_Element is Interfaces.Bit_Types.Bit;
   ...
   subtype SWIER1_SWIER_Element is Interfaces.Bit_Types.Bit;
   ...
   subtype PR1_PR_Element is Interfaces.Bit_Types.Bit;
   ...
   subtype IMR2_MR_Element is Interfaces.Bit_Types.Bit;
   ...
   subtype EMR2_MR_Element is Interfaces.Bit_Types.Bit;
