...
package Interfaces.STM32.DMA is
   ...
   subtype IFCR_CGIF1_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CTCIF1_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CHTIF1_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CTEIF1_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CGIF2_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CTCIF2_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CHTIF2_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CTEIF2_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CGIF3_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CTCIF3_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CHTIF3_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CTEIF3_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CGIF4_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CTCIF4_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CHTIF4_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CTEIF4_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CGIF5_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CTCIF5_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CHTIF5_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CTEIF5_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CGIF6_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CTCIF6_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CHTIF6_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CTEIF6_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CGIF7_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CTCIF7_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CHTIF7_Field is Interfaces.Bit_Types.Bit;
   subtype IFCR_CTEIF7_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CNDTR_NDT_Field is Interfaces.Bit_Types.UInt16;
