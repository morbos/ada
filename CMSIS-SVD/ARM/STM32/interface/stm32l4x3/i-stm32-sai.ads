...
package Interfaces.STM32.SAI is
   ...
   subtype ACR1_OutDri_Field is Interfaces.Bit_Types.Bit;
   subtype ACR1_SAIAEN_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype ACR2_MUTEVAL_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype ASLOTR_SLOTEN_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype AIM_MUTEDET_Field is Interfaces.Bit_Types.Bit;
   subtype AIM_WCKCFG_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype AIM_LFSDET_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype ACLRFR_OVRUDR_Field is Interfaces.Bit_Types.Bit;
   subtype ACLRFR_MUTEDET_Field is Interfaces.Bit_Types.Bit;
   subtype ACLRFR_WCKCFG_Field is Interfaces.Bit_Types.Bit;
   subtype ACLRFR_CNRDY_Field is Interfaces.Bit_Types.Bit;
   subtype ACLRFR_CAFSDET_Field is Interfaces.Bit_Types.Bit;
   subtype ACLRFR_LFSDET_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype BCR1_OutDri_Field is Interfaces.Bit_Types.Bit;
   subtype BCR1_SAIBEN_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype BCR2_MUTEVAL_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype BSLOTR_SLOTEN_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype BIM_MUTEDET_Field is Interfaces.Bit_Types.Bit;
   subtype BIM_WCKCFG_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype BCLRFR_OVRUDR_Field is Interfaces.Bit_Types.Bit;
   subtype BCLRFR_MUTEDET_Field is Interfaces.Bit_Types.Bit;
   subtype BCLRFR_WCKCFG_Field is Interfaces.Bit_Types.Bit;
   subtype BCLRFR_CNRDY_Field is Interfaces.Bit_Types.Bit;
   subtype BCLRFR_CAFSDET_Field is Interfaces.Bit_Types.Bit;
   subtype BCLRFR_LFSDET_Field is Interfaces.Bit_Types.Bit;
   ...
   type SAI1_Peripheral is record
      ...
      --  AData register
      ADR    : aliased Interfaces.Bit_Types.UInt32;
      --  BConfiguration register 1
      ...
      --  BData register
      BDR    : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
