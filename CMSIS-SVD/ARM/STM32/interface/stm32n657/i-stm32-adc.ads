...
package Interfaces.STM32.ADC is
   ...
   subtype ADC_PCSEL_PCSEL_Field is Interfaces.Bit_Types.UInt20;
   ...
   subtype ADC_OFCFGR_OFFSET_CH_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype ADC_OFR_OFFSET_Field is Interfaces.Bit_Types.UInt22;
   ...
   subtype ADC_AWD1LTR_LTR_Field is Interfaces.Bit_Types.UInt23;
   ...
   subtype ADC_AWD1HTR_HTR_Field is Interfaces.Bit_Types.UInt23;
   subtype ADC_AWD1HTR_AWDFILT_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype ADC_AWD2LTR_LTR_Field is Interfaces.Bit_Types.UInt23;
   ...
   subtype ADC_AWD2HTR_HTR_Field is Interfaces.Bit_Types.UInt23;
   ...
   subtype ADC_AWD3LTR_LTR_Field is Interfaces.Bit_Types.UInt23;
   ...
   subtype ADC_AWD3HTR_HTR_Field is Interfaces.Bit_Types.UInt23;
   ...
   subtype ADC_CALFACT_CALFACT_S_Field is Interfaces.Bit_Types.UInt9;
   subtype ADC_CALFACT_CALFACT_D_Field is Interfaces.Bit_Types.UInt9;
   ...
   type ADC_CALFACT_Register is record
      ...
      --  unspecified
      Reserved_25_30 : Interfaces.Bit_Types.UInt6 := 16#0#;
