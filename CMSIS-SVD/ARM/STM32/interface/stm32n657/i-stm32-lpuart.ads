...
package Interfaces.STM32.LPUART is
   ...
   subtype LPUART_CR1_ENABLED_DEDT_Field is Interfaces.Bit_Types.UInt5;
   subtype LPUART_CR1_ENABLED_DEAT_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype LPUART_CR1_DISABLED_DEDT_Field is Interfaces.Bit_Types.UInt5;
   subtype LPUART_CR1_DISABLED_DEAT_Field is Interfaces.Bit_Types.UInt5;
