...
package Interfaces.STM32.FMC is
   ...
   subtype FMC_BCR1_MTYP_Field is Interfaces.Bit_Types.UInt2;
   subtype FMC_BCR1_MWID_Field is Interfaces.Bit_Types.UInt2;
   subtype FMC_BCR1_CPSIZE_Field is Interfaces.Bit_Types.UInt3;
   subtype FMC_BCR1_CSCOUNT0_Field is Interfaces.Bit_Types.UInt2;
   subtype FMC_BCR1_NBLSET_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype FMC_BTR_ADDSET_Field is Interfaces.Bit_Types.UInt4;
   subtype FMC_BTR_ADDHLD_Field is Interfaces.Bit_Types.UInt4;
   subtype FMC_BTR_DATAST_Field is Interfaces.Bit_Types.Byte;
   subtype FMC_BTR_BUSTURN_Field is Interfaces.Bit_Types.UInt4;
   subtype FMC_BTR_CLKDIV_Field is Interfaces.Bit_Types.UInt4;
   subtype FMC_BTR_DATLAT_Field is Interfaces.Bit_Types.UInt4;
   subtype FMC_BTR_ACCMOD_Field is Interfaces.Bit_Types.UInt2;
   subtype FMC_BTR_DATAHLD_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype FMC_BCR_MTYP_Field is Interfaces.Bit_Types.UInt2;
   subtype FMC_BCR_MWID_Field is Interfaces.Bit_Types.UInt2;
   subtype FMC_BCR_CPSIZE_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype FMC_BCR_NBLSET_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype FMC_CFGR_CLKDIV_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype FMC_PCR_PWID_Field is Interfaces.Bit_Types.UInt2;
   subtype FMC_PCR_TCLR_Field is Interfaces.Bit_Types.UInt4;
   subtype FMC_PCR_TAR_Field is Interfaces.Bit_Types.UInt4;
   subtype FMC_PCR_ECCSS_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype FMC_SR_ISOST_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype FMC_PMEM_MEMSET_Field is Interfaces.Bit_Types.Byte;
   subtype FMC_PMEM_MEMWAIT_Field is Interfaces.Bit_Types.Byte;
   subtype FMC_PMEM_MEMHOLD_Field is Interfaces.Bit_Types.Byte;
   subtype FMC_PMEM_MEMHIZ_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype FMC_PATT_ATTSET_Field is Interfaces.Bit_Types.Byte;
   subtype FMC_PATT_ATTWAIT_Field is Interfaces.Bit_Types.Byte;
   subtype FMC_PATT_ATTHOLD_Field is Interfaces.Bit_Types.Byte;
   subtype FMC_PATT_ATTHIZ_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype FMC_BWTR_ADDSET_Field is Interfaces.Bit_Types.UInt4;
   subtype FMC_BWTR_ADDHLD_Field is Interfaces.Bit_Types.UInt4;
   subtype FMC_BWTR_DATAST_Field is Interfaces.Bit_Types.Byte;
   subtype FMC_BWTR_BUSTURN_Field is Interfaces.Bit_Types.UInt4;
   subtype FMC_BWTR_ACCMOD_Field is Interfaces.Bit_Types.UInt2;
   subtype FMC_BWTR_DATAHLD_Field is Interfaces.Bit_Types.UInt2;
   ...
   type FMC_BWTR_Register is record
      ...
      --  unspecified
      Reserved_20_27 : Interfaces.Bit_Types.Byte := 16#0#;
      --  Access mode.
   ...
   subtype FMC_SDCR1_NC_Field is Interfaces.Bit_Types.UInt2;
   subtype FMC_SDCR1_NR_Field is Interfaces.Bit_Types.UInt2;
   subtype FMC_SDCR1_MWID_Field is Interfaces.Bit_Types.UInt2;
   subtype FMC_SDCR1_CAS_Field is Interfaces.Bit_Types.UInt2;
   subtype FMC_SDCR1_SDCLK_Field is Interfaces.Bit_Types.UInt2;
   subtype FMC_SDCR1_RPIPE_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype FMC_SDCR2_NC_Field is Interfaces.Bit_Types.UInt2;
   subtype FMC_SDCR2_NR_Field is Interfaces.Bit_Types.UInt2;
   subtype FMC_SDCR2_MWID_Field is Interfaces.Bit_Types.UInt2;
   subtype FMC_SDCR2_CAS_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype FMC_SDTR_TMRD_Field is Interfaces.Bit_Types.UInt4;
   subtype FMC_SDTR_TXSR_Field is Interfaces.Bit_Types.UInt4;
   subtype FMC_SDTR_TRAS_Field is Interfaces.Bit_Types.UInt4;
   subtype FMC_SDTR_TRC_Field is Interfaces.Bit_Types.UInt4;
   subtype FMC_SDTR_TWR_Field is Interfaces.Bit_Types.UInt4;
   subtype FMC_SDTR_TRP_Field is Interfaces.Bit_Types.UInt4;
   subtype FMC_SDTR_TRCD_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype FMC_SDCMR_MODE_Field is Interfaces.Bit_Types.UInt3;
   subtype FMC_SDCMR_NRFS_Field is Interfaces.Bit_Types.UInt4;
   subtype FMC_SDCMR_MRD_Field is Interfaces.Bit_Types.UInt14;
   ...
   subtype FMC_SDRTR_RFSCNT_Field is Interfaces.Bit_Types.UInt13;
   ...
   subtype FMC_SDSR_MODES_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype FMC_CSQCFGR1_ACYNBR_Field is Interfaces.Bit_Types.UInt3;
   --  FMC_CSQCFGR1_CMD array element
   subtype FMC_CSQCFGR1_CMD_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype FMC_CSQCFGR2_RCMD_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype FMC_CSQCFGR3_SNBR_Field is Interfaces.Bit_Types.UInt6;
   ...
   subtype FMC_CSQAR1_ADDC_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype FMC_CSQAR2_ADDC5_Field is Interfaces.Bit_Types.Byte;
   subtype FMC_CSQAR2_SAO_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype FMC_CSQEMSR_SEM_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype FMC_BCHPBR4_BCHPB_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype FMC_BCHDSR0_DEN_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype FMC_BCHDSR1_EBP1_Field is Interfaces.Bit_Types.UInt13;
   subtype FMC_BCHDSR1_EBP2_Field is Interfaces.Bit_Types.UInt13;
   ...
   subtype FMC_BCHDSR2_EBP3_Field is Interfaces.Bit_Types.UInt13;
   subtype FMC_BCHDSR2_EBP4_Field is Interfaces.Bit_Types.UInt13;
   ...
   subtype FMC_BCHDSR3_EBP5_Field is Interfaces.Bit_Types.UInt13;
   subtype FMC_BCHDSR3_EBP6_Field is Interfaces.Bit_Types.UInt13;
   ...
   subtype FMC_BCHDSR4_EBP7_Field is Interfaces.Bit_Types.UInt13;
   subtype FMC_BCHDSR4_EBP8_Field is Interfaces.Bit_Types.UInt13;
   ...
   type FMC_Peripheral is record
      ...
      FMC_HPR      : aliased Interfaces.Bit_Types.UInt32;
      --  FMC Hamming code ECC result register
      FMC_HECCR    : aliased Interfaces.Bit_Types.UInt32;
      --  SRAM/NOR-Flash write timing registers for memory region 1
      ...
      FMC_BCHPBR1  : aliased Interfaces.Bit_Types.UInt32;
      --  FMC BCH parity bits register 2
      FMC_BCHPBR2  : aliased Interfaces.Bit_Types.UInt32;
      --  FMC BCH parity bits register 3
      FMC_BCHPBR3  : aliased Interfaces.Bit_Types.UInt32;
      --  FMC BCH parity bits register 4
