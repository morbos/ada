...
package Interfaces.STM32.GPIOQ is
   pragma Preelaborate;
   ...
   subtype GPIOQ_MODER_MODE_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOQ_OSPEEDR_OSPEED_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOQ_PUPDR_PUPD_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOQ_AFRL_AFSEL_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOQ_AFRH_AFSEL_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOQ_DELAYRL_DELAY_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOQ_DELAYRH_DELAY_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOQ_PIOCFGRL_PIOCFG_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOQ_PIOCFGRH_PIOCFG_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOQ_HWCFGR10_AHB_IOP_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOQ_HWCFGR10_AFSIZE_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOQ_HWCFGR10_SPEED_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOQ_HWCFGR10_LOCK_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOQ_HWCFGR10_SEC_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOQ_HWCFGR10_OR_CFG_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOQ_HWCFGR9_EN_IO_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOQ_HWCFGR8_FAST_AF_IO_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOQ_HWCFGR7_FAST_AF_IO_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOQ_HWCFGR3_ODR_RES_Field is Interfaces.Bit_Types.UInt16;
   subtype GPIOQ_HWCFGR3_OTYPER_RES_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOQ_HWCFGR0_OR_RES_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOQ_VERR_MINREV_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOQ_VERR_MAJREV_Field is Interfaces.Bit_Types.UInt4;
   ...
   --  General-purpose I/Os
   type GPIOQ_Peripheral is record
      --  GPIO port Q mode register
   ...
   --  General-purpose I/Os
   GPIOQ_Periph : aliased GPIOQ_Peripheral
     with Import, Address => GPIOQ_Base;

end Interfaces.STM32.GPIOQ;
