...
package Interfaces.STM32.TIM14_S is
   pragma Preelaborate;
   ...
   subtype TIM14_CR1_CKD_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype TIM14_CCMR1_Input_CC1S_Field is Interfaces.Bit_Types.UInt2;
   subtype TIM14_CCMR1_Input_IC1PSC_Field is Interfaces.Bit_Types.UInt2;
   subtype TIM14_CCMR1_Input_IC1F_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype TIM14_CCMR1_Output_CC1S_Field is Interfaces.Bit_Types.UInt2;
   subtype TIM14_CCMR1_Output_OC1M_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype TIM14_CNT_CNT_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype TIM14_ARR_ARR_Field is Interfaces.Bit_Types.UInt20;
   ...
   subtype TIM14_CCR1_CCR1_Field is Interfaces.Bit_Types.UInt20;
   ...
   subtype TIM14_TISEL_TI1SEL_Field is Interfaces.Bit_Types.UInt4;
   ...
   type TIM14_S_Disc is
     (Input,
      Output);

   --  General-purpose timers
   type TIM14_S_Peripheral
     (Discriminent : TIM14_S_Disc := Input)
   is record
      --  TIM14 control register 1
      ...
      --  TIM14 prescaler
      TIM14_PSC          : aliased Interfaces.Bit_Types.UInt16;
      --  TIM14 auto-reload register
   ...
   for TIM14_S_Peripheral use record
   ...
   --  General-purpose timers
   TIM14_S_Periph : aliased TIM14_S_Peripheral
     with Import, Address => TIM14_S_Base;

end Interfaces.STM32.TIM14_S;
