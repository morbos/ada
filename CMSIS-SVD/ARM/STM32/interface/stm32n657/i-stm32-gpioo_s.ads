...
package Interfaces.STM32.GPIOO_S is
   pragma Preelaborate;
   ...
   subtype GPIOO_MODER_MODE_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOO_OSPEEDR_OSPEED_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOO_PUPDR_PUPD_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOO_AFRL_AFSEL_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOO_AFRH_AFSEL_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOO_DELAYRL_DELAY_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOO_DELAYRH_DELAY_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOO_PIOCFGRL_PIOCFG_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOO_PIOCFGRH_PIOCFG_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOO_HWCFGR10_AHB_IOP_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOO_HWCFGR10_AFSIZE_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOO_HWCFGR10_SPEED_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOO_HWCFGR10_LOCK_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOO_HWCFGR10_SEC_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOO_HWCFGR10_OR_CFG_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOO_HWCFGR9_EN_IO_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOO_HWCFGR8_FAST_AF_IO_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOO_HWCFGR7_FAST_AF_IO_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOO_HWCFGR3_ODR_RES_Field is Interfaces.Bit_Types.UInt16;
   subtype GPIOO_HWCFGR3_OTYPER_RES_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOO_HWCFGR0_OR_RES_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOO_VERR_MINREV_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOO_VERR_MAJREV_Field is Interfaces.Bit_Types.UInt4;
   ...
   --  General-purpose I/Os
   type GPIOO_S_Peripheral is record
      --  GPIO port O mode register
   ...
   --  General-purpose I/Os
   GPIOO_S_Periph : aliased GPIOO_S_Peripheral
     with Import, Address => GPIOO_S_Base;

end Interfaces.STM32.GPIOO_S;
