...
package Interfaces.STM32.SPI is
   ...
   subtype SPI_CR2_TSIZE_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype SPI_CFG1_DSIZE_Field is Interfaces.Bit_Types.UInt5;
   subtype SPI_CFG1_FTHLV_Field is Interfaces.Bit_Types.UInt4;
   subtype SPI_CFG1_CRCSIZE_Field is Interfaces.Bit_Types.UInt5;
   subtype SPI_CFG1_MBR_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype SPI_CFG2_MSSI_Field is Interfaces.Bit_Types.UInt4;
   subtype SPI_CFG2_MIDI_Field is Interfaces.Bit_Types.UInt4;
   subtype SPI_CFG2_COMM_Field is Interfaces.Bit_Types.UInt2;
   subtype SPI_CFG2_SP_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype SPI_SR_RXPLVL_Field is Interfaces.Bit_Types.UInt2;
   subtype SPI_SR_CTSIZE_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype SPI_I2SCFGR_I2SCFG_Field is Interfaces.Bit_Types.UInt3;
   subtype SPI_I2SCFGR_I2SSTD_Field is Interfaces.Bit_Types.UInt2;
   subtype SPI_I2SCFGR_DATLEN_Field is Interfaces.Bit_Types.UInt2;
   subtype SPI_I2SCFGR_I2SDIV_Field is Interfaces.Bit_Types.Byte;
   ...
   type SPI_I2SCFGR_Register is record
      ...
      --  data length to be transferred. Data width of 24 and 32 bits are not
      --  always supported, (DATLEN = 01 or 10), refer to Section 58.3: SPI
      --  implementation to check the supported data size.
      ...
      I2SDIV         : SPI_I2SCFGR_I2SDIV_Field := 16#0#;
   ...
   type SPI_Peripheral is record
      ...
      SPI_TXDR    : aliased Interfaces.Bit_Types.UInt32;
      --  SPI/I2S receive data register
      SPI_RXDR    : aliased Interfaces.Bit_Types.UInt32;
      --  SPI/I2S polynomial register
      SPI_CRCPOLY : aliased Interfaces.Bit_Types.UInt32;
      --  SPI/I2S transmitter CRC register
      SPI_TXCRC   : aliased Interfaces.Bit_Types.UInt32;
      --  SPI/I2S receiver CRC register
      SPI_RXCRC   : aliased Interfaces.Bit_Types.UInt32;
      --  SPI/I2S underrun data register
      SPI_UDRDR   : aliased Interfaces.Bit_Types.UInt32;
      --  SPI/I2S configuration register
   ...
   for SPI_Peripheral use record
      ...
      SPI_I2SCFGR at 16#50# range 0 .. 31;
   end record;
   ...
   --  Serial peripheral interface
   SPI1_S_Periph : aliased SPI_Peripheral
   ...
   --  Serial peripheral interface
   SPI2_S_Periph : aliased SPI_Peripheral
   ...
   --  Serial peripheral interface
   SPI3_S_Periph : aliased SPI_Peripheral
   ...
   --  Serial peripheral interface
   SPI4_S_Periph : aliased SPI_Peripheral
   ...
   --  Serial peripheral interface
   SPI5_S_Periph : aliased SPI_Peripheral
   ...
   --  Serial peripheral interface
   SPI6_S_Periph : aliased SPI_Peripheral
