...
package Interfaces.STM32.GPIOD_S is
   pragma Preelaborate;
   ...
   subtype GPIOD_DELAYRL_DELAY_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOD_DELAYRH_DELAY_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOD_PIOCFGRL_PIOCFG_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOD_PIOCFGRH_PIOCFG_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOD_HWCFGR10_AHB_IOP_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOD_HWCFGR10_AFSIZE_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOD_HWCFGR10_SPEED_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOD_HWCFGR10_LOCK_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOD_HWCFGR10_SEC_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOD_HWCFGR10_OR_CFG_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOD_HWCFGR9_EN_IO_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOD_HWCFGR8_FAST_AF_IO_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOD_HWCFGR7_FAST_AF_IO_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOD_HWCFGR3_ODR_RES_Field is Interfaces.Bit_Types.UInt16;
   subtype GPIOD_HWCFGR3_OTYPER_RES_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOD_HWCFGR0_OR_RES_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOD_VERR_MINREV_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOD_VERR_MAJREV_Field is Interfaces.Bit_Types.UInt4;
   ...
   --  General-purpose I/Os
   type GPIOD_S_Peripheral is record
      --  GPIO port D mode register
   ...
   --  General-purpose I/Os
   GPIOD_S_Periph : aliased GPIOD_S_Peripheral
     with Import, Address => GPIOD_S_Base;

end Interfaces.STM32.GPIOD_S;
