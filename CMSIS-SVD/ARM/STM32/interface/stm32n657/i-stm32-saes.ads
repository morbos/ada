...
package Interfaces.STM32.SAES is
   ...
   type SAES_Peripheral is record
      ...
      SAES_SUSPR0 : aliased Interfaces.Bit_Types.UInt32;
      --  SAES suspend registers
      SAES_SUSPR1 : aliased Interfaces.Bit_Types.UInt32;
      --  SAES suspend registers
      SAES_SUSPR2 : aliased Interfaces.Bit_Types.UInt32;
      --  SAES suspend registers
      SAES_SUSPR3 : aliased Interfaces.Bit_Types.UInt32;
      --  SAES suspend registers
      SAES_SUSPR4 : aliased Interfaces.Bit_Types.UInt32;
      --  SAES suspend registers
      SAES_SUSPR5 : aliased Interfaces.Bit_Types.UInt32;
      --  SAES suspend registers
      SAES_SUSPR6 : aliased Interfaces.Bit_Types.UInt32;
      --  SAES suspend registers
      SAES_SUSPR7 : aliased Interfaces.Bit_Types.UInt32;
      --  SAES interrupt enable register
