...
package Interfaces.STM32.MCE is
   pragma Preelaborate;
   ...
   subtype MCE_CR_CIPHERSEL_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype MCE_REGCR_CTXID_Field is Interfaces.Bit_Types.UInt2;
   subtype MCE_REGCR_ENC_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype MCE_SADDR_BADDSTART_Field is Interfaces.Bit_Types.UInt20;
   ...
   subtype MCE_EADDR_BADDEND_Field is Interfaces.Bit_Types.UInt20;
   ...
   subtype MCE_CC1CFGR_MODE_Field is Interfaces.Bit_Types.UInt2;
   subtype MCE_CC1CFGR_KEYCRC_Field is Interfaces.Bit_Types.Byte;
   subtype MCE_CC1CFGR_VERSION_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype MCE_CC2CFGR_MODE_Field is Interfaces.Bit_Types.UInt2;
   subtype MCE_CC2CFGR_KEYCRC_Field is Interfaces.Bit_Types.Byte;
   subtype MCE_CC2CFGR_VERSION_Field is Interfaces.Bit_Types.UInt16;
   ...
   type MCE_Peripheral is record
      ...
      MCE_IADDR    : aliased Interfaces.Bit_Types.UInt32;
      --  MCE region 1 configuration register
      ...
      MCE_CC1NR0   : aliased Interfaces.Bit_Types.UInt32;
      --  MCE cipher context 1 nonce register 1
      MCE_CC1NR1   : aliased Interfaces.Bit_Types.UInt32;
      --  MCE cipher context 1 key register 0
      MCE_CC1KEYR0 : aliased Interfaces.Bit_Types.UInt32;
      --  MCE cipher context 1 key register 1
      MCE_CC1KEYR1 : aliased Interfaces.Bit_Types.UInt32;
      --  MCE cipher context 1 key register 2
      MCE_CC1KEYR2 : aliased Interfaces.Bit_Types.UInt32;
      --  MCE cipher context 1 key register 3
      MCE_CC1KEYR3 : aliased Interfaces.Bit_Types.UInt32;
      --  MCE cipher context 2 configuration register
      MCE_CC2CFGR  : aliased MCE_CC2CFGR_Register;
      --  MCE cipher context 2 nonce register 0
      MCE_CC2NR0   : aliased Interfaces.Bit_Types.UInt32;
      --  MCE cipher context 2 nonce register 1
      MCE_CC2NR1   : aliased Interfaces.Bit_Types.UInt32;
      --  MCE cipher context 2 key register 0
      MCE_CC2KEYR0 : aliased Interfaces.Bit_Types.UInt32;
      --  MCE cipher context 2 key register 1
      MCE_CC2KEYR1 : aliased Interfaces.Bit_Types.UInt32;
      --  MCE cipher context 2 key register 2
      MCE_CC2KEYR2 : aliased Interfaces.Bit_Types.UInt32;
      --  MCE cipher context 2 key register 3
      MCE_CC2KEYR3 : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
