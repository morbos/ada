...
package Interfaces.STM32.GPIOF_S is
   pragma Preelaborate;
   ...
   subtype GPIOF_DELAYRL_DELAY_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOF_DELAYRH_DELAY_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOF_PIOCFGRL_PIOCFG_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOF_PIOCFGRH_PIOCFG_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOF_HWCFGR10_AHB_IOP_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOF_HWCFGR10_AFSIZE_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOF_HWCFGR10_SPEED_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOF_HWCFGR10_LOCK_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOF_HWCFGR10_SEC_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOF_HWCFGR10_OR_CFG_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOF_HWCFGR9_EN_IO_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOF_HWCFGR7_FAST_AF_IO_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOF_HWCFGR3_ODR_RES_Field is Interfaces.Bit_Types.UInt16;
   subtype GPIOF_HWCFGR3_OTYPER_RES_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOF_HWCFGR0_OR_RES_Field is Interfaces.Bit_Types.UInt16;
   ...
   --  General-purpose I/Os
   type GPIOF_S_Peripheral is record
      --  GPIO port F mode register
      ...
      GPIOF_HWCFGR4   : aliased Interfaces.Bit_Types.UInt32;
      --  GPIO port F hardware configuration register 3
      ...
      GPIOF_HWCFGR1   : aliased Interfaces.Bit_Types.UInt32;
      --  GPIO port F hardware configuration register 0
   ...
   for GPIOF_S_Peripheral use record
   ...
   --  General-purpose I/Os
   GPIOF_S_Periph : aliased GPIOF_S_Peripheral
     with Import, Address => GPIOF_S_Base;

end Interfaces.STM32.GPIOF_S;
