...
package Interfaces.STM32.ADF is
   ...
   type ADF_DFLT0CR_Register is record
      ...
      --  Read-only. DFLT0 run status flag
      DFLTRUN        : Boolean := False;
      --  Read-only. DFLT0 active flag
   ...
   type ADF_SADSDLVR_Register is record
      --  Read-only. Short term sound level
   ...
   type ADF_SADANLVR_Register is record
      --  Read-only. Ambient noise level estimation
