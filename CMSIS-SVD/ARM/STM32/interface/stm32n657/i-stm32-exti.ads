...
package Interfaces.STM32.EXTI is
   ...
   type RTSR2_Register is record
      ...
      --  unspecified
      Reserved_9_18  : Interfaces.Bit_Types.UInt10 := 16#0#;
   ...
   subtype EXTICR1_EXTI_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype EXTICR2_EXTI_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype EXTICR3_EXTI_Element is Interfaces.Bit_Types.Byte;
   ...
   subtype EXTICR4_EXTI_Element is Interfaces.Bit_Types.Byte;
