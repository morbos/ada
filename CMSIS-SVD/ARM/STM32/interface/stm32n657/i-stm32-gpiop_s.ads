...
package Interfaces.STM32.GPIOP_S is
   pragma Preelaborate;
   ...
   subtype GPIOP_MODER_MODE_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOP_OSPEEDR_OSPEED_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOP_PUPDR_PUPD_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype GPIOP_AFRL_AFSEL_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOP_AFRH_AFSEL_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOP_DELAYRL_DELAY_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOP_DELAYRH_DELAY_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOP_PIOCFGRL_PIOCFG_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOP_PIOCFGRH_PIOCFG_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOP_HWCFGR10_AHB_IOP_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOP_HWCFGR10_AFSIZE_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOP_HWCFGR10_SPEED_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOP_HWCFGR10_LOCK_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOP_HWCFGR10_SEC_CFG_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOP_HWCFGR10_OR_CFG_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOP_HWCFGR9_EN_IO_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOP_HWCFGR8_FAST_AF_IO_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOP_HWCFGR7_FAST_AF_IO_Element is Interfaces.Bit_Types.UInt4;
   ...
   subtype GPIOP_HWCFGR3_ODR_RES_Field is Interfaces.Bit_Types.UInt16;
   subtype GPIOP_HWCFGR3_OTYPER_RES_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOP_HWCFGR0_OR_RES_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype GPIOP_VERR_MINREV_Field is Interfaces.Bit_Types.UInt4;
   subtype GPIOP_VERR_MAJREV_Field is Interfaces.Bit_Types.UInt4;
   ...
   --  General-purpose I/Os
   type GPIOP_S_Peripheral is record
      --  GPIO port P mode register
   ...
   --  General-purpose I/Os
   GPIOP_S_Periph : aliased GPIOP_S_Peripheral
     with Import, Address => GPIOP_S_Base;

end Interfaces.STM32.GPIOP_S;
