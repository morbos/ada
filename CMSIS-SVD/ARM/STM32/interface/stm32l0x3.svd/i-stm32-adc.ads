...
package Interfaces.STM32.ADC is
   ...
   subtype CFGR1_AWDCH_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype SMPR_SMPR_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype TR_LT_Field is Interfaces.Bit_Types.UInt12;
   subtype TR_HT_Field is Interfaces.Bit_Types.UInt12;
