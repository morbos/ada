...
package Interfaces.STM32.RTC is
   ...
   subtype WUTR_WUTOCLR_Field is Interfaces.Bit_Types.Short;
   ...
   type SMCR_Register is record
      --  ALRADPROT
      ALRADPROT      : Boolean := True;
      --  ALRBDPROT
      ALRBDPROT      : Boolean := True;
      --  WUTDPROT
      WUTDPROT       : Boolean := True;
      --  TSDPROT
      TSDPROT        : Boolean := True;
      --  unspecified
      Reserved_4_12  : Interfaces.Bit_Types.UInt9 := 16#0#;
      --  CALDPROT
      CALDPROT       : Boolean := True;
      --  INITDPROT
      INITDPROT      : Boolean := True;
      --  DECPROT
      DECPROT        : Boolean := True;
      --  unspecified
      Reserved_16_31 : Interfaces.Bit_Types.Short := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   for SMCR_Register use record
      ALRADPROT      at 0 range 0 .. 0;
      ALRBDPROT      at 0 range 1 .. 1;
      WUTDPROT       at 0 range 2 .. 2;
      TSDPROT        at 0 range 3 .. 3;
      Reserved_4_12  at 0 range 4 .. 12;
      CALDPROT       at 0 range 13 .. 13;
      INITDPROT      at 0 range 14 .. 14;
      DECPROT        at 0 range 15 .. 15;
      Reserved_16_31 at 0 range 16 .. 31;
   end record;
   ...
   SEC_RTC_Periph : aliased RTC_Peripheral
     with Import, Address => System'To_Address (16#50002800#);
