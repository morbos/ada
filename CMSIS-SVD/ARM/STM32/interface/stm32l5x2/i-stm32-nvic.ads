...
package Interfaces.STM32.NVIC is
   ...
   subtype IPR_IPR_N_Element is Interfaces.Bit_Types.Byte;
   ...
   type NVIC_Peripheral is record
      ...
      ISER0 : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Set-Enable Register
      ISER1 : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Set-Enable Register
      ISER2 : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Set-Enable Register
      ISER3 : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Clear-Enable Register
      ICER0 : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Clear-Enable Register
      ICER1 : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Clear-Enable Register
      ICER2 : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Clear-Enable Register
      ICER3 : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Set-Pending Register
      ISPR0 : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Set-Pending Register
      ISPR1 : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Set-Pending Register
      ISPR2 : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Set-Pending Register
      ISPR3 : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Clear-Pending Register
      ICPR0 : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Clear-Pending Register
      ICPR1 : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Clear-Pending Register
      ICPR2 : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Clear-Pending Register
      ICPR3 : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Active Bit Register
      IABR0 : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Active Bit Register
      IABR1 : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Active Bit Register
      IABR2 : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Active Bit Register
      IABR3 : aliased Interfaces.Bit_Types.Word;
      --  Interrupt Priority Register
      ...
      --  IPR21
      IPR21 : aliased Interfaces.Bit_Types.Word;
      --  IPR22
      IPR22 : aliased Interfaces.Bit_Types.Word;
      --  IPR23
      IPR23 : aliased Interfaces.Bit_Types.Word;
      --  IPR24
      IPR24 : aliased Interfaces.Bit_Types.Word;
      --  IPR25
      IPR25 : aliased Interfaces.Bit_Types.Word;
      --  IPR26
      IPR26 : aliased Interfaces.Bit_Types.Word;
      --  IPR27
      IPR27 : aliased Interfaces.Bit_Types.Word;
      --  IPR28
      IPR28 : aliased Interfaces.Bit_Types.Word;
      --  IPR29
      IPR29 : aliased Interfaces.Bit_Types.Word;
   end record
     with Volatile;
