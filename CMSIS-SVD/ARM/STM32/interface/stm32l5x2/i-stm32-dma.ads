...
package Interfaces.STM32.DMA is
   ...
   subtype CM1AR_PSIZE_Field is Interfaces.Bit_Types.UInt2;
   subtype CM1AR_MSIZE_Field is Interfaces.Bit_Types.UInt2;
   subtype CM1AR_PL_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype CCR_NDT_Field is Interfaces.Bit_Types.UInt18;
   ...
   subtype CM0AR2_PSIZE_Field is Interfaces.Bit_Types.UInt2;
   subtype CM0AR2_MSIZE_Field is Interfaces.Bit_Types.UInt2;
   subtype CM0AR2_PL_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype CM1AR2_NDT_Field is Interfaces.Bit_Types.UInt18;
   ...
   subtype CPAR3_PSIZE_Field is Interfaces.Bit_Types.UInt2;
   subtype CPAR3_MSIZE_Field is Interfaces.Bit_Types.UInt2;
   subtype CPAR3_PL_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype CM0AR3_NDT_Field is Interfaces.Bit_Types.UInt18;
   ...
   subtype CNDTR4_PSIZE_Field is Interfaces.Bit_Types.UInt2;
   subtype CNDTR4_MSIZE_Field is Interfaces.Bit_Types.UInt2;
   subtype CNDTR4_PL_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype CPAR_NDT_Field is Interfaces.Bit_Types.UInt18;
   ...
   subtype CM0AR6_C1S_Field is Interfaces.Bit_Types.UInt4;
   subtype CM0AR6_C2S_Field is Interfaces.Bit_Types.UInt4;
   subtype CM0AR6_C3S_Field is Interfaces.Bit_Types.UInt4;
   subtype CM0AR6_C4S_Field is Interfaces.Bit_Types.UInt4;
   subtype CM0AR6_C5S_Field is Interfaces.Bit_Types.UInt4;
   subtype CM0AR6_C6S_Field is Interfaces.Bit_Types.UInt4;
   subtype CM0AR6_C7S_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype CNDTR8_PSIZE_Field is Interfaces.Bit_Types.UInt2;
   subtype CNDTR8_MSIZE_Field is Interfaces.Bit_Types.UInt2;
   subtype CNDTR8_PL_Field is Interfaces.Bit_Types.UInt2;
   ...
   type DMA_Peripheral is record
      ...
      --  channel x memory address register
      CM0AR1 : aliased Interfaces.Bit_Types.Word;
      --  channel x memory address register
      CM1AR1 : aliased CM1AR_Register;
      --  channel x configuration register
      CCR2   : aliased CCR_Register_1;
      --  channel x number of data register
      CNDTR2 : aliased Interfaces.Bit_Types.Word;
      --  channel x peripheral address register
      ...
      --  channel x number of data register
      CNDTR3 : aliased Interfaces.Bit_Types.Word;
      --  channel x peripheral address register
      CPAR3  : aliased CPAR3_Register;
      --  channel x memory address register
      CM0AR3 : aliased CM0AR3_Register;
      --  channel x memory address register
      CM1AR3 : aliased Interfaces.Bit_Types.Word;
      --  channel x configuration register
      ...
      --  channel x memory address register
      CM0AR4 : aliased Interfaces.Bit_Types.Word;
      --  channel x memory address register
      CM1AR4 : aliased Interfaces.Bit_Types.Word;
      --  channel x configuration register
      ...
      --  channel x memory address register
      CM0AR5 : aliased Interfaces.Bit_Types.Word;
      --  channel x memory address register
      CM1AR5 : aliased CM1AR_Register;
      --  channel x configuration register
      CCR6   : aliased CCR_Register_1;
      --  channel x number of data register
      CNDTR6 : aliased Interfaces.Bit_Types.Word;
      --  channel x peripheral address register
      CPAR6  : aliased Interfaces.Bit_Types.Word;
      --  channel x memory address register
      CM0AR6 : aliased CM0AR6_Register;
      --  channel x memory address register
      CM1AR6 : aliased Interfaces.Bit_Types.Word;
      --  channel x configuration register
      CCR7   : aliased Interfaces.Bit_Types.Word;
      --  channel x number of data register
      CNDTR7 : aliased Interfaces.Bit_Types.Word;
      --  channel x peripheral address register
      CPAR7  : aliased Interfaces.Bit_Types.Word;
      --  channel x memory address register
      CM0AR7 : aliased Interfaces.Bit_Types.Word;
      --  channel x memory address register
      CM1AR7 : aliased Interfaces.Bit_Types.Word;
      --  channel x configuration register
      CCR8   : aliased Interfaces.Bit_Types.Word;
      --  channel x number of data register
      CNDTR8 : aliased CNDTR8_Register;
      --  channel x peripheral address register
      CPAR8  : aliased CPAR_Register;
      --  channel x peripheral address register
      CM0AR8 : aliased Interfaces.Bit_Types.Word;
      --  channel x peripheral address register
      CM1AR8 : aliased Interfaces.Bit_Types.Word;
      --  channel selection register
      CSELR  : aliased Interfaces.Bit_Types.Word;
   end record
     with Volatile;
