...
package Interfaces.STM32.OctoSPI is
   ...
   subtype DCR1_CSHT_Field is Interfaces.Bit_Types.UInt3;
   subtype DCR1_DEVSIZE_Field is Interfaces.Bit_Types.UInt5;
   subtype DCR1_MTYP_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype DCR4_FLEVEL_Field is Interfaces.Bit_Types.UInt6;
   ...
   subtype PSMAR_INTERVAL_Field is Interfaces.Bit_Types.Short;
   ...
   subtype PIR_IMODE_Field is Interfaces.Bit_Types.UInt3;
   subtype PIR_ISIZE_Field is Interfaces.Bit_Types.UInt2;
   subtype PIR_ADMODE_Field is Interfaces.Bit_Types.UInt3;
   subtype PIR_ADSIZE_Field is Interfaces.Bit_Types.UInt2;
   subtype PIR_ABMODE_Field is Interfaces.Bit_Types.UInt3;
   subtype PIR_ABSIZE_Field is Interfaces.Bit_Types.UInt2;
   subtype PIR_DMODE_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype ABR_TIMEOUT_Field is Interfaces.Bit_Types.Short;
   ...
   subtype LPTR_IMODE_Field is Interfaces.Bit_Types.UInt3;
   subtype LPTR_ISIZE_Field is Interfaces.Bit_Types.UInt2;
   subtype LPTR_ADMODE_Field is Interfaces.Bit_Types.UInt3;
   subtype LPTR_ADSIZE_Field is Interfaces.Bit_Types.UInt2;
   subtype LPTR_ABMODE_Field is Interfaces.Bit_Types.UInt3;
   subtype LPTR_ABSIZE_Field is Interfaces.Bit_Types.UInt2;
   subtype LPTR_DMODE_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype WPCCR_DCYC_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype WPABR_TACC_Field is Interfaces.Bit_Types.Byte;
   subtype WPABR_TRWR_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype WCCR_REFRESH_Field is Interfaces.Bit_Types.Short;
   ...
   subtype WTCR_IMODE_Field is Interfaces.Bit_Types.UInt3;
   subtype WTCR_ISIZE_Field is Interfaces.Bit_Types.UInt2;
   subtype WTCR_ADMODE_Field is Interfaces.Bit_Types.UInt3;
   subtype WTCR_ADSIZE_Field is Interfaces.Bit_Types.UInt2;
   subtype WTCR_ABMODE_Field is Interfaces.Bit_Types.UInt3;
   subtype WTCR_ABSIZE_Field is Interfaces.Bit_Types.UInt2;
   subtype WTCR_DMODE_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype WIR_DCYC_Field is Interfaces.Bit_Types.UInt5;
   ...
   type OctoSPI_Peripheral is record
      ...
      --  flag clear register
      FCR   : aliased Interfaces.Bit_Types.Word;
      ...
      TCR   : aliased Interfaces.Bit_Types.Word;
      --  instruction register
      IR    : aliased Interfaces.Bit_Types.Word;
      --  alternate bytes register
      ...
      WPTCR : aliased Interfaces.Bit_Types.Word;
      --  write instruction register
      WPIR  : aliased Interfaces.Bit_Types.Word;
      --  write alternate bytes register
      ...
      --  WABR
      WABR  : aliased Interfaces.Bit_Types.Word;
      --  HyperBusTM latency configuration register
      HLCR  : aliased Interfaces.Bit_Types.Word;
   end record
     with Volatile;
