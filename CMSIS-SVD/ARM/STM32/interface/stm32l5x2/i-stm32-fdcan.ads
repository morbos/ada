...
package Interfaces.STM32.FDCAN is
   ...
   subtype FDCAN_NBTP_TSEG2_Field is Interfaces.Bit_Types.UInt7;
   ...
   subtype FDCAN_TSCV_TSC_Field is Interfaces.Bit_Types.Short;
   ...
   subtype FDCAN_TOCC_TOP_Field is Interfaces.Bit_Types.Short;
   ...
   subtype FDCAN_TOCV_TOC_Field is Interfaces.Bit_Types.Short;
   ...
   subtype FDCAN_RXGFC_ANFE_Field is Interfaces.Bit_Types.UInt2;
   subtype FDCAN_RXGFC_ANFS_Field is Interfaces.Bit_Types.UInt2;
   subtype FDCAN_RXGFC_LSS_Field is Interfaces.Bit_Types.UInt5;
   subtype FDCAN_RXGFC_LSE_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype FDCAN_HPMS_BIDX_Field is Interfaces.Bit_Types.UInt3;
   subtype FDCAN_HPMS_MSI_Field is Interfaces.Bit_Types.UInt2;
   subtype FDCAN_HPMS_FIDX_Field is Interfaces.Bit_Types.UInt5;
   ...
   type FDCAN_HPMS_Register is record
      ...
      --  unspecified
      Reserved_13_14 : Interfaces.Bit_Types.UInt2;
   ...
   subtype FDCAN_RXF0S_F0FL_Field is Interfaces.Bit_Types.UInt4;
   subtype FDCAN_RXF0S_F0GI_Field is Interfaces.Bit_Types.UInt2;
   subtype FDCAN_RXF0S_F0PI_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype FDCAN_RXF0A_F0AI_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype FDCAN_RXF1S_F1FL_Field is Interfaces.Bit_Types.UInt4;
   subtype FDCAN_RXF1S_F1GI_Field is Interfaces.Bit_Types.UInt2;
   subtype FDCAN_RXF1S_F1PI_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype FDCAN_RXF1A_F1AI_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype FDCAN_TXFQS_TFFL_Field is Interfaces.Bit_Types.UInt3;
   subtype FDCAN_TXFQS_TFGI_Field is Interfaces.Bit_Types.UInt2;
   subtype FDCAN_TXFQS_TFQPI_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype FDCAN_TXBRP_TRP_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype FDCAN_TXBAR_AR_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype FDCAN_TXBCR_CR_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype FDCAN_TXBTO_TO_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype FDCAN_TXBCF_CF_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype FDCAN_TXBTIE_TIE_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype FDCAN_TXBCIE_CF_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype FDCAN_TXEFS_EFFL_Field is Interfaces.Bit_Types.UInt3;
   subtype FDCAN_TXEFS_EFGI_Field is Interfaces.Bit_Types.UInt2;
   subtype FDCAN_TXEFS_EFPI_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype FDCAN_TXEFA_EFAI_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype FDCAN_CKDIV_PDIV_Field is Interfaces.Bit_Types.UInt4;
   ...
   type FDCAN_Peripheral is record
      ...
      --  FDCAN Core Release Register
      FDCAN_ENDN   : aliased Interfaces.Bit_Types.Word;
      --  FDCAN Data Bit Timing and Prescaler Register
