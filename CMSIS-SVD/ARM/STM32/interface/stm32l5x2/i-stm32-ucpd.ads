...
package Interfaces.STM32.UCPD is
   ...
   subtype CFG1_HBITCLKDIV_Field is Interfaces.Bit_Types.UInt6;
   subtype CFG1_IFRGAP_Field is Interfaces.Bit_Types.UInt5;
   subtype CFG1_TRANSWIN_Field is Interfaces.Bit_Types.UInt5;
   subtype CFG1_PSC_USBPDCLK_Field is Interfaces.Bit_Types.UInt3;
   subtype CFG1_RXORDSETEN_Field is Interfaces.Bit_Types.UInt9;
   ...
   subtype CFG3_TRIM1_NG_CCRPD_Field is Interfaces.Bit_Types.UInt4;
   subtype CFG3_TRIM1_NG_CC1A5_Field is Interfaces.Bit_Types.UInt5;
   subtype CFG3_TRIM1_NG_CC3A0_Field is Interfaces.Bit_Types.UInt4;
   subtype CFG3_TRIM2_NG_CCRPD_Field is Interfaces.Bit_Types.UInt4;
   subtype CFG3_TRIM2_NG_CC1A5_Field is Interfaces.Bit_Types.UInt5;
   subtype CFG3_TRIM2_NG_CC3A0_Field is Interfaces.Bit_Types.UInt4;

   --  UCPD configuration register 3
   type CFG3_Register is record
      --  TRIM1_NG_CCRPD
      TRIM1_NG_CCRPD : CFG3_TRIM1_NG_CCRPD_Field := 16#0#;
      --  TRIM1_NG_CC1A5
      TRIM1_NG_CC1A5 : CFG3_TRIM1_NG_CC1A5_Field := 16#0#;
      --  TRIM1_NG_CC3A0
      TRIM1_NG_CC3A0 : CFG3_TRIM1_NG_CC3A0_Field := 16#0#;
      --  unspecified
      Reserved_13_15 : Interfaces.Bit_Types.UInt3 := 16#0#;
      --  TRIM2_NG_CCRPD
      TRIM2_NG_CCRPD : CFG3_TRIM2_NG_CCRPD_Field := 16#0#;
      --  TRIM2_NG_CC1A5
      TRIM2_NG_CC1A5 : CFG3_TRIM2_NG_CC1A5_Field := 16#0#;
      --  TRIM2_NG_CC3A0
      TRIM2_NG_CC3A0 : CFG3_TRIM2_NG_CC3A0_Field := 16#0#;
      --  unspecified
   ...
   for CFG3_Register use record
      ...
      TRIM1_NG_CC1A5 at 0 range 4 .. 8;
      TRIM1_NG_CC3A0 at 0 range 9 .. 12;
      Reserved_13_15 at 0 range 13 .. 15;
      TRIM2_NG_CCRPD at 0 range 16 .. 19;
      TRIM2_NG_CC1A5 at 0 range 20 .. 24;
      TRIM2_NG_CC3A0 at 0 range 25 .. 28;
      Reserved_29_31 at 0 range 29 .. 31;
   end record;

   subtype CR_TXMODE_Field is Interfaces.Bit_Types.UInt2;
   subtype CR_ANASUBMODE_Field is Interfaces.Bit_Types.UInt2;
   subtype CR_CCENABLE_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype SR_TYPEC_VSTATE_CC_Element is Interfaces.Bit_Types.UInt2;
   ...
   subtype TX_ORDSET_TXORDSET_Field is Interfaces.Bit_Types.UInt20;
   ...
   subtype TX_PAYSZ_TXPAYSZ_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype RX_ORDSET_RXORDSET_Field is Interfaces.Bit_Types.UInt3;
   subtype RX_ORDSET_RXSOPKINVALID_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype RX_PAYSZ_RXPAYSZ_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype RX_ORDEXT1_RXSOPX1_Field is Interfaces.Bit_Types.UInt20;
   ...
   subtype RX_ORDEXT2_RXSOPX2_Field is Interfaces.Bit_Types.UInt20;
   ...
   SEC_UCPD1_Periph : aliased UCPD_Peripheral
     with Import, Address => System'To_Address (16#5000DC00#);

   --  USB Power Delivery interface
   UCPD1_Periph : aliased UCPD_Peripheral
     with Import, Address => System'To_Address (16#4000DC00#);
