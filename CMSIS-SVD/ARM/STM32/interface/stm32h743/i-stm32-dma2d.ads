...
package Interfaces.STM32.DMA2D is
   ...
   subtype FGPFCCR_CSS_Field is Interfaces.Bit_Types.UInt2;
   ...
   type OPFCCR_Register is record
      ...
      --  unspecified
      Reserved_3_19  : Interfaces.Bit_Types.UInt17 := 16#0#;
      --  Alpha Inverted This bit inverts the alpha value. Once the transfer
      --  has started, this bit is read-only.
      AI             : Boolean := False;
      --  Red Blue Swap This bit allows to swap the R &amp; B to support BGR or
   ...
   subtype OCOLR_ALPHA_Field is Interfaces.Bit_Types.Byte;
