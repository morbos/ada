...
package Interfaces.STM32.Ethernet is
   ...
   subtype DMAMR_PR_Field is Interfaces.Bit_Types.UInt3;
   ...
   type DMAMR_Register is record
      ...
      DA             : Boolean := False;
      --  unspecified
      Reserved_2_10  : Interfaces.Bit_Types.UInt9 := 16#0#;
   ...
   type DMASBMR_Register is record
      ...
      FB             : Boolean := False;
      --  unspecified
      Reserved_1_11  : Interfaces.Bit_Types.UInt11 := 16#0#;
      ...
      RB             : Boolean := False;
      --  unspecified
      Reserved_16_31 : Interfaces.Bit_Types.UInt16 := 16#101#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype DMADSR_RPS0_Field is Interfaces.Bit_Types.UInt4;
   subtype DMADSR_TPS0_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype DMACCR_MSS_Field is Interfaces.Bit_Types.UInt14;
   subtype DMACCR_DSL_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype DMACTxCR_TXPBL_Field is Interfaces.Bit_Types.UInt6;
   ...
   subtype DMACRxCR_RBSZ_Field is Interfaces.Bit_Types.UInt14;
   subtype DMACRxCR_RXPBL_Field is Interfaces.Bit_Types.UInt6;
   ...
   subtype DMACTxDLAR_TDESLA_Field is Interfaces.Bit_Types.UInt30;
   ...
   subtype DMACRxDLAR_RDESLA_Field is Interfaces.Bit_Types.UInt30;
   ...
   subtype DMACTxDTPR_TDT_Field is Interfaces.Bit_Types.UInt30;
   ...
   subtype DMACRxDTPR_RDT_Field is Interfaces.Bit_Types.UInt30;
   ...
   subtype DMACTxRLR_TDRL_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype DMACRxRLR_RDRL_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype DMACRxIWTR_RWT_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype DMACSR_TEB_Field is Interfaces.Bit_Types.UInt3;
   subtype DMACSR_REB_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype DMACMFCR_MFC_Field is Interfaces.Bit_Types.UInt11;
   ...
   subtype MACCR_PRELEN_Field is Interfaces.Bit_Types.UInt2;
   subtype MACCR_BL_Field is Interfaces.Bit_Types.UInt2;
   subtype MACCR_IPG_Field is Interfaces.Bit_Types.UInt3;
   subtype MACCR_SARC_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype MACECR_GPSL_Field is Interfaces.Bit_Types.UInt14;
   subtype MACECR_EIPG_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype MACPFR_PCF_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype MACWTR_WTO_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype MACVTR_VL_Field is Interfaces.Bit_Types.UInt16;
   subtype MACVTR_EVLS_Field is Interfaces.Bit_Types.UInt2;
   subtype MACVTR_EIVLS_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype MACVHTR_VLHT_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype MACVIR_VLT_Field is Interfaces.Bit_Types.UInt16;
   subtype MACVIR_VLC_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype MACIVIR_VLT_Field is Interfaces.Bit_Types.UInt16;
   subtype MACIVIR_VLC_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype MACQTxFCR_PLT_Field is Interfaces.Bit_Types.UInt3;
   subtype MACQTxFCR_PT_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype MACPCSR_RWKPTR_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype MACLTCR_TWT_Field is Interfaces.Bit_Types.UInt16;
   subtype MACLTCR_LST_Field is Interfaces.Bit_Types.UInt10;
   ...
   subtype MACLETR_LPIET_Field is Interfaces.Bit_Types.UInt17;
   ...
   subtype MAC1USTCR_TIC_1US_CNTR_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype MACVR_SNPSVER_Field is Interfaces.Bit_Types.Byte;
   subtype MACVR_USERVER_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype MACDR_RFCFCSTS_Field is Interfaces.Bit_Types.UInt2;
   subtype MACDR_TFCSTS_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype MACHWF1R_RXFIFOSIZE_Field is Interfaces.Bit_Types.UInt5;
   subtype MACHWF1R_TXFIFOSIZE_Field is Interfaces.Bit_Types.UInt5;
   subtype MACHWF1R_ADDR64_Field is Interfaces.Bit_Types.UInt2;
   subtype MACHWF1R_HASHTBLSZ_Field is Interfaces.Bit_Types.UInt2;
   subtype MACHWF1R_L3L4FNUM_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype MACHWF2R_RXQCNT_Field is Interfaces.Bit_Types.UInt4;
   subtype MACHWF2R_TXQCNT_Field is Interfaces.Bit_Types.UInt4;
   subtype MACHWF2R_RXCHCNT_Field is Interfaces.Bit_Types.UInt4;
   subtype MACHWF2R_TXCHCNT_Field is Interfaces.Bit_Types.UInt4;
   subtype MACHWF2R_PPSOUTNUM_Field is Interfaces.Bit_Types.UInt3;
   subtype MACHWF2R_AUXSNAPNUM_Field is Interfaces.Bit_Types.UInt3;
   ...
   type MACHWF2R_Register is record
      ...
      --  unspecified
      Reserved_16_17 : Interfaces.Bit_Types.UInt2;
      --  Read-only. TXCHCNT
   ...
   subtype MACMDIOAR_GOC_Field is Interfaces.Bit_Types.UInt2;
   subtype MACMDIOAR_CR_Field is Interfaces.Bit_Types.UInt4;
   subtype MACMDIOAR_NTC_Field is Interfaces.Bit_Types.UInt3;
   subtype MACMDIOAR_RDA_Field is Interfaces.Bit_Types.UInt5;
   subtype MACMDIOAR_PA_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype MACMDIODR_MD_Field is Interfaces.Bit_Types.UInt16;
   subtype MACMDIODR_RA_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype MACA0HR_ADDRHI_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype MACA1HR_ADDRHI_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype MACA2HR_ADDRHI_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype MACA3HR_ADDRHI_Field is Interfaces.Bit_Types.UInt16;
   ...
   type MMC_RX_INTERRUPT_Register is record
      ...
      RXALGNERPIS    : Boolean;
      --  unspecified
      Reserved_7_16  : Interfaces.Bit_Types.UInt10;
      --  Read-only. RXUCGPIS
      RXUCGPIS       : Boolean;
      --  unspecified
      Reserved_18_25 : Interfaces.Bit_Types.Byte;
   ...
   type MMC_RX_INTERRUPT_MASK_Register is record
      ...
      --  unspecified
      Reserved_18_25 : Interfaces.Bit_Types.Byte := 16#0#;
      --  RXLPIUSCIM
   ...
   subtype MACL3L4C0R_L3HSBM0_Field is Interfaces.Bit_Types.UInt5;
   subtype MACL3L4C0R_L3HDBM0_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype MACL4A0R_L4SP0_Field is Interfaces.Bit_Types.UInt16;
   subtype MACL4A0R_L4DP0_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype MACL3L4C1R_L3HSBM1_Field is Interfaces.Bit_Types.UInt5;
   subtype MACL3L4C1R_L3HDBM1_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype MACL4A1R_L4SP1_Field is Interfaces.Bit_Types.UInt16;
   subtype MACL4A1R_L4DP1_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype MACTSCR_SNAPTYPSEL_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype MACSSIR_SNSINC_Field is Interfaces.Bit_Types.Byte;
   subtype MACSSIR_SSINC_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype MACSTNR_TSSS_Field is Interfaces.Bit_Types.UInt31;
   ...
   subtype MACSTNUR_TSSS_Field is Interfaces.Bit_Types.UInt31;
   ...
   subtype MACTSSR_ATSSTN_Field is Interfaces.Bit_Types.UInt4;
   subtype MACTSSR_ATSNS_Field is Interfaces.Bit_Types.UInt5;
   ...
   type MACTSSR_Register is record
      ...
      TSTRGTERR0     : Boolean;
      --  unspecified
      Reserved_4_14  : Interfaces.Bit_Types.UInt11;
      --  Read-only. TXTSSIS
      TXTSSIS        : Boolean;
      --  Read-only. ATSSTN
   ...
   subtype MACTxTSSNR_TXTSSLO_Field is Interfaces.Bit_Types.UInt31;
   ...
   subtype MACATSNR_AUXTSLO_Field is Interfaces.Bit_Types.UInt31;
   ...
   subtype MACPPSCR_PPSCTRL_Field is Interfaces.Bit_Types.UInt4;
   subtype MACPPSCR_TRGTMODSEL0_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype MACPPSTTSR_TSTRH0_Field is Interfaces.Bit_Types.UInt31;
   ...
   subtype MACPPSTTNR_TTSL0_Field is Interfaces.Bit_Types.UInt31;
   ...
   subtype MACPOCR_DN_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype MACSPI2R_SPI2_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype MACLMIR_LSI_Field is Interfaces.Bit_Types.Byte;
   subtype MACLMIR_DRSYNCR_Field is Interfaces.Bit_Types.UInt3;
   subtype MACLMIR_LMPDRI_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype MTLTxQOMR_TXQEN_Field is Interfaces.Bit_Types.UInt2;
   subtype MTLTxQOMR_TTC_Field is Interfaces.Bit_Types.UInt3;
   subtype MTLTxQOMR_TQS_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype MTLTxQUR_UFFRMCNT_Field is Interfaces.Bit_Types.UInt11;
   ...
   subtype MTLTxQDR_TRCSTS_Field is Interfaces.Bit_Types.UInt2;
   subtype MTLTxQDR_PTXQ_Field is Interfaces.Bit_Types.UInt3;
   subtype MTLTxQDR_STXSTSF_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype MTLRxQOMR_RTC_Field is Interfaces.Bit_Types.UInt2;
   subtype MTLRxQOMR_RFA_Field is Interfaces.Bit_Types.UInt3;
   subtype MTLRxQOMR_RFD_Field is Interfaces.Bit_Types.UInt3;
   subtype MTLRxQOMR_RQS_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype MTLRxQMPOCR_OVFPKTCNT_Field is Interfaces.Bit_Types.UInt11;
   subtype MTLRxQMPOCR_MISPKTCNT_Field is Interfaces.Bit_Types.UInt11;
   ...
   subtype MTLRxQDR_RRCSTS_Field is Interfaces.Bit_Types.UInt2;
   subtype MTLRxQDR_RXQSTS_Field is Interfaces.Bit_Types.UInt2;
   subtype MTLRxQDR_PRXQ_Field is Interfaces.Bit_Types.UInt14;
   ...
   type Ethernet_DMA_Peripheral is record
      ...
      DMACCATxDR : aliased Interfaces.Bit_Types.UInt32;
      --  Channel current application receive descriptor register
      DMACCARxDR : aliased Interfaces.Bit_Types.UInt32;
      --  Channel current application transmit buffer register
      DMACCATxBR : aliased Interfaces.Bit_Types.UInt32;
      --  Channel current application receive buffer register
      DMACCARxBR : aliased Interfaces.Bit_Types.UInt32;
      --  Channel status register
   ...
   type Ethernet_MAC_Peripheral is record
      ...
      MACHT0R                            : aliased Interfaces.Bit_Types.UInt32;
      --  Hash Table 1 register
      MACHT1R                            : aliased Interfaces.Bit_Types.UInt32;
      --  VLAN tag register
      ...
      MACRWKPFR                          : aliased Interfaces.Bit_Types.UInt32;
      --  LPI control status register
      ...
      MACA0LR                            : aliased Interfaces.Bit_Types.UInt32;
      --  Address 1 high register
      MACA1HR                            : aliased MACA1HR_Register;
      --  Address 1 low register
      MACA1LR                            : aliased Interfaces.Bit_Types.UInt32;
      --  Address 2 high register
      MACA2HR                            : aliased MACA2HR_Register;
      --  Address 2 low register
      MACA2LR                            : aliased Interfaces.Bit_Types.UInt32;
      --  Address 3 high register
      MACA3HR                            : aliased MACA3HR_Register;
      --  Address 3 low register
      MACA3LR                            : aliased Interfaces.Bit_Types.UInt32;
      --  MMC control register
      ...
      TX_SINGLE_COLLISION_GOOD_PACKETS   : aliased Interfaces.Bit_Types.UInt32;
      --  Tx multiple collision good packets register
      TX_MULTIPLE_COLLISION_GOOD_PACKETS : aliased Interfaces.Bit_Types.UInt32;
      --  Tx packet count good register
      TX_PACKET_COUNT_GOOD               : aliased Interfaces.Bit_Types.UInt32;
      --  Rx CRC error packets register
      RX_CRC_ERROR_PACKETS               : aliased Interfaces.Bit_Types.UInt32;
      --  Rx alignment error packets register
      RX_ALIGNMENT_ERROR_PACKETS         : aliased Interfaces.Bit_Types.UInt32;
      --  Rx unicast packets good register
      RX_UNICAST_PACKETS_GOOD            : aliased Interfaces.Bit_Types.UInt32;
      --  Tx LPI microsecond timer register
      TX_LPI_USEC_CNTR                   : aliased Interfaces.Bit_Types.UInt32;
      --  Tx LPI transition counter register
      TX_LPI_TRAN_CNTR                   : aliased Interfaces.Bit_Types.UInt32;
      --  Rx LPI microsecond counter register
      RX_LPI_USEC_CNTR                   : aliased Interfaces.Bit_Types.UInt32;
      --  Rx LPI transition counter register
      RX_LPI_TRAN_CNTR                   : aliased Interfaces.Bit_Types.UInt32;
      --  L3 and L4 control 0 register
      MACL3L4C0R                         : aliased MACL3L4C0R_Register;
      --  Layer4 address filter 0 register
      MACL4A0R                           : aliased MACL4A0R_Register;
      --  MACL3A00R
      MACL3A00R                          : aliased Interfaces.Bit_Types.UInt32;
      --  Layer3 address 1 filter 0 register
      MACL3A10R                          : aliased Interfaces.Bit_Types.UInt32;
      --  Layer3 Address 2 filter 0 register
      MACL3A20                           : aliased Interfaces.Bit_Types.UInt32;
      --  Layer3 Address 3 filter 0 register
      MACL3A30                           : aliased Interfaces.Bit_Types.UInt32;
      --  L3 and L4 control 1 register
      MACL3L4C1R                         : aliased MACL3L4C1R_Register;
      --  Layer 4 address filter 1 register
      MACL4A1R                           : aliased MACL4A1R_Register;
      --  Layer3 address 0 filter 1 Register
      MACL3A01R                          : aliased Interfaces.Bit_Types.UInt32;
      --  Layer3 address 1 filter 1 register
      MACL3A11R                          : aliased Interfaces.Bit_Types.UInt32;
      --  Layer3 address 2 filter 1 Register
      MACL3A21R                          : aliased Interfaces.Bit_Types.UInt32;
      --  Layer3 address 3 filter 1 register
      MACL3A31R                          : aliased Interfaces.Bit_Types.UInt32;
      --  ARP address register
      MACARPAR                           : aliased Interfaces.Bit_Types.UInt32;
      --  Timestamp control Register
      MACTSCR                            : aliased MACTSCR_Register;
      --  Sub-second increment register
      MACSSIR                            : aliased MACSSIR_Register;
      --  System time seconds register
      MACSTSR                            : aliased Interfaces.Bit_Types.UInt32;
      --  System time nanoseconds register
      MACSTNR                            : aliased MACSTNR_Register;
      --  System time seconds update register
      MACSTSUR                           : aliased Interfaces.Bit_Types.UInt32;
      --  System time nanoseconds update register
      MACSTNUR                           : aliased MACSTNUR_Register;
      --  Timestamp addend register
      MACTSAR                            : aliased Interfaces.Bit_Types.UInt32;
      --  Timestamp status register
      MACTSSR                            : aliased MACTSSR_Register;
      --  Tx timestamp status nanoseconds register
      MACTxTSSNR                         : aliased MACTxTSSNR_Register;
      --  Tx timestamp status seconds register
      MACTxTSSSR                         : aliased Interfaces.Bit_Types.UInt32;
      --  Auxiliary control register
      MACACR                             : aliased MACACR_Register;
      --  Auxiliary timestamp nanoseconds register
      MACATSNR                           : aliased MACATSNR_Register;
      --  Auxiliary timestamp seconds register
      MACATSSR                           : aliased Interfaces.Bit_Types.UInt32;
      --  Timestamp Ingress asymmetric correction register
      MACTSIACR                          : aliased Interfaces.Bit_Types.UInt32;
      --  Timestamp Egress asymmetric correction register
      MACTSEACR                          : aliased Interfaces.Bit_Types.UInt32;
      --  Timestamp Ingress correction nanosecond register
      MACTSICNR                          : aliased Interfaces.Bit_Types.UInt32;
      --  Timestamp Egress correction nanosecond register
      MACTSECNR                          : aliased Interfaces.Bit_Types.UInt32;
      --  PPS control register
      ...
      MACPPSIR                           : aliased Interfaces.Bit_Types.UInt32;
      --  PPS width register
      MACPPSWR                           : aliased Interfaces.Bit_Types.UInt32;
      --  PTP Offload control register
      MACPOCR                            : aliased MACPOCR_Register;
      --  PTP Source Port Identity 0 Register
      MACSPI0R                           : aliased Interfaces.Bit_Types.UInt32;
      --  PTP Source port identity 1 register
      MACSPI1R                           : aliased Interfaces.Bit_Types.UInt32;
      --  PTP Source port identity 2 register
