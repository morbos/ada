...
package Interfaces.STM32.BDMA is
   pragma Preelaborate;
   ...
   type BDMA_CCR_Register is record
      ...
      EN             : BDMA_CCR0_EN_Field := Interfaces.STM32.BDMA.B_0X0;
      ...
      TCIE           : BDMA_CCR0_TCIE_Field := Interfaces.STM32.BDMA.B_0X0;
      --  half transfer interrupt enable Note: this bit is set and cleared by
      --  software. It must not be written when the channel is enabled (EN =
      --  1). It is not read-only when the channel is enabled (EN = 1).
      HTIE           : BDMA_CCR0_HTIE_Field := Interfaces.STM32.BDMA.B_0X0;
      --  transfer error interrupt enable Note: this bit is set and cleared by
      --  software. It must not be written when the channel is enabled (EN =
      --  1). It is not read-only when the channel is enabled (EN = 1).
      TEIE           : BDMA_CCR0_TEIE_Field := Interfaces.STM32.BDMA.B_0X0;
      --  data transfer direction This bit must be set only in
      ...
      DIR            : BDMA_CCR0_DIR_Field := Interfaces.STM32.BDMA.B_0X0;
      ...
      --  read-only when the channel is enabled (EN = 1).
      CIRC           : BDMA_CCR0_CIRC_Field := Interfaces.STM32.BDMA.B_0X0;
      --  peripheral increment mode Defines the increment mode for each DMA
      --  transfer to the identified peripheral. n memory-to-memory mode, this
      ...
      --  must not be written when the channel is enabled (EN = 1). It is
      --  read-only when the channel is enabled (EN = 1).
      PINC           : BDMA_CCR0_PINC_Field := Interfaces.STM32.BDMA.B_0X0;
      ...
      --  software. It must not be written when the channel is enabled (EN =
      --  1). It is read-only when the channel is enabled (EN = 1).
      MINC           : BDMA_CCR0_MINC_Field := Interfaces.STM32.BDMA.B_0X0;
      --  peripheral size Defines the data size of each DMA transfer to the
      ...
      PSIZE          : BDMA_CCR0_PSIZE_Field := Interfaces.STM32.BDMA.B_0X0;
      ...
      --  written when the channel is enabled (EN = 1). It is read-only when
      --  the channel is enabled (EN = 1).
      MSIZE          : BDMA_CCR0_MSIZE_Field := Interfaces.STM32.BDMA.B_0X0;
      --  priority level Note: this field is set and cleared by software. It
      --  must not be written when the channel is enabled (EN = 1). It is
      --  read-only when the channel is enabled (EN = 1).
      PL             : BDMA_CCR0_PL_Field := Interfaces.STM32.BDMA.B_0X0;
      ...
      --  read-only when the channel is enabled (EN = 1).
      MEM2MEM        : BDMA_CCR0_MEM2MEM_Field := Interfaces.STM32.BDMA.B_0X0;
      ...
      --  by software. It must not be written when the channel is enabled (EN =
      --  1). It is not read-only when the channel is enabled (EN = 1).
      DBM            : BDMA_CCR0_DBM_Field := Interfaces.STM32.BDMA.B_0X0;
      ...
      --  must not be written when the channel is enabled (EN = 1). It is
      --  read-only when the channel is enabled (EN = 1).
      CT             : BDMA_CCR0_CT_Field := Interfaces.STM32.BDMA.B_0X0;
      --  unspecified
   ...
   subtype BDMA_CNDTR_NDT_Field is Interfaces.Bit_Types.UInt16;
   ...
   type BDMA_Peripheral is record
      ...
      BDMA_CPAR0  : aliased Interfaces.Bit_Types.UInt32;
      BDMA_CM0AR0 : aliased Interfaces.Bit_Types.UInt32;
      BDMA_CM1AR0 : aliased Interfaces.Bit_Types.UInt32;
      --  BDMA channel 1 configuration register
      BDMA_CCR1   : aliased BDMA_CCR_Register;
      BDMA_CNDTR1 : aliased BDMA_CNDTR_Register;
      BDMA_CPAR1  : aliased Interfaces.Bit_Types.UInt32;
      BDMA_CM0AR1 : aliased Interfaces.Bit_Types.UInt32;
      BDMA_CM1AR1 : aliased Interfaces.Bit_Types.UInt32;
      --  BDMA channel 2 configuration register
      BDMA_CCR2   : aliased BDMA_CCR_Register;
      BDMA_CNDTR2 : aliased BDMA_CNDTR_Register;
      BDMA_CPAR2  : aliased Interfaces.Bit_Types.UInt32;
      BDMA_CM0AR2 : aliased Interfaces.Bit_Types.UInt32;
      BDMA_CM1AR2 : aliased Interfaces.Bit_Types.UInt32;
      --  BDMA channel 3 configuration register
      BDMA_CCR3   : aliased BDMA_CCR_Register;
      BDMA_CNDTR3 : aliased BDMA_CNDTR_Register;
      BDMA_CPAR3  : aliased Interfaces.Bit_Types.UInt32;
      BDMA_CM0AR3 : aliased Interfaces.Bit_Types.UInt32;
      BDMA_CM1AR3 : aliased Interfaces.Bit_Types.UInt32;
      --  BDMA channel 4 configuration register
      BDMA_CCR4   : aliased BDMA_CCR_Register;
      BDMA_CNDTR4 : aliased BDMA_CNDTR_Register;
      BDMA_CPAR4  : aliased Interfaces.Bit_Types.UInt32;
      BDMA_CM0AR4 : aliased Interfaces.Bit_Types.UInt32;
      BDMA_CM1AR4 : aliased Interfaces.Bit_Types.UInt32;
      --  BDMA channel 5 configuration register
      BDMA_CCR5   : aliased BDMA_CCR_Register;
      BDMA_CNDTR5 : aliased BDMA_CNDTR_Register;
      BDMA_CPAR5  : aliased Interfaces.Bit_Types.UInt32;
      BDMA_CM0AR5 : aliased Interfaces.Bit_Types.UInt32;
      BDMA_CM1AR5 : aliased Interfaces.Bit_Types.UInt32;
      --  BDMA channel 6 configuration register
      BDMA_CCR6   : aliased BDMA_CCR_Register;
      BDMA_CNDTR6 : aliased BDMA_CNDTR_Register;
      BDMA_CPAR6  : aliased Interfaces.Bit_Types.UInt32;
      BDMA_CM0AR6 : aliased Interfaces.Bit_Types.UInt32;
      BDMA_CM1AR6 : aliased Interfaces.Bit_Types.UInt32;
      --  BDMA channel 7 configuration register
      BDMA_CCR7   : aliased BDMA_CCR_Register;
      BDMA_CNDTR7 : aliased BDMA_CNDTR_Register;
      BDMA_CPAR7  : aliased Interfaces.Bit_Types.UInt32;
      BDMA_CM0AR7 : aliased Interfaces.Bit_Types.UInt32;
      BDMA_CM1AR7 : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
