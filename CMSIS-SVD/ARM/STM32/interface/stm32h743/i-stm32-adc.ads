...
package Interfaces.STM32.ADC is
   ...
   subtype CFGR_DMNGT_Field is Interfaces.Bit_Types.UInt2;
   subtype CFGR_RES_Field is Interfaces.Bit_Types.UInt3;
   subtype CFGR_EXTSEL_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype CFGR2_OSR_Field is Interfaces.Bit_Types.UInt10;
   subtype CFGR2_LSHIFT_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype PCSEL_PCSEL_Field is Interfaces.Bit_Types.UInt20;
   ...
   subtype LTR1_LTR1_Field is Interfaces.Bit_Types.UInt26;
   ...
   type LTR1_Register is record
      ...
      --  unspecified
      Reserved_26_31 : Interfaces.Bit_Types.UInt6 := 16#3#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype LHTR1_LHTR1_Field is Interfaces.Bit_Types.UInt26;
   ...
   subtype SQR1_L3_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype DR_RDATA_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype JSQR_JEXTSEL_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype OFR_OFFSET1_Field is Interfaces.Bit_Types.UInt26;
   subtype OFR_OFFSET1_CH_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype AWD2CR_AWD2CH_Field is Interfaces.Bit_Types.UInt20;
   ...
   subtype AWD3CR_AWD3CH_Field is Interfaces.Bit_Types.UInt20;
   ...
   subtype LTR2_LTR2_Field is Interfaces.Bit_Types.UInt26;
   ...
   subtype HTR2_HTR2_Field is Interfaces.Bit_Types.UInt26;
   ...
   subtype LTR3_LTR3_Field is Interfaces.Bit_Types.UInt26;
   ...
   subtype HTR3_HTR3_Field is Interfaces.Bit_Types.UInt26;
   ...
   subtype DIFSEL_DIFSEL_Field is Interfaces.Bit_Types.UInt20;
   ...
   subtype CALFACT_CALFACT_S_Field is Interfaces.Bit_Types.UInt11;
   subtype CALFACT_CALFACT_D_Field is Interfaces.Bit_Types.UInt11;
   ...
   subtype CALFACT2_LINCALFACT_Field is Interfaces.Bit_Types.UInt30;
   ...
   subtype CCR_DAMDF_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype CDR_RDATA_MST_Field is Interfaces.Bit_Types.UInt16;
   subtype CDR_RDATA_SLV_Field is Interfaces.Bit_Types.UInt16;
   ...
   type ADC1_Peripheral is record
      ...
      JDR1     : aliased Interfaces.Bit_Types.UInt32;
      --  ADC group injected sequencer rank 2 register
      JDR2     : aliased Interfaces.Bit_Types.UInt32;
      --  ADC group injected sequencer rank 3 register
      JDR3     : aliased Interfaces.Bit_Types.UInt32;
      --  ADC group injected sequencer rank 4 register
      JDR4     : aliased Interfaces.Bit_Types.UInt32;
      --  ADC analog watchdog 2 configuration register
   ...
   type ADC12_Common_Peripheral is record
      ...
      CDR2 : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
