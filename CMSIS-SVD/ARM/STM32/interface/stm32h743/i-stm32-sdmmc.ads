...
package Interfaces.STM32.SDMMC is
   ...
   subtype IDMABSIZER_IDMABNDT_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype VER_MINREV_Field is Interfaces.Bit_Types.UInt4;
   subtype VER_MAJREV_Field is Interfaces.Bit_Types.UInt4;
   ...
   type SDMMC_Peripheral is record
      ...
      RESP1R     : aliased Interfaces.Bit_Types.UInt32;
      --  The SDMMC_RESP1/2/3/4R registers contain the status of a card, which
      --  is part of the received response.
      RESP2R     : aliased Interfaces.Bit_Types.UInt32;
      --  The SDMMC_RESP1/2/3/4R registers contain the status of a card, which
      --  is part of the received response.
      RESP3R     : aliased Interfaces.Bit_Types.UInt32;
      --  The SDMMC_RESP1/2/3/4R registers contain the status of a card, which
      --  is part of the received response.
      RESP4R     : aliased Interfaces.Bit_Types.UInt32;
      ...
      FIFOR      : aliased Interfaces.Bit_Types.UInt32;
      --  SDMMC IP version register
      VER        : aliased VER_Register;
      --  SDMMC IP identification register
      ID         : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
