...
package Interfaces.STM32.FDCAN is
   ...
   subtype CREL_DAY_Field is Interfaces.Bit_Types.Byte;
   subtype CREL_MON_Field is Interfaces.Bit_Types.Byte;
   subtype CREL_YEAR_Field is Interfaces.Bit_Types.UInt4;
   subtype CREL_SUBSTEP_Field is Interfaces.Bit_Types.UInt4;
   subtype CREL_STEP_Field is Interfaces.Bit_Types.UInt4;
   subtype CREL_REL_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype CCFG_TQBT_Field is Interfaces.Bit_Types.UInt5;
   subtype CCFG_OCPM_Field is Interfaces.Bit_Types.Byte;
   subtype CCFG_CDIV_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype CSTAT_OCPC_Field is Interfaces.Bit_Types.UInt18;
   subtype CSTAT_TQC_Field is Interfaces.Bit_Types.UInt11;
   subtype CSTAT_CALS_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype CWD_WDC_Field is Interfaces.Bit_Types.UInt16;
   subtype CWD_WDV_Field is Interfaces.Bit_Types.UInt16;
   ...
   type FDCAN_DBTP_Register is record
      ...
      --  unspecified
      Reserved_21_22 : Interfaces.Bit_Types.UInt2;
   ...
   subtype FDCAN_ECR_TREC_Field is Interfaces.Bit_Types.UInt7;
   ...
   type FDCAN_IR_Register is record
      ...
      DRX            : Boolean;
      --  unspecified
      Reserved_20_21 : Interfaces.Bit_Types.UInt2;
   ...
   subtype FDCAN_RXF0C_F0S_Field is Interfaces.Bit_Types.Byte;
   subtype FDCAN_RXF0C_F0WM_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype FDCAN_RXF0S_F0G_Field is Interfaces.Bit_Types.UInt6;
   subtype FDCAN_RXF0S_F0P_Field is Interfaces.Bit_Types.UInt6;
   ...
   subtype FDCAN_RXF0A_FA01_Field is Interfaces.Bit_Types.UInt6;
   ...
   subtype FDCAN_RXF1S_F1GI_Field is Interfaces.Bit_Types.UInt7;
   subtype FDCAN_RXF1S_F1PI_Field is Interfaces.Bit_Types.UInt7;
   ...
   subtype CAN_TTGTP_NCL_Field is Interfaces.Bit_Types.UInt16;
   subtype CAN_TTGTP_CTP_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype FDCAN_TTCPT_CT_Field is Interfaces.Bit_Types.UInt6;
