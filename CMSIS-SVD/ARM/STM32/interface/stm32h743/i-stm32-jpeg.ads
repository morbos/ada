...
package Interfaces.STM32.JPEG is
   ...
   subtype CONFR1_NF_Field is Interfaces.Bit_Types.UInt2;
   subtype CONFR1_COLORSPACE_Field is Interfaces.Bit_Types.UInt2;
   subtype CONFR1_NS_Field is Interfaces.Bit_Types.UInt2;
   subtype CONFR1_YSIZE_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype CONFR2_NMCU_Field is Interfaces.Bit_Types.UInt26;
   ...
   subtype CONFR3_XSIZE_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype CONFRN_QT_Field is Interfaces.Bit_Types.UInt2;
   subtype CONFRN_NB_Field is Interfaces.Bit_Types.UInt4;
   subtype CONFRN_VSF_Field is Interfaces.Bit_Types.UInt4;
   subtype CONFRN_HSF_Field is Interfaces.Bit_Types.UInt4;
   ...
   type JPEG_Peripheral is record
      ...
      DIR     : aliased Interfaces.Bit_Types.UInt32;
      --  JPEG data output register
      DOR     : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
