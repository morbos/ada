...
package Interfaces.STM32.HSEM is
   ...
   subtype HSEM_R_MASTERID_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype HSEM_RLR_MASTERID_Field is Interfaces.Bit_Types.Byte;
   ...
   type HSEM_RLR_Register is record
      ...
      --  unspecified
      Reserved_16_30 : Interfaces.Bit_Types.UInt15;
   ...
   subtype HSEM_CR_MASTERID_Field is Interfaces.Bit_Types.Byte;
