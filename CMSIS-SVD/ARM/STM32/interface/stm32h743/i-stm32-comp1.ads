...
package Interfaces.STM32.COMP1 is
   pragma Preelaborate;
   ...
   subtype OR_AFOP_Field is Interfaces.Bit_Types.UInt11;
   subtype OR_OR_Field is Interfaces.Bit_Types.UInt21;
   ...
   subtype CFGR1_HYST_Field is Interfaces.Bit_Types.UInt2;
   subtype CFGR1_PWRMODE_Field is Interfaces.Bit_Types.UInt2;
   subtype CFGR1_INMSEL_Field is Interfaces.Bit_Types.UInt3;
   subtype CFGR1_BLANKING_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype CFGR2_HYST_Field is Interfaces.Bit_Types.UInt2;
   subtype CFGR2_PWRMODE_Field is Interfaces.Bit_Types.UInt2;
   subtype CFGR2_INMSEL_Field is Interfaces.Bit_Types.UInt3;
   subtype CFGR2_BLANKING_Field is Interfaces.Bit_Types.UInt4;
