...
package Interfaces.STM32.LTDC is
   ...
   subtype AWCR_AAV_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype BCCR_BCBLUE_Field is Interfaces.Bit_Types.Byte;
   subtype BCCR_BCGREEN_Field is Interfaces.Bit_Types.Byte;
   subtype BCCR_BCRED_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype CPSR_CYPOS_Field is Interfaces.Bit_Types.UInt16;
   subtype CPSR_CXPOS_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype L2CKCR_CKGREEN_Field is Interfaces.Bit_Types.Byte;
   subtype L2CKCR_CKRED_Field is Interfaces.Bit_Types.Byte;
   ...
   type LTDC_Peripheral is record
      ...
      L1CFBAR  : aliased Interfaces.Bit_Types.UInt32;
      --  Layerx Color Frame Buffer Length Register
      ...
      --  Layerx Color Frame Buffer Address Register
      L2CFBAR  : aliased Interfaces.Bit_Types.UInt32;
      --  Layerx Color Frame Buffer Length Register
