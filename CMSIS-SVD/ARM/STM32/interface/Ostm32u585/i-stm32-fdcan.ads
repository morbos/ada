...
package Interfaces.STM32.FDCAN is
   ...
   subtype FDCAN_TXBCIE_CFIE_Field is Interfaces.Bit_Types.UInt3;
   ...
   --  FDCAN1_RAM
   FDCAN1_RAM_Periph : aliased FDCAN_Peripheral
     with Import, Address => FDCAN1_RAM_Base;
   ...
   --  FDCAN1_RAM
   SEC_FDCAN1_RAM_Periph : aliased FDCAN_Peripheral
     with Import, Address => SEC_FDCAN1_RAM_Base;
