...
package Interfaces.STM32.DBGMCU is
   ...
   subtype IDCODE_REV_ID_Field is Interfaces.Bit_Types.UInt16;
   ...
   type APB3FZR_Register is record
      ...
      --  unspecified
      Reserved_11_16  : Interfaces.Bit_Types.UInt6 := 16#0#;
      ...
      --  unspecified
      Reserved_20_29  : Interfaces.Bit_Types.UInt10 := 16#0#;
      --  RTC stop in debug
   ...
   subtype DBGMCU_SR_AP_PRESENT_Field is Interfaces.Bit_Types.Byte;
   subtype DBGMCU_SR_AP_LOCKED_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype PIDR4_JEP106CON_Field is Interfaces.Bit_Types.UInt4;
   subtype PIDR4_KCOUNT_4_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype PIDR0_PARTNUM_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype PIDR1_PARTNUM_Field is Interfaces.Bit_Types.UInt4;
   subtype PIDR1_JEP106ID_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype PIDR2_JEP106ID_Field is Interfaces.Bit_Types.UInt3;
   subtype PIDR2_REVISION_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype PIDR3_CMOD_Field is Interfaces.Bit_Types.UInt4;
   subtype PIDR3_REVAND_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype CIDR_PREAMBLE_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype CIDR1_PREAMBLE_Field is Interfaces.Bit_Types.UInt4;
   subtype CIDR1_CLASS_Field is Interfaces.Bit_Types.UInt4;
   ...
   type DBGMCU_Peripheral is record
      ...
      DBGMCU_DBG_AUTH_HOST   : aliased Interfaces.Bit_Types.UInt32;
      --  DBGMCU debug device authentication register
      DBGMCU_DBG_AUTH_DEVICE : aliased Interfaces.Bit_Types.UInt32;
      --  Debug MCU CoreSight peripheral identity register 4
