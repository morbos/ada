...
package Interfaces.STM32.SDMMC is
   ...
   subtype CLKCR_CLKDIV_Field is Interfaces.Bit_Types.UInt10;
   subtype CLKCR_WIDBUS_Field is Interfaces.Bit_Types.UInt2;
   subtype CLKCR_SELCLKRX_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype CMDR_CMDINDEX_Field is Interfaces.Bit_Types.UInt6;
   subtype CMDR_WAITRESP_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype RESPCMDR_RESPCMD_Field is Interfaces.Bit_Types.UInt6;
   ...
   subtype DLENR_DATALENGTH_Field is Interfaces.Bit_Types.UInt25;
   ...
   subtype DCTRL_DTMODE_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype DCNTR_DATACOUNT_Field is Interfaces.Bit_Types.UInt25;
   ...
   subtype ACKTIMER_ACKTIME_Field is Interfaces.Bit_Types.UInt25;
   ...
   subtype SDMMC_IDMABSIZER_IDMABNDT_Field is Interfaces.Bit_Types.UInt12;
   ...
   type SDMMC_Peripheral is record
      ...
      --  argument register
      ARGR             : aliased Interfaces.Bit_Types.UInt32;
      --  command register
      ...
      FIFOR0           : aliased Interfaces.Bit_Types.UInt32;
      --  data FIFO register 1
      FIFOR1           : aliased Interfaces.Bit_Types.UInt32;
      --  data FIFO register 2
      FIFOR2           : aliased Interfaces.Bit_Types.UInt32;
      --  data FIFO register 3
      FIFOR3           : aliased Interfaces.Bit_Types.UInt32;
      --  data FIFO register 4
      FIFOR4           : aliased Interfaces.Bit_Types.UInt32;
      --  data FIFO register 5
      FIFOR5           : aliased Interfaces.Bit_Types.UInt32;
      --  data FIFO register 6
      FIFOR6           : aliased Interfaces.Bit_Types.UInt32;
      --  data FIFO register 7
      FIFOR7           : aliased Interfaces.Bit_Types.UInt32;
      --  data FIFO register 8
      FIFOR8           : aliased Interfaces.Bit_Types.UInt32;
      --  data FIFO register 9
      FIFOR9           : aliased Interfaces.Bit_Types.UInt32;
      --  data FIFO register 10
      FIFOR10          : aliased Interfaces.Bit_Types.UInt32;
      --  data FIFO register 11
      FIFOR11          : aliased Interfaces.Bit_Types.UInt32;
      --  data FIFO register 12
      FIFOR12          : aliased Interfaces.Bit_Types.UInt32;
      --  data FIFO register 13
      FIFOR13          : aliased Interfaces.Bit_Types.UInt32;
      --  data FIFO register 14
      FIFOR14          : aliased Interfaces.Bit_Types.UInt32;
      --  data FIFO register 15
      FIFOR15          : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
