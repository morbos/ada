...
package Interfaces.STM32.IWDG is
   ...
   subtype KR_KEY_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype PR_PR_Field is Interfaces.Bit_Types.UInt4;
   ...
   type SR_Register is record
      ...
      EWU            : Boolean;
      --  unspecified
      Reserved_4_13  : Interfaces.Bit_Types.UInt10;
   ...
   subtype EWCR_EWIT_Field is Interfaces.Bit_Types.UInt12;
