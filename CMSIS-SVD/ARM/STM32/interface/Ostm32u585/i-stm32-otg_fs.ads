...
package Interfaces.STM32.OTG_FS is
   pragma Preelaborate;
   ...
   subtype GUSBCFG_TOCAL_Field is Interfaces.Bit_Types.UInt3;
   subtype GUSBCFG_TRDT_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype GRSTCTL_TXFNUM_Field is Interfaces.Bit_Types.UInt5;
   ...
   subtype GRXSTSR_DEVICE_EPNUM_Field is Interfaces.Bit_Types.UInt4;
   subtype GRXSTSR_DEVICE_BCNT_Field is Interfaces.Bit_Types.UInt11;
   subtype GRXSTSR_DEVICE_DPID_Field is Interfaces.Bit_Types.UInt2;
   subtype GRXSTSR_DEVICE_PKTSTS_Field is Interfaces.Bit_Types.UInt4;
   subtype GRXSTSR_DEVICE_FRMNUM_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype GRXSTSR_HOST_CHNUM_Field is Interfaces.Bit_Types.UInt4;
   subtype GRXSTSR_HOST_BCNT_Field is Interfaces.Bit_Types.UInt11;
   subtype GRXSTSR_HOST_DPID_Field is Interfaces.Bit_Types.UInt2;
   subtype GRXSTSR_HOST_PKTSTS_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype GRXSTSP_DEVICE_EPNUM_Field is Interfaces.Bit_Types.UInt4;
   subtype GRXSTSP_DEVICE_BCNT_Field is Interfaces.Bit_Types.UInt11;
   subtype GRXSTSP_DEVICE_DPID_Field is Interfaces.Bit_Types.UInt2;
   subtype GRXSTSP_DEVICE_PKTSTS_Field is Interfaces.Bit_Types.UInt4;
   subtype GRXSTSP_DEVICE_FRMNUM_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype GRXSTSP_HOST_CHNUM_Field is Interfaces.Bit_Types.UInt4;
   subtype GRXSTSP_HOST_BCNT_Field is Interfaces.Bit_Types.UInt11;
   subtype GRXSTSP_HOST_DPID_Field is Interfaces.Bit_Types.UInt2;
   subtype GRXSTSP_HOST_PKTSTS_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype GRXFSIZ_RXFD_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype HNPTXFSIZ_NPTXFSA_Field is Interfaces.Bit_Types.UInt16;
   subtype HNPTXFSIZ_NPTXFD_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype HNPTXSTS_NPTXFSAV_Field is Interfaces.Bit_Types.UInt16;
   subtype HNPTXSTS_NPTQXSAV_Field is Interfaces.Bit_Types.Byte;
   subtype HNPTXSTS_NPTXQTOP_Field is Interfaces.Bit_Types.UInt7;
   ...
   subtype GLPMCFG_BESL_Field is Interfaces.Bit_Types.UInt4;
   subtype GLPMCFG_BESLTHRS_Field is Interfaces.Bit_Types.UInt4;
   subtype GLPMCFG_LPMRSP_Field is Interfaces.Bit_Types.UInt2;
   subtype GLPMCFG_LPMCHIDX_Field is Interfaces.Bit_Types.UInt4;
   subtype GLPMCFG_LPMRCNT_Field is Interfaces.Bit_Types.UInt3;
   subtype GLPMCFG_LPMRCNTSTS_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype HPTXFSIZ_PTXSA_Field is Interfaces.Bit_Types.UInt16;
   subtype HPTXFSIZ_PTXFSIZ_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype DIEPTXF_INEPTXSA_Field is Interfaces.Bit_Types.UInt16;
   subtype DIEPTXF_INEPTXFD_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype HCFG_FSLSPCS_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype HFIR_FRIVL_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype HFNUM_FRNUM_Field is Interfaces.Bit_Types.UInt16;
   subtype HFNUM_FTREM_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype HPTXSTS_PTXFSAVL_Field is Interfaces.Bit_Types.UInt16;
   subtype HPTXSTS_PTXQSAV_Field is Interfaces.Bit_Types.Byte;
   subtype HPTXSTS_PTXQTOP_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype HAINT_HAINT_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype HAINTMSK_HAINTM_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype HPRT_PLSTS_Field is Interfaces.Bit_Types.UInt2;
   subtype HPRT_PTCTL_Field is Interfaces.Bit_Types.UInt4;
   subtype HPRT_PSPD_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype HCCHAR_MPSIZ_Field is Interfaces.Bit_Types.UInt11;
   subtype HCCHAR_EPNUM_Field is Interfaces.Bit_Types.UInt4;
   subtype HCCHAR_EPTYP_Field is Interfaces.Bit_Types.UInt2;
   subtype HCCHAR_MCNT_Field is Interfaces.Bit_Types.UInt2;
   subtype HCCHAR_DAD_Field is Interfaces.Bit_Types.UInt7;
   ...
   subtype HCTSIZ_XFRSIZ_Field is Interfaces.Bit_Types.UInt19;
   subtype HCTSIZ_PKTCNT_Field is Interfaces.Bit_Types.UInt10;
   subtype HCTSIZ_DPID_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype DCFG_DSPD_Field is Interfaces.Bit_Types.UInt2;
   subtype DCFG_DAD_Field is Interfaces.Bit_Types.UInt7;
   subtype DCFG_PFIVL_Field is Interfaces.Bit_Types.UInt2;
   ...
   type DCFG_Register is record
      ...
      --  unspecified
      Reserved_16_31 : Interfaces.Bit_Types.UInt16 := 16#220#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype DCTL_TCTL_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype DSTS_ENUMSPD_Field is Interfaces.Bit_Types.UInt2;
   subtype DSTS_FNSOF_Field is Interfaces.Bit_Types.UInt14;
   subtype DSTS_DEVLNSTS_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype DAINT_IEPINT_Field is Interfaces.Bit_Types.UInt16;
   subtype DAINT_OEPINT_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype DAINTMSK_IEPM_Field is Interfaces.Bit_Types.UInt16;
   subtype DAINTMSK_OEPM_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype DVBUSDIS_VBUSDT_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype DVBUSPULSE_DVBUSP_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype DIEPEMPMSK_INEPTXFEM_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype DIEPCTL0_MPSIZ_Field is Interfaces.Bit_Types.UInt2;
   subtype DIEPCTL0_EPTYP_Field is Interfaces.Bit_Types.UInt2;
   subtype DIEPCTL0_TXFNUM_Field is Interfaces.Bit_Types.UInt4;
   ...
   subtype DTXFSTS_INEPTFSAV_Field is Interfaces.Bit_Types.UInt16;
   ...
   is record
      ...
      CID            : aliased Interfaces.Bit_Types.UInt32;
      --  OTG core LPM configuration register
      ...
      DIEPDMA1       : aliased Interfaces.Bit_Types.UInt32;
      --  This read-only register contains the free space information for the
      --  device IN endpoint Tx FIFO.
      ...
      DIEPDMA2       : aliased Interfaces.Bit_Types.UInt32;
      --  This read-only register contains the free space information for the
      --  device IN endpoint Tx FIFO.
      ...
      DIEPDMA3       : aliased Interfaces.Bit_Types.UInt32;
      --  This read-only register contains the free space information for the
      --  device IN endpoint Tx FIFO.
      ...
      DIEPDMA4       : aliased Interfaces.Bit_Types.UInt32;
      --  This read-only register contains the free space information for the
      --  device IN endpoint Tx FIFO.
      ...
      DIEPDMA5       : aliased Interfaces.Bit_Types.UInt32;
      --  This read-only register contains the free space information for the
      --  device IN endpoint Tx FIFO.
      ...
      DIEPDMA6       : aliased Interfaces.Bit_Types.UInt32;
      --  This register indicates the status of an endpoint with respect to
      --  USB- and AHB-related events. It is shown in Figure724. The
      --  application must read this register when the IN endpoints interrupt
      --  bit of the core interrupt register (IEPINT in GINTSTS) is set. Before
      ...
      DIEPDMA7       : aliased Interfaces.Bit_Types.UInt32;
      --  This register indicates the status of an endpoint with respect to
      --  USB- and AHB-related events. It is shown in Figure724. The
      --  application must read this register when the IN endpoints interrupt
      --  bit of the core interrupt register (IEPINT in GINTSTS) is set. Before
      ...
      DIEPDMA8       : aliased Interfaces.Bit_Types.UInt32;
      --  This section describes the DOEPCTL0 register.
      ...
      DOEPDMA0       : aliased Interfaces.Bit_Types.UInt32;
      --  The application uses this register to control the behavior of each
      --  logical endpoint other than endpoint 0.
      ...
      DOEPDMA1       : aliased Interfaces.Bit_Types.UInt32;
      --  The application uses this register to control the behavior of each
      --  logical endpoint other than endpoint 0.
      ...
      DOEPDMA2       : aliased Interfaces.Bit_Types.UInt32;
      --  The application uses this register to control the behavior of each
      --  logical endpoint other than endpoint 0.
      ...
      DOEPDMA3       : aliased Interfaces.Bit_Types.UInt32;
      --  The application uses this register to control the behavior of each
      --  logical endpoint other than endpoint 0.
      ...
      DOEPDMA4       : aliased Interfaces.Bit_Types.UInt32;
      --  The application uses this register to control the behavior of each
      --  logical endpoint other than endpoint 0.
      ...
      DOEPDMA5       : aliased Interfaces.Bit_Types.UInt32;
      --  The application uses this register to control the behavior of each
      --  logical endpoint other than endpoint 0.
      ...
      DOEPDMA6       : aliased Interfaces.Bit_Types.UInt32;
      --  The application uses this register to control the behavior of each
      --  logical endpoint other than endpoint 0.
      ...
      DOEPDMA7       : aliased Interfaces.Bit_Types.UInt32;
      --  The application uses this register to control the behavior of each
      --  logical endpoint other than endpoint 0.
      ...
      DOEPDMA8       : aliased Interfaces.Bit_Types.UInt32;
      --  This register is available in host and device modes.
