...
package Interfaces.STM32.DMA2D is
   ...
   subtype FGOR_LO_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype BGOR_LO_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype OCOLR_RGB888_BLUE_Field is Interfaces.Bit_Types.Byte;
   subtype OCOLR_RGB888_GREEN_Field is Interfaces.Bit_Types.Byte;
   subtype OCOLR_RGB888_RED_Field is Interfaces.Bit_Types.Byte;
   subtype OCOLR_RGB888_APLHA_Field is Interfaces.Bit_Types.Byte;

   --  output color register
   type OCOLR_RGB888_Register is record
      --  Blue Value
      BLUE  : OCOLR_RGB888_BLUE_Field := 16#0#;
      --  Green Value
      GREEN : OCOLR_RGB888_GREEN_Field := 16#0#;
      --  Red Value
      RED   : OCOLR_RGB888_RED_Field := 16#0#;
      --  Alpha Channel Value
      APLHA : OCOLR_RGB888_APLHA_Field := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;

   for OCOLR_RGB888_Register use record
      BLUE  at 0 range 0 .. 7;
      GREEN at 0 range 8 .. 15;
      RED   at 0 range 16 .. 23;
   ...
   subtype OCOLR_RGB565_BLUE_Field is Interfaces.Bit_Types.UInt5;
   subtype OCOLR_RGB565_GREEN_Field is Interfaces.Bit_Types.UInt6;
   subtype OCOLR_RGB565_RED_Field is Interfaces.Bit_Types.UInt5;

   --  output color register
   type OCOLR_RGB565_Register is record
      --  Blue value in RGB565 mode
      BLUE           : OCOLR_RGB565_BLUE_Field := 16#0#;
      --  Green value in RGB565 mode
      GREEN          : OCOLR_RGB565_GREEN_Field := 16#0#;
      --  Red value in RGB565 mode
      RED            : OCOLR_RGB565_RED_Field := 16#0#;
      --  unspecified
      Reserved_16_31 : Interfaces.Bit_Types.UInt16 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   for OCOLR_RGB565_Register use record
      BLUE           at 0 range 0 .. 4;
   ...
   subtype OCOLR_ARGB1555_BLUE_Field is Interfaces.Bit_Types.UInt5;
   subtype OCOLR_ARGB1555_GREEN_Field is Interfaces.Bit_Types.UInt5;
   subtype OCOLR_ARGB1555_RED_Field is Interfaces.Bit_Types.UInt5;

   --  output color register
   type OCOLR_ARGB1555_Register is record
      --  Blue value in ARGB1555 mode
      BLUE           : OCOLR_ARGB1555_BLUE_Field := 16#0#;
      --  Green value in ARGB1555 mode
      GREEN          : OCOLR_ARGB1555_GREEN_Field := 16#0#;
      --  Red value in ARGB1555 mode
      RED            : OCOLR_ARGB1555_RED_Field := 16#0#;
      --  Alpha channel value in ARGB1555 mode
      A              : Boolean := False;
      --  unspecified
      Reserved_16_31 : Interfaces.Bit_Types.UInt16 := 16#0#;
   end record
   ...
   for OCOLR_ARGB1555_Register use record
      BLUE           at 0 range 0 .. 4;
   ...
   subtype OCOLR_ARGB4444_BLUE_Field is Interfaces.Bit_Types.UInt4;
   subtype OCOLR_ARGB4444_GREEN_Field is Interfaces.Bit_Types.UInt4;
   subtype OCOLR_ARGB4444_RED_Field is Interfaces.Bit_Types.UInt4;
   subtype OCOLR_ARGB4444_ALPHA_Field is Interfaces.Bit_Types.UInt4;

   --  output color register
   type OCOLR_ARGB4444_Register is record
      --  Blue value in ARGB4444 mode
      BLUE           : OCOLR_ARGB4444_BLUE_Field := 16#0#;
      --  Green value in ARGB4444 mode
      GREEN          : OCOLR_ARGB4444_GREEN_Field := 16#0#;
      --  Red value in ARGB4444 mode
      RED            : OCOLR_ARGB4444_RED_Field := 16#0#;
      --  Alpha channel value in ARGB4444
      ALPHA          : OCOLR_ARGB4444_ALPHA_Field := 16#0#;
      --  unspecified
      Reserved_16_31 : Interfaces.Bit_Types.UInt16 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   for OCOLR_ARGB4444_Register use record
      BLUE           at 0 range 0 .. 3;
   ...
   subtype OOR_LO_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype NLR_NL_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype LWR_LW_Field is Interfaces.Bit_Types.UInt16;
   ...
   is record
      ...
      FGMAR          : aliased Interfaces.Bit_Types.UInt32;
      --  foreground offset register
      FGOR           : aliased FGOR_Register;
      --  background memory address register
      BGMAR          : aliased Interfaces.Bit_Types.UInt32;
      --  background offset register
      ...
      FGCMAR         : aliased Interfaces.Bit_Types.UInt32;
      --  background CLUT memory address register
      BGCMAR         : aliased Interfaces.Bit_Types.UInt32;
      --  output PFC control register
      OPFCCR         : aliased OPFCCR_Register;
      --  output memory address register
      OMAR           : aliased Interfaces.Bit_Types.UInt32;
      --  output offset register
      ...
      case Discriminent is
         when Rgb888 =>
            --  output color register
            OCOLR_RGB888 : aliased OCOLR_RGB888_Register;
         when Rgb565 =>
            --  output color register
            OCOLR_RGB565 : aliased OCOLR_RGB565_Register;
         when Argb1555 =>
            --  output color register
            OCOLR_ARGB1555 : aliased OCOLR_ARGB1555_Register;
         when Argb4444 =>
            --  output color register
            OCOLR_ARGB4444 : aliased OCOLR_ARGB4444_Register;
      end case;
   end record
   ...
   for DMA2D_Peripheral use record
      ...
      OCOLR_RGB888   at 16#38# range 0 .. 31;
      OCOLR_RGB565   at 16#38# range 0 .. 31;
      OCOLR_ARGB1555 at 16#38# range 0 .. 31;
      OCOLR_ARGB4444 at 16#38# range 0 .. 31;
   end record;
   ...
   --  DMA2D controller
   SEC_DMA2D_Periph : aliased DMA2D_Peripheral
     with Import, Address => SEC_DMA2D_Base;
