...
package Interfaces.STM32.CORDIC is
   ...
   subtype CSR_FUNC_Field is Interfaces.Bit_Types.UInt4;
   subtype CSR_PRECISION_Field is Interfaces.Bit_Types.UInt4;
   subtype CSR_SCALE_Field is Interfaces.Bit_Types.UInt3;
   ...
   type CORDIC_Peripheral is record
      ...
      WDATA : aliased Interfaces.Bit_Types.UInt32;
      --  FMAC Read Data register
      RDATA : aliased Interfaces.Bit_Types.UInt32;
   end record
     with Volatile;
