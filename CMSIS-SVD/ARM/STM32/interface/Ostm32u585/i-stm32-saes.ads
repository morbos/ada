...
package Interfaces.STM32.SAES is
   ...
   subtype CR_KMOD_Field is Interfaces.Bit_Types.UInt2;
   subtype CR_KSHAREID_Field is Interfaces.Bit_Types.UInt2;
   subtype CR_KEYSEL_Field is Interfaces.Bit_Types.UInt3;
   ...
   subtype DPACFGR_TRIMCFG_Field is Interfaces.Bit_Types.UInt2;
