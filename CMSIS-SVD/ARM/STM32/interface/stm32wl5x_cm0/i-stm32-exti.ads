...
package Interfaces.STM32.EXTI is
   ...
   subtype RTSR1_RT_Field is Interfaces.Bit_Types.UInt17;
   subtype RTSR1_RT21_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype FTSR1_FT_Field is Interfaces.Bit_Types.UInt17;
   subtype FTSR1_FT21_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype SWIER1_SWI_Field is Interfaces.Bit_Types.UInt17;
   subtype SWIER1_SWI21_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype PR1_PIF_Field is Interfaces.Bit_Types.UInt17;
   subtype PR1_PIF21_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype RTSR2_RT34_Field is Interfaces.Bit_Types.Bit;
   --  RTSR2_RT array element
   subtype RTSR2_RT_Element is Interfaces.Bit_Types.Bit;

   --  RTSR2_RT array
   type RTSR2_RT_Field_Array is array (40 .. 41) of RTSR2_RT_Element
   ...
   subtype RTSR2_RT45_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype FTSR2_FT34_Field is Interfaces.Bit_Types.Bit;
   --  FTSR2_FT array element
   subtype FTSR2_FT_Element is Interfaces.Bit_Types.Bit;

   --  FTSR2_FT array
   type FTSR2_FT_Field_Array is array (40 .. 41) of FTSR2_FT_Element
     with Component_Size => 1, Size => 2;
   ...
   subtype FTSR2_FT45_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype SWIER2_SWI34_Field is Interfaces.Bit_Types.Bit;
   --  SWIER2_SWI array element
   subtype SWIER2_SWI_Element is Interfaces.Bit_Types.Bit;

   --  SWIER2_SWI array
   type SWIER2_SWI_Field_Array is array (40 .. 41) of SWIER2_SWI_Element
     with Component_Size => 1, Size => 2;
   ...
   subtype SWIER2_SWI45_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype PR2_PIF34_Field is Interfaces.Bit_Types.Bit;
   --  PR2_PIF array element
   subtype PR2_PIF_Element is Interfaces.Bit_Types.Bit;

   --  PR2_PIF array
   type PR2_PIF_Field_Array is array (40 .. 41) of PR2_PIF_Element
     with Component_Size => 1, Size => 2;
   ...
   subtype PR2_PIF45_Field is Interfaces.Bit_Types.Bit;
   ...
   --  C1EMR1_EM array element
   subtype C1EMR1_EM_Element is Interfaces.Bit_Types.Bit;

   --  C1EMR1_EM array
   type C1EMR1_EM_Field_Array is array (0 .. 15) of C1EMR1_EM_Element
   ...
   --  C1EMR1_EM array
   type C1EMR1_EM_Field_Array_1 is array (17 .. 22) of C1EMR1_EM_Element
   ...
   subtype C1IMR2_IM34_Field is Interfaces.Bit_Types.Bit;
   --  C1IMR2_IM array element
   subtype C1IMR2_IM_Element is Interfaces.Bit_Types.Bit;

   --  C1IMR2_IM array
   type C1IMR2_IM_Field_Array is array (36 .. 46) of C1IMR2_IM_Element
   ...
   --  C1EMR2_EM array element
   subtype C1EMR2_EM_Element is Interfaces.Bit_Types.Bit;

   --  C1EMR2_EM array
   type C1EMR2_EM_Field_Array is array (40 .. 41) of C1EMR2_EM_Element
     with Component_Size => 1, Size => 2;
   ...
   --  C2EMR1_EM array element
   subtype C2EMR1_EM_Element is Interfaces.Bit_Types.Bit;

   --  C2EMR1_EM array
   type C2EMR1_EM_Field_Array is array (0 .. 15) of C2EMR1_EM_Element
     with Component_Size => 1, Size => 16;
   ...
   --  C2EMR1_EM array
   type C2EMR1_EM_Field_Array_1 is array (17 .. 22) of C2EMR1_EM_Element
     with Component_Size => 1, Size => 6;
   ...
   subtype C2IMR2_IM34_Field is Interfaces.Bit_Types.Bit;
   --  C2IMR2_IM array element
   subtype C2IMR2_IM_Element is Interfaces.Bit_Types.Bit;

   --  C2IMR2_IM array
   type C2IMR2_IM_Field_Array is array (36 .. 46) of C2IMR2_IM_Element
     with Component_Size => 1, Size => 11;
   ...
   --  C2EMR2_EM array element
   subtype C2EMR2_EM_Element is Interfaces.Bit_Types.Bit;

   --  C2EMR2_EM array
   type C2EMR2_EM_Field_Array is array (40 .. 41) of C2EMR2_EM_Element
     with Component_Size => 1, Size => 2;
   ...
   type EXTI_Peripheral is record
      ...
      C1IMR1 : aliased Interfaces.Bit_Types.UInt32;
      --  event mask register
      ...
      --  interrupt mask register
      C2IMR1 : aliased Interfaces.Bit_Types.UInt32;
      --  event mask register
