...
package Interfaces.STM32.HSEM is
   ...
   subtype HSEM_R_COREID_Field is Interfaces.Bit_Types.UInt4;
   subtype HSEM_R_LOCK_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype HSEM_RLR_COREID_Field is Interfaces.Bit_Types.UInt4;
   subtype HSEM_RLR_LOCK_Field is Interfaces.Bit_Types.Bit;
   ...
   type HSEM_RLR_Register is record
      ...
      --  unspecified
      Reserved_12_30 : Interfaces.Bit_Types.UInt19;
   ...
   --  HSEM_C1IER_ISE array element
   subtype HSEM_C1IER_ISE_Element is Interfaces.Bit_Types.Bit;

   --  HSEM_C1IER_ISE array
   type HSEM_C1IER_ISE_Field_Array is array (0 .. 15)
     of HSEM_C1IER_ISE_Element
   ...
   --  HSEM_C1ICR_ISC array element
   subtype HSEM_C1ICR_ISC_Element is Interfaces.Bit_Types.Bit;

   --  HSEM_C1ICR_ISC array
   type HSEM_C1ICR_ISC_Field_Array is array (0 .. 15)
     of HSEM_C1ICR_ISC_Element
     with Component_Size => 1, Size => 16;
   ...
   --  HSEM_C1ISR_ISF array element
   subtype HSEM_C1ISR_ISF_Element is Interfaces.Bit_Types.Bit;

   --  HSEM_C1ISR_ISF array
   type HSEM_C1ISR_ISF_Field_Array is array (0 .. 15)
     of HSEM_C1ISR_ISF_Element
     with Component_Size => 1, Size => 16;
   ...
   --  HSEM_C1MISR_MISF array element
   subtype HSEM_C1MISR_MISF_Element is Interfaces.Bit_Types.Bit;

   --  HSEM_C1MISR_MISF array
   type HSEM_C1MISR_MISF_Field_Array is array (0 .. 15)
     of HSEM_C1MISR_MISF_Element
     with Component_Size => 1, Size => 16;
   ...
   --  HSEM_C2IER_ISE array element
   subtype HSEM_C2IER_ISE_Element is Interfaces.Bit_Types.Bit;

   --  HSEM_C2IER_ISE array
   type HSEM_C2IER_ISE_Field_Array is array (0 .. 15)
     of HSEM_C2IER_ISE_Element
     with Component_Size => 1, Size => 16;
   ...
   --  HSEM_C2ICR_ISC array element
   subtype HSEM_C2ICR_ISC_Element is Interfaces.Bit_Types.Bit;

   --  HSEM_C2ICR_ISC array
   type HSEM_C2ICR_ISC_Field_Array is array (0 .. 15)
     of HSEM_C2ICR_ISC_Element
     with Component_Size => 1, Size => 16;
   ...
   --  HSEM_C2ISR_ISF array element
   subtype HSEM_C2ISR_ISF_Element is Interfaces.Bit_Types.Bit;

   --  HSEM_C2ISR_ISF array
   type HSEM_C2ISR_ISF_Field_Array is array (0 .. 15)
     of HSEM_C2ISR_ISF_Element
     with Component_Size => 1, Size => 16;
   ...
   --  HSEM_C2MISR_MISF array element
   subtype HSEM_C2MISR_MISF_Element is Interfaces.Bit_Types.Bit;

   --  HSEM_C2MISR_MISF array
   type HSEM_C2MISR_MISF_Field_Array is array (0 .. 15)
     of HSEM_C2MISR_MISF_Element
     with Component_Size => 1, Size => 16;
   ...
   subtype HSEM_CR_COREID_Field is Interfaces.Bit_Types.UInt4;
