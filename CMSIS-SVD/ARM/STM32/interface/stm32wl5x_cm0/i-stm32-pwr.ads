...
package Interfaces.STM32.PWR is
   ...
   subtype CR1_SUBGHZSPINSSSEL_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CR3_EULPEN_Field is Interfaces.Bit_Types.Bit;
   subtype CR3_EWPVD_Field is Interfaces.Bit_Types.Bit;
   subtype CR3_RRS_Field is Interfaces.Bit_Types.Bit;
   subtype CR3_APC_Field is Interfaces.Bit_Types.Bit;
   subtype CR3_EWRFBUSY_Field is Interfaces.Bit_Types.Bit;
   subtype CR3_EWRFIRQ_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CR4_WRFBUSYP_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype SR1_WPVDF_Field is Interfaces.Bit_Types.Bit;
   subtype SR1_WRFBUSYF_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype SR2_C2BOOTS_Field is Interfaces.Bit_Types.Bit;
   subtype SR2_RFBUSYS_Field is Interfaces.Bit_Types.Bit;
   subtype SR2_RFBUSYMS_Field is Interfaces.Bit_Types.Bit;
   subtype SR2_SMPSRDY_Field is Interfaces.Bit_Types.Bit;
   subtype SR2_LDORDY_Field is Interfaces.Bit_Types.Bit;
   subtype SR2_RFEOLF_Field is Interfaces.Bit_Types.Bit;
   subtype SR2_REGMRS_Field is Interfaces.Bit_Types.Bit;
   subtype SR2_FLASHRDY_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype SCR_CWPVDF_Field is Interfaces.Bit_Types.Bit;
   subtype SCR_CWRFBUSYF_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CR5_RFEOLEN_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype C2CR3_EWPVD_Field is Interfaces.Bit_Types.Bit;
   subtype C2CR3_APC_Field is Interfaces.Bit_Types.Bit;
   subtype C2CR3_EWRFBUSY_Field is Interfaces.Bit_Types.Bit;
   subtype C2CR3_EWRFIRQ_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype EXTSCR_C1STOP2F_Field is Interfaces.Bit_Types.Bit;
   subtype EXTSCR_C1STOPF_Field is Interfaces.Bit_Types.Bit;
   subtype EXTSCR_C2SBF_Field is Interfaces.Bit_Types.Bit;
   subtype EXTSCR_C2STOP2F_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype SECCFGR_C2EWILA_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype SUBGHZSPICR_NSS_Field is Interfaces.Bit_Types.Bit;
