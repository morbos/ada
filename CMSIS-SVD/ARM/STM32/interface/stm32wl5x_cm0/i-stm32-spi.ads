...
package Interfaces.STM32.SPI is
   ...
   subtype SR_CHSIDE_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype I2SCFGR_CHLEN_Field is Interfaces.Bit_Types.Bit;
   subtype I2SCFGR_DATLEN_Field is Interfaces.Bit_Types.UInt2;
   subtype I2SCFGR_CKPOL_Field is Interfaces.Bit_Types.Bit;
   subtype I2SCFGR_I2SSTD_Field is Interfaces.Bit_Types.UInt2;
   subtype I2SCFGR_PCMSYNC_Field is Interfaces.Bit_Types.Bit;
   subtype I2SCFGR_I2SCFG_Field is Interfaces.Bit_Types.UInt2;
   subtype I2SCFGR_I2SE_Field is Interfaces.Bit_Types.Bit;
   subtype I2SCFGR_I2SMOD_Field is Interfaces.Bit_Types.Bit;
   subtype I2SCFGR_ASTRTEN_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype I2SPR_ODD_Field is Interfaces.Bit_Types.Bit;
   subtype I2SPR_MCKOE_Field is Interfaces.Bit_Types.Bit;
