...
package Interfaces.STM32.GPIO is
   ...
   subtype OTYPER_OT3_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype IDR_IDR3_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype ODR_ODR3_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype BSRR_BS3_Field is Interfaces.Bit_Types.Bit;
   subtype BSRR_BR3_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype LCKR_LCK3_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype BRR_BR3_Field is Interfaces.Bit_Types.Bit;
