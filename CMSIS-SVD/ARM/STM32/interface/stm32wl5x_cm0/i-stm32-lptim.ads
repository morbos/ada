...
package Interfaces.STM32.LPTIM is
   ...
   subtype ISR_UE_Field is Interfaces.Bit_Types.Bit;
   subtype ISR_REPOK_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype ICR_UECF_Field is Interfaces.Bit_Types.Bit;
   subtype ICR_REPOKCF_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype IER_UEIE_Field is Interfaces.Bit_Types.Bit;
   subtype IER_REPOKIE_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype LPTIM1_OR_OR_0_Field is Interfaces.Bit_Types.Bit;
   subtype LPTIM1_OR_OR_1_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype LPTIM2_OR_OR_0_Field is Interfaces.Bit_Types.Bit;
   subtype LPTIM2_OR_OR_1_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype LPTIM3_OR_OR_0_Field is Interfaces.Bit_Types.Bit;
   subtype LPTIM3_OR_OR_1_Field is Interfaces.Bit_Types.Bit;
