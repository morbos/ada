...
package Interfaces.STM32.AdavanceTIM is
   pragma Preelaborate;
   ...
   subtype SMCR_SMS_3_Field is Interfaces.Bit_Types.Bit;
   subtype SMCR_TS3_4_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype CCMR1_Output_OC1M_3_Field is Interfaces.Bit_Types.Bit;
   subtype CCMR1_Output_OC2M_3_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CCMR2_Output_OC3M_3_Field is Interfaces.Bit_Types.Bit;
   subtype CCMR2_Output_OC4M_3_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype RCR_REP_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype CCR2_CCR2_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype CCR3_CCR3_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype CCR4_CCR4_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype CCMR3OutputComparemode_OC5FE_Field is Interfaces.Bit_Types.Bit;
   subtype CCMR3OutputComparemode_OC5PE_Field is Interfaces.Bit_Types.Bit;
   subtype CCMR3OutputComparemode_OC5M_Field is Interfaces.Bit_Types.UInt3;
   subtype CCMR3OutputComparemode_OC5CE_Field is Interfaces.Bit_Types.Bit;
   subtype CCMR3OutputComparemode_OC6FE_Field is Interfaces.Bit_Types.Bit;
   subtype CCMR3OutputComparemode_OC6PE_Field is Interfaces.Bit_Types.Bit;
   subtype CCMR3OutputComparemode_OC6M_Field is Interfaces.Bit_Types.UInt3;
   subtype CCMR3OutputComparemode_OC6CE_Field is Interfaces.Bit_Types.Bit;
   subtype CCMR3OutputComparemode_OC5M_3_Field is Interfaces.Bit_Types.Bit;
   subtype CCMR3OutputComparemode_OC6M_3_Field is Interfaces.Bit_Types.Bit;
   ...
   type CCMR3OutputComparemode_Register is record
      ...
      --  OC5FE
      OC5FE          : CCMR3OutputComparemode_OC5FE_Field := 16#0#;
      --  OC5PE
      OC5PE          : CCMR3OutputComparemode_OC5PE_Field := 16#0#;
      --  OC5M
      OC5M           : CCMR3OutputComparemode_OC5M_Field := 16#0#;
      --  OC5CE
      OC5CE          : CCMR3OutputComparemode_OC5CE_Field := 16#0#;
      --  unspecified
      Reserved_8_9   : Interfaces.Bit_Types.UInt2 := 16#0#;
      --  OC6FE
      OC6FE          : CCMR3OutputComparemode_OC6FE_Field := 16#0#;
      --  OC6PE
      OC6PE          : CCMR3OutputComparemode_OC6PE_Field := 16#0#;
      --  OC6M
      OC6M           : CCMR3OutputComparemode_OC6M_Field := 16#0#;
      --  OC6CE
      OC6CE          : CCMR3OutputComparemode_OC6CE_Field := 16#0#;
      --  OC5M
      OC5M_3         : CCMR3OutputComparemode_OC5M_3_Field := 16#0#;
      --  unspecified
      Reserved_17_23 : Interfaces.Bit_Types.UInt7 := 16#0#;
      --  OC6M
      OC6M_3         : CCMR3OutputComparemode_OC6M_3_Field := 16#0#;
      --  unspecified
      Reserved_25_31 : Interfaces.Bit_Types.UInt7 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype CCR5_CCR5_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype CCR6_CCR6_Field is Interfaces.Bit_Types.UInt16;
   ...
   subtype AF1_BKINE_Field is Interfaces.Bit_Types.Bit;
   subtype AF1_BKCMP1E_Field is Interfaces.Bit_Types.Bit;
   subtype AF1_BKCMP2E_Field is Interfaces.Bit_Types.Bit;
   subtype AF1_BKINP_Field is Interfaces.Bit_Types.Bit;
   subtype AF1_BKCMP1P_Field is Interfaces.Bit_Types.Bit;
   subtype AF1_BKCMP2P_Field is Interfaces.Bit_Types.Bit;
   subtype AF1_ResETRSEL_Field is Interfaces.Bit_Types.UInt4;

   --  alternate function option register 1
   type AF1_Register is record
      --  BRK BKIN input enable
      BKINE          : AF1_BKINE_Field := 16#1#;
      --  BRK COMP1 enable
...
end Interfaces.STM32.AdavanceTIM;
